...
public final class ClassReference implements KClass<Object>, ClassBasedDeclarationContainer {
    ...
    static {
        ...
        for (Object obj : listListOf) {
            ...
            arrayList.add(TuplesKt.m2729to((Class) obj, Integer.valueOf(i)));
            i = i2;
        }
        ...
        map.put(CommonCssConstants.DOUBLE, "kotlin.Double");
        ...
        for (String str : collectionValues) {
            ...
            Pair pairM2729to = TuplesKt.m2729to(sb.append(StringsKt.substringAfterLast$default(str, ClassUtils.PACKAGE_SEPARATOR_CHAR, (String) null, 2, (Object) null)).append("CompanionObject").toString(), str + ".Companion");
            map3.put(pairM2729to.getFirst(), pairM2729to.getSecond());
        }
