...
public interface SendChannel<E> {
    ...
    void mo4887invokeOnClose(Function1<? super Throwable, Unit> handler);
    ...
    Object mo4818trySendJP2dKIU(E element);
    ...
    public static final class DefaultImpls {
        ...
        public static <E> boolean offer(SendChannel<? super E> sendChannel, E e) throws Throwable {
            ...
            if (ChannelResult.m4839isSuccessimpl(objMo4818trySendJP2dKIU)) {
                return true;
            }
            Throwable thM4833exceptionOrNullimpl = ChannelResult.m4833exceptionOrNullimpl(objMo4818trySendJP2dKIU);
