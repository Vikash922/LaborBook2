...
public interface ReceiveChannel<E> {
    ...
    @DebugMetadata(m2734c = "kotlinx.coroutines.channels.ReceiveChannel$DefaultImpls", m2735f = "Channel.kt", m2736i = {}, m2737l = {380}, m2738m = "receiveOrNull", m2739n = {}, m2740s = {})
    static final class C41451<E> extends ContinuationImpl {
        int label;
        /* synthetic */ Object result;

        C41451(Continuation<? super C41451> continuation) {
            super(continuation);
        }
    ...
    Object mo4822receiveCatchingJP2dKIU(Continuation<? super ChannelResult<? extends E>> continuation);
    ...
    Object mo4823tryReceivePtdJZtk();
    ...
    public static final class DefaultImpls {
        ...
        public static <E> E poll(ReceiveChannel<? extends E> receiveChannel) throws Throwable {
            Object objMo4823tryReceivePtdJZtk = receiveChannel.mo4823tryReceivePtdJZtk();
            if (ChannelResult.m4839isSuccessimpl(objMo4823tryReceivePtdJZtk)) {
                return (E) ChannelResult.m4835getOrThrowimpl(objMo4823tryReceivePtdJZtk);
            }
            Throwable thM4833exceptionOrNullimpl = ChannelResult.m4833exceptionOrNullimpl(objMo4823tryReceivePtdJZtk);
            if (thM4833exceptionOrNullimpl == null) {
                return null;
            }
            throw StackTraceRecoveryKt.recoverStackTrace(thM4833exceptionOrNullimpl);
        }
        ...
        */
        public static <E> java.lang.Object receiveOrNull(kotlinx.coroutines.channels.ReceiveChannel<? extends E> r4, kotlin.coroutines.Continuation<? super E> r5) {
            /*
                boolean r0 = r5 instanceof kotlinx.coroutines.channels.ReceiveChannel.C41451
                if (r0 == 0) goto L14
                r0 = r5
                kotlinx.coroutines.channels.ReceiveChannel$receiveOrNull$1 r0 = (kotlinx.coroutines.channels.ReceiveChannel.C41451) r0
                int r1 = r0.label
            ...
            L38:
                kotlin.ResultKt.throwOnFailure(r5)
                r0.label = r3
                java.lang.Object r4 = r4.mo4822receiveCatchingJP2dKIU(r0)
                if (r4 != r1) goto L44
                return r1
            L44:
                java.lang.Object r4 = kotlinx.coroutines.channels.ChannelResult.m4834getOrNullimpl(r4)
                return r4
            */
