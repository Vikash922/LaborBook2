...
public class ConflatedBufferedChannel<E> extends BufferedChannel<E> {
    ...
    static /* synthetic */ <E> Object send$suspendImpl(ConflatedBufferedChannel<E> conflatedBufferedChannel, E e, Continuation<? super Unit> continuation) throws Throwable {
        ...
        Object objM4846trySendImplMj0NB7M = conflatedBufferedChannel.m4846trySendImplMj0NB7M(e, true);
        if (objM4846trySendImplMj0NB7M instanceof ChannelResult.Closed) {
            ChannelResult.m4833exceptionOrNullimpl(objM4846trySendImplMj0NB7M);
    ...
    static /* synthetic */ <E> Object sendBroadcast$suspendImpl(ConflatedBufferedChannel<E> conflatedBufferedChannel, E e, Continuation<? super Boolean> continuation) {
        Object objM4846trySendImplMj0NB7M = conflatedBufferedChannel.m4846trySendImplMj0NB7M(e, true);
        if (!(objM4846trySendImplMj0NB7M instanceof ChannelResult.Failed)) {
    ...
    public Object mo4818trySendJP2dKIU(E element) {
        return m4846trySendImplMj0NB7M(element, false);
    }

    /* JADX INFO: renamed from: trySendImpl-Mj0NB7M, reason: not valid java name */
    private final Object m4846trySendImplMj0NB7M(E element, boolean isSendOp) {
        return this.onBufferOverflow == BufferOverflow.DROP_LATEST ? m4845trySendDropLatestMj0NB7M(element, isSendOp) : m4824trySendDropOldestJP2dKIU(element);
    }

    /* JADX INFO: renamed from: trySendDropLatest-Mj0NB7M, reason: not valid java name */
    private final Object m4845trySendDropLatestMj0NB7M(E element, boolean isSendOp) {
        Function1<E, Unit> function1;
        UndeliveredElementException undeliveredElementExceptionCallUndeliveredElementCatchingException$default;
        Object objMo4818trySendJP2dKIU = super.mo4818trySendJP2dKIU(element);
        if (ChannelResult.m4839isSuccessimpl(objMo4818trySendJP2dKIU) || ChannelResult.m4837isClosedimpl(objMo4818trySendJP2dKIU)) {
            return objMo4818trySendJP2dKIU;
        }
    ...
    protected void registerSelectForSend(SelectInstance<?> select, Object element) {
        Object objMo4818trySendJP2dKIU = mo4818trySendJP2dKIU(element);
        if (!(objMo4818trySendJP2dKIU instanceof ChannelResult.Failed)) {
            select.selectInRegistrationPhase(Unit.INSTANCE);
        } else {
            if (!(objMo4818trySendJP2dKIU instanceof ChannelResult.Closed)) {
                throw new IllegalStateException("unreachable".toString());
            }
            ChannelResult.m4833exceptionOrNullimpl(objMo4818trySendJP2dKIU);
