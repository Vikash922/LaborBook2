...
final class SubscribedSharedFlow<T> implements SharedFlow<T> {
    ...
    @DebugMetadata(m2734c = "kotlinx.coroutines.flow.SubscribedSharedFlow", m2735f = "Share.kt", m2736i = {}, m2737l = {WalletConstants.ERROR_CODE_MERCHANT_ACCOUNT_ERROR}, m2738m = "collect", m2739n = {}, m2740s = {})
    static final class C42651 extends ContinuationImpl {
        int label;
        /* synthetic */ Object result;
        final /* synthetic */ SubscribedSharedFlow<T> this$0;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C42651(SubscribedSharedFlow<T> subscribedSharedFlow, Continuation<? super C42651> continuation) {
            super(continuation);
    ...
    */
    public java.lang.Object collect(kotlinx.coroutines.flow.FlowCollector<? super T> r6, kotlin.coroutines.Continuation<?> r7) {
        /*
            r5 = this;
            boolean r0 = r7 instanceof kotlinx.coroutines.flow.SubscribedSharedFlow.C42651
            if (r0 == 0) goto L14
            r0 = r7
            kotlinx.coroutines.flow.SubscribedSharedFlow$collect$1 r0 = (kotlinx.coroutines.flow.SubscribedSharedFlow.C42651) r0
            int r1 = r0.label
