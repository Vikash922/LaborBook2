...
public final class SubscribedFlowCollector<T> implements FlowCollector<T> {
    ...
    @DebugMetadata(m2734c = "kotlinx.coroutines.flow.SubscribedFlowCollector", m2735f = "Share.kt", m2736i = {0, 0}, m2737l = {415, 419}, m2738m = "onSubscription", m2739n = {"this", "safeCollector"}, m2740s = {"L$0", "L$1"})
    static final class C42641 extends ContinuationImpl {
        Object L$0;
        Object L$1;
        int label;
        ...
        C42641(SubscribedFlowCollector<T> subscribedFlowCollector, Continuation<? super C42641> continuation) {
            super(continuation);
    ...
    */
    public final java.lang.Object onSubscription(kotlin.coroutines.Continuation<? super kotlin.Unit> r7) {
        /*
            r6 = this;
            boolean r0 = r7 instanceof kotlinx.coroutines.flow.SubscribedFlowCollector.C42641
            if (r0 == 0) goto L14
            r0 = r7
            kotlinx.coroutines.flow.SubscribedFlowCollector$onSubscription$1 r0 = (kotlinx.coroutines.flow.SubscribedFlowCollector.C42641) r0
            int r1 = r0.label
