...
final /* synthetic */ class FlowKt__MigrationKt {
    ...
    /* JADX INFO: compiled from: Migration.kt */
    @Metadata(m2721d1 = {"\u0000\u0012\n\u0000\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0003\u0010\u0000\u001a\u00020\u0001\"\u0004\b\u0000\u0010\u0002*\b\u0012\u0004\u0012\u0002H\u00020\u00032\u0006\u0010\u0004\u001a\u00020\u0005H\u008a@"}, m2722d2 = {"<anonymous>", "", "T", "Lkotlinx/coroutines/flow/FlowCollector;", "e", ""}, m2723k = 3, m2724mv = {1, 9, 0}, m2726xi = 48)
    @DebugMetadata(m2734c = "kotlinx.coroutines.flow.FlowKt__MigrationKt$onErrorReturn$2", m2735f = "Migration.kt", m2736i = {}, m2737l = {302}, m2738m = "invokeSuspend", m2739n = {}, m2740s = {})
    static final class C42092<T> extends SuspendLambda implements Function3<FlowCollector<? super T>, Throwable, Continuation<? super Unit>, Object> {
        ...
        C42092(Function1<? super Throwable, Boolean> function1, T t, Continuation<? super C42092> continuation) {
        ...
        public final Object invoke(FlowCollector<? super T> flowCollector, Throwable th, Continuation<? super Unit> continuation) {
            C42092 c42092 = new C42092(this.$predicate, this.$fallback, continuation);
            c42092.L$0 = flowCollector;
            c42092.L$1 = th;
            return c42092.invokeSuspend(Unit.INSTANCE);
        }
    ...
    public static final <T> Flow<T> onErrorReturn(Flow<? extends T> flow, T t, Function1<? super Throwable, Boolean> function1) {
        return FlowKt.m4847catch(flow, new C42092(function1, t, null));
    }
    ...
    /* JADX INFO: compiled from: Migration.kt */
    @Metadata(m2721d1 = {"\u0000\f\n\u0000\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\u0010\u0000\u001a\u00020\u0001\"\u0004\b\u0000\u0010\u0002*\b\u0012\u0004\u0012\u0002H\u00020\u0003H\u008a@"}, m2722d2 = {"<anonymous>", "", "T", "Lkotlinx/coroutines/flow/FlowCollector;"}, m2723k = 3, m2724mv = {1, 9, 0}, m2726xi = 48)
    @DebugMetadata(m2734c = "kotlinx.coroutines.flow.FlowKt__MigrationKt$delayFlow$1", m2735f = "Migration.kt", m2736i = {}, m2737l = {WalletConstants.ERROR_CODE_AUTHENTICATION_FAILURE}, m2738m = "invokeSuspend", m2739n = {}, m2740s = {})
    static final class C42071<T> extends SuspendLambda implements Function2<FlowCollector<? super T>, Continuation<? super Unit>, Object> {
        final /* synthetic */ long $timeMillis;
        int label;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C42071(long j, Continuation<? super C42071> continuation) {
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return new C42071(this.$timeMillis, continuation);
        }

        @Override // kotlin.jvm.functions.Function2
        public final Object invoke(FlowCollector<? super T> flowCollector, Continuation<? super Unit> continuation) {
            return ((C42071) create(flowCollector, continuation)).invokeSuspend(Unit.INSTANCE);
        }
    ...
    public static final <T> Flow<T> delayFlow(Flow<? extends T> flow, long j) {
        return FlowKt.onStart(flow, new C42071(j, null));
    }

    /* JADX INFO: Add missing generic type declarations: [T] */
    /* JADX INFO: renamed from: kotlinx.coroutines.flow.FlowKt__MigrationKt$delayEach$1 */
    /* JADX INFO: compiled from: Migration.kt */
    @Metadata(m2721d1 = {"\u0000\n\n\u0000\n\u0002\u0010\u0002\n\u0002\b\u0002\u0010\u0000\u001a\u00020\u0001\"\u0004\b\u0000\u0010\u00022\u0006\u0010\u0003\u001a\u0002H\u0002H\u008a@"}, m2722d2 = {"<anonymous>", "", "T", "it"}, m2723k = 3, m2724mv = {1, 9, 0}, m2726xi = 48)
    @DebugMetadata(m2734c = "kotlinx.coroutines.flow.FlowKt__MigrationKt$delayEach$1", m2735f = "Migration.kt", m2736i = {}, m2737l = {TypedValues.CycleType.TYPE_WAVE_PERIOD}, m2738m = "invokeSuspend", m2739n = {}, m2740s = {})
    static final class C42061<T> extends SuspendLambda implements Function2<T, Continuation<? super Unit>, Object> {
        final /* synthetic */ long $timeMillis;
        int label;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C42061(long j, Continuation<? super C42061> continuation) {
            super(2, continuation);
            this.$timeMillis = j;
        }
        ...
        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return new C42061(this.$timeMillis, continuation);
        }

        @Override // kotlin.jvm.functions.Function2
        public final Object invoke(T t, Continuation<? super Unit> continuation) {
            return ((C42061) create(t, continuation)).invokeSuspend(Unit.INSTANCE);
        }
    ...
    public static final <T> Flow<T> delayEach(Flow<? extends T> flow, long j) {
        return FlowKt.onEach(flow, new C42061(j, null));
    }
