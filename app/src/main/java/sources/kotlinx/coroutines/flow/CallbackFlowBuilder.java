...
final class CallbackFlowBuilder<T> extends ChannelFlowBuilder<T> {
    ...
    @DebugMetadata(m2734c = "kotlinx.coroutines.flow.CallbackFlowBuilder", m2735f = "Builders.kt", m2736i = {0}, m2737l = {TIFFConstants.TIFFTAG_SUBIFD}, m2738m = "collectTo", m2739n = {"scope"}, m2740s = {"L$0"})
    static final class C41571 extends ContinuationImpl {
        Object L$0;
        int label;
        ...
        C41571(CallbackFlowBuilder<T> callbackFlowBuilder, Continuation<? super C41571> continuation) {
            super(continuation);
    ...
    */
    protected java.lang.Object collectTo(kotlinx.coroutines.channels.ProducerScope<? super T> r5, kotlin.coroutines.Continuation<? super kotlin.Unit> r6) {
        /*
            r4 = this;
            boolean r0 = r6 instanceof kotlinx.coroutines.flow.CallbackFlowBuilder.C41571
            if (r0 == 0) goto L14
            r0 = r6
            kotlinx.coroutines.flow.CallbackFlowBuilder$collectTo$1 r0 = (kotlinx.coroutines.flow.CallbackFlowBuilder.C41571) r0
            int r1 = r0.label
