...
final class PublisherAsFlow<T> extends ChannelFlow<T> {
    ...
    @DebugMetadata(m2734c = "kotlinx.coroutines.reactive.PublisherAsFlow", m2735f = "ReactiveFlow.kt", m2736i = {0, 0, 0, 0, 1, 1, 1, 1}, m2737l = {94, 96}, m2738m = "collectImpl", m2739n = {"this", "collector", "subscriber", "consumed", "this", "collector", "subscriber", "consumed"}, m2740s = {"L$0", "L$1", "L$2", "J$0", "L$0", "L$1", "L$2", "J$0"})
    static final class C42901 extends ContinuationImpl {
        long J$0;
        Object L$0;
        Object L$1;
        Object L$2;
        ...
        C42901(PublisherAsFlow<T> publisherAsFlow, Continuation<? super C42901> continuation) {
            super(continuation);
    ...
    @DebugMetadata(m2734c = "kotlinx.coroutines.reactive.PublisherAsFlow$collectSlowPath$2", m2735f = "ReactiveFlow.kt", m2736i = {}, m2737l = {83}, m2738m = "invokeSuspend", m2739n = {}, m2740s = {})
    static final class C42912 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        C42912(FlowCollector<? super T> flowCollector, PublisherAsFlow<T> publisherAsFlow, Continuation<? super C42912> continuation) {
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            C42912 c42912 = new C42912(this.$collector, this.this$0, continuation);
            c42912.L$0 = obj;
            return c42912;
        }
    ...
    public final Object collectSlowPath(FlowCollector<? super T> flowCollector, Continuation<? super Unit> continuation) {
        Object objCoroutineScope = CoroutineScopeKt.coroutineScope(new C42912(flowCollector, this, null), continuation);
