...
public final class PublisherCoroutine<T> extends AbstractCoroutine<Unit> implements ProducerScope<T>, Subscription {
    ...
    /* JADX INFO: renamed from: kotlinx.coroutines.reactive.PublisherCoroutine$send$1 */
    /* JADX INFO: compiled from: Publish.kt */
    @Metadata(m2723k = 3, m2724mv = {1, 9, 0}, m2726xi = 48)
    @DebugMetadata(m2734c = "kotlinx.coroutines.reactive.PublisherCoroutine", m2735f = "Publish.kt", m2736i = {0, 0}, m2737l = {128}, m2738m = "send", m2739n = {"this", "element"}, m2740s = {"L$0", "L$1"})
    static final class C42931 extends ContinuationImpl {
        ...
        C42931(PublisherCoroutine<? super T> publisherCoroutine, Continuation<? super C42931> continuation) {
            super(continuation);
    ...
    public final void registerSelectForSend(SelectInstance<?> select, Object element) {
        if (!Mutex.DefaultImpls.tryLock$default(this.mutex, null, 1, null)) {
            BuildersKt__Builders_commonKt.launch$default(this, null, null, new C42921(this, select, null), 3, null);
        } else {
            select.selectInRegistrationPhase(Unit.INSTANCE);
        }
    }

    /* JADX INFO: renamed from: kotlinx.coroutines.reactive.PublisherCoroutine$registerSelectForSend$1 */
    /* JADX INFO: compiled from: Publish.kt */
    @Metadata(m2721d1 = {"\u0000\f\n\u0000\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\u0010\u0000\u001a\u00020\u0001\"\u0006\b\u0000\u0010\u0002 \u0000*\u00020\u0003H\u008a@"}, m2722d2 = {"<anonymous>", "", "T", "Lkotlinx/coroutines/CoroutineScope;"}, m2723k = 3, m2724mv = {1, 9, 0}, m2726xi = 48)
    @DebugMetadata(m2734c = "kotlinx.coroutines.reactive.PublisherCoroutine$registerSelectForSend$1", m2735f = "Publish.kt", m2736i = {}, m2737l = {104}, m2738m = "invokeSuspend", m2739n = {}, m2740s = {})
    static final class C42921 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        /* JADX WARN: Multi-variable type inference failed */
        C42921(PublisherCoroutine<? super T> publisherCoroutine, SelectInstance<?> selectInstance, Continuation<? super C42921> continuation) {
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return new C42921(this.this$0, this.$select, continuation);
        }
    ...
    */
    public java.lang.Object send(T r5, kotlin.coroutines.Continuation<? super kotlin.Unit> r6) throws java.lang.Throwable {
        /*
            r4 = this;
            boolean r0 = r6 instanceof kotlinx.coroutines.reactive.PublisherCoroutine.C42931
            if (r0 == 0) goto L14
            r0 = r6
            kotlinx.coroutines.reactive.PublisherCoroutine$send$1 r0 = (kotlinx.coroutines.reactive.PublisherCoroutine.C42931) r0
            int r1 = r0.label
