...
public final class WorkQueue {
    ...
    private final Task pollWithExclusiveMode(boolean onlyBlocking) {
        ...
        do {
            ...
            return null;
        } while (!C0214xc40028dd.m8m(lastScheduledTask$volatile$FU, this, task, null));
        return task;
    }
    ...
    private final Task tryExtractFromTheMiddle(int index, boolean onlyBlocking) {
        ...
        if (task != null) {
            if ((task.taskContext.getTaskMode() == 1) == onlyBlocking && C2185xa7a47114.m442m(this.buffer, i, task, null)) {
                if (onlyBlocking) {
    ...
    private final long tryStealLastScheduled(int stealingMode, Ref.ObjectRef<Task> stolenTaskRef) {
        ...
        } while (!C0214xc40028dd.m8m(lastScheduledTask$volatile$FU, this, r0, null));
