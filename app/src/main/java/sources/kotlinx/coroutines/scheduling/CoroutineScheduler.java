...
public final class CoroutineScheduler implements Executor, Closeable {
    ...
    */
        ...
        for (int i6 = 1; i6 < iCurrentLength; i6++) {
            ...
            if (worker != null) {
                ...
                if (i7 == 1) {
                    ...
                    i++;
                    arrayList.add(new StringBuilder().append(size$kotlinx_coroutines_core).append(Barcode128.CODE_AB_TO_C).toString());
                } else if (i7 == 4) {
                    i4++;
                    if (size$kotlinx_coroutines_core > 0) {
                        arrayList.add(new StringBuilder().append(size$kotlinx_coroutines_core).append(Barcode128.CODE_AC_TO_B).toString());
                    }
                } else if (i7 == 5) {
                    i5++;
                }
    ...
    /* JADX INFO: compiled from: CoroutineScheduler.kt */
    @Metadata(m2721d1 = {"\u0000\f\n\u0002\u0018\u0002\n\u0002\u0010\u0010\n\u0002\b\u0007\b\u0086\u0081\u0002\u0018\u00002\b\u0012\u0004\u0012\u00020\u00000\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002j\u0002\b\u0003j\u0002\b\u0004j\u0002\b\u0005j\u0002\b\u0006j\u0002\b\u0007¨\u0006\b"}, m2722d2 = {"Lkotlinx/coroutines/scheduling/CoroutineScheduler$WorkerState;", "", "(Ljava/lang/String;I)V", "CPU_ACQUIRED", "BLOCKING", "PARKING", "DORMANT", "TERMINATED", "kotlinx-coroutines-core"}, m2723k = 1, m2724mv = {1, 9, 0}, m2726xi = 48)
