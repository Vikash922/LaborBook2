...
@Metadata(m2721d1 = {"\u0000T\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\t\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0002\n\u0000\n\u0002\u0010\u000e\n\u0002\b\u0002\b\u0002\u0018\u00002\u00020\u0001:\u0001\u001aB\r\u0012\u0006\u0010\u0002\u001a\u00020\u0003¢\u0006\u0002\u0010\u0004J\b\u0010\u000b\u001a\u00020\fH\u0016J$\u0010\r\u001a\u00020\u000e2\n\u0010\u000f\u001a\u00060\u0010j\u0002`\u00112\u0006\u0010\u0012\u001a\u00020\u00132\u0006\u0010\u0014\u001a\u00020\u0015H\u0016J\b\u0010\u0016\u001a\u00020\u0017H\u0016J\b\u0010\u0018\u001a\u00020\u0019H\u0016R\u0010\u0010\u0002\u001a\u00020\u00038\u0006X\u0087\u0004¢\u0006\u0002\n\u0000R\u000e\u0010\u0005\u001a\u00020\u0006X\u0082\u0004¢\u0006\u0002\n\u0000R\u000e\u0010\u0007\u001a\u00020\bX\u0082\u0004¢\u0006\u0002\n\u0000R\t\u0010\t\u001a\u00020\nX\u0082\u0004¨\u0006\u001b"}, m2722d2 = {"Lkotlinx/coroutines/rx3/DispatcherScheduler;", "Lio/reactivex/rxjava3/core/Scheduler;", "dispatcher", "Lkotlinx/coroutines/CoroutineDispatcher;", "(Lkotlinx/coroutines/CoroutineDispatcher;)V", "schedulerJob", "Lkotlinx/coroutines/CompletableJob;", "scope", "Lkotlinx/coroutines/CoroutineScope;", "workerCounter", "Lkotlinx/atomicfu/AtomicLong;", "createWorker", "Lio/reactivex/rxjava3/core/Scheduler$Worker;", "scheduleDirect", "Lio/reactivex/rxjava3/disposables/Disposable;", "block", "Ljava/lang/Runnable;", "Lkotlinx/coroutines/Runnable;", "delay", "", "unit", "Ljava/util/concurrent/TimeUnit;", "shutdown", "", InAppPurchaseConstants.METHOD_TO_STRING, "", "DispatcherWorker", "kotlinx-coroutines-rx3"}, m2723k = 1, m2724mv = {1, 9, 0}, m2726xi = 48)
final class DispatcherScheduler extends Scheduler {
    ...
    static final class DispatcherWorker extends Scheduler.Worker {
        ...
        public DispatcherWorker(long j, CoroutineDispatcher coroutineDispatcher, Job job) {
            ...
            BuildersKt__Builders_commonKt.launch$default(CoroutineScope, null, null, new C42951(null), 3, null);
        }

        /* JADX INFO: renamed from: kotlinx.coroutines.rx3.DispatcherScheduler$DispatcherWorker$1 */
        /* JADX INFO: compiled from: RxScheduler.kt */
        @Metadata(m2721d1 = {"\u0000\n\n\u0000\n\u0002\u0010\u0002\n\u0002\u0018\u0002\u0010\u0000\u001a\u00020\u0001*\u00020\u0002H\u008a@"}, m2722d2 = {"<anonymous>", "", "Lkotlinx/coroutines/CoroutineScope;"}, m2723k = 3, m2724mv = {1, 9, 0}, m2726xi = 48)
        @DebugMetadata(m2734c = "kotlinx.coroutines.rx3.DispatcherScheduler$DispatcherWorker$1", m2735f = "RxScheduler.kt", m2736i = {0, 1}, m2737l = {Opcodes.INVOKEDYNAMIC, 78}, m2738m = "invokeSuspend", m2739n = {"$this$consume$iv$iv", "$this$consume$iv$iv"}, m2740s = {"L$0", "L$0"})
        static final class C42951 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
            Object L$0;
            Object L$1;
            int label;
            ...
            public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
                return DispatcherWorker.this.new C42951(continuation);
            }
            ...
            */
            public final java.lang.Object invokeSuspend(java.lang.Object r8) {
                ...
                L75:
                    ...
                    throw r0
                */
                throw new UnsupportedOperationException("Method not decompiled: kotlinx.coroutines.rx3.DispatcherScheduler.DispatcherWorker.C42951.invokeSuspend(java.lang.Object):java.lang.Object");
            }
        }
            ...
            return RxSchedulerKt.scheduleTask(this.workerScope, block, unit.toMillis(delay), new Function1<Function1<? super Continuation<? super Unit>, ? extends Object>, Runnable>() { // from class: kotlinx.coroutines.rx3.DispatcherScheduler$DispatcherWorker$schedule$1
                ...
                public final Runnable invoke(final Function1<? super Continuation<? super Unit>, ? extends Object> function1) {
                    ...
                    return new Runnable() { // from class: kotlinx.coroutines.rx3.DispatcherScheduler$DispatcherWorker$schedule$1$invoke$$inlined$Runnable$1
                        @Override // java.lang.Runnable
                        public final void run() {
                            dispatcherWorker.blockChannel.mo4818trySendJP2dKIU(function1);
                        }
                    };
                }
            });
