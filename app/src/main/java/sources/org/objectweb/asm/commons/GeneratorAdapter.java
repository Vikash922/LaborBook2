...
public class GeneratorAdapter extends LocalVariablesSorter {
    ...
    public static final int f4758EQ = 153;

    /* JADX INFO: renamed from: GE */
    public static final int f4759GE = 156;

    /* JADX INFO: renamed from: GT */
    public static final int f4760GT = 157;

    /* JADX INFO: renamed from: LE */
    public static final int f4761LE = 158;

    /* JADX INFO: renamed from: LT */
    public static final int f4762LT = 155;
    public static final int MUL = 104;

    /* JADX INFO: renamed from: NE */
    public static final int f4763NE = 154;
    public static final int NEG = 116;

    /* JADX INFO: renamed from: OR */
    public static final int f4764OR = 128;
    ...
    public void push(Type type) {
        ...
        switch (type.getSort()) {
            case 1:
                this.f4754mv.visitFieldInsn(Opcodes.GETSTATIC, "java/lang/Boolean", "TYPE", CLASS_DESCRIPTOR);
                break;
            case 2:
                this.f4754mv.visitFieldInsn(Opcodes.GETSTATIC, "java/lang/Character", "TYPE", CLASS_DESCRIPTOR);
                break;
            case 3:
                this.f4754mv.visitFieldInsn(Opcodes.GETSTATIC, "java/lang/Byte", "TYPE", CLASS_DESCRIPTOR);
                break;
            case 4:
                this.f4754mv.visitFieldInsn(Opcodes.GETSTATIC, "java/lang/Short", "TYPE", CLASS_DESCRIPTOR);
                break;
            case 5:
                this.f4754mv.visitFieldInsn(Opcodes.GETSTATIC, "java/lang/Integer", "TYPE", CLASS_DESCRIPTOR);
                break;
            case 6:
                this.f4754mv.visitFieldInsn(Opcodes.GETSTATIC, "java/lang/Float", "TYPE", CLASS_DESCRIPTOR);
                break;
            case 7:
                this.f4754mv.visitFieldInsn(Opcodes.GETSTATIC, "java/lang/Long", "TYPE", CLASS_DESCRIPTOR);
                break;
            case 8:
                this.f4754mv.visitFieldInsn(Opcodes.GETSTATIC, "java/lang/Double", "TYPE", CLASS_DESCRIPTOR);
                break;
            default:
    ...
    public void loadThis() {
        ...
        this.f4754mv.visitVarInsn(25, 0);
    }
    ...
    public void math(int i, Type type) {
        this.f4754mv.visitInsn(type.getOpcode(i));
    }

    public void not() {
        this.f4754mv.visitInsn(4);
        this.f4754mv.visitInsn(130);
    }
    ...
    public void cast(Type type, Type type2) {
        if (type != type2) {
            ...
            InstructionAdapter.cast(this.f4754mv, type, type2);
        }
    }
    ...
    public void ifCmp(Type type, int i, Label label) {
        ...
        switch (type.getSort()) {
            case 6:
                this.f4754mv.visitInsn((i == 156 || i == 157) ? Opcodes.FCMPL : Opcodes.FCMPG);
                break;
            case 7:
                this.f4754mv.visitInsn(Opcodes.LCMP);
                break;
            case 8:
                this.f4754mv.visitInsn((i == 156 || i == 157) ? Opcodes.DCMPL : Opcodes.DCMPG);
                break;
            case 9:
            case 10:
                if (i == 153) {
            ...
            default:
                ...
                this.f4754mv.visitJumpInsn(i2, label);
                return;
        }
        this.f4754mv.visitJumpInsn(i, label);
    }
    ...
    public void tableSwitch(int[] iArr, TableSwitchGenerator tableSwitchGenerator, boolean z) {
        ...
        if (iArr.length > 0) {
            ...
            if (z) {
                ...
                this.f4754mv.visitTableSwitchInsn(i3, i4, labelNewLabel, labelArr);
                while (i2 < i5) {
                ...
                this.f4754mv.visitLookupSwitchInsn(labelNewLabel, iArr, labelArr2);
                while (i2 < length) {
                    mark(labelArr2[i2]);
    ...
    public void returnValue() {
        this.f4754mv.visitInsn(this.returnType.getOpcode(Opcodes.IRETURN));
    }

    private void fieldInsn(int i, Type type, String str, Type type2) {
        this.f4754mv.visitFieldInsn(i, type.getInternalName(), str, type2.getDescriptor());
    }
    ...
    private void invokeInsn(int i, Type type, Method method, boolean z) {
        this.f4754mv.visitMethodInsn(i, type.getSort() == 9 ? type.getDescriptor() : type.getInternalName(), method.getName(), method.getDescriptor(), z);
    }
    ...
    private void typeInsn(int i, Type type) {
        this.f4754mv.visitTypeInsn(i, type.getInternalName());
    }
    ...
    public void newArray(Type type) {
        InstructionAdapter.newarray(this.f4754mv, type);
    }
    ...
    public void endMethod() {
        if ((this.access & 1024) == 0) {
            this.f4754mv.visitMaxs(0, 0);
        }
        this.f4754mv.visitEnd();
    }

    public void catchException(Label label, Label label2, Type type) {
        Label label3 = new Label();
        if (type == null) {
            this.f4754mv.visitTryCatchBlock(label, label2, label3, null);
        } else {
            this.f4754mv.visitTryCatchBlock(label, label2, label3, type.getInternalName());
        }
        mark(label3);
    }
}
