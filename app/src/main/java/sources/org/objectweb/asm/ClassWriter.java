...
public class ClassWriter extends ClassVisitor {
    ...
    public final FieldVisitor visitField(int i, String str, String str2, String str3, Object obj) {
        ...
        if (this.firstField == null) {
            ...
            this.lastField.f4753fv = fieldWriter;
        }
    ...
    public final MethodVisitor visitMethod(int i, String str, String str2, String str3, String[] strArr) {
        ...
        if (this.firstMethod == null) {
            ...
            this.lastMethod.f4754mv = methodWriter;
        }
    ...
    public byte[] toByteArray() {
        ...
        int i4 = 0;
        for (FieldWriter fieldWriter = this.firstField; fieldWriter != null; fieldWriter = (FieldWriter) fieldWriter.f4753fv) {
            i4++;
            iComputeAttributesSize += fieldWriter.computeFieldInfoSize();
        }
        int i5 = 0;
        for (MethodWriter methodWriter = this.firstMethod; methodWriter != null; methodWriter = (MethodWriter) methodWriter.f4754mv) {
            i5++;
        ...
        for (FieldWriter fieldWriter2 = this.firstField; fieldWriter2 != null; fieldWriter2 = (FieldWriter) fieldWriter2.f4753fv) {
            fieldWriter2.putFieldInfo(byteVector5);
        }
        byteVector5.putShort(i5);
        boolean zHasFrames = false;
        boolean zHasAsmInstructions = false;
        for (MethodWriter methodWriter2 = this.firstMethod; methodWriter2 != null; methodWriter2 = (MethodWriter) methodWriter2.f4754mv) {
