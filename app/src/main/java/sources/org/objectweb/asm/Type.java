...
public final class Type {
    ...
    private void appendDescriptor(StringBuilder sb) {
        ...
        if (i == 10) {
            ...
            sb.append(Matrix.MATRIX_TYPE_RANDOM_LT).append((CharSequence) this.valueBuffer, this.valueBegin, this.valueEnd).append(';');
        } else {
    ...
    private static void appendDescriptor(Class<?> cls, StringBuilder sb) {
        ...
        sb.append(Matrix.MATRIX_TYPE_RANDOM_LT).append(getInternalName(cls)).append(';');
    }
