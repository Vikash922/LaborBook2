...
public final class ViewModelParameter<T> {
    ...
    public ViewModelParameter(KClass<T> clazz, Qualifier qualifier, Function0<? extends DefinitionParameters> function0, Bundle bundle, ViewModelStore viewModelStore, SavedStateRegistryOwner savedStateRegistryOwner) {
