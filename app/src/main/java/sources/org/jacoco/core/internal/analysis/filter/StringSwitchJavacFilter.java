    ...
    private static class Matcher extends AbstractMatcher {
        ...
        boolean match(AbstractInsnNode abstractInsnNode, AbstractInsnNode abstractInsnNode2) {
            ...
            if (this.cursor != null && this.cursor.getOpcode() == 2) {
                nextIsVar(54, SvgConstants.Attributes.PATH_DATA_REL_CURVE_TO);
                nextIsVar(25, SvgConstants.Attributes.PATH_DATA_REL_CURVE_TO_S);
                ...
                do {
                    ...
                    if (this.cursor.getNext() != abstractInsnNode2) {
                        ...
                        nextIsVar(21, SvgConstants.Attributes.PATH_DATA_REL_CURVE_TO);
                        nextIsSwitch();
