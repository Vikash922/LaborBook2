...
class ProbeInserter extends MethodVisitor implements IProbeInserter {
    ...
    public void insertProbe(int i) {
        this.f4754mv.visitVarInsn(25, this.variable);
        InstrSupport.push(this.f4754mv, i);
        this.f4754mv.visitInsn(4);
        this.f4754mv.visitInsn(84);
    }

    @Override // org.objectweb.asm.MethodVisitor
    public void visitCode() {
        this.f4754mv.visitLabel(this.beginLabel);
        this.accessorStackSize = this.arrayStrategy.storeInstance(this.f4754mv, this.clinit, this.variable);
        this.f4754mv.visitCode();
    }

    @Override // org.objectweb.asm.MethodVisitor
    public final void visitVarInsn(int i, int i2) {
        this.f4754mv.visitVarInsn(i, map(i2));
    }

    @Override // org.objectweb.asm.MethodVisitor
    public final void visitIincInsn(int i, int i2) {
        this.f4754mv.visitIincInsn(map(i), i2);
    }

    @Override // org.objectweb.asm.MethodVisitor
    public final void visitLocalVariable(String str, String str2, String str3, Label label, Label label2, int i) {
        if (i < this.variable) {
            this.f4754mv.visitLocalVariable(str, str2, str3, this.beginLabel, label2, i);
        } else {
            this.f4754mv.visitLocalVariable(str, str2, str3, label, label2, map(i));
        }
    }
    ...
    public AnnotationVisitor visitLocalVariableAnnotation(int i, TypePath typePath, Label[] labelArr, Label[] labelArr2, int[] iArr, String str, boolean z) {
        ...
        return this.f4754mv.visitLocalVariableAnnotation(i, typePath, labelArr, labelArr2, iArr2, str, z);
    }

    @Override // org.objectweb.asm.MethodVisitor
    public void visitMaxs(int i, int i2) {
        this.f4754mv.visitMaxs(Math.max(i + 3, this.accessorStackSize), i2 + 1);
    }
    ...
    public final void visitFrame(int i, int i2, Object[] objArr, int i3, Object[] objArr2) {
        ...
        while (true) {
            if (i5 < i2 || i6 <= this.variable) {
                ...
                this.f4754mv.visitFrame(i, i7, objArr3, i3, objArr2);
                return;
            }
        }
    }
