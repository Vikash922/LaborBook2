...
public class ClassProbesAdapter extends ClassVisitor implements IProbeIdGenerator {
    ...
    private final ClassProbesVisitor f4746cv;
    private String name;
    ...
    public ClassProbesAdapter(ClassProbesVisitor classProbesVisitor, boolean z) {
        ...
        this.counter = 0;
        this.f4746cv = classProbesVisitor;
        this.trackFrames = z;
    }
    ...
    public final MethodVisitor visitMethod(int i, String str, String str2, String str3, String[] strArr) {
        MethodProbesVisitor methodProbesVisitorVisitMethod = this.f4746cv.visitMethod(i, str, str2, str3, strArr);
    ...
    @Override // org.objectweb.asm.ClassVisitor
    public void visitEnd() {
        this.f4746cv.visitTotalProbeCount(this.counter);
        super.visitEnd();
    }
