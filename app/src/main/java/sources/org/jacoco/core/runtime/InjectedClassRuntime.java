...
public class InjectedClassRuntime extends AbstractRuntime {
    ...
    public InjectedClassRuntime(Class<?> cls, String str) {
        this.locator = cls;
        this.injectedClassName = cls.getPackage().getName().replace(ClassUtils.PACKAGE_SEPARATOR_CHAR, '/') + '/' + str;
    }
    ...
    private static byte[] createClass(String str) {
        ...
        classWriter.visit(53, FragmentTransaction.TRANSIT_FRAGMENT_OPEN, str.replace(ClassUtils.PACKAGE_SEPARATOR_CHAR, '/'), null, "java/lang/Object", null);
