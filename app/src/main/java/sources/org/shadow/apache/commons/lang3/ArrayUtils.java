...
import org.shadow.apache.commons.lang3.mutable.MutableInt;
...
public class ArrayUtils {
    ...
    public static <T> T[] removeElements(T[] tArr, T... tArr2) {
        ...
        for (Map.Entry entry : map.entrySet()) {
            ...
            int i2 = 0;
            while (i < iIntValue) {
                int iIndexOf = indexOf(tArr, key, i2);
                if (iIndexOf < 0) {
                    break;
                }
                bitSet.set(iIndexOf);
    ...
    public static byte[] removeElements(byte[] bArr, byte... bArr2) {
        ...
        for (Map.Entry entry : map.entrySet()) {
            ...
            int i2 = 0;
            while (i < iIntValue) {
                int iIndexOf = indexOf(bArr, b2.byteValue(), i2);
                if (iIndexOf < 0) {
                    break;
                }
                bitSet.set(iIndexOf);
    ...
    public static short[] removeElements(short[] sArr, short... sArr2) {
        ...
        for (Map.Entry entry : map.entrySet()) {
            ...
            int i2 = 0;
            while (i < iIntValue) {
                int iIndexOf = indexOf(sArr, sh.shortValue(), i2);
                if (iIndexOf < 0) {
                    break;
                }
                bitSet.set(iIndexOf);
    ...
    public static int[] removeElements(int[] iArr, int... iArr2) {
        ...
        for (Map.Entry entry : map.entrySet()) {
            ...
            int i3 = 0;
            while (i2 < iIntValue) {
                int iIndexOf = indexOf(iArr, num.intValue(), i3);
                if (iIndexOf < 0) {
                    break;
                }
                bitSet.set(iIndexOf);
    ...
    public static char[] removeElements(char[] cArr, char... cArr2) {
        ...
        for (Map.Entry entry : map.entrySet()) {
            ...
            int i2 = 0;
            while (i < iIntValue) {
                int iIndexOf = indexOf(cArr, ch.charValue(), i2);
                if (iIndexOf < 0) {
                    break;
                }
                bitSet.set(iIndexOf);
    ...
    public static long[] removeElements(long[] jArr, long... jArr2) {
        ...
        for (Map.Entry entry : map.entrySet()) {
            ...
            int i2 = 0;
            while (i < iIntValue) {
                int iIndexOf = indexOf(jArr, l.longValue(), i2);
                if (iIndexOf < 0) {
                    break;
                }
                bitSet.set(iIndexOf);
    ...
    public static float[] removeElements(float[] fArr, float... fArr2) {
        ...
        for (Map.Entry entry : map.entrySet()) {
            ...
            int i2 = 0;
            while (i < iIntValue) {
                int iIndexOf = indexOf(fArr, f2.floatValue(), i2);
                if (iIndexOf < 0) {
                    break;
                }
                bitSet.set(iIndexOf);
    ...
    public static double[] removeElements(double[] dArr, double... dArr2) {
        ...
        for (Map.Entry entry : map.entrySet()) {
            ...
            int i2 = 0;
            while (i < iIntValue) {
                int iIndexOf = indexOf(dArr, d2.doubleValue(), i2);
                if (iIndexOf < 0) {
                    break;
                }
                bitSet.set(iIndexOf);
    ...
    public static boolean[] removeElements(boolean[] zArr, boolean... zArr2) {
        ...
        for (Map.Entry entry : map.entrySet()) {
            ...
            int i2 = 0;
            while (i < iIntValue) {
                int iIndexOf = indexOf(zArr, bool.booleanValue(), i2);
                if (iIndexOf < 0) {
                    break;
                }
                bitSet.set(iIndexOf);
    ...
    public static <T extends Comparable<? super T>> boolean isSorted(T[] tArr) {
        return isSorted(tArr, new Comparator<T>() { // from class: org.shadow.apache.commons.lang3.ArrayUtils.1
