...
public class BooleanUtils {
    ...
    public static String toStringYesNo(Boolean bool) {
        return toString(bool, ConstantEventSources.YES, ConstantEventSources.f3418NO, null);
    }
    ...
    public static String toStringYesNo(boolean z) {
        return toString(z, ConstantEventSources.YES, ConstantEventSources.f3418NO);
    }
    ...
    public static boolean m2903or(boolean... zArr) {
        if (zArr == null) {
            throw new IllegalArgumentException("The Array must not be null");
        }
        if (zArr.length == 0) {
    ...
    /* JADX INFO: renamed from: or */
    public static Boolean m2902or(Boolean... boolArr) {
        if (boolArr == null) {
            throw new IllegalArgumentException("The Array must not be null");
        }
        if (boolArr.length == 0) {
        ...
        try {
            return m2903or(ArrayUtils.toPrimitive(boolArr)) ? Boolean.TRUE : Boolean.FALSE;
        } catch (NullPointerException unused) {
            throw new IllegalArgumentException("The array must not contain any null elements");
        }
    }
