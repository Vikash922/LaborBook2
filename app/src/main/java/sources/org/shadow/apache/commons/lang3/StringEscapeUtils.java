...
import org.shadow.apache.commons.lang3.text.translate.AggregateTranslator;
import org.shadow.apache.commons.lang3.text.translate.CharSequenceTranslator;
import org.shadow.apache.commons.lang3.text.translate.EntityArrays;
import org.shadow.apache.commons.lang3.text.translate.JavaUnicodeEscaper;
import org.shadow.apache.commons.lang3.text.translate.LookupTranslator;
import org.shadow.apache.commons.lang3.text.translate.NumericEntityEscaper;
import org.shadow.apache.commons.lang3.text.translate.NumericEntityUnescaper;
import org.shadow.apache.commons.lang3.text.translate.OctalUnescaper;
import org.shadow.apache.commons.lang3.text.translate.UnicodeUnescaper;
import org.shadow.apache.commons.lang3.text.translate.UnicodeUnpairedSurrogateRemover;
...
public class StringEscapeUtils {
    ...
    public static final CharSequenceTranslator ESCAPE_ECMASCRIPT = new AggregateTranslator(new LookupTranslator(new String[]{"'", "\\'"}, new String[]{"\"", "\\\""}, new String[]{"\\", "\\\\"}, new String[]{RemoteSettings.FORWARD_SLASH_STRING, "\\/"}), new LookupTranslator(EntityArrays.JAVA_CTRL_CHARS_ESCAPE()), JavaUnicodeEscaper.outsideOf(32, 127));
    public static final CharSequenceTranslator ESCAPE_JSON = new AggregateTranslator(new LookupTranslator(new String[]{"\"", "\\\""}, new String[]{"\\", "\\\\"}, new String[]{RemoteSettings.FORWARD_SLASH_STRING, "\\/"}), new LookupTranslator(EntityArrays.JAVA_CTRL_CHARS_ESCAPE()), JavaUnicodeEscaper.outsideOf(32, 127));
    ...
    public static final CharSequenceTranslator ESCAPE_XML10 = new AggregateTranslator(new LookupTranslator(EntityArrays.BASIC_ESCAPE()), new LookupTranslator(EntityArrays.APOS_ESCAPE()), new LookupTranslator(new String[]{EventsFileManager.DELIMITER, ""}, new String[]{"\u0001", ""}, new String[]{"\u0002", ""}, new String[]{"\u0003", ""}, new String[]{"\u0004", ""}, new String[]{"\u0005", ""}, new String[]{"\u0006", ""}, new String[]{"\u0007", ""}, new String[]{"\b", ""}, new String[]{"\u000b", ""}, new String[]{"\f", ""}, new String[]{"\u000e", ""}, new String[]{"\u000f", ""}, new String[]{"\u0010", ""}, new String[]{"\u0011", ""}, new String[]{"\u0012", ""}, new String[]{"\u0013", ""}, new String[]{"\u0014", ""}, new String[]{"\u0015", ""}, new String[]{"\u0016", ""}, new String[]{"\u0017", ""}, new String[]{"\u0018", ""}, new String[]{"\u0019", ""}, new String[]{"\u001a", ""}, new String[]{"\u001b", ""}, new String[]{"\u001c", ""}, new String[]{"\u001d", ""}, new String[]{"\u001e", ""}, new String[]{"\u001f", ""}, new String[]{"\ufffe", ""}, new String[]{"\uffff", ""}), NumericEntityEscaper.between(127, 132), NumericEntityEscaper.between(134, Opcodes.IF_ICMPEQ), new UnicodeUnpairedSurrogateRemover());
    public static final CharSequenceTranslator ESCAPE_XML11 = new AggregateTranslator(new LookupTranslator(EntityArrays.BASIC_ESCAPE()), new LookupTranslator(EntityArrays.APOS_ESCAPE()), new LookupTranslator(new String[]{EventsFileManager.DELIMITER, ""}, new String[]{"\u000b", "&#11;"}, new String[]{"\f", "&#12;"}, new String[]{"\ufffe", ""}, new String[]{"\uffff", ""}), NumericEntityEscaper.between(1, 8), NumericEntityEscaper.between(14, 31), NumericEntityEscaper.between(127, 132), NumericEntityEscaper.between(134, Opcodes.IF_ICMPEQ), new UnicodeUnpairedSurrogateRemover());
    ...
    static class CsvEscaper extends CharSequenceTranslator {
        ...
        private static final char[] CSV_SEARCH_CHARS = {CSV_DELIMITER, '\"', CharUtils.f4765CR, '\n'};

        CsvEscaper() {
        }

        @Override // org.shadow.apache.commons.lang3.text.translate.CharSequenceTranslator
