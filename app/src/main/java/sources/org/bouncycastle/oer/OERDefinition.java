...
public class OERDefinition {
    ...
    public static class Builder {
        ...
        public Element build() {
            ...
            for (Builder builder2 : this.children) {
                if (!z2 && builder2.baseType == BaseType.EXTENSION) {
                    if (!builder2.children.isEmpty() || this.baseType == BaseType.CHOICE) {
                        z2 = true;
                    } else {
                        z2 = true;
                    }
        ...
        public Builder items(Object... objArr) {
            ...
            for (int i = 0; i != objArr.length; i++) {
                ...
                if (obj instanceof OptionalList) {
                    ...
                    while (it.hasNext()) {
                        builderCopy.children.add(wrap(false, it.next()));
                    }
        ...
        public Builder label(String str) {
            ...
            builderCopy.explicit = this.explicit;
            return builderCopy;
        }
    ...
    public static class Element {
        ...
        public String appendLabel(String str) {
            ...
            return sb.append(str2).append(this.explicit ? " (E)" : "").append("] ").append(str).toString();
        }
        ...
        public String rangeExpression() {
            StringBuilder sb = new StringBuilder("(");
            BigInteger bigInteger = this.lowerBound;
            StringBuilder sbAppend = sb.append(bigInteger != null ? bigInteger.toString() : "MIN").append(" ... ");
            BigInteger bigInteger2 = this.upperBound;
            return sbAppend.append(bigInteger2 != null ? bigInteger2.toString() : "MAX").append(")").toString();
        }
    }
    ...
    public static Builder extension() {
        return new Builder(BaseType.EXTENSION).label(ShareConstants.MEDIA_EXTENSION);
    }
