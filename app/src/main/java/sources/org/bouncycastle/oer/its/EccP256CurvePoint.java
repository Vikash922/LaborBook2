...
public class EccP256CurvePoint extends EccCurvePoint {
    ...
    */
    public static org.bouncycastle.oer.its.EccP256CurvePoint getInstance(java.lang.Object r3) {
        /*
            boolean r0 = r3 instanceof org.bouncycastle.oer.its.EccP256CurvePoint
            if (r0 == 0) goto L7
            org.bouncycastle.oer.its.EccP256CurvePoint r3 = (org.bouncycastle.oer.its.EccP256CurvePoint) r3
            return r3
        L7:
        ...
        L51:
            org.bouncycastle.oer.its.EccP256CurvePoint$Builder r1 = new org.bouncycastle.oer.its.EccP256CurvePoint$Builder
            r1.<init>()
            int r3 = r3.getTagNo()
            org.bouncycastle.oer.its.EccP256CurvePoint$Builder r3 = r1.setChoice(r3)
            org.bouncycastle.oer.its.EccP256CurvePoint$Builder r3 = r3.setValue(r0)
            org.bouncycastle.oer.its.EccP256CurvePoint r3 = org.bouncycastle.oer.its.EccP256CurvePoint.Builder.access$000(r3)
            return r3
        */
        throw new UnsupportedOperationException("Method not decompiled: org.bouncycastle.oer.its.EccP256CurvePoint.getInstance(java.lang.Object):org.bouncycastle.oer.its.EccP256CurvePoint");
    }
