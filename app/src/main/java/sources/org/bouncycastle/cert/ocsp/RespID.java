...
public class RespID {
    ...
    public RespID(ResponderID responderID) {
        this.f3862id = responderID;
    }

    public RespID(X500Name x500Name) {
        this.f3862id = new ResponderID(x500Name);
    }
    ...
    public RespID(SubjectPublicKeyInfo subjectPublicKeyInfo, DigestCalculator digestCalculator) throws OCSPException {
        try {
            ...
            outputStream.close();
            this.f3862id = new ResponderID(new DEROctetString(digestCalculator.getDigest()));
        } catch (Exception e) {
    ...
    public boolean equals(Object obj) {
        if (obj instanceof RespID) {
            return this.f3862id.equals(((RespID) obj).f3862id);
        }
        return false;
    }

    public int hashCode() {
        return this.f3862id.hashCode();
    }
