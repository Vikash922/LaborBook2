...
public class BCMcElieceCCA2PublicKey implements CipherParameters, PublicKey {
    ...
    public String toString() {
        return (("McEliecePublicKey:\n length of the code         : " + this.params.getN() + StringUtils.f4768LF) + " error correction capability: " + this.params.getT() + StringUtils.f4768LF) + " generator matrix           : " + this.params.getG().toString();
    }
}
