...
class LMOtsSignature implements Encodable {
    ...
    public boolean equals(Object obj) {
        ...
        if (Arrays.equals(this.f4627C, lMOtsSignature.f4627C)) {
            return Arrays.equals(this.f4628y, lMOtsSignature.f4628y);
        }
        return false;
    }
    ...
    public byte[] getEncoded() throws IOException {
        return Composer.compose().u32str(this.type.getType()).bytes(this.f4627C).bytes(this.f4628y).build();
    }
    ...
    public int hashCode() {
        LMOtsParameters lMOtsParameters = this.type;
        return ((((lMOtsParameters != null ? lMOtsParameters.hashCode() : 0) * 31) + Arrays.hashCode(this.f4627C)) * 31) + Arrays.hashCode(this.f4628y);
    }
}
