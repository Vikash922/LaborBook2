...
class LMOtsPublicKey implements Encodable {
    ...
    private final byte[] f4624I;

    /* JADX INFO: renamed from: K */
    private final byte[] f4625K;
    ...
    LMSContext createOtsContext(LMOtsSignature lMOtsSignature) {
        ...
        LmsUtils.byteArray(this.f4624I, digest);
        LmsUtils.u32str(this.f4626q, digest);
    ...
    public boolean equals(Object obj) {
        ...
        if (this.f4626q != lMOtsPublicKey.f4626q) {
            return false;
        }
        ...
        if (Arrays.equals(this.f4624I, lMOtsPublicKey.f4624I)) {
            return Arrays.equals(this.f4625K, lMOtsPublicKey.f4625K);
        }
        return false;
    }
    ...
    public byte[] getEncoded() throws IOException {
        return Composer.compose().u32str(this.parameter.getType()).bytes(this.f4624I).u32str(this.f4626q).bytes(this.f4625K).build();
    }
    ...
    public int hashCode() {
        LMOtsParameters lMOtsParameters = this.parameter;
        return ((((((lMOtsParameters != null ? lMOtsParameters.hashCode() : 0) * 31) + Arrays.hashCode(this.f4624I)) * 31) + this.f4626q) * 31) + Arrays.hashCode(this.f4625K);
    }
}
