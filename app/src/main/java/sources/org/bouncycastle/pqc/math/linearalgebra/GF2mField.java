...
public class GF2mField {
    ...
    private static String polyToString(int i) {
        ...
        String str = ((byte) (i & 1)) == 1 ? AppEventsConstants.EVENT_PARAM_VALUE_YES : "";
        int i2 = i >>> 1;
        int i3 = 1;
        while (i2 != 0) {
            if (((byte) (i2 & 1)) == 1) {
    ...
    public String elementToStr(int i) {
        ...
        for (int i2 = 0; i2 < this.degree; i2++) {
            string = ((((byte) i) & 1) == 0 ? new StringBuilder(AppEventsConstants.EVENT_PARAM_VALUE_NO) : new StringBuilder(AppEventsConstants.EVENT_PARAM_VALUE_YES)).append(string).toString();
            i >>>= 1;
        }
        return string;
    }
