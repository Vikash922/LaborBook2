...
public class JceAsymmetricKeyUnwrapper extends AsymmetricKeyUnwrapper {
    ...
    */
    public org.bouncycastle.operator.GenericKey generateUnwrappedKey(org.bouncycastle.asn1.x509.AlgorithmIdentifier r6, byte[] r7) throws org.bouncycastle.operator.OperatorException {
        /*
            r5 = this;
            org.bouncycastle.operator.jcajce.OperatorHelper r0 = r5.helper     // Catch: javax.crypto.BadPaddingException -> L66 javax.crypto.IllegalBlockSizeException -> L80 java.security.InvalidKeyException -> L9a
            org.bouncycastle.asn1.x509.AlgorithmIdentifier r1 = r5.getAlgorithmIdentifier()     // Catch: javax.crypto.BadPaddingException -> L66 javax.crypto.IllegalBlockSizeException -> L80 java.security.InvalidKeyException -> L9a
            org.bouncycastle.asn1.ASN1ObjectIdentifier r1 = r1.getAlgorithm()     // Catch: javax.crypto.BadPaddingException -> L66 javax.crypto.IllegalBlockSizeException -> L80 java.security.InvalidKeyException -> L9a
            ...
            org.bouncycastle.operator.jcajce.OperatorHelper r1 = r5.helper     // Catch: javax.crypto.BadPaddingException -> L66 javax.crypto.IllegalBlockSizeException -> L80 java.security.InvalidKeyException -> L9a
            org.bouncycastle.asn1.x509.AlgorithmIdentifier r2 = r5.getAlgorithmIdentifier()     // Catch: javax.crypto.BadPaddingException -> L66 javax.crypto.IllegalBlockSizeException -> L80 java.security.InvalidKeyException -> L9a
        ...
        L29:
            org.bouncycastle.operator.jcajce.OperatorHelper r1 = r5.helper     // Catch: java.lang.Throwable -> L47 javax.crypto.BadPaddingException -> L66 javax.crypto.IllegalBlockSizeException -> L80 java.security.InvalidKeyException -> L9a
            org.bouncycastle.asn1.ASN1ObjectIdentifier r2 = r6.getAlgorithm()     // Catch: java.lang.Throwable -> L47 javax.crypto.BadPaddingException -> L66 javax.crypto.IllegalBlockSizeException -> L80 java.security.InvalidKeyException -> L9a
        ...
        L47:
            ...
            org.bouncycastle.asn1.ASN1ObjectIdentifier r0 = r6.getAlgorithm()     // Catch: javax.crypto.BadPaddingException -> L66 javax.crypto.IllegalBlockSizeException -> L80 java.security.InvalidKeyException -> L9a
        ...
        L60:
            org.bouncycastle.operator.jcajce.JceGenericKey r7 = new org.bouncycastle.operator.jcajce.JceGenericKey     // Catch: javax.crypto.BadPaddingException -> L66 javax.crypto.IllegalBlockSizeException -> L80 java.security.InvalidKeyException -> L9a
