...
import org.bouncycastle.asn1.p028bc.BCObjectIdentifiers;
...
import org.bouncycastle.jcajce.p038io.CipherOutputStream;
...
public class JcePKCSPBEOutputEncryptorBuilder {
    ...
    public boolean isPKCS12(ASN1ObjectIdentifier aSN1ObjectIdentifier) {
        return aSN1ObjectIdentifier.m2764on(PKCSObjectIdentifiers.pkcs_12PbeIds) || aSN1ObjectIdentifier.m2764on(BCObjectIdentifiers.bc_pbe_sha1_pkcs12) || aSN1ObjectIdentifier.m2764on(BCObjectIdentifiers.bc_pbe_sha256_pkcs12);
    }
        ...
        try {
            if (isPKCS12(this.algorithm)) {
                ...
                if (MiscObjectIdentifiers.id_scrypt.equals((ASN1Primitive) pBKDFConfigBuild.getAlgorithm())) {
                    ...
                    algorithmIdentifier = new AlgorithmIdentifier(this.algorithm, cipherCreateCipher2.getParameters() != null ? new PBES2Parameters(new KeyDerivationFunc(MiscObjectIdentifiers.id_scrypt, scryptParams), new EncryptionScheme(this.keyEncAlgorithm, ASN1Primitive.fromByteArray(cipherCreateCipher2.getParameters().getEncoded()))) : new PBES2Parameters(new KeyDerivationFunc(MiscObjectIdentifiers.id_scrypt, scryptParams), new EncryptionScheme(this.keyEncAlgorithm)));
