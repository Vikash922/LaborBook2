...
public class SMIMEEnvelopedWriter extends MimeWriter {
    ...
    public static class Builder {
        private static final String[] stdHeaders = {HttpHeaders.CONTENT_TYPE, HttpHeaders.CONTENT_DISPOSITION, "Content-Transfer-Encoding", "Content-Description"};
        private static final String[] stdValues = {"application/pkcs7-mime; name=\"smime.p7m\"; smime-type=enveloped-data", "attachment; filename=\"smime.p7m\"", ResourceResolver.BASE64_IDENTIFIER, "S/MIME Encrypted Message"};
        private final CMSEnvelopedDataStreamGenerator envGen = new CMSEnvelopedDataStreamGenerator();
        private final Map<String, String> headers = new LinkedHashMap();
        String contentTransferEncoding = ResourceResolver.BASE64_IDENTIFIER;
    ...
    public OutputStream getContentStream() throws IOException {
        ...
        try {
            ...
            if (ResourceResolver.BASE64_IDENTIFIER.equals(this.contentTransferEncoding)) {
