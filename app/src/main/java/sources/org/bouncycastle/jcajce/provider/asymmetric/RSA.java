...
public class RSA {
    ...
    public static class Mappings extends AsymmetricAlgorithmProvider {
        ...
        public void configure(ConfigurableProvider configurableProvider) {
            ...
            if (configurableProvider.hasAlgorithm("MessageDigest", DigestAlgorithms.RIPEMD160)) {
                addDigestSignature(configurableProvider, DigestAlgorithms.RIPEMD160, "org.bouncycastle.jcajce.provider.asymmetric.rsa.DigestSignatureSpi$RIPEMD160", TeleTrusTObjectIdentifiers.rsaSignatureWithripemd160);
                ...
                addX931Signature(configurableProvider, DigestAlgorithms.RIPEMD160, "org.bouncycastle.jcajce.provider.asymmetric.rsa.X931SignatureSpi$RIPEMD160WithRSAEncryption");
            }
