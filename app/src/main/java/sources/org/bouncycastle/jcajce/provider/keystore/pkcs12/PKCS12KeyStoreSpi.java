...
public class PKCS12KeyStoreSpi extends KeyStoreSpi implements PKCSObjectIdentifiers, X509ObjectIdentifiers, BCKeyStore {
    ...
    private class CertId {
        ...
        CertId(PublicKey publicKey) {
            this.f4399id = PKCS12KeyStoreSpi.this.createSubjectKeyId(publicKey).getKeyIdentifier();
        }
        ...
        public boolean equals(Object obj) {
            ...
            if (obj instanceof CertId) {
                return Arrays.areEqual(this.f4399id, ((CertId) obj).f4399id);
            }
            return false;
        }

        public int hashCode() {
            return Arrays.hashCode(this.f4399id);
        }
    }
    ...
    protected byte[] cryptData(boolean z, AlgorithmIdentifier algorithmIdentifier, char[] cArr, boolean z2, byte[] bArr) throws IOException {
        ...
        int i = z ? 1 : 2;
        if (!algorithm.m2764on(PKCSObjectIdentifiers.pkcs_12PbeIds)) {
