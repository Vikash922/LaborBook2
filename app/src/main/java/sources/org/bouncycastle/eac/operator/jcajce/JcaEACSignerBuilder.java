...
public class JcaEACSignerBuilder {
    ...
    static {
        ...
        hashtable.put(OidcSecurityUtil.SIGNATURE_ALGORITHM_SHA256, EACObjectIdentifiers.id_TA_RSA_v1_5_SHA_256);
            ...
            return new EACSigner() { // from class: org.bouncycastle.eac.operator.jcajce.JcaEACSignerBuilder.1
                ...
                public byte[] getSignature() {
                    try {
                        ...
                        return aSN1ObjectIdentifier.m2764on(EACObjectIdentifiers.id_TA_ECDSA) ? JcaEACSignerBuilder.reencode(signature2) : signature2;
                    } catch (SignatureException e) {
