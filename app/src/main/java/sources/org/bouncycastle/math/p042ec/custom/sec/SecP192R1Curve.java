...
public class SecP192R1Curve extends ECCurve.AbstractFp {
    ...
    public static final BigInteger f4501q = SecP192R1FieldElement.f4505Q;
    ...
    public SecP192R1Curve() {
        ...
        this.f4448a = fromBigInteger(new BigInteger(1, Hex.decodeStrict("FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFEFFFFFFFFFFFFFFFC")));
        this.f4449b = fromBigInteger(new BigInteger(1, Hex.decodeStrict("64210519E59C80E70FA7E9AB72243049FEB8DEECC146B9B1")));
    ...
    public ECLookupTable createCacheSafeLookupTable(ECPoint[] eCPointArr, int i, final int i2) {
        ...
        for (int i4 = 0; i4 < i2; i4++) {
            ...
            Nat192.copy(((SecP192R1FieldElement) eCPoint.getRawXCoord()).f4506x, 0, iArr, i3);
            Nat192.copy(((SecP192R1FieldElement) eCPoint.getRawYCoord()).f4506x, 0, iArr, i3 + 6);
            i3 += 12;
        }
