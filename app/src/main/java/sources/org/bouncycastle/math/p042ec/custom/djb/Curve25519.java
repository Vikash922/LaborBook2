...
public class Curve25519 extends ECCurve.AbstractFp {
    ...
    public static final BigInteger f4468q = Curve25519FieldElement.f4472Q;
    ...
    public Curve25519() {
        ...
        this.f4448a = fromBigInteger(C_a);
        this.f4449b = fromBigInteger(C_b);
    ...
    public ECLookupTable createCacheSafeLookupTable(ECPoint[] eCPointArr, int i, final int i2) {
        ...
        for (int i4 = 0; i4 < i2; i4++) {
            ...
            Nat256.copy(((Curve25519FieldElement) eCPoint.getRawXCoord()).f4473x, 0, iArr, i3);
            Nat256.copy(((Curve25519FieldElement) eCPoint.getRawYCoord()).f4473x, 0, iArr, i3 + 8);
            i3 += 16;
        }
