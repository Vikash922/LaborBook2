...
public abstract class Ed25519 {
    ...
    private static int checkPoint(int[] iArr, int[] iArr2) {
        ...
        F.sub(iArrCreate3, iArrCreate2, iArrCreate3);
        F.mul(iArrCreate, C_d, iArrCreate);
        F.addOne(iArrCreate);
        F.sub(iArrCreate, iArrCreate3, iArrCreate);
    ...
    private static int checkPoint(int[] iArr, int[] iArr2, int[] iArr3) {
        ...
        F.mul(iArrCreate2, iArrCreate3, iArrCreate);
        F.sub(iArrCreate3, iArrCreate2, iArrCreate3);
        F.mul(iArrCreate3, iArrCreate4, iArrCreate3);
        F.sqr(iArrCreate4, iArrCreate4);
        F.mul(iArrCreate, C_d, iArrCreate);
        F.add(iArrCreate, iArrCreate4, iArrCreate);
        F.sub(iArrCreate, iArrCreate3, iArrCreate);
        F.normalize(iArrCreate);
        return F.isZero(iArrCreate);
    }
    ...
    private static boolean decodePointVar(byte[] bArr, int i, boolean z, PointAffine pointAffine) {
        ...
        F.decode(bArrCopy, 0, pointAffine.y);
        int[] iArrCreate = F.create();
        int[] iArrCreate2 = F.create();
        F.sqr(pointAffine.y, iArrCreate);
        F.mul(C_d, iArrCreate, iArrCreate2);
        F.subOne(iArrCreate);
    ...
    private static int encodePoint(PointAccum pointAccum, byte[] bArr, int i) {
        int[] iArrCreate = F.create();
        int[] iArrCreate2 = F.create();
        F.inv(pointAccum.z, iArrCreate2);
        F.mul(pointAccum.x, iArrCreate2, iArrCreate);
        F.mul(pointAccum.y, iArrCreate2, iArrCreate2);
        F.normalize(iArrCreate);
    ...
    private static void pointAdd(PointExt pointExt, PointAccum pointAccum) {
        ...
        F.apm(pointAccum.y, pointAccum.x, iArrCreate2, iArrCreate);
        F.apm(pointExt.y, pointExt.x, iArrCreate4, iArrCreate3);
        F.mul(iArrCreate, iArrCreate3, iArrCreate);
        F.mul(iArrCreate2, iArrCreate4, iArrCreate2);
        F.mul(pointAccum.u, pointAccum.v, iArrCreate3);
        F.mul(iArrCreate3, pointExt.t, iArrCreate3);
        F.mul(iArrCreate3, C_d2, iArrCreate3);
        F.mul(pointAccum.z, pointExt.z, iArrCreate4);
        F.add(iArrCreate4, iArrCreate4, iArrCreate4);
        F.apm(iArrCreate2, iArrCreate, iArr2, iArr);
        F.apm(iArrCreate4, iArrCreate3, iArrCreate6, iArrCreate5);
        F.carry(iArrCreate6);
        F.mul(iArr, iArrCreate5, pointAccum.x);
        F.mul(iArrCreate6, iArr2, pointAccum.y);
        F.mul(iArrCreate5, iArrCreate6, pointAccum.z);
    }
    ...
    private static void pointAdd(PointExt pointExt, PointExt pointExt2) {
        ...
        F.apm(pointExt.y, pointExt.x, iArrCreate2, iArrCreate);
        F.apm(pointExt2.y, pointExt2.x, iArrCreate4, iArrCreate3);
        F.mul(iArrCreate, iArrCreate3, iArrCreate);
        F.mul(iArrCreate2, iArrCreate4, iArrCreate2);
        F.mul(pointExt.t, pointExt2.t, iArrCreate3);
        F.mul(iArrCreate3, C_d2, iArrCreate3);
        F.mul(pointExt.z, pointExt2.z, iArrCreate4);
        F.add(iArrCreate4, iArrCreate4, iArrCreate4);
        F.apm(iArrCreate2, iArrCreate, iArrCreate8, iArrCreate5);
        F.apm(iArrCreate4, iArrCreate3, iArrCreate7, iArrCreate6);
        F.carry(iArrCreate7);
        F.mul(iArrCreate5, iArrCreate6, pointExt2.x);
        F.mul(iArrCreate7, iArrCreate8, pointExt2.y);
        F.mul(iArrCreate6, iArrCreate7, pointExt2.z);
        F.mul(iArrCreate5, iArrCreate8, pointExt2.t);
    }
    ...
    private static void pointAddPrecomp(PointPrecomp pointPrecomp, PointAccum pointAccum) {
        ...
        int[] iArr2 = pointAccum.v;
        F.apm(pointAccum.y, pointAccum.x, iArrCreate2, iArrCreate);
        F.mul(iArrCreate, pointPrecomp.ymx_h, iArrCreate);
        F.mul(iArrCreate2, pointPrecomp.ypx_h, iArrCreate2);
        F.mul(pointAccum.u, pointAccum.v, iArrCreate3);
        F.mul(iArrCreate3, pointPrecomp.xyd, iArrCreate3);
        F.apm(iArrCreate2, iArrCreate, iArr2, iArr);
        F.apm(pointAccum.z, iArrCreate3, iArrCreate5, iArrCreate4);
        F.carry(iArrCreate5);
        F.mul(iArr, iArrCreate4, pointAccum.x);
        F.mul(iArrCreate5, iArr2, pointAccum.y);
        F.mul(iArrCreate4, iArrCreate5, pointAccum.z);
    }
    ...
    private static void pointAddVar(boolean z, PointExt pointExt, PointAccum pointAccum) {
        ...
        F.mul(pointAccum.z, pointExt.z, iArrCreate4);
        F.add(iArrCreate4, iArrCreate4, iArrCreate4);
        F.apm(iArrCreate2, iArrCreate, iArr6, iArr5);
        F.apm(iArrCreate4, iArrCreate3, iArr4, iArr3);
        F.carry(iArr4);
        F.mul(iArr5, iArrCreate5, pointAccum.x);
        F.mul(iArrCreate6, iArr6, pointAccum.y);
        F.mul(iArrCreate5, iArrCreate6, pointAccum.z);
    }
    ...
    private static void pointAddVar(boolean z, PointExt pointExt, PointExt pointExt2, PointExt pointExt3) {
        ...
        F.apm(iArrCreate4, iArrCreate3, iArr4, iArr3);
        F.carry(iArr4);
        F.mul(iArrCreate5, iArrCreate6, pointExt3.x);
        F.mul(iArrCreate7, iArrCreate8, pointExt3.y);
        F.mul(iArrCreate6, iArrCreate7, pointExt3.z);
        F.mul(iArrCreate5, iArrCreate8, pointExt3.t);
    }
    ...
    private static void pointDouble(PointAccum pointAccum) {
        ...
        int[] iArrCreate5 = F.create();
        int[] iArr2 = pointAccum.v;
        F.sqr(pointAccum.x, iArrCreate);
        F.sqr(pointAccum.y, iArrCreate2);
        F.sqr(pointAccum.z, iArrCreate3);
        F.add(iArrCreate3, iArrCreate3, iArrCreate3);
        F.apm(iArrCreate, iArrCreate2, iArr2, iArrCreate5);
        F.add(pointAccum.x, pointAccum.y, iArr);
        F.sqr(iArr, iArr);
        F.sub(iArr2, iArr, iArr);
        F.add(iArrCreate3, iArrCreate5, iArrCreate4);
        F.carry(iArrCreate4);
        F.mul(iArr, iArrCreate4, pointAccum.x);
        F.mul(iArrCreate5, iArr2, pointAccum.y);
        F.mul(iArrCreate4, iArrCreate5, pointAccum.z);
    ...
    private static int[] pointPrecompute(PointAffine pointAffine, int i) {
        ...
        int[] iArrCreateTable = F.createTable(i * 4);
        int i2 = 0;
        int i3 = 0;
        while (true) {
            F.copy(pointExtPointCopy.x, 0, iArrCreateTable, i2);
            F.copy(pointExtPointCopy.y, 0, iArrCreateTable, i2 + 10);
            F.copy(pointExtPointCopy.z, 0, iArrCreateTable, i2 + 20);
            F.copy(pointExtPointCopy.t, 0, iArrCreateTable, i2 + 30);
            i2 += 40;
            i3++;
            if (i3 == i) {
    ...
    public static void precompute() {
        ...
        synchronized (precompLock) {
            ...
            for (int i3 = 0; i3 < 8; i3++) {
                ...
                int[] iArrCreateTable = F.createTable(8);
                int[] iArrCreate = F.create();
                ...
                while (true) {
                    ...
                    F.copy(iArrCreate, 0, iArrCreateTable, i10 * 10);
                    i9 = i10;
                }
                F.add(iArrCreate, iArrCreate, iArrCreate);
                F.invVar(iArrCreate, iArrCreate);
                int[] iArrCreate2 = F.create();
                while (i9 > 0) {
                    int i11 = i9 - 1;
                    F.copy(iArrCreateTable, i11 * 10, iArrCreate2, 0);
                    F.mul(iArrCreate2, iArrCreate, iArrCreate2);
                    F.copy(iArrCreate2, 0, iArrCreateTable, i9 * 10);
                ...
                for (int i12 = 0; i12 < 8; i12++) {
                    ...
                    int[] iArrCreate3 = F.create();
                    int[] iArrCreate4 = F.create();
                    F.copy(iArrCreateTable, i12 * 10, iArrCreate4, 0);
                    F.mul(pointExt6.x, iArrCreate4, iArrCreate3);
                    F.mul(pointExt6.y, iArrCreate4, iArrCreate4);
                    PointPrecomp pointPrecomp = new PointPrecomp();
                    F.apm(iArrCreate4, iArrCreate3, pointPrecomp.ypx_h, pointPrecomp.ymx_h);
                    F.mul(iArrCreate3, iArrCreate4, pointPrecomp.xyd);
