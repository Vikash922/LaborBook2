...
public class SecP192R1Point extends ECPoint.AbstractFp {
    ...
    public ECPoint add(ECPoint eCPoint) {
        ...
        SecP192R1FieldElement secP192R1FieldElement = (SecP192R1FieldElement) this.f4463x;
        SecP192R1FieldElement secP192R1FieldElement2 = (SecP192R1FieldElement) this.f4464y;
        ...
        SecP192R1FieldElement secP192R1FieldElement5 = (SecP192R1FieldElement) this.f4465zs[0];
        ...
        if (zIsOne) {
            iArr = secP192R1FieldElement3.f4506x;
            iArr2 = secP192R1FieldElement4.f4506x;
        } else {
            SecP192R1Field.square(secP192R1FieldElement5.f4506x, iArrCreate2);
            SecP192R1Field.multiply(iArrCreate2, secP192R1FieldElement3.f4506x, iArrCreate);
            SecP192R1Field.multiply(iArrCreate2, secP192R1FieldElement5.f4506x, iArrCreate2);
            SecP192R1Field.multiply(iArrCreate2, secP192R1FieldElement4.f4506x, iArrCreate2);
            iArr = iArrCreate;
            iArr2 = iArrCreate2;
        }
        boolean zIsOne2 = secP192R1FieldElement6.isOne();
        if (zIsOne2) {
            iArr3 = secP192R1FieldElement.f4506x;
            iArr4 = secP192R1FieldElement2.f4506x;
        } else {
            SecP192R1Field.square(secP192R1FieldElement6.f4506x, iArrCreate3);
            SecP192R1Field.multiply(iArrCreate3, secP192R1FieldElement.f4506x, iArrCreateExt);
            SecP192R1Field.multiply(iArrCreate3, secP192R1FieldElement6.f4506x, iArrCreate3);
            SecP192R1Field.multiply(iArrCreate3, secP192R1FieldElement2.f4506x, iArrCreate3);
            iArr3 = iArrCreateExt;
            iArr4 = iArrCreate3;
        }
        ...
        SecP192R1Field.square(iArrCreate, secP192R1FieldElement7.f4506x);
        SecP192R1Field.subtract(secP192R1FieldElement7.f4506x, iArrCreate5, secP192R1FieldElement7.f4506x);
        SecP192R1FieldElement secP192R1FieldElement8 = new SecP192R1FieldElement(iArrCreate5);
        SecP192R1Field.subtract(iArrCreate2, secP192R1FieldElement7.f4506x, secP192R1FieldElement8.f4506x);
        SecP192R1Field.multiplyAddToExt(secP192R1FieldElement8.f4506x, iArrCreate, iArrCreateExt);
        SecP192R1Field.reduce(iArrCreateExt, secP192R1FieldElement8.f4506x);
        SecP192R1FieldElement secP192R1FieldElement9 = new SecP192R1FieldElement(iArrCreate4);
        if (!zIsOne) {
            SecP192R1Field.multiply(secP192R1FieldElement9.f4506x, secP192R1FieldElement5.f4506x, secP192R1FieldElement9.f4506x);
        }
        if (!zIsOne2) {
            SecP192R1Field.multiply(secP192R1FieldElement9.f4506x, secP192R1FieldElement6.f4506x, secP192R1FieldElement9.f4506x);
        }
    ...
    public ECPoint negate() {
        return isInfinity() ? this : new SecP192R1Point(this.curve, this.f4463x, this.f4464y.negate(), this.f4465zs);
    }
    ...
    public ECPoint twice() {
        ...
        ECCurve curve = getCurve();
        SecP192R1FieldElement secP192R1FieldElement = (SecP192R1FieldElement) this.f4464y;
        if (secP192R1FieldElement.isZero()) {
            return curve.getInfinity();
        }
        SecP192R1FieldElement secP192R1FieldElement2 = (SecP192R1FieldElement) this.f4463x;
        SecP192R1FieldElement secP192R1FieldElement3 = (SecP192R1FieldElement) this.f4465zs[0];
        int[] iArrCreate = Nat192.create();
        int[] iArrCreate2 = Nat192.create();
        int[] iArrCreate3 = Nat192.create();
        SecP192R1Field.square(secP192R1FieldElement.f4506x, iArrCreate3);
        int[] iArrCreate4 = Nat192.create();
        SecP192R1Field.square(iArrCreate3, iArrCreate4);
        boolean zIsOne = secP192R1FieldElement3.isOne();
        int[] iArr = secP192R1FieldElement3.f4506x;
        if (!zIsOne) {
            SecP192R1Field.square(secP192R1FieldElement3.f4506x, iArrCreate2);
            iArr = iArrCreate2;
        }
        SecP192R1Field.subtract(secP192R1FieldElement2.f4506x, iArr, iArrCreate);
        SecP192R1Field.add(secP192R1FieldElement2.f4506x, iArr, iArrCreate2);
        ...
        SecP192R1Field.square(iArrCreate2, secP192R1FieldElement4.f4506x);
        SecP192R1Field.subtract(secP192R1FieldElement4.f4506x, iArrCreate3, secP192R1FieldElement4.f4506x);
        SecP192R1Field.subtract(secP192R1FieldElement4.f4506x, iArrCreate3, secP192R1FieldElement4.f4506x);
        SecP192R1FieldElement secP192R1FieldElement5 = new SecP192R1FieldElement(iArrCreate3);
        SecP192R1Field.subtract(iArrCreate3, secP192R1FieldElement4.f4506x, secP192R1FieldElement5.f4506x);
        SecP192R1Field.multiply(secP192R1FieldElement5.f4506x, iArrCreate2, secP192R1FieldElement5.f4506x);
        SecP192R1Field.subtract(secP192R1FieldElement5.f4506x, iArrCreate, secP192R1FieldElement5.f4506x);
        SecP192R1FieldElement secP192R1FieldElement6 = new SecP192R1FieldElement(iArrCreate2);
        SecP192R1Field.twice(secP192R1FieldElement.f4506x, secP192R1FieldElement6.f4506x);
        if (!zIsOne) {
            SecP192R1Field.multiply(secP192R1FieldElement6.f4506x, secP192R1FieldElement3.f4506x, secP192R1FieldElement6.f4506x);
        }
