...
public class SecT571Field {
    ...
    public static void invert(long[] jArr, long[] jArr2) {
        ...
        multiply(jArrCreate64, jArrCreate642, jArrCreate64);
        squareN(jArrCreate64, Opcodes.GETFIELD, jArrCreate642);
        multiply(jArrCreate64, jArrCreate642, jArrCreate64);
        squareN(jArrCreate642, Opcodes.GETFIELD, jArrCreate642);
        multiply(jArrCreate64, jArrCreate642, jArrCreate64);
    ...
    public static long[] precompMultiplicand(long[] jArr) {
        long[] jArr2 = new long[TIFFConstants.TIFFTAG_FREEOFFSETS];
        ...
        Nat.shiftUpBits64(Opcodes.D2F, jArr2, 0, 4, 0L, jArr2, Opcodes.D2F);
        return jArr2;
    }
