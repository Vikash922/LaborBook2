...
class Tnaf {
    ...
    public static BigInteger norm(byte b, ZTauElement zTauElement) {
        BigInteger bigIntegerSubtract;
        BigInteger bigIntegerMultiply = zTauElement.f4466u.multiply(zTauElement.f4466u);
        BigInteger bigIntegerMultiply2 = zTauElement.f4466u.multiply(zTauElement.f4467v);
        BigInteger bigIntegerShiftLeft = zTauElement.f4467v.multiply(zTauElement.f4467v).shiftLeft(1);
        if (b == 1) {
    ...
    public static ZTauElement partModReduction(BigInteger bigInteger, int i, byte b, BigInteger[] bigIntegerArr, byte b2, byte b3) {
        ...
        return new ZTauElement(bigInteger.subtract(bigIntegerAdd.multiply(zTauElementRound.f4466u)).subtract(BigInteger.valueOf(2L).multiply(bigIntegerArr[1]).multiply(zTauElementRound.f4467v)), bigIntegerArr[1].multiply(zTauElementRound.f4466u).subtract(bigIntegerArr[0].multiply(zTauElementRound.f4467v)));
    }

    /* JADX WARN: Code restructure failed: missing block: B:30:0x0083, code lost:
    
        if (r5.compareTo(org.bouncycastle.math.p042ec.ECConstants.ONE) >= 0) goto L34;
     */
    ...
    */
    public static org.bouncycastle.math.p042ec.ZTauElement round(org.bouncycastle.math.p042ec.SimpleBigDecimal r7, org.bouncycastle.math.p042ec.SimpleBigDecimal r8, byte r9) {
        /*
            int r0 = r7.getScale()
            int r1 = r8.getScale()
            if (r1 != r0) goto La9
        ...
        L57:
            java.math.BigInteger r8 = org.bouncycastle.math.p042ec.ECConstants.ONE
            int r8 = r4.compareTo(r8)
            r6 = 0
            if (r8 < 0) goto L69
            java.math.BigInteger r8 = org.bouncycastle.math.p042ec.Tnaf.MINUS_ONE
            int r8 = r5.compareTo(r8)
            if (r8 >= 0) goto L75
            goto L71
        L69:
            java.math.BigInteger r8 = org.bouncycastle.math.p042ec.ECConstants.TWO
        ...
        L75:
            ...
            int r8 = r4.compareTo(r8)
            if (r8 >= 0) goto L86
            java.math.BigInteger r7 = org.bouncycastle.math.p042ec.ECConstants.ONE
            int r7 = r5.compareTo(r7)
            if (r7 < 0) goto L91
            goto L8e
        L86:
            java.math.BigInteger r8 = org.bouncycastle.math.p042ec.Tnaf.MINUS_TWO
        ...
        La9:
            ...
            throw r7
        */
        throw new UnsupportedOperationException("Method not decompiled: org.bouncycastle.math.p042ec.Tnaf.round(org.bouncycastle.math.ec.SimpleBigDecimal, org.bouncycastle.math.ec.SimpleBigDecimal, byte):org.bouncycastle.math.ec.ZTauElement");
    }
    ...
    public static byte[] tauAdicNaf(byte b, ZTauElement zTauElement) {
        ...
        BigInteger bigIntegerClearBit = zTauElement.f4466u;
        BigInteger bigInteger = zTauElement.f4467v;
        int i = 0;
        int i2 = 0;
        while (true) {
    ...
    public static byte[] tauAdicWNaf(byte b, ZTauElement zTauElement, byte b2, BigInteger bigInteger, BigInteger bigInteger2, ZTauElement[] zTauElementArr) {
        ...
        BigInteger bigIntegerAdd = zTauElement.f4466u;
        BigInteger bigIntegerAdd2 = zTauElement.f4467v;
        int i = 0;
        while (true) {
            ...
            if (bigIntegerAdd.testBit(0)) {
                ...
                if (z) {
                    bigIntegerAdd = bigIntegerAdd.subtract(zTauElementArr[bIntValue].f4466u);
                    bigIntegerAdd2 = bigIntegerAdd2.subtract(zTauElementArr[bIntValue].f4467v);
                } else {
                    bigIntegerAdd = bigIntegerAdd.add(zTauElementArr[bIntValue].f4466u);
                    bigIntegerAdd2 = bigIntegerAdd2.add(zTauElementArr[bIntValue].f4467v);
                }
            } else {
                bArr[i] = 0;
            }
