...
public class SecP160R1FieldElement extends ECFieldElement.AbstractFp {
    ...
    public static final BigInteger f4489Q = new BigInteger(1, Hex.decodeStrict("FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF7FFFFFFF"));

    /* JADX INFO: renamed from: x */
    protected int[] f4490x;

    public SecP160R1FieldElement() {
        this.f4490x = Nat160.create();
    }

    public SecP160R1FieldElement(BigInteger bigInteger) {
        if (bigInteger == null || bigInteger.signum() < 0 || bigInteger.compareTo(f4489Q) >= 0) {
            throw new IllegalArgumentException("x value invalid for SecP160R1FieldElement");
        }
        this.f4490x = SecP160R1Field.fromBigInteger(bigInteger);
    }
    ...
    public ECFieldElement add(ECFieldElement eCFieldElement) {
        ...
        SecP160R1Field.add(this.f4490x, ((SecP160R1FieldElement) eCFieldElement).f4490x, iArrCreate);
    ...
    public ECFieldElement addOne() {
        int[] iArrCreate = Nat160.create();
        SecP160R1Field.addOne(this.f4490x, iArrCreate);
        return new SecP160R1FieldElement(iArrCreate);
    }
    ...
    public ECFieldElement divide(ECFieldElement eCFieldElement) {
        int[] iArrCreate = Nat160.create();
        SecP160R1Field.inv(((SecP160R1FieldElement) eCFieldElement).f4490x, iArrCreate);
        SecP160R1Field.multiply(iArrCreate, this.f4490x, iArrCreate);
        return new SecP160R1FieldElement(iArrCreate);
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof SecP160R1FieldElement) {
            return Nat160.m2875eq(this.f4490x, ((SecP160R1FieldElement) obj).f4490x);
        }
        return false;
    }
    ...
    public int getFieldSize() {
        return f4489Q.bitLength();
    }

    public int hashCode() {
        return f4489Q.hashCode() ^ Arrays.hashCode(this.f4490x, 0, 5);
    }

    @Override // org.bouncycastle.math.p042ec.ECFieldElement
    public ECFieldElement invert() {
        int[] iArrCreate = Nat160.create();
        SecP160R1Field.inv(this.f4490x, iArrCreate);
        return new SecP160R1FieldElement(iArrCreate);
    }

    @Override // org.bouncycastle.math.p042ec.ECFieldElement
    public boolean isOne() {
        return Nat160.isOne(this.f4490x);
    }

    @Override // org.bouncycastle.math.p042ec.ECFieldElement
    public boolean isZero() {
        return Nat160.isZero(this.f4490x);
    }

    @Override // org.bouncycastle.math.p042ec.ECFieldElement
    public ECFieldElement multiply(ECFieldElement eCFieldElement) {
        int[] iArrCreate = Nat160.create();
        SecP160R1Field.multiply(this.f4490x, ((SecP160R1FieldElement) eCFieldElement).f4490x, iArrCreate);
        return new SecP160R1FieldElement(iArrCreate);
    }
    ...
    public ECFieldElement negate() {
        int[] iArrCreate = Nat160.create();
        SecP160R1Field.negate(this.f4490x, iArrCreate);
        return new SecP160R1FieldElement(iArrCreate);
    }

    @Override // org.bouncycastle.math.p042ec.ECFieldElement
    public ECFieldElement sqrt() {
        int[] iArr = this.f4490x;
    ...
    public ECFieldElement square() {
        int[] iArrCreate = Nat160.create();
        SecP160R1Field.square(this.f4490x, iArrCreate);
        return new SecP160R1FieldElement(iArrCreate);
    }
    ...
    public ECFieldElement subtract(ECFieldElement eCFieldElement) {
        int[] iArrCreate = Nat160.create();
        SecP160R1Field.subtract(this.f4490x, ((SecP160R1FieldElement) eCFieldElement).f4490x, iArrCreate);
        return new SecP160R1FieldElement(iArrCreate);
    }

    @Override // org.bouncycastle.math.p042ec.ECFieldElement
    public boolean testBitZero() {
        return Nat160.getBit(this.f4490x, 0) == 1;
    }

    @Override // org.bouncycastle.math.p042ec.ECFieldElement
    public BigInteger toBigInteger() {
        return Nat160.toBigInteger(this.f4490x);
    }
}
