    ...
    public Enumeration getObjects() {
        return this.elements == null ? new Enumeration() { // from class: org.bouncycastle.asn1.BEROctetString.1
            ...
            public Object nextElement() {
                ...
                int iMin = Math.min(BEROctetString.this.string.length - this.pos, BEROctetString.this.segmentLimit);
                byte[] bArr = new byte[iMin];
                System.arraycopy(BEROctetString.this.string, this.pos, bArr, 0, iMin);
                this.pos += iMin;
