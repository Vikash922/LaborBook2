...
public class DVCSErrorNotice extends ASN1Object {
    ...
    public String toString() {
        return "DVCSErrorNotice {\ntransactionStatus: " + this.transactionStatus + StringUtils.f4768LF + (this.transactionIdentifier != null ? "transactionIdentifier: " + this.transactionIdentifier + StringUtils.f4768LF : "") + "}\n";
    }
}
