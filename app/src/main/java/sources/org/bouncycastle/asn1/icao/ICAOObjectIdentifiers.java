...
public interface ICAOObjectIdentifiers {
    ...
    static {
        ...
        ASN1ObjectIdentifier aSN1ObjectIdentifierBranch = aSN1ObjectIdentifier.branch(AppEventsConstants.EVENT_PARAM_VALUE_YES);
        id_icao_mrtd = aSN1ObjectIdentifierBranch;
        ASN1ObjectIdentifier aSN1ObjectIdentifierBranch2 = aSN1ObjectIdentifierBranch.branch(AppEventsConstants.EVENT_PARAM_VALUE_YES);
        id_icao_mrtd_security = aSN1ObjectIdentifierBranch2;
        id_icao_ldsSecurityObject = aSN1ObjectIdentifierBranch2.branch(AppEventsConstants.EVENT_PARAM_VALUE_YES);
        ...
        id_icao_extensions_namechangekeyrollover = aSN1ObjectIdentifierBranch3.branch(AppEventsConstants.EVENT_PARAM_VALUE_YES);
    }
}
