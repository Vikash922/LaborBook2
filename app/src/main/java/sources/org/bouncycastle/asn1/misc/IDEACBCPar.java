...
public class IDEACBCPar extends ASN1Object {
    ...
    ASN1OctetString f3790iv;

    private IDEACBCPar(ASN1Sequence aSN1Sequence) {
        this.f3790iv = aSN1Sequence.size() == 1 ? (ASN1OctetString) aSN1Sequence.getObjectAt(0) : null;
    }

    public IDEACBCPar(byte[] bArr) {
        this.f3790iv = new DEROctetString(bArr);
    }
    ...
    public byte[] getIV() {
        ASN1OctetString aSN1OctetString = this.f3790iv;
