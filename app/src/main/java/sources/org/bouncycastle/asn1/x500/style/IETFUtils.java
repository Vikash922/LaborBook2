    ...
    public static RDN[] rDNsFromString(String str, X500NameStyle x500NameStyle) {
        ...
        while (x500NameTokenizer.hasMoreTokens()) {
            ...
            if (strNextToken.indexOf(43) > 0) {
                X500NameTokenizer x500NameTokenizer2 = new X500NameTokenizer(strNextToken, SignatureVisitor.EXTENDS);
                ...
                X500NameTokenizer x500NameTokenizer5 = new X500NameTokenizer(strNextToken, SignatureVisitor.INSTANCEOF);
