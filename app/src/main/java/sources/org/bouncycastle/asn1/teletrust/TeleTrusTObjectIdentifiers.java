...
public interface TeleTrusTObjectIdentifiers {
    ...
    static {
        ...
        ecSignWithSha1 = aSN1ObjectIdentifierBranch2.branch(AppEventsConstants.EVENT_PARAM_VALUE_YES);
        ...
        ASN1ObjectIdentifier aSN1ObjectIdentifierBranch5 = aSN1ObjectIdentifierBranch4.branch(AppEventsConstants.EVENT_PARAM_VALUE_YES);
        versionOne = aSN1ObjectIdentifierBranch5;
        brainpoolP160r1 = aSN1ObjectIdentifierBranch5.branch(AppEventsConstants.EVENT_PARAM_VALUE_YES);
