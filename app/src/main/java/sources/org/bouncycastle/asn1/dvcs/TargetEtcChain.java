...
public class TargetEtcChain extends ASN1Object {
    ...
    public String toString() {
        ...
        stringBuffer.append("target: " + this.target + StringUtils.f4768LF);
        if (this.chain != null) {
            stringBuffer.append("chain: " + this.chain + StringUtils.f4768LF);
        }
        if (this.pathProcInput != null) {
            stringBuffer.append("pathProcInput: " + this.pathProcInput + StringUtils.f4768LF);
        }
        stringBuffer.append("}\n");
