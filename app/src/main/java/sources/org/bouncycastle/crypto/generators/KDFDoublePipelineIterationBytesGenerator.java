...
public class KDFDoublePipelineIterationBytesGenerator implements MacDerivationFunction {
    ...
    public KDFDoublePipelineIterationBytesGenerator(Mac mac) {
        ...
        this.f4190h = macSize;
        this.f4189a = new byte[macSize];
        this.f4191k = new byte[macSize];
    }
    ...
    private void generateNext() {
        if (this.generatedBytes == 0) {
            ...
            this.prf.doFinal(this.f4189a, 0);
        } else {
            Mac mac2 = this.prf;
        ...
        Mac mac3 = this.prf;
        byte[] bArr3 = this.f4189a;
        mac3.update(bArr3, 0, bArr3.length);
        if (this.useCounter) {
            int i = (this.generatedBytes / this.f4190h) + 1;
            byte[] bArr4 = this.ios;
        ...
        this.prf.doFinal(this.f4191k, 0);
    }
    ...
    public int generateBytes(byte[] bArr, int i, int i2) throws DataLengthException, IllegalArgumentException {
        ...
        System.arraycopy(this.f4191k, i7, bArr, i, iMin);
        ...
        while (true) {
            ...
            generateNext();
            iMin = Math.min(this.f4190h, i8);
            System.arraycopy(this.f4191k, 0, bArr, i, iMin);
            this.generatedBytes += iMin;
            i8 -= iMin;
        }
    }
    ...
    public void init(DerivationParameters derivationParameters) {
        ...
        if (kDFDoublePipelineIterationParameters.useCounter()) {
            BigInteger bigIntegerMultiply = TWO.pow(r).multiply(BigInteger.valueOf(this.f4190h));
