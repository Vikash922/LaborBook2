...
public class DHPublicKeyParameters extends DHKeyParameters {
    ...
    private BigInteger f4305y;

    public DHPublicKeyParameters(BigInteger bigInteger, DHParameters dHParameters) {
        super(false, dHParameters);
        this.f4305y = validate(bigInteger, dHParameters);
    }
    ...
    public boolean equals(Object obj) {
        return (obj instanceof DHPublicKeyParameters) && ((DHPublicKeyParameters) obj).getY().equals(this.f4305y) && super.equals(obj);
    }
    ...
    @Override // org.bouncycastle.crypto.params.DHKeyParameters
    public int hashCode() {
        return this.f4305y.hashCode() ^ super.hashCode();
    }
}
