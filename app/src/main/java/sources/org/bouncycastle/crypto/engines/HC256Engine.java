...
public class HC256Engine implements StreamCipher {
    ...
    private byte[] f4126iv;
    private byte[] key;

    /* JADX INFO: renamed from: p */
    private int[] f4127p = new int[1024];

    /* JADX INFO: renamed from: q */
    private int[] f4128q = new int[1024];
    private int cnt = 0;
    ...
    private void init() {
        ...
        byte[] bArr4 = this.f4126iv;
        if (bArr4.length < 32) {
            byte[] bArr5 = new byte[32];
            System.arraycopy(bArr4, 0, bArr5, 0, bArr4.length);
            byte[] bArr6 = this.f4126iv;
        ...
        for (int i3 = 0; i3 < 32; i3++) {
            int i4 = (i3 >> 2) + 8;
            iArr[i4] = iArr[i4] | ((this.f4126iv[i3] & 255) << ((i3 & 3) * 8));
        }
        ...
        System.arraycopy(iArr, 512, this.f4127p, 0, 1024);
        System.arraycopy(iArr, 1536, this.f4128q, 0, 1024);
    ...
    public void init(boolean z, CipherParameters cipherParameters) throws IllegalArgumentException {
        ...
        if (cipherParameters instanceof ParametersWithIV) {
            ...
            this.f4126iv = parametersWithIV.getIV();
            parameters = parametersWithIV.getParameters();
        } else {
            this.f4126iv = new byte[0];
