...
public class Blake3Digest implements ExtendedDigest, Memoable, Xof {
    ...
    private static final byte[] SIGMA = {2, 6, 3, 10, 7, 0, 4, Ascii.f384CR, 1, Ascii.f397VT, Ascii.f386FF, 5, 9, Ascii.f394SO, Ascii.f393SI, 8};
    private static final byte[] ROTATE = {16, Ascii.f386FF, 8, 7};

    /* JADX INFO: renamed from: IV */
    private static final int[] f3922IV = {1779033703, -1150833019, 1013904242, -1521486534, 1359893119, -1694144372, 528734635, 1541459225};
    ...
    private void initChunkBlock(int i, boolean z) {
        ...
        System.arraycopy(f3922IV, 0, this.theV, 8, 4);
        int[] iArr = this.theV;
    ...
    private void initNullKey() {
        System.arraycopy(f3922IV, 0, this.theK, 0, 8);
    }
