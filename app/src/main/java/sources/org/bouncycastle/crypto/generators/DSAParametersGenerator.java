...
public class DSAParametersGenerator {
        ...
        while (true) {
            ...
            if (isProbablePrime(bigInteger)) {
                ...
                while (i6 < 4096) {
                    ...
                    if (bigIntegerSubtract.bitLength() == this.f4185L && isProbablePrime(bigIntegerSubtract)) {
    ...
    private DSAParameters generateParameters_FIPS186_3() {
        ...
        byte[] bArr = new byte[this.f4186N / 8];
        int i2 = this.f4185L;
        ...
        loop0: while (true) {
            ...
            bit = new BigInteger(1, bArr3).mod(ONE.shiftLeft(this.f4186N - 1)).setBit(0).setBit(this.f4186N - 1);
            if (isProbablePrime(bit)) {
                byte[] bArrClone = Arrays.clone(bArr);
                int i7 = this.f4185L * 4;
                i = 0;
                while (i < i7) {
    ...
    public void init(int i, int i2, SecureRandom secureRandom) {
        this.f4185L = i;
        this.f4186N = getDefaultN(i);
        this.certainty = i2;
        this.iterations = Math.max(getMinimumIterations(this.f4185L), (i2 + 1) / 2);
