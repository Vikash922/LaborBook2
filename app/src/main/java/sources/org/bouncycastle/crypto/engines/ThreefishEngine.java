...
public class ThreefishEngine implements BlockCipher {
    ...
    private long[] f4165kw;

    /* JADX INFO: renamed from: t */
    private long[] f4166t = new long[5];
    ...
    private static final class Threefish1024Cipher extends ThreefishCipher {
        ...
        void decryptBlock(long[] jArr, long[] jArr2) {
            long[] jArr3 = this.f4167kw;
            long[] jArr4 = this.f4168t;
    ...
    private static abstract class ThreefishCipher {
        ...
        /* JADX INFO: renamed from: kw */
        protected final long[] f4167kw;

        /* JADX INFO: renamed from: t */
        protected final long[] f4168t;
    ...
    public ThreefishEngine(int i) {
        ...
        this.f4165kw = new long[(i3 * 2) + 1];
        if (i == 256) {
            threefish256Cipher = new Threefish256Cipher(this.f4165kw, this.f4166t);
        } else if (i == 512) {
            threefish256Cipher = new Threefish512Cipher(this.f4165kw, this.f4166t);
        } else {
            if (i != 1024) {
                throw new IllegalArgumentException("Invalid blocksize - Threefish is defined with block size of 256, 512, or 1024 bits");
            }
            threefish256Cipher = new Threefish1024Cipher(this.f4165kw, this.f4166t);
        }
    ...
    private void setKey(long[] jArr) {
        ...
        while (true) {
            ...
            if (i >= i2) {
                long[] jArr2 = this.f4165kw;
                jArr2[i2] = j;
                System.arraycopy(jArr2, 0, jArr2, i2 + 1, i2);
                return;
            } else {
                long[] jArr3 = this.f4165kw;
                long j2 = jArr[i];
                jArr3[i] = j2;
                j ^= j2;
                i++;
