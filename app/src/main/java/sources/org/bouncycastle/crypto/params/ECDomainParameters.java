...
public class ECDomainParameters implements ECConstants {
    ...
    private final ECPoint f4313G;
    private final ECCurve curve;

    /* JADX INFO: renamed from: h */
    private final BigInteger f4314h;
    private BigInteger hInv;

    /* JADX INFO: renamed from: n */
    private final BigInteger f4315n;
    ...
    public ECDomainParameters(ECCurve eCCurve, ECPoint eCPoint, BigInteger bigInteger, BigInteger bigInteger2, byte[] bArr) {
        ...
        this.curve = eCCurve;
        this.f4313G = validatePublicPoint(eCCurve, eCPoint);
        this.f4315n = bigInteger;
        this.f4314h = bigInteger2;
    ...
    public boolean equals(Object obj) {
        ...
        return this.curve.equals(eCDomainParameters.curve) && this.f4313G.equals(eCDomainParameters.f4313G) && this.f4315n.equals(eCDomainParameters.f4315n);
    }
    ...
    public synchronized BigInteger getHInv() {
        if (this.hInv == null) {
            this.hInv = BigIntegers.modOddInverseVar(this.f4315n, this.f4314h);
        }
        return this.hInv;
    }
    ...
    public int hashCode() {
        return ((((this.curve.hashCode() ^ 1028) * 257) ^ this.f4313G.hashCode()) * 257) ^ this.f4315n.hashCode();
    }
