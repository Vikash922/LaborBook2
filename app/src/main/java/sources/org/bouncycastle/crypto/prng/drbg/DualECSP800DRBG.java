...
public class DualECSP800DRBG implements SP80090DRBG {
    ...
    private ECPoint f4360_P;

    /* JADX INFO: renamed from: _Q */
    private ECPoint f4361_Q;
    private ECCurve.C4651Fp _curve;
    ...
    static {
        ...
        nistPoints = new DualECPoints[]{new DualECPoints(128, c4651Fp.createPoint(bigInteger, bigInteger2), c4651Fp.createPoint(bigInteger3, bigInteger4), 1), new DualECPoints(192, c4651Fp.createPoint(bigInteger5, bigInteger6), c4651Fp.createPoint(bigInteger7, bigInteger8), 1), new DualECPoints(256, c4651Fp.createPoint(bigInteger9, bigInteger10), c4651Fp.createPoint(bigInteger11, bigInteger12), 1)};
        ECCurve.C4651Fp c4651Fp = (ECCurve.C4651Fp) NISTNamedCurves.getByName("P-256").getCurve();
        ECCurve.C4651Fp c4651Fp2 = (ECCurve.C4651Fp) NISTNamedCurves.getByName("P-384").getCurve();
        ECCurve.C4651Fp c4651Fp3 = (ECCurve.C4651Fp) NISTNamedCurves.getByName("P-521").getCurve();
    }
    ...
    */
    public DualECSP800DRBG(org.bouncycastle.crypto.prng.drbg.DualECPoints[] r2, org.bouncycastle.crypto.Digest r3, int r4, org.bouncycastle.crypto.prng.EntropySource r5, byte[] r6, byte[] r7) {
        ...
        L71:
            ...
            goto L2f
        L74:
            org.bouncycastle.math.ec.ECPoint r2 = r1.f4360_P
            if (r2 == 0) goto L8a
    ...
    public int generate(byte[] bArr, byte[] bArr2, boolean z) {
        ...
        BigInteger bigInteger = bArr2 != null ? new BigInteger(1, xor(this.f4362_s, Utils.hash_df(this._digest, bArr2, this._seedlen))) : new BigInteger(1, this.f4362_s);
        int length3 = 0;
        Arrays.fill(bArr, (byte) 0);
        int length4 = 0;
        for (int i = 0; i < length2; i++) {
            bigInteger = getScalarMultipleXCoord(this.f4360_P, bigInteger);
            byte[] byteArray = getScalarMultipleXCoord(this.f4361_Q, bigInteger).toByteArray();
        ...
        if (length4 < bArr.length) {
            bigInteger = getScalarMultipleXCoord(this.f4360_P, bigInteger);
            byte[] byteArray2 = getScalarMultipleXCoord(this.f4361_Q, bigInteger).toByteArray();
        ...
        this.f4362_s = BigIntegers.asUnsignedByteArray(this._sLength, getScalarMultipleXCoord(this.f4360_P, bigInteger));
        return length;
    }
    ...
    public void reseed(byte[] bArr) {
        ...
        this.f4362_s = Utils.hash_df(this._digest, Arrays.concatenate(pad8(this.f4362_s, this._seedlen), getEntropy(), bArr), this._seedlen);
