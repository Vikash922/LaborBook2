...
public class TSPUtil {
    ...
    static {
        ...
        map.put(RosstandartObjectIdentifiers.id_tc26_gost_3411_12_256.getId(), Integers.valueOf(32));
        map.put(RosstandartObjectIdentifiers.id_tc26_gost_3411_12_512.getId(), Integers.valueOf(64));
        map.put(GMObjectIdentifiers.sm3.getId(), Integers.valueOf(32));
        ...
        map2.put(TeleTrusTObjectIdentifiers.ripemd160.getId(), DigestAlgorithms.RIPEMD160);
        ...
        map2.put(RosstandartObjectIdentifiers.id_tc26_gost_3411_12_256.getId(), "GOST3411-2012-256");
        map2.put(RosstandartObjectIdentifiers.id_tc26_gost_3411_12_512.getId(), "GOST3411-2012-512");
        map2.put(GMObjectIdentifiers.sm3.getId(), "SM3");
    }
