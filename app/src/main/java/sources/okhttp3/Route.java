...
public final class Route {
    ...
    public int hashCode() {
        return ((((MetaDo.META_OFFSETWINDOWORG + this.address.hashCode()) * 31) + this.proxy.hashCode()) * 31) + this.socketAddress.hashCode();
    }
