...
public final class Response implements Closeable {
    ...
    public final CacheControl m5012deprecated_cacheControl() {
        return cacheControl();
    }
