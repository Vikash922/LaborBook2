...
public final class Request {
    ...
    String logId() {
        ...
        if (jNanoTime > TOO_LONG_LOG) {
            return plainId() + SignatureVisitor.EXTENDS + TimeUnit.NANOSECONDS.toSeconds(jNanoTime) + 's';
        }
        return plainId() + SignatureVisitor.EXTENDS + TimeUnit.NANOSECONDS.toMillis(jNanoTime) + "ms";
    }

    String plainId() {
        return "[R" + this.f3513id + ']';
    }
