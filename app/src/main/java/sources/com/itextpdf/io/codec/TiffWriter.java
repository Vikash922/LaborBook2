...
public class TiffWriter {
    ...
    public static class FieldShort extends FieldBase {
        ...
        public FieldShort(int i, int[] iArr) {
            ...
            for (int i3 : iArr) {
                int i4 = i2 + 1;
                this.data[i2] = (byte) (i3 >> 8);
                i2 += 2;
                this.data[i4] = (byte) i3;
            }
        }
    }
    ...
    public static class FieldLong extends FieldBase {
        ...
        public FieldLong(int i, int[] iArr) {
            ...
            int i2 = 0;
            for (int i3 : iArr) {
                this.data[i2] = (byte) (i3 >> 24);
                this.data[i2 + 1] = (byte) (i3 >> 16);
                int i4 = i2 + 3;
    ...
    public static class FieldRational extends FieldBase {
        ...
        public FieldRational(int i, int[][] iArr) {
            ...
            int i2 = 0;
            for (int[] iArr2 : iArr) {
                this.data[i2] = (byte) (iArr2[0] >> 24);
                this.data[i2 + 1] = (byte) (iArr2[0] >> 16);
                this.data[i2 + 2] = (byte) (iArr2[0] >> 8);
                this.data[i2 + 3] = (byte) iArr2[0];
                this.data[i2 + 4] = (byte) (iArr2[1] >> 24);
                this.data[i2 + 5] = (byte) (iArr2[1] >> 16);
                int i3 = i2 + 7;
                this.data[i2 + 6] = (byte) (iArr2[1] >> 8);
                i2 += 8;
                this.data[i3] = (byte) iArr2[1];
            }
        }
    }
    ...
    public static class FieldAscii extends FieldBase {
        public FieldAscii(int i, String str) {
            super(i, 2, str.getBytes(StandardCharsets.US_ASCII).length + 1);
