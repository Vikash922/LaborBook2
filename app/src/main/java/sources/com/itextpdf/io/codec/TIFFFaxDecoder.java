...
public class TIFFFaxDecoder {
    ...
    public void decode2D(byte[] bArr, byte[] bArr2, int i, int i2, long j) {
        ...
        while (i6 < i2) {
            if (readEOL() == 0) {
                ...
                int i8 = i3;
                boolean z = true;
                while (iDecodeWhiteCodeWord < this.w) {
    ...
    */
    public void decodeT6(byte[] r19, byte[] r20, int r21, int r22, long r23) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.itextpdf.io.codec.TIFFFaxDecoder.decodeT6(byte[], byte[], int, int, long):void");
    }
