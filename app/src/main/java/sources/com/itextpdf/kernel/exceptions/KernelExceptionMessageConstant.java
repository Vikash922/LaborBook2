...
public final class KernelExceptionMessageConstant {
    public static final String AMOUNT_OF_BYTES_LESS_THAN_ZERO = "Amount of bytes in the PDF document cannot be less than zero";
    public static final String ANNOTATION_SHALL_HAVE_REFERENCE_TO_PAGE = "Annotation shall have reference to page.";

    /* JADX INFO: renamed from: APPEND_MODE_REQUIRES_A_DOCUMENT_WITHOUT_ERRORS_EVEN_IF_RECOVERY_IS_POSSIBLE */
    public static final String f2909xb0c47c6a = "Append mode requires a document without errors, even if recovery is possible.";
    ...
    /* JADX INFO: renamed from: CANNOT_COPY_INDIRECT_OBJECT_FROM_THE_DOCUMENT_THAT_IS_BEING_WRITTEN */
    public static final String f2910x779baddc = "Cannot copy indirect object from the document that is being written.";
    ...
    /* JADX INFO: renamed from: CANNOT_CREATE_TYPE_0_FONT_WITH_TRUE_TYPE_FONT_PROGRAM_WITHOUT_EMBEDDING_IT */
    public static final String f2911x40006cab = "Cannot create Type0 font with true type font program without embedding it.";
    ...
    /* JADX INFO: renamed from: CANNOT_REMOVE_MARKED_CONTENT_REFERENCE_BECAUSE_ITS_PAGE_WAS_ALREADY_FLUSHED */
    public static final String f2912xdd388fd4 = "Cannot remove marked content reference, because its page has been already flushed.";
    ...
    /* JADX INFO: renamed from: CERTIFICATE_IS_NOT_PROVIDED_DOCUMENT_IS_ENCRYPTED_WITH_PUBLIC_KEY_CERTIFICATE */
    public static final String f2913x6506ab0b = "Certificate is not provided. Document is encrypted with public key certificate, it should be passed to PdfReader constructor with properties. See ReaderProperties#setPublicKeySecurityParams() method.";
    ...
    /* JADX INFO: renamed from: CONTENT_STREAM_MUST_NOT_INVOKE_OPERATORS_THAT_SPECIFY_COLORS_OR_OTHER_COLOR_RELATED_PARAMETERS */
    public static final String f2914x8df3b63e = "Content stream must not invoke operators that specify colors or other color related parameters in the graphics state.";
    public static final String CORRUPTED_OUTLINE_DICTIONARY_HAS_INFINITE_LOOP = "Document outline dictionary is corrupted: some outline (PDF object: \"{0}\") has wrong first/next link entry.";
    public static final String CORRUPTED_OUTLINE_NO_PARENT_ENTRY = "Document outline is corrupted: some outline (PDF object: \"{0}\") lacks the required parent entry.";
    public static final String CORRUPTED_OUTLINE_NO_TITLE_ENTRY = "Document outline is corrupted: some outline (PDF object: \"{0}\") lacks the required title entry.";
    public static final String CORRUPTED_ROOT_ENTRY_IN_TRAILER = "The trailer is corrupted: the catalog is corrupted or cannot be referenced from the file's trailer. The PDF cannot be opened.";
    ...
    /* JADX INFO: renamed from: DURING_DECOMPRESSION_MULTIPLE_STREAMS_IN_SUM_OCCUPIED_MORE_MEMORY_THAN_ALLOWED */
    public static final String f2915x16d50bf4 = "During decompression multiple streams in sum occupied more memory than allowed. Please either check your pdf or increase the allowed single decompressed pdf stream maximum size value by setting the appropriate parameter of ReaderProperties's MemoryLimitsAwareHandler.";

    /* JADX INFO: renamed from: DURING_DECOMPRESSION_SINGLE_STREAM_OCCUPIED_MORE_MEMORY_THAN_ALLOWED */
    public static final String f2916x3e8b5f7f = "During decompression a single stream occupied more memory than allowed. Please either check your pdf or increase the allowed multiple decompressed pdf streams maximum size value by setting the appropriate parameter of ReaderProperties's MemoryLimitsAwareHandler.";

    /* JADX INFO: renamed from: DURING_DECOMPRESSION_SINGLE_STREAM_OCCUPIED_MORE_THAN_MAX_INTEGER_VALUE */
    public static final String f2917xce1a18a0 = "During decompression a single stream occupied more than a maximum integer value. Please check your pdf.";

    /* JADX INFO: renamed from: ENCRYPTED_PAYLOAD_FILE_SPEC_DOES_NOT_HAVE_ENCRYPTED_PAYLOAD_DICTIONARY */
    public static final String f2918x55092f54 = "Encrypted payload file spec shall have encrypted payload dictionary.";
    ...
    /* JADX INFO: renamed from: ENCRYPTED_PAYLOAD_SHALL_HAVE_TYPE_EQUALS_TO_ENCRYPTED_PAYLOAD_IF_PRESENT */
    public static final String f2919x3b00c936 = "Encrypted payload dictionary shall have field 'Type' equal to 'EncryptedPayload' if present";
    ...
    public static final String EXTERNAL_ENTITY_ELEMENT_FOUND_IN_XML = "External entity element found in XML. This entity will not be parsed to prevent XML attacks.";
    ...
    public static final String FLUSHED_STREAM_FILTER_EXCEPTION = "Stream {0} {1} R contains flushed indirect filter object in encrypted document, try to use PdfStream#flush() stream before PdfDocument#close() to prevent this exception";
    ...
    public static final String FUCTIONFACTORY_INVALID_OBJECT_TYPE = "Invalid object type, a function must be either a Dictionary or a Stream";
    public static final String FUCTIONFACTORY_INVALID_OBJECT_TYPE_TYPE0 = "Invalid object type, a function type 0 requires a stream object";
    public static final String FUCTIONFACTORY_INVALID_OBJECT_TYPE_TYPE4 = "Invalid object type, a function type 4 requires a stream object";
    public static final String FUNCTION_IS_NOT_COMPATIBLE_WITH_COLOR_SPACE = "Function is not compatible with ColorSpace.";
    public static final String FUNCTION_NOT_SET = "The output size depends on the functions, but no function is set yet.";
    public static final String GET_IMAGEBYTES_FOR_SEPARATION_COLOR_ONLY_SUPPORTS_RGB = "Only RGB alternate color spaces are currently supported for extracting separation color images";
    ...
    public static final String INPUT_NOT_MULTIPLE_OF_DOMAIN_SIZE = "The size of the input array must be a multiple of the domain size";
    public static final String INPUT_NOT_MULTIPLE_OF_RANGE_SIZE = "The size of the input array must be a multiple of the range size";
    ...
    public static final String INVALID_INPUT_FOR_TYPE_2_FUNCTION = "Invalid input value for PDF Type 2 Function, value should be a single number.";
    public static final String INVALID_INPUT_FOR_TYPE_3_FUNCTION = "Invalid input value for PDF Type 3 Function, value should be a single number.";
    public static final String INVALID_LENGTH = "The offset + length must be lower than or equal to the length of the byte array.";
    ...
    public static final String INVALID_TYPE_2_FUNCTION_DOMAIN = "Invalid PDF Type 2 Function object, \"Domain\" array shall consist of 2 numbers.";
    public static final String INVALID_TYPE_2_FUNCTION_N = "Invalid PDF Type 2 Function object, \"N\" field should be existed and must be a number.";
    public static final String INVALID_TYPE_2_FUNCTION_N_NEGATIVE = "Invalid PDF Type 2 Function object, when \"N\" is negative, values of \"Domain\" shall not allow zero as input value.";
    public static final String INVALID_TYPE_2_FUNCTION_N_NOT_INTEGER = "Invalid PDF Type 2 Function object, when \"N\" is not an integer, values of \"Domain\" shall define the input value as non-negative.";
    public static final String INVALID_TYPE_2_FUNCTION_OUTPUT_SIZE = "Invalid PDF Type 2 Function object, if present the size of \"C0\", \"C1\" and half \"Range\" shall be equal.";
    public static final String INVALID_TYPE_3_FUNCTION_BOUNDS = "Invalid PDF Type 3 Function object, \"Bounds\" elements shall be in order of increasing value, and each value shall be within the domain defined by \"Domain\".";
    public static final String INVALID_TYPE_3_FUNCTION_DOMAIN = "Invalid PDF Type 3 Function object, \"Domain\" array shall consist of 2 numbers.";
    public static final String INVALID_TYPE_3_FUNCTION_FUNCTIONS_INPUT = "Invalid PDF Type 3 Function object, all functions shall have 1 input value.";
    public static final String INVALID_TYPE_3_FUNCTION_FUNCTIONS_OUTPUT = "Invalid PDF Type 3 Function object, the output dimensionality of all functions shall be the same, and compatible with the value of \"Range\".";
    public static final String INVALID_TYPE_3_FUNCTION_NULL_BOUNDS = "Invalid PDF Type 3 Function object, \"Bounds\" array should be exist and it size should corresponds to the size of \"Functions\" array.";
    public static final String INVALID_TYPE_3_FUNCTION_NULL_ENCODE = "Invalid PDF Type 3 Function object, \"Encode\" array should be exist and it size should be 2 times more than \"Functions\" array size.";
    public static final String INVALID_TYPE_3_FUNCTION_NULL_FUNCTIONS = "Invalid PDF Type 3 Function object, \"Functions\" array should be exist and can't be empty.";
    ...
    /* JADX INFO: renamed from: NUMBER_OF_BOOLEANS_IN_THE_ARRAY_DOES_NOT_CORRESPOND_WITH_THE_NUMBER_OF_FIELDS */
    public static final String f2920x17a56308 = "The number of booleans in the array doesn't correspond with the number of fields.";
    ...
    /* JADX INFO: renamed from: OBJECT_NUMBER_OF_THE_FIRST_OBJECT_IN_THIS_XREF_SUBSECTION_NOT_FOUND */
    public static final String f2921x89e1ddc8 = "Object number of the first object in this xref subsection not found.";
    ...
    /* JADX INFO: renamed from: PAGE_CANNOT_BE_ADDED_TO_DOCUMENT_BECAUSE_IT_BELONGS_TO_ANOTHER_DOCUMENT */
    public static final String f2922xeea6ed64 = "The passed page belongs to document {0} (page {1} of the document) and therefore cannot be added to this document ({2}).";
    ...
    public static final String PDF_TYPE0_FUNCTION_BITS_PER_SAMPLE_INVALID_VALUE = "bitsPerSample value must be from {1, 2, 4, 8, 12, 16, 24, 32}";
    ...
    /* JADX INFO: renamed from: REF_ARRAY_ITEMS_IN_STRUCTURE_ELEMENT_DICTIONARY_SHALL_BE_INDIRECT_OBJECTS */
    public static final String f2923xb061bdfb = "Ref array items in structure element dictionary shall be indirect objects.";
    ...
    /* JADX INFO: renamed from: RESOURCES_DO_NOT_CONTAIN_EXTGSTATE_ENTRY_UNABLE_TO_PROCESS_THIS_OPERATOR */
    public static final String f2924xdbda090b = "Resources do not contain ExtGState entry. Unable to process operator {0}.";
    ...
    /* JADX INFO: renamed from: STRUCTURE_ELEMENT_DICTIONARY_SHALL_BE_AN_INDIRECT_OBJECT_IN_ORDER_TO_HAVE_CHILDREN */
    public static final String f2925x19c0568b = "Structure element dictionary shall be an indirect object in order to have children.";

    /* JADX INFO: renamed from: STRUCTURE_ELEMENT_IN_STRUCTURE_DESTINATION_SHALL_BE_AN_INDIRECT_OBJECT */
    public static final String f2926x7514b45f = "Structure element referenced by a structure destination shall be an indirect object.";
    ...
    /* JADX INFO: renamed from: TAG_FROM_THE_EXISTING_TAG_STRUCTURE_IS_FLUSHED_CANNOT_ADD_COPIED_PAGE_TAGS */
    public static final String f2927xc89f17de = "Tag from the existing tag structure is flushed. Cannot add copied page tags.";

    /* JADX INFO: renamed from: TAG_STRUCTURE_COPYING_FAILED_IT_MIGHT_BE_CORRUPTED_IN_ONE_OF_THE_DOCUMENTS */
    public static final String f2928xc0aded03 = "Tag structure copying failed: it might be corrupted in one of the documents.";
    ...
    /* JADX INFO: renamed from: TAG_TREE_POINTER_IS_IN_INVALID_STATE_IT_POINTS_AT_FLUSHED_ELEMENT_USE_MOVE_TO_ROOT */
    public static final String f2929x2b3b9dda = "TagTreePointer is in invalid state: it points at flushed element. Use TagTreePointer#moveToRoot.";

    /* JADX INFO: renamed from: TAG_TREE_POINTER_IS_IN_INVALID_STATE_IT_POINTS_AT_REMOVED_ELEMENT_USE_MOVE_TO_ROOT */
    public static final String f2930x7bea9abd = "TagTreePointer is in invalid state: it points at removed element use TagTreePointer#moveToRoot.";
    ...
    /* JADX INFO: renamed from: TO_FLUSH_THIS_WRAPPER_UNDERLYING_OBJECT_MUST_BE_ADDED_TO_DOCUMENT */
    public static final String f2931xa0cdaee = "To manually flush this wrapper, you have to ensure that the object behind this wrapper is added to the document, i.e. it has an indirect reference.";
    ...
    public static final String TYPE4_EXECUTION_NOT_SUPPORTED = "Type 4 functions are not yet supported for separation color image extraction.";
    ...
    public static final String UNSUPPORTED_ASN1_ENCODING = "Unknown ASN1-encoding {0}. Only DER and BER encodings are supported!";
    ...
    /* JADX INFO: renamed from: WHEN_ADDING_OBJECT_REFERENCE_TO_THE_TAG_TREE_IT_MUST_BE_CONNECTED_TO_NOT_FLUSHED_OBJECT */
    public static final String f2932x1aeb7c0 = "When adding object reference to the tag tree, it must be connected to not flushed object.";
    ...
    public static final String XREF_PREV_SHALL_BE_DIRECT_NUMBER_OBJECT = "Prev pointer in xref structure shall be direct number object.";
    public static final String XREF_STREAM_HAS_CYCLED_REFERENCES = "Xref stream has cycled references. Prev pointer indicates an already visited xref stream.";
    public static final String XREF_STRUCTURE_SIZE_EXCEEDED_THE_LIMIT = "Xref structure contains too many elements and may cause OOM exception. You can increase number of elements by setting custom MemoryLimitsAwareHandler.";
    public static final String XREF_SUBSECTION_NOT_FOUND = "xref subsection not found.";
    public static final String XREF_TABLE_HAS_CYCLED_REFERENCES = "Xref table has cycled references. Prev pointer indicates an already visited xref table.";

    /* JADX INFO: renamed from: YOU_HAVE_TO_DEFINE_A_BOOLEAN_ARRAY_FOR_THIS_COLLECTION_SORT_DICTIONARY */
    public static final String f2933x35bf7d4f = "You have to define a boolean array for this collection sort dictionary.";
