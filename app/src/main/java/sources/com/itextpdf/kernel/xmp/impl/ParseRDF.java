...
public class ParseRDF implements XMPError, XMPConst {
    ...
    private static void rdf_NodeElementAttrs(XMPMetaImpl xMPMetaImpl, XMPNode xMPNode, Node node, boolean z) throws XMPException {
        ...
        for (int i2 = 0; i2 < node.getAttributes().getLength(); i2++) {
            ...
            if (!SvgConstants.Attributes.XMLNS.equals(nodeItem.getPrefix()) && (nodeItem.getPrefix() != null || !SvgConstants.Attributes.XMLNS.equals(nodeItem.getNodeName()))) {
            ...
            if (!isWhitespaceNode(nodeItem2)) {
                ...
                if (zEquals && "Bag".equals(localName2)) {
                    ...
                    if (!zEquals && !"Description".equals(localName2)) {
                        ...
                        addQualifierNode(xMPNodeAddChildNode, XMPConst.RDF_TYPE, namespaceURI2 + ':' + localName2);
                    }
                }
    ...
    */
    private static void rdf_EmptyPropertyElement(com.itextpdf.kernel.xmp.impl.XMPMetaImpl r16, com.itextpdf.kernel.xmp.impl.XMPNode r17, org.w3c.dom.Node r18, boolean r19) throws com.itextpdf.kernel.xmp.XMPException {
        /*
            Method dump skipped, instruction units count: 358
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: com.itextpdf.kernel.xmp.impl.ParseRDF.rdf_EmptyPropertyElement(com.itextpdf.kernel.xmp.impl.XMPMetaImpl, com.itextpdf.kernel.xmp.impl.XMPNode, org.w3c.dom.Node, boolean):void");
    }
