...
final class Version {
    ...
    private Version(int i, int[] iArr, ECBlocks eCBlocks, ECBlocks eCBlocks2, ECBlocks eCBlocks3, ECBlocks eCBlocks4) {
        ...
        this.alignmentPatternCenters = (int[]) iArr.clone();
