...
public class Attributes implements Iterable<Attribute>, Cloneable {
    ...
    public Iterator<Attribute> iterator() {
        return new Iterator<Attribute>() { // from class: com.itextpdf.styledxmlparser.jsoup.nodes.Attributes.1
            ...
            public boolean hasNext() {
                while (this.f3312i < Attributes.this.size) {
                    Attributes attributes = Attributes.this;
                    if (!attributes.isInternalKey(attributes.keys[this.f3312i])) {
                        break;
                    }
                    this.f3312i++;
                }
                return this.f3312i < Attributes.this.size;
            }

            /* JADX WARN: Can't rename method to resolve collision */
            @Override // java.util.Iterator
            public Attribute next() {
                Attribute attribute = new Attribute(Attributes.this.keys[this.f3312i], Attributes.this.vals[this.f3312i], Attributes.this);
                this.f3312i++;
                return attribute;
            }
        };
    ...
    */
    public int deduplicate(com.itextpdf.styledxmlparser.jsoup.parser.ParseSettings r7) {
        /*
            r6 = this;
        ...
        L43:
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.itextpdf.styledxmlparser.jsoup.nodes.Attributes.deduplicate(com.itextpdf.styledxmlparser.jsoup.parser.ParseSettings):int");
    }
