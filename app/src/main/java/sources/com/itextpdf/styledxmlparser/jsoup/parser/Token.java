...
public abstract class Token {
    ...
    static abstract class Tag extends Token {
        ...
        final void newAttribute() {
            ...
            if (str != null) {
                String strTrimControlCodes = PortUtil.trimControlCodes(str);
                this.pendingAttributeName = strTrimControlCodes;
                if (strTrimControlCodes.length() > 0) {
                    ...
                    this.attributes.add(this.pendingAttributeName, string);
                }
            }
            this.pendingAttributeName = null;
            this.hasEmptyAttributeValue = false;
    ...
    static final class StartTag extends Tag {
        ...
        @Override // com.itextpdf.styledxmlparser.jsoup.parser.Token.Tag
        public String toString() {
            if (hasAttributes() && this.attributes.size() > 0) {
                return "<" + toStringName() + StringUtils.SPACE + this.attributes.toString() + ">";
            }
            return "<" + toStringName() + ">";
        }
    }
