...
public class IOException extends ITextException {
    ...
    /* JADX INFO: renamed from: CompressionJpegIsOnlySupportedWithASingleStripThisImageHas1Strips */
    public static final String f2865xe866cd90 = "Compression jpeg is only supported with a single strip. This image has {0} strips.";
