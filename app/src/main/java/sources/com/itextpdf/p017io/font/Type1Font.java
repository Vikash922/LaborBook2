...
public class Type1Font extends FontProgram {
    ...
    protected static Type1Font createStandardFont(String str) throws IOException {
        ...
        throw new com.itextpdf.p017io.exceptions.IOException("{0} is not a standard type1 font.").setMessageParams(str);
    }
    ...
    */
    protected void process() throws java.io.IOException {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.itextpdf.p017io.font.Type1Font.process():void");
    }
}
