...
import com.itextpdf.p017io.font.woff2.Woff2Converter;
...
public final class FontProgramFactory {
    ...
    private static FontProgram createFont(String str, byte[] bArr, boolean z) throws IOException {
            ...
            if (zIsStandardFont || ".afm".equals(lowerCase) || ".pfm".equals(lowerCase)) {
                ...
                if (".woff".equals(lowerCase)) {
                    try {
                        ...
                        throw new com.itextpdf.p017io.exceptions.IOException(com.itextpdf.p017io.exceptions.IOException.InvalidWoffFile, (Throwable) e);
                    }
                } else {
                    try {
                        bArrConvert = Woff2Converter.convert(bArr);
                    } catch (FontCompressionException e2) {
                        throw new com.itextpdf.p017io.exceptions.IOException(com.itextpdf.p017io.exceptions.IOException.InvalidWoff2File, (Throwable) e2);
                    }
                }
                ...
                if (iIndexOf > 0) {
                    try {
                        ...
                        throw new com.itextpdf.p017io.exceptions.IOException(e3.getMessage(), (Throwable) e3);
                    }
                }
            }
        } else if (bArr != null) {
        ...
        if (str != null) {
            throw new com.itextpdf.p017io.exceptions.IOException(com.itextpdf.p017io.exceptions.IOException.TypeOfFont1IsNotRecognized).setMessageParams(str);
        }
        throw new com.itextpdf.p017io.exceptions.IOException(com.itextpdf.p017io.exceptions.IOException.TypeOfFontIsNotRecognized);
    }
    ...
    static byte[] readFontBytesFromPath(String str) throws IOException {
        ...
        if (length < randomAccessFileOrArray.length()) {
            throw new com.itextpdf.p017io.exceptions.IOException(MessageFormatUtil.format("Source data from \"{0}\" is bigger than byte array can hold.", str));
        }
