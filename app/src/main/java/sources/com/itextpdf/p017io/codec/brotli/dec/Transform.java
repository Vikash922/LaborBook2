...
final class Transform {
    ...
    static int transformDictionaryWord(byte[] bArr, int i, ByteBuffer byteBuffer, int i2, int i3, Transform transform) {
        int i4 = i;
