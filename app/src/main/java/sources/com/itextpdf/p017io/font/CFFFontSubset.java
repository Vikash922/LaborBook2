...
import com.itextpdf.p017io.font.CFFFont;
import com.itextpdf.p017io.source.RandomAccessFileOrArray;
import com.itextpdf.p017io.util.GenericArray;
    ...
    protected int StackOpp() {
        ...
        switch (str.hashCode()) {
            ...
            case 99839:
                ...
                break;
            case 102230:
                b = !str.equals("get") ? (byte) -1 : Ascii.f386FF;
                break;
            case 108484:
                b = !str.equals("mul") ? (byte) -1 : Ascii.f384CR;
                break;
            case 108944:
                b = !str.equals("neg") ? (byte) -1 : (byte) 14;
                break;
            case 109267:
                b = !str.equals("not") ? (byte) -1 : Ascii.f393SI;
                break;
            case 111375:
