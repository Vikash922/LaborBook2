...
import com.itextpdf.p017io.codec.TIFFDirectory;
import com.itextpdf.p017io.codec.TIFFField;
import com.itextpdf.p017io.source.DeflaterOutputStream;
...
class TiffImageHelper {
    ...
    public static void processImage(ImageData imageData) throws Throwable {
        ...
        try {
            ...
            throw new com.itextpdf.p017io.exceptions.IOException(com.itextpdf.p017io.exceptions.IOException.TiffImageException, (Throwable) e);
        }
    }
    ...
    */
    private static void processTiffImage(com.itextpdf.p017io.source.RandomAccessFileOrArray r47, com.itextpdf.io.image.TiffImageHelper.TiffParameters r48) throws java.lang.Throwable {
        /*
            Method dump skipped, instruction units count: 926
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: com.itextpdf.p017io.image.TiffImageHelper.processTiffImage(com.itextpdf.io.source.RandomAccessFileOrArray, com.itextpdf.io.image.TiffImageHelper$TiffParameters):void");
    }
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    private static void processTiffImageColor(com.itextpdf.p017io.codec.TIFFDirectory r42, com.itextpdf.p017io.source.RandomAccessFileOrArray r43, com.itextpdf.io.image.TiffImageHelper.TiffParameters r44) throws java.lang.Throwable {
        /*
            Method dump skipped, instruction units count: 1308
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: com.itextpdf.p017io.image.TiffImageHelper.processTiffImageColor(com.itextpdf.io.codec.TIFFDirectory, com.itextpdf.io.source.RandomAccessFileOrArray, com.itextpdf.io.image.TiffImageHelper$TiffParameters):void");
    }
    ...
    private static void processExtraSamples(DeflaterOutputStream deflaterOutputStream, DeflaterOutputStream deflaterOutputStream2, byte[] bArr, int i, int i2, int i3, int i4) throws IOException {
        ...
        throw new com.itextpdf.p017io.exceptions.IOException(com.itextpdf.p017io.exceptions.IOException.ExtraSamplesAreNotSupported);
    }
