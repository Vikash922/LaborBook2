...
public final class SvgExceptionMessageConstant {
    ...
    /* JADX INFO: renamed from: COORDINATE_ARRAY_LENGTH_MUST_BY_DIVISIBLE_BY_CURRENT_COORDINATES_ARRAY_LENGTH */
    public static final String f3338xcc3e6cee = "Array of current coordinates must have length that is divisible by the length of the array with current coordinates";
    ...
    public static final String CURRENT_VIEWPORT_IS_NULL = "The current viewport is null. The viewBox applying could not be processed.";
    ...
    public static final String MEET_OR_SLICE_ARGUMENT_IS_INCORRECT = "The meetOrSlice argument is incorrect. It must be `meet`, `slice` or null.";
    ...
    public static final String VIEWBOX_IS_INCORRECT = "The viewBox is incorrect. The viewBox applying could not be processed.";
