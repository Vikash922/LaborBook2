...
public final class Rc extends AbstractC0487rb {
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public Rc(String url, Kc kc, String str, int i, int i2, int i3) {
        super(url, kc, str, i, i2);
    ...
    public final void f() {
        ...
        HashMap map5;
        super.f();
        InMobiUserDataModel inMobiUserDataModel = C0578y4.f531a;
        String.valueOf(C0578y4.f531a);
        HashMap mapA = AbstractC0256ca.a();
        HashMap map6 = this.k;
        if (map6 != null) {
            map6.put("mk-version", Lb.a());
            String str = C0247c1.f317a;
            if (str != null) {
            }
            map6.put("ua", Kb.k());
        ...
        InMobiUserDataModel inMobiUserDataModel2 = C0578y4.f531a;
        ...
        InMobiUserDataModel inMobiUserDataModel3 = C0578y4.f531a;
        ...
        JSONObject jSONObjectB = AbstractC0523u5.b();
        if (jSONObjectB != null) {
            try {
        ...
        InMobiUserDataModel inMobiUserDataModel4 = C0578y4.f531a;
