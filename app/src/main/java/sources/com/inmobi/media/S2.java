...
public final class S2 {
    ...
    */
    public S2(org.json.JSONObject r9, com.inmobi.commons.core.configs.Config r10) {
        /*
            r8 = this;
        ...
        L2c:
            ...
            com.inmobi.commons.core.configs.Config r9 = com.inmobi.media.C2.a(r3, r9, r10, r6)     // Catch: org.json.JSONException -> La2
            if (r9 != 0) goto L5f
            ...
            goto L61
        L5f:
            r8.f239a = r9     // Catch: org.json.JSONException -> La2
        L61:
            kotlin.jvm.internal.Intrinsics.checkNotNullExpressionValue(r5, r2)     // Catch: org.json.JSONException -> La2
            com.inmobi.commons.core.configs.Config r9 = r8.f239a     // Catch: org.json.JSONException -> La2
            ...
            kotlin.jvm.internal.Intrinsics.checkNotNullExpressionValue(r5, r2)     // Catch: org.json.JSONException -> La2
            com.inmobi.commons.core.configs.Config r10 = r8.f239a     // Catch: org.json.JSONException -> La2
        ...
        Lad:
            r10.<init>(r1, r9)
            com.inmobi.commons.core.configs.Config r9 = r8.f239a
            r9.getType()
            r8.c = r10
        Lb7:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.inmobi.media.S2.<init>(org.json.JSONObject, com.inmobi.commons.core.configs.Config):void");
    }
}
