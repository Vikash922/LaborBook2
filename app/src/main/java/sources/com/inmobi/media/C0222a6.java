...
public final class C0222a6 extends C0397l9 {
    public final AdQualityResult y;
    public final AdConfig.AdQualityConfig z;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public C0222a6(AdQualityResult result, Kc uidMap, AdConfig.AdQualityConfig config) {
        super("POST", result.getBeaconUrl(), uidMap, false, (InterfaceC0298f5) null, "application/json", 64);
    ...
    public final void f() {
        ...
        if (AbstractC0576y2.a(this.y.getExtras())) {
        ...
        Intrinsics.checkNotNullParameter("getExtras", "message");
        Log.i("JsonBeaconRequest", "getExtras");
        if (!AbstractC0576y2.a(this.y.getSdkModelResult())) {
            Intrinsics.checkNotNullParameter("JsonBeaconRequest", "tag");
