...
public final class C0599z9 {
    ...
    public C0599z9(String mAdSessionType, ImpressionType impressionType, AdSessionContext adSessionContext, boolean z) {
        Intrinsics.checkNotNullParameter(mAdSessionType, "mAdSessionType");
        Intrinsics.checkNotNullParameter(impressionType, "impressionType");
        this.f549a = mAdSessionType;
    ...
    public static boolean a(byte b, byte b2) {
        ...
        C0264d2 event = new C0264d2(new Exception("Omid AdSession State Error currentState :: " + ((int) b) + ", expectedState :: " + ((int) b2)));
    ...
    */
    public final void a(android.view.View r8, java.util.Map r9, android.view.View r10) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.inmobi.media.C0599z9.a(android.view.View, java.util.Map, android.view.View):void");
    }
    ...
    public final void a(int i, int i2, float f, VastProperties vastProps) {
        ...
        if (a(this.e, (byte) 2)) {
            ...
            } else if (b == 0 && (c0573y = this.g) != null && (adEvents = c0573y.f527a) != null) {
                adEvents.impressionOccurred();
            }
            C0573y c0573y2 = this.g;
            if (c0573y2 != null) {
                Intrinsics.checkNotNullParameter(vastProps, "vastProps");
                MediaEvents mediaEvents = c0573y2.b;
                if (mediaEvents == null) {
                    return;
                }
                if (b == 7) {
                ...
                if (b == 5) {
                    AdEvents adEvents2 = c0573y2.f527a;
                    if (adEvents2 != null) {
