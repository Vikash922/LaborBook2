...
import com.rebuilt.app.auth.databinding.ActivityLoginBinding;
...
public final class LoginActivity extends BaseActivity {
    ...
    public LoginActivity() {
        ...
        this.fragmentNavigator = LazyKt.lazy(lazyThreadSafetyMode, (Function0) new Function0<FragmentNavigator>() { // from class: com.rebuilt.app.auth.screen.login.view.LoginActivity$special$$inlined$inject$default$1
        ...
        this.rootFragmentProvider = CollectionsKt.arrayListOf(new Function0() { // from class: com.rebuilt.app.auth.screen.login.view.LoginActivity$$ExternalSyntheticLambda0
            @Override // kotlin.jvm.functions.Function0
    ...
    private final void enableEdgeToEdge() {
        ...
        ViewCompat.setOnApplyWindowInsetsListener(constraintLayout, new OnApplyWindowInsetsListener() { // from class: com.rebuilt.app.auth.screen.login.view.LoginActivity$$ExternalSyntheticLambda1
