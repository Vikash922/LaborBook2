...
import com.rebuilt.app.keep.databinding.ActivityAppLockBinding;
...
public final class AppLockActivity extends AppCompatActivity {
    ...
    public AppLockActivity() {
        ...
        this.dataStoreManager = LazyKt.lazy(lazyThreadSafetyMode, (Function0) new Function0<DataStoreManager>() { // from class: com.rebuilt.app.keep.screen.AppLockActivity$special$$inlined$inject$default$1
    ...
    private final void setupBiometricPrompt() {
        ...
        this.biometricPrompt = new BiometricPrompt(appLockActivity, executor, new BiometricPrompt.AuthenticationCallback() { // from class: com.rebuilt.app.keep.screen.AppLockActivity.setupBiometricPrompt.1
