...
public final class FragmentTransactionReportsBinding implements ViewBinding {
    ...
    public static FragmentTransactionReportsBinding inflate(LayoutInflater inflater, ViewGroup parent, boolean attachToParent) {
        View viewInflate = inflater.inflate(C3621R.layout.fragment_transaction_reports, parent, false);
        if (attachToParent) {
    ...
    public static FragmentTransactionReportsBinding bind(View rootView) {
        ...
        int i = C3621R.id.btn_share_pdf;
        Button button = (Button) ViewBindings.findChildViewById(rootView, i);
        if (button != null) {
            i = C3621R.id.btn_share_whatsapp;
            ...
            if (textViewBoldWhite16 != null) {
                ...
                if (constraintLayout != null && (viewFindChildViewById = ViewBindings.findChildViewById(rootView, (i = C3621R.id.header_divider))) != null) {
                    i = C3621R.id.iv_back;
                    ImageView imageView = (ImageView) ViewBindings.findChildViewById(rootView, i);
                    if (imageView != null) {
                        i = C3621R.id.ll_date_range;
                        LinearLayout linearLayout = (LinearLayout) ViewBindings.findChildViewById(rootView, i);
                        if (linearLayout != null) {
                            i = C3621R.id.ll_share_buttons;
                            ...
                            if (linearLayout2 != null) {
                                ...
                                if (linearLayout3 != null) {
                                    i = C3621R.id.rv_transactions;
                                    RecyclerView recyclerView = (RecyclerView) ViewBindings.findChildViewById(rootView, i);
                                    if (recyclerView != null) {
                                        i = C3621R.id.tv_from_date;
