...
import com.rebuilt.app.keep.databinding.ItemCashbookDateHeaderBinding;
import com.rebuilt.app.keep.databinding.ItemCashbookTableHeaderBinding;
import com.rebuilt.app.keep.databinding.ItemCashbookTransactionBinding;
...
public final class CashbookTransactionAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public final class TransactionViewHolder extends RecyclerView.ViewHolder {
        ...
        public final void bind(CashbookItem.TransactionRow item) {
            ...
            root.setOnClickListener(new View.OnClickListener() { // from class: com.rebuilt.app.keep.screen.home.adapter.CashbookTransactionAdapter$TransactionViewHolder$$ExternalSyntheticLambda0
