...
/* JADX INFO: renamed from: com.rebuilt.app.keep.screen.deletestaff.viewmodel.DeleteStaffViewModel$special$$inlined$CoroutineExceptionHandler$1 */
...
public final class C3778xb3b11423 extends AbstractCoroutineContextElement implements CoroutineExceptionHandler {
    final /* synthetic */ DeleteStaffViewModel this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public C3778xb3b11423(CoroutineExceptionHandler.Companion companion, DeleteStaffViewModel deleteStaffViewModel) {
        super(companion);
    ...
    public void handleException(CoroutineContext context, Throwable exception) {
        ...
        uiState.setValue(new DeleteStaffUiState.Error(localizedMessage));
    }
}
