package com.rebuilt.app.keep.screen.calendar.dao;
...
public final class CalendarItemDao_Impl implements CalendarItemDao {
    ...
    public CalendarItemDao_Impl(final RoomDatabase __db) {
        this.__db = __db;
        this.__insertionAdapterOfCalendarItem = new EntityInsertionAdapter<CalendarItem>(__db) { // from class: com.rebuilt.app.keep.screen.calendar.dao.CalendarItemDao_Impl.1
        ...
        this.__preparedStmtOfDeleteByUserIdMonthYear = new SharedSQLiteStatement(__db) { // from class: com.rebuilt.app.keep.screen.calendar.dao.CalendarItemDao_Impl.2
            @Override // androidx.room.SharedSQLiteStatement
            public String createQuery() {
                return "DELETE FROM calendar_item WHERE id = ? AND month = ? AND year = ?";
            }
        };
        this.__preparedStmtOfDeleteOldest = new SharedSQLiteStatement(__db) { // from class: com.rebuilt.app.keep.screen.calendar.dao.CalendarItemDao_Impl.3
            @Override // androidx.room.SharedSQLiteStatement
            public String createQuery() {
                return "DELETE FROM calendar_item WHERE id IN (SELECT id FROM calendar_item ORDER BY id ASC LIMIT ?)";
            }
        };
        this.__preparedStmtOfDeleteAll = new SharedSQLiteStatement(__db) { // from class: com.rebuilt.app.keep.screen.calendar.dao.CalendarItemDao_Impl.4
            @Override // androidx.room.SharedSQLiteStatement
            public String createQuery() {
    ...
    @Override // com.rebuilt.app.keep.screen.calendar.dao.CalendarItemDao
    public Object insert(final CalendarItem item, final Continuation<? super Unit> $completion) {
        return CoroutinesRoom.execute(this.__db, true, new Callable<Unit>() { // from class: com.rebuilt.app.keep.screen.calendar.dao.CalendarItemDao_Impl.5
    ...
    public Object insertAll(final List<CalendarItem> items, final Continuation<? super Unit> $completion) {
        return CoroutinesRoom.execute(this.__db, true, new Callable<Unit>() { // from class: com.rebuilt.app.keep.screen.calendar.dao.CalendarItemDao_Impl.6
            @Override // java.util.concurrent.Callable
            public Unit call() throws Exception {
                CalendarItemDao_Impl.this.__db.beginTransaction();
                try {
    ...
    public Object deleteByUserIdMonthYear(final String id, final String month, final String year, final Continuation<? super Unit> $completion) {
        return CoroutinesRoom.execute(this.__db, true, new Callable<Unit>() { // from class: com.rebuilt.app.keep.screen.calendar.dao.CalendarItemDao_Impl.7
            @Override // java.util.concurrent.Callable
            public Unit call() throws Exception {
    ...
    public Object deleteOldest(final int count, final Continuation<? super Unit> $completion) {
        return CoroutinesRoom.execute(this.__db, true, new Callable<Unit>() { // from class: com.rebuilt.app.keep.screen.calendar.dao.CalendarItemDao_Impl.8
            @Override // java.util.concurrent.Callable
            public Unit call() throws Exception {
    ...
    public Object deleteAll(final Continuation<? super Unit> $completion) {
        return CoroutinesRoom.execute(this.__db, true, new Callable<Unit>() { // from class: com.rebuilt.app.keep.screen.calendar.dao.CalendarItemDao_Impl.9
            @Override // java.util.concurrent.Callable
            public Unit call() throws Exception {
    ...
    public Object getAllByIdMonthYear(final String id, final String month, final String year, final Continuation<? super List<CalendarItem>> $completion) {
        ...
        return CoroutinesRoom.execute(this.__db, false, DBUtil.createCancellationSignal(), new Callable<List<CalendarItem>>() { // from class: com.rebuilt.app.keep.screen.calendar.dao.CalendarItemDao_Impl.10
            @Override // java.util.concurrent.Callable
    ...
    public Object getCount(final Continuation<? super Integer> $completion) {
        ...
        return CoroutinesRoom.execute(this.__db, false, DBUtil.createCancellationSignal(), new Callable<Integer>() { // from class: com.rebuilt.app.keep.screen.calendar.dao.CalendarItemDao_Impl.11
