...
import com.rebuilt.app.auth.screen.login.view.LoginFragment;
...
public final class MainActivity extends AppCompatActivity implements Navigator.NavigatorListener {
    ...
    private final ArrayList<Function0<Fragment>> rootFragmentProvider = CollectionsKt.arrayListOf(new Function0() { // from class: com.rebuilt.app.MainActivity$$ExternalSyntheticLambda0
    ...
    private final void enableEdgeToEdge() {
        ...
        ViewCompat.setOnApplyWindowInsetsListener(viewFindViewById, new OnApplyWindowInsetsListener() { // from class: com.rebuilt.app.MainActivity$$ExternalSyntheticLambda1
