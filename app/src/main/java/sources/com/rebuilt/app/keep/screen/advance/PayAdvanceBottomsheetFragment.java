package com.rebuilt.app.keep.screen.advance;
...
import com.rebuilt.app.keep.databinding.FragmentPayAdvanceBottomsheetBinding;
import com.rebuilt.app.keep.model.AddAdvanceRequestBody;
import com.rebuilt.app.keep.model.Advance;
...
public final class PayAdvanceBottomsheetFragment extends BaseBottomsheetFragment<FragmentPayAdvanceBottomsheetBinding> {
    ...
    public PayAdvanceBottomsheetFragment() {
        ...
        this.viewModel = LazyKt.lazy(lazyThreadSafetyMode, (Function0) new Function0<AddAdvanceViewModel>() { // from class: com.rebuilt.app.keep.screen.advance.PayAdvanceBottomsheetFragment$special$$inlined$viewModel$default$1
            ...
            /* JADX WARN: Type inference failed for: r0v1, types: [androidx.lifecycle.ViewModel, com.rebuilt.app.keep.screen.advance.viewmodel.AddAdvanceViewModel] */
        ...
        this.observerUtil = LazyKt.lazy(lazyThreadSafetyMode2, (Function0) new Function0<ObserverUtil>() { // from class: com.rebuilt.app.keep.screen.advance.PayAdvanceBottomsheetFragment$special$$inlined$inject$default$1
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            {
                super(0);
            }
    ...
    /* JADX INFO: renamed from: com.rebuilt.app.keep.screen.advance.PayAdvanceBottomsheetFragment$onViewCreated$1 */
    /* JADX INFO: compiled from: PayAdvanceBottomsheetFragment.kt */
    @Metadata(m2721d1 = {"\u0000\n\n\u0000\n\u0002\u0010\u0002\n\u0002\u0018\u0002\u0010\u0000\u001a\u00020\u0001*\u00020\u0002H\n"}, m2722d2 = {"<anonymous>", "", "Lkotlinx/coroutines/CoroutineScope;"}, m2723k = 3, m2724mv = {2, 0, 0}, m2726xi = 48)
    @DebugMetadata(m2734c = "com.rebuilt.app.keep.screen.advance.PayAdvanceBottomsheetFragment$onViewCreated$1", m2735f = "PayAdvanceBottomsheetFragment.kt", m2736i = {}, m2737l = {100}, m2738m = "invokeSuspend", m2739n = {}, m2740s = {})
    ...
    private final void viewModelObserver() {
        getViewModel().uiState().observe(getViewLifecycleOwner(), new C3721xe32bd877(new Function1() { // from class: com.rebuilt.app.keep.screen.advance.PayAdvanceBottomsheetFragment$$ExternalSyntheticLambda0
    ...
    private final void setupInputWatchers() {
        ...
        if (binding != null) {
            ...
            etAdvance.addTextChangedListener(new TextWatcher() { // from class: com.rebuilt.app.keep.screen.advance.PayAdvanceBottomsheetFragment$setupInputWatchers$lambda$5$$inlined$doAfterTextChanged$1
            ...
            etDescription.addTextChangedListener(new TextWatcher() { // from class: com.rebuilt.app.keep.screen.advance.PayAdvanceBottomsheetFragment$setupInputWatchers$lambda$5$$inlined$doAfterTextChanged$2
                @Override // android.text.TextWatcher
                public void beforeTextChanged(CharSequence text, int start, int count, int after) {
                }
    ...
    private final void setupPaymentMethodToggle() {
        ...
        if (binding != null) {
            ...
            binding.rbOnline.setOnClickListener(new View.OnClickListener() { // from class: com.rebuilt.app.keep.screen.advance.PayAdvanceBottomsheetFragment$$ExternalSyntheticLambda4
                @Override // android.view.View.OnClickListener
                public final void onClick(View view) {
                    PayAdvanceBottomsheetFragment.setupPaymentMethodToggle$lambda$9$lambda$7(this.f$0, view);
                }
            });
            binding.rbCash.setOnClickListener(new View.OnClickListener() { // from class: com.rebuilt.app.keep.screen.advance.PayAdvanceBottomsheetFragment$$ExternalSyntheticLambda5
                @Override // android.view.View.OnClickListener
                public final void onClick(View view) {
    ...
    private final void setOnClickListeners() {
        ...
        if (binding != null && (imageView = binding.ivClose) != null) {
            imageView.setOnClickListener(new View.OnClickListener() { // from class: com.rebuilt.app.keep.screen.advance.PayAdvanceBottomsheetFragment$$ExternalSyntheticLambda1
                @Override // android.view.View.OnClickListener
                public final void onClick(View view) {
        ...
        if (binding2 != null && (primaryButton = binding2.btnAddAdvance) != null) {
            primaryButton.setOnClickListener(new View.OnClickListener() { // from class: com.rebuilt.app.keep.screen.advance.PayAdvanceBottomsheetFragment$$ExternalSyntheticLambda2
                @Override // android.view.View.OnClickListener
                public final void onClick(View view) {
        ...
        textView.setOnClickListener(new View.OnClickListener() { // from class: com.rebuilt.app.keep.screen.advance.PayAdvanceBottomsheetFragment$$ExternalSyntheticLambda3
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
    ...
    /* JADX INFO: renamed from: com.rebuilt.app.keep.screen.advance.PayAdvanceBottomsheetFragment$addOrUpdateAdvance$1 */
    /* JADX INFO: compiled from: PayAdvanceBottomsheetFragment.kt */
    @Metadata(m2721d1 = {"\u0000\n\n\u0000\n\u0002\u0010\u0002\n\u0002\u0018\u0002\u0010\u0000\u001a\u00020\u0001*\u00020\u0002H\n"}, m2722d2 = {"<anonymous>", "", "Lkotlinx/coroutines/CoroutineScope;"}, m2723k = 3, m2724mv = {2, 0, 0}, m2726xi = 48)
    @DebugMetadata(m2734c = "com.rebuilt.app.keep.screen.advance.PayAdvanceBottomsheetFragment$addOrUpdateAdvance$1", m2735f = "PayAdvanceBottomsheetFragment.kt", m2736i = {}, m2737l = {255}, m2738m = "invokeSuspend", m2739n = {}, m2740s = {})
