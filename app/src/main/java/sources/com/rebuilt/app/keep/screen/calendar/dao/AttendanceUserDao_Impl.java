...
public final class AttendanceUserDao_Impl implements AttendanceUserDao {
    ...
    public AttendanceUserDao_Impl(final RoomDatabase __db) {
        this.__db = __db;
        this.__insertionAdapterOfAttendanceUser = new EntityInsertionAdapter<AttendanceUser>(__db) { // from class: com.rebuilt.app.keep.screen.calendar.dao.AttendanceUserDao_Impl.1
        ...
        this.__preparedStmtOfDeleteByUserId = new SharedSQLiteStatement(__db) { // from class: com.rebuilt.app.keep.screen.calendar.dao.AttendanceUserDao_Impl.2
            @Override // androidx.room.SharedSQLiteStatement
            public String createQuery() {
                return "DELETE FROM attendance_user WHERE id = ?";
            }
        };
        this.__preparedStmtOfDeleteAll = new SharedSQLiteStatement(__db) { // from class: com.rebuilt.app.keep.screen.calendar.dao.AttendanceUserDao_Impl.3
            @Override // androidx.room.SharedSQLiteStatement
            public String createQuery() {
    ...
    @Override // com.rebuilt.app.keep.screen.calendar.dao.AttendanceUserDao
    public Object insert(final AttendanceUser user, final Continuation<? super Unit> $completion) {
        return CoroutinesRoom.execute(this.__db, true, new Callable<Unit>() { // from class: com.rebuilt.app.keep.screen.calendar.dao.AttendanceUserDao_Impl.4
    ...
    public Object deleteByUserId(final String id, final Continuation<? super Unit> $completion) {
        return CoroutinesRoom.execute(this.__db, true, new Callable<Unit>() { // from class: com.rebuilt.app.keep.screen.calendar.dao.AttendanceUserDao_Impl.5
            @Override // java.util.concurrent.Callable
            public Unit call() throws Exception {
    ...
    public Object deleteAll(final Continuation<? super Unit> $completion) {
        return CoroutinesRoom.execute(this.__db, true, new Callable<Unit>() { // from class: com.rebuilt.app.keep.screen.calendar.dao.AttendanceUserDao_Impl.6
            @Override // java.util.concurrent.Callable
            public Unit call() throws Exception {
    ...
    public Object getUserById(final String id, final Continuation<? super AttendanceUser> $completion) {
        ...
        return CoroutinesRoom.execute(this.__db, false, DBUtil.createCancellationSignal(), new Callable<AttendanceUser>() { // from class: com.rebuilt.app.keep.screen.calendar.dao.AttendanceUserDao_Impl.7
