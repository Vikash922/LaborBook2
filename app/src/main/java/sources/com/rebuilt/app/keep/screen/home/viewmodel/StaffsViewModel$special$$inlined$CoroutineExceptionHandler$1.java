...
public final class StaffsViewModel$special$$inlined$CoroutineExceptionHandler$1 extends AbstractCoroutineContextElement implements CoroutineExceptionHandler {
    final /* synthetic */ StaffsViewModel this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public StaffsViewModel$special$$inlined$CoroutineExceptionHandler$1(CoroutineExceptionHandler.Companion companion, StaffsViewModel staffsViewModel) {
        super(companion);
    ...
    public void handleException(CoroutineContext context, Throwable exception) {
        ...
        uiState.setValue(new StaffsUiState.Error(localizedMessage));
    }
}
