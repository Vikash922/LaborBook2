...
public final class TransactionDetailsBottomSheetFragment extends BaseBottomsheetFragment<FragmentTransactionDetailsBinding> {
    ...
    public TransactionDetailsBottomSheetFragment() {
        ...
        this.incomeObserverUtil = LazyKt.lazy(lazyThreadSafetyMode, (Function0) new Function0<IncomeObserverUtil>() { // from class: com.rebuilt.app.income.screen.details.fragment.TransactionDetailsBottomSheetFragment$special$$inlined$inject$default$1
    ...
    private final void setupClicks() {
        ...
        if (binding != null && (imageView = binding.ivClose) != null) {
            imageView.setOnClickListener(new View.OnClickListener() { // from class: com.rebuilt.app.income.screen.details.fragment.TransactionDetailsBottomSheetFragment$$ExternalSyntheticLambda3
        ...
        if (binding2 != null && (primaryButton = binding2.btnOk) != null) {
            primaryButton.setOnClickListener(new View.OnClickListener() { // from class: com.rebuilt.app.income.screen.details.fragment.TransactionDetailsBottomSheetFragment$$ExternalSyntheticLambda4
                @Override // android.view.View.OnClickListener
                public final void onClick(View view) {
        ...
        textViewBold12.setOnClickListener(new View.OnClickListener() { // from class: com.rebuilt.app.income.screen.details.fragment.TransactionDetailsBottomSheetFragment$$ExternalSyntheticLambda5
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
    ...
    public final void openEditFragment() {
        ...
        try {
            ...
            decorView.postDelayed(new Runnable() { // from class: com.rebuilt.app.income.screen.details.fragment.TransactionDetailsBottomSheetFragment$$ExternalSyntheticLambda2
    ...
    private final void setupObserverCallbacks() {
        ...
        if (incomeFragmentFindIncomeFragment != null) {
            getIncomeObserverUtil().setOnIncomeAddedOrUpdated(new Function2() { // from class: com.rebuilt.app.income.screen.details.fragment.TransactionDetailsBottomSheetFragment$$ExternalSyntheticLambda0
            ...
            getIncomeObserverUtil().setOnIncomeDeleted(new Function1() { // from class: com.rebuilt.app.income.screen.details.fragment.TransactionDetailsBottomSheetFragment$$ExternalSyntheticLambda1
