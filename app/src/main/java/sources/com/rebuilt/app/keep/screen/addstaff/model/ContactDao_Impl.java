...
public final class ContactDao_Impl implements ContactDao {
    ...
    public ContactDao_Impl(final RoomDatabase __db) {
        this.__db = __db;
        this.__insertionAdapterOfContactItem = new EntityInsertionAdapter<ContactItem>(__db) { // from class: com.rebuilt.app.keep.screen.addstaff.model.ContactDao_Impl.1
        ...
        this.__preparedStmtOfDeleteAllContacts = new SharedSQLiteStatement(__db) { // from class: com.rebuilt.app.keep.screen.addstaff.model.ContactDao_Impl.2
            @Override // androidx.room.SharedSQLiteStatement
    ...
    @Override // com.rebuilt.app.keep.screen.addstaff.model.ContactDao
    public Object insertContacts(final ContactItem[] contacts, final Continuation<? super Unit> $completion) {
        return CoroutinesRoom.execute(this.__db, true, new Callable<Unit>() { // from class: com.rebuilt.app.keep.screen.addstaff.model.ContactDao_Impl.3
    ...
    public Object deleteAllContacts(final Continuation<? super Unit> $completion) {
        return CoroutinesRoom.execute(this.__db, true, new Callable<Unit>() { // from class: com.rebuilt.app.keep.screen.addstaff.model.ContactDao_Impl.4
            @Override // java.util.concurrent.Callable
            public Unit call() throws Exception {
    ...
    public Object getAllContacts(final Continuation<? super List<ContactItem>> $completion) {
        ...
        return CoroutinesRoom.execute(this.__db, false, DBUtil.createCancellationSignal(), new Callable<List<ContactItem>>() { // from class: com.rebuilt.app.keep.screen.addstaff.model.ContactDao_Impl.5
            @Override // java.util.concurrent.Callable
