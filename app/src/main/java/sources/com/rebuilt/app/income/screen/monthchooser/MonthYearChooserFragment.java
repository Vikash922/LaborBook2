package com.rebuilt.app.income.screen.monthchooser;
...
import com.rebuilt.app.income.databinding.FragmentMonthYearChooserBinding;
...
public final class MonthYearChooserFragment extends BaseBottomsheetFragment<FragmentMonthYearChooserBinding> {
    ...
    /* JADX INFO: compiled from: MonthYearChooserFragment.kt */
    @Metadata(m2721d1 = {"\u0000\u001a\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\b\n\u0002\b\u0002\b\u0086\u0003\u0018\u00002\u00020\u0001B\t\b\u0002¢\u0006\u0004\b\u0002\u0010\u0003J\u0016\u0010\u0004\u001a\u00020\u00052\u0006\u0010\u0006\u001a\u00020\u00072\u0006\u0010\b\u001a\u00020\u0007¨\u0006\t"}, m2722d2 = {"Lcom/laborbook/income/screen/monthchooser/MonthYearChooserFragment$Companion;", "", "<init>", "()V", "newInstance", "Lcom/laborbook/income/screen/monthchooser/MonthYearChooserFragment;", "currentMonth", "", "currentYear", "income_release"}, m2723k = 1, m2724mv = {2, 0, 0}, m2726xi = 48)
    ...
    private final void setOnClickListeners() {
        ...
        if (binding != null && (imageView = binding.ivClose) != null) {
            imageView.setOnClickListener(new View.OnClickListener() { // from class: com.rebuilt.app.income.screen.monthchooser.MonthYearChooserFragment$$ExternalSyntheticLambda1
        ...
        if (binding2 != null && (linearLayout2 = binding2.llMonth) != null) {
            linearLayout2.setOnClickListener(new View.OnClickListener() { // from class: com.rebuilt.app.income.screen.monthchooser.MonthYearChooserFragment$$ExternalSyntheticLambda2
                @Override // android.view.View.OnClickListener
                public final void onClick(View view) {
        ...
        if (binding3 != null && (linearLayout = binding3.llYear) != null) {
            linearLayout.setOnClickListener(new View.OnClickListener() { // from class: com.rebuilt.app.income.screen.monthchooser.MonthYearChooserFragment$$ExternalSyntheticLambda3
                @Override // android.view.View.OnClickListener
                public final void onClick(View view) {
        ...
        primaryButton.setOnClickListener(new View.OnClickListener() { // from class: com.rebuilt.app.income.screen.monthchooser.MonthYearChooserFragment$$ExternalSyntheticLambda4
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
    ...
    public static final void setOnClickListeners$lambda$3(final MonthYearChooserFragment this$0, View view) {
        ...
        new AlertDialog.Builder(this$0.requireContext()).setTitle(this$0.getString(C3621R.string.select_month)).setSingleChoiceItems(strArr, this$0.selectedMonth, new DialogInterface.OnClickListener() { // from class: com.rebuilt.app.income.screen.monthchooser.MonthYearChooserFragment$$ExternalSyntheticLambda0
    ...
    public static final void setOnClickListeners$lambda$6(final MonthYearChooserFragment this$0, View view) {
        ...
        new AlertDialog.Builder(this$0.requireContext()).setTitle(this$0.getString(C3621R.string.select_year)).setSingleChoiceItems(strArr, ArraysKt.indexOf(strArr, String.valueOf(this$0.selectedYear)), new DialogInterface.OnClickListener() { // from class: com.rebuilt.app.income.screen.monthchooser.MonthYearChooserFragment$$ExternalSyntheticLambda5
            @Override // android.content.DialogInterface.OnClickListener
