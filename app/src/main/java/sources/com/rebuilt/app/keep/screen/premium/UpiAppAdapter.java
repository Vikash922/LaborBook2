...
import com.rebuilt.app.keep.databinding.ItemUpiAppBinding;
import com.rebuilt.app.keep.screen.premium.UpiAppAdapter;
...
public final class UpiAppAdapter extends RecyclerView.Adapter<UpiAppViewHolder> {
    ...
    public final class UpiAppViewHolder extends RecyclerView.ViewHolder {
        ...
        public final void bind(final InstalledUpiApp upiApp) {
            ...
            itemUpiAppBinding.getRoot().setOnClickListener(new View.OnClickListener() { // from class: com.rebuilt.app.keep.screen.premium.UpiAppAdapter$UpiAppViewHolder$$ExternalSyntheticLambda0
