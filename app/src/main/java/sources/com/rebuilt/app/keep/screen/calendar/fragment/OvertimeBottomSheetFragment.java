...
import com.rebuilt.app.keep.databinding.FragmentOvertimeBottomsheetBinding;
import com.rebuilt.app.keep.screen.attendance.AttendanceMarkBottomsheetFragment;
...
public final class OvertimeBottomSheetFragment extends BaseBottomsheetFragment<FragmentOvertimeBottomsheetBinding> implements KoinComponent {
    ...
    public OvertimeBottomSheetFragment() {
        ...
        this.viewModel = LazyKt.lazy(lazyThreadSafetyMode, (Function0) new Function0<OvertimeViewModel>() { // from class: com.rebuilt.app.keep.screen.calendar.fragment.OvertimeBottomSheetFragment$special$$inlined$viewModel$default$1
            ...
            /* JADX WARN: Type inference failed for: r0v1, types: [androidx.lifecycle.ViewModel, com.rebuilt.app.keep.screen.calendar.viewmodel.OvertimeViewModel] */
        ...
        this.dataStore = LazyKt.lazy(lazyThreadSafetyModeDefaultLazyMode, (Function0) new Function0<DataStoreManager>() { // from class: com.rebuilt.app.keep.screen.calendar.fragment.OvertimeBottomSheetFragment$special$$inlined$inject$default$1
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            {
                super(0);
            }
        ...
        this.observerUtil = LazyKt.lazy(lazyThreadSafetyModeDefaultLazyMode2, (Function0) new Function0<ObserverUtil>() { // from class: com.rebuilt.app.keep.screen.calendar.fragment.OvertimeBottomSheetFragment$special$$inlined$inject$default$2
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            {
                super(0);
            }

            /* JADX WARN: Type inference failed for: r0v5, types: [com.rebuilt.app.keep.screen.calendar.utils.ObserverUtil, java.lang.Object] */
            @Override // kotlin.jvm.functions.Function0
    ...
    private final void setupClickListeners() {
        ...
        if (binding != null && (imageView = binding.ivClose) != null) {
            imageView.setOnClickListener(new View.OnClickListener() { // from class: com.rebuilt.app.keep.screen.calendar.fragment.OvertimeBottomSheetFragment$$ExternalSyntheticLambda0
        ...
        FragmentOvertimeBottomsheetBinding binding2 = getBinding();
        if (binding2 != null && (editText2 = binding2.etHours) != null) {
            editText2.setOnClickListener(new View.OnClickListener() { // from class: com.rebuilt.app.keep.screen.calendar.fragment.OvertimeBottomSheetFragment$$ExternalSyntheticLambda5
                @Override // android.view.View.OnClickListener
                public final void onClick(View view) {
        ...
        if (binding3 != null && (editText = binding3.etHours) != null) {
            editText.setOnFocusChangeListener(new View.OnFocusChangeListener() { // from class: com.rebuilt.app.keep.screen.calendar.fragment.OvertimeBottomSheetFragment$$ExternalSyntheticLambda6
        ...
        if (binding4 != null && (primaryButton = binding4.btnOk) != null) {
            primaryButton.setOnClickListener(new View.OnClickListener() { // from class: com.rebuilt.app.keep.screen.calendar.fragment.OvertimeBottomSheetFragment$$ExternalSyntheticLambda7
                @Override // android.view.View.OnClickListener
                public final void onClick(View view) {
        ...
        textView.setOnClickListener(new View.OnClickListener() { // from class: com.rebuilt.app.keep.screen.calendar.fragment.OvertimeBottomSheetFragment$$ExternalSyntheticLambda8
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
    ...
    private final void setupTextWatchers() {
        EditText editText;
        EditText editText2;
        final Function4 function4 = new Function4() { // from class: com.rebuilt.app.keep.screen.calendar.fragment.OvertimeBottomSheetFragment$$ExternalSyntheticLambda9
        ...
        if (binding != null && (editText2 = binding.etHours) != null) {
            editText2.addTextChangedListener(new TextWatcher() { // from class: com.rebuilt.app.keep.screen.calendar.fragment.OvertimeBottomSheetFragment$setupTextWatchers$$inlined$doOnTextChanged$1
        ...
        editText.addTextChangedListener(new TextWatcher() { // from class: com.rebuilt.app.keep.screen.calendar.fragment.OvertimeBottomSheetFragment$setupTextWatchers$$inlined$doOnTextChanged$2
            @Override // android.text.TextWatcher
            public void afterTextChanged(Editable s) {
            }
    ...
    */
    public static final kotlin.Unit setupTextWatchers$lambda$5(com.rebuilt.app.keep.screen.calendar.fragment.OvertimeBottomSheetFragment r0, java.lang.CharSequence r1, int r2, int r3, int r4) {
        /*
            java.lang.String r1 = "this$0"
            kotlin.jvm.internal.Intrinsics.checkNotNullParameter(r0, r1)
            r0.calculateTotal()
            androidx.viewbinding.ViewBinding r1 = r0.getBinding()
            com.rebuilt.app.keep.databinding.FragmentOvertimeBottomsheetBinding r1 = (com.rebuilt.app.keep.databinding.FragmentOvertimeBottomsheetBinding) r1
            r2 = 0
            if (r1 == 0) goto L1a
        ...
        L44:
            ...
            com.rebuilt.app.keep.databinding.FragmentOvertimeBottomsheetBinding r2 = (com.rebuilt.app.keep.databinding.FragmentOvertimeBottomsheetBinding) r2
            if (r2 == 0) goto L53
        ...
        L53:
            ...
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.rebuilt.app.keep.screen.calendar.fragment.OvertimeBottomSheetFragment.setupTextWatchers$lambda$5(com.rebuilt.app.keep.screen.calendar.fragment.OvertimeBottomSheetFragment, java.lang.CharSequence, int, int, int):kotlin.Unit");
    }
    ...
    private final void showTimePicker() {
        ...
        numberPicker.postDelayed(new Runnable() { // from class: com.rebuilt.app.keep.screen.calendar.fragment.OvertimeBottomSheetFragment$$ExternalSyntheticLambda11
            @Override // java.lang.Runnable
            public final void run() {
                OvertimeBottomSheetFragment.showTimePicker$lambda$6(this.f$0, numberPicker);
            }
        }, 100L);
        numberPicker2.postDelayed(new Runnable() { // from class: com.rebuilt.app.keep.screen.calendar.fragment.OvertimeBottomSheetFragment$$ExternalSyntheticLambda12
            @Override // java.lang.Runnable
            public final void run() {
                OvertimeBottomSheetFragment.showTimePicker$lambda$7(this.f$0, numberPicker2);
            }
        }, 100L);
        numberPicker.setOnValueChangedListener(new NumberPicker.OnValueChangeListener() { // from class: com.rebuilt.app.keep.screen.calendar.fragment.OvertimeBottomSheetFragment$$ExternalSyntheticLambda13
        ...
        numberPicker2.setOnValueChangedListener(new NumberPicker.OnValueChangeListener() { // from class: com.rebuilt.app.keep.screen.calendar.fragment.OvertimeBottomSheetFragment$$ExternalSyntheticLambda1
            @Override // android.widget.NumberPicker.OnValueChangeListener
            public final void onValueChange(NumberPicker numberPicker3, int i, int i2) {
        ...
        imageView.setOnClickListener(new View.OnClickListener() { // from class: com.rebuilt.app.keep.screen.calendar.fragment.OvertimeBottomSheetFragment$$ExternalSyntheticLambda2
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                OvertimeBottomSheetFragment.showTimePicker$lambda$10(bottomSheetDialog, view);
            }
        });
        primaryButton.setOnClickListener(new View.OnClickListener() { // from class: com.rebuilt.app.keep.screen.calendar.fragment.OvertimeBottomSheetFragment$$ExternalSyntheticLambda3
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
        ...
        decorView.post(new Runnable() { // from class: com.rebuilt.app.keep.screen.calendar.fragment.OvertimeBottomSheetFragment$$ExternalSyntheticLambda4
            @Override // java.lang.Runnable
            public final void run() {
    ...
    /* JADX INFO: renamed from: com.rebuilt.app.keep.screen.calendar.fragment.OvertimeBottomSheetFragment$saveOvertime$1 */
    /* JADX INFO: compiled from: OvertimeBottomSheetFragment.kt */
    @Metadata(m2721d1 = {"\u0000\n\n\u0000\n\u0002\u0010\u0002\n\u0002\u0018\u0002\u0010\u0000\u001a\u00020\u0001*\u00020\u0002H\n"}, m2722d2 = {"<anonymous>", "", "Lkotlinx/coroutines/CoroutineScope;"}, m2723k = 3, m2724mv = {2, 0, 0}, m2726xi = 48)
    @DebugMetadata(m2734c = "com.rebuilt.app.keep.screen.calendar.fragment.OvertimeBottomSheetFragment$saveOvertime$1", m2735f = "OvertimeBottomSheetFragment.kt", m2736i = {}, m2737l = {322}, m2738m = "invokeSuspend", m2739n = {}, m2740s = {})
    static final class C37631 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        /* JADX INFO: renamed from: com.rebuilt.app.keep.screen.calendar.fragment.OvertimeBottomSheetFragment$saveOvertime$1$1, reason: invalid class name */
        /* JADX INFO: compiled from: OvertimeBottomSheetFragment.kt */
        @Metadata(m2721d1 = {"\u0000\n\n\u0000\n\u0002\u0010\u0002\n\u0002\u0018\u0002\u0010\u0000\u001a\u00020\u0001*\u00020\u0002H\n"}, m2722d2 = {"<anonymous>", "", "Lkotlinx/coroutines/CoroutineScope;"}, m2723k = 3, m2724mv = {2, 0, 0}, m2726xi = 48)
        @DebugMetadata(m2734c = "com.rebuilt.app.keep.screen.calendar.fragment.OvertimeBottomSheetFragment$saveOvertime$1$1", m2735f = "OvertimeBottomSheetFragment.kt", m2736i = {}, m2737l = {TIFFConstants.TIFFTAG_TILELENGTH}, m2738m = "invokeSuspend", m2739n = {}, m2740s = {})
    ...
    /* JADX INFO: renamed from: com.rebuilt.app.keep.screen.calendar.fragment.OvertimeBottomSheetFragment$deleteOvertime$1 */
    /* JADX INFO: compiled from: OvertimeBottomSheetFragment.kt */
    @Metadata(m2721d1 = {"\u0000\n\n\u0000\n\u0002\u0010\u0002\n\u0002\u0018\u0002\u0010\u0000\u001a\u00020\u0001*\u00020\u0002H\n"}, m2722d2 = {"<anonymous>", "", "Lkotlinx/coroutines/CoroutineScope;"}, m2723k = 3, m2724mv = {2, 0, 0}, m2726xi = 48)
    @DebugMetadata(m2734c = "com.rebuilt.app.keep.screen.calendar.fragment.OvertimeBottomSheetFragment$deleteOvertime$1", m2735f = "OvertimeBottomSheetFragment.kt", m2736i = {}, m2737l = {344}, m2738m = "invokeSuspend", m2739n = {}, m2740s = {})
    static final class C37621 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        /* JADX INFO: renamed from: com.rebuilt.app.keep.screen.calendar.fragment.OvertimeBottomSheetFragment$deleteOvertime$1$1, reason: invalid class name */
        /* JADX INFO: compiled from: OvertimeBottomSheetFragment.kt */
        @Metadata(m2721d1 = {"\u0000\n\n\u0000\n\u0002\u0010\u0002\n\u0002\u0018\u0002\u0010\u0000\u001a\u00020\u0001*\u00020\u0002H\n"}, m2722d2 = {"<anonymous>", "", "Lkotlinx/coroutines/CoroutineScope;"}, m2723k = 3, m2724mv = {2, 0, 0}, m2726xi = 48)
        @DebugMetadata(m2734c = "com.rebuilt.app.keep.screen.calendar.fragment.OvertimeBottomSheetFragment$deleteOvertime$1$1", m2735f = "OvertimeBottomSheetFragment.kt", m2736i = {}, m2737l = {345}, m2738m = "invokeSuspend", m2739n = {}, m2740s = {})
        static final class AnonymousClass1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
            final /* synthetic */ String $dateStr;
            final /* synthetic */ String $staffUserId;
            int label;
    ...
    private final void observeViewModel() {
        getViewModel().getOtResult().observe(getViewLifecycleOwner(), new OvertimeBottomSheetFragmentKt$sam$androidx_lifecycle_Observer$0(new Function1() { // from class: com.rebuilt.app.keep.screen.calendar.fragment.OvertimeBottomSheetFragment$$ExternalSyntheticLambda10
    ...
    @Override // com.rebuilt.app.base.BaseBottomsheetFragment, androidx.fragment.app.DialogFragment, androidx.fragment.app.Fragment
