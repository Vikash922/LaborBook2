package com.rebuilt.app.keep.screen.calendar.adapter;
...
import com.rebuilt.app.keep.databinding.ItemCalendarAttendanceBinding;
import com.rebuilt.app.keep.model.CalendarItem;
import com.rebuilt.app.keep.screen.advance.AdvanceDetailsBottomsheetFragment;
import com.rebuilt.app.keep.screen.advance.PayAdvanceBottomsheetFragment;
...
import com.rebuilt.app.keep.screen.calendar.fragment.OvertimeBottomSheetFragment;
...
public final class AttendanceCalendarItemAdapter extends ListAdapter<CalendarItem, ItemViewHolder> {
    ...
    public static final class ItemViewHolder extends RecyclerView.ViewHolder implements KoinComponent {
        ...
        public ItemViewHolder(ItemCalendarAttendanceBinding binding) {
            ...
            this.fragmentNavigator = LazyKt.lazy(lazyThreadSafetyModeDefaultLazyMode, (Function0) new Function0<FragmentNavigator>() { // from class: com.rebuilt.app.keep.screen.calendar.adapter.AttendanceCalendarItemAdapter$ItemViewHolder$special$$inlined$inject$default$1
                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                {
                    super(0);
                }
            ...
            this.observerUtil = LazyKt.lazy(lazyThreadSafetyModeDefaultLazyMode2, (Function0) new Function0<ObserverUtil>() { // from class: com.rebuilt.app.keep.screen.calendar.adapter.AttendanceCalendarItemAdapter$ItemViewHolder$special$$inlined$inject$default$2
                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                {
                    super(0);
                }
            ...
            this.analytics = LazyKt.lazy(lazyThreadSafetyModeDefaultLazyMode3, (Function0) new Function0<Analytics>() { // from class: com.rebuilt.app.keep.screen.calendar.adapter.AttendanceCalendarItemAdapter$ItemViewHolder$special$$inlined$inject$default$3
                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                {
                    super(0);
                }
        ...
        public final void bind(final CalendarItem calendarItem, final String iStaffName, final String iStaffId) {
            ...
            this.binding.ivMore.setOnClickListener(new View.OnClickListener() { // from class: com.rebuilt.app.keep.screen.calendar.adapter.AttendanceCalendarItemAdapter$ItemViewHolder$$ExternalSyntheticLambda0
                @Override // android.view.View.OnClickListener
                public final void onClick(View view) {
                    AttendanceCalendarItemAdapter.ItemViewHolder.bind$lambda$0(this.f$0, iStaffId, iStaffName, calendarItem, view);
                }
            });
            this.binding.ivAttendanceOne.setOnClickListener(new View.OnClickListener() { // from class: com.rebuilt.app.keep.screen.calendar.adapter.AttendanceCalendarItemAdapter$ItemViewHolder$$ExternalSyntheticLambda1
                @Override // android.view.View.OnClickListener
                public final void onClick(View view) {
                    AttendanceCalendarItemAdapter.ItemViewHolder.bind$lambda$2(this.f$0, calendarItem, iStaffId, iStaffName, view);
                }
            });
            this.binding.ivAttendanceTwo.setOnClickListener(new View.OnClickListener() { // from class: com.rebuilt.app.keep.screen.calendar.adapter.AttendanceCalendarItemAdapter$ItemViewHolder$$ExternalSyntheticLambda2
                @Override // android.view.View.OnClickListener
                public final void onClick(View view) {
                    AttendanceCalendarItemAdapter.ItemViewHolder.bind$lambda$4(calendarItem, this, iStaffId, view);
                }
            });
            this.binding.ivOtPill.setOnClickListener(new View.OnClickListener() { // from class: com.rebuilt.app.keep.screen.calendar.adapter.AttendanceCalendarItemAdapter$ItemViewHolder$$ExternalSyntheticLambda3
                @Override // android.view.View.OnClickListener
                public final void onClick(View view) {
                    AttendanceCalendarItemAdapter.ItemViewHolder.bind$lambda$5(calendarItem, this, iStaffId, view);
                }
            });
            this.binding.tvAddAdvance.setOnClickListener(new View.OnClickListener() { // from class: com.rebuilt.app.keep.screen.calendar.adapter.AttendanceCalendarItemAdapter$ItemViewHolder$$ExternalSyntheticLambda4
                @Override // android.view.View.OnClickListener
                public final void onClick(View view) {
                    AttendanceCalendarItemAdapter.ItemViewHolder.bind$lambda$6(calendarItem, this, iStaffId, iStaffName, view);
                }
            });
            this.binding.ivEdit.setOnClickListener(new View.OnClickListener() { // from class: com.rebuilt.app.keep.screen.calendar.adapter.AttendanceCalendarItemAdapter$ItemViewHolder$$ExternalSyntheticLambda5
                @Override // android.view.View.OnClickListener
                public final void onClick(View view) {
        ...
        */
        public static final void bind$lambda$2(com.rebuilt.app.keep.screen.calendar.adapter.AttendanceCalendarItemAdapter.ItemViewHolder r23, com.rebuilt.app.keep.model.CalendarItem r24, java.lang.String r25, java.lang.String r26, android.view.View r27) {
            /*
                Method dump skipped, instruction units count: 340
                To view this dump add '--comments-level debug' option
            */
            throw new UnsupportedOperationException("Method not decompiled: com.rebuilt.app.keep.screen.calendar.adapter.AttendanceCalendarItemAdapter.ItemViewHolder.bind$lambda$2(com.rebuilt.app.keep.screen.calendar.adapter.AttendanceCalendarItemAdapter$ItemViewHolder, com.rebuilt.app.keep.model.CalendarItem, java.lang.String, java.lang.String, android.view.View):void");
        }
        ...
        /*
            ...
            To view partially-correct add '--show-bad-code' argument
        */
        public static final void bind$lambda$4(com.rebuilt.app.keep.model.CalendarItem r24, com.rebuilt.app.keep.screen.calendar.adapter.AttendanceCalendarItemAdapter.ItemViewHolder r25, java.lang.String r26, android.view.View r27) {
            /*
                Method dump skipped, instruction units count: 409
                To view this dump add '--comments-level debug' option
            */
            throw new UnsupportedOperationException("Method not decompiled: com.rebuilt.app.keep.screen.calendar.adapter.AttendanceCalendarItemAdapter.ItemViewHolder.bind$lambda$4(com.rebuilt.app.keep.model.CalendarItem, com.rebuilt.app.keep.screen.calendar.adapter.AttendanceCalendarItemAdapter$ItemViewHolder, java.lang.String, android.view.View):void");
        }
        ...
        /*
            ...
            To view partially-correct add '--show-bad-code' argument
        */
        private final void setAttendance(com.rebuilt.app.keep.model.CalendarItem r15) {
            /*
                Method dump skipped, instruction units count: 1303
                To view this dump add '--comments-level debug' option
            */
            throw new UnsupportedOperationException("Method not decompiled: com.rebuilt.app.keep.screen.calendar.adapter.AttendanceCalendarItemAdapter.ItemViewHolder.setAttendance(com.rebuilt.app.keep.model.CalendarItem):void");
        }
    }
