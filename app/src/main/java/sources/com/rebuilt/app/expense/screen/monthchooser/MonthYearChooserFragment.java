package com.rebuilt.app.expense.screen.monthchooser;
...
import com.rebuilt.app.expense.databinding.FragmentMonthYearChooserBinding;
...
public final class MonthYearChooserFragment extends BaseBottomsheetFragment<FragmentMonthYearChooserBinding> {
    ...
    private final void setOnClickListeners() {
        ...
        if (binding != null && (imageView = binding.ivClose) != null) {
            imageView.setOnClickListener(new View.OnClickListener() { // from class: com.rebuilt.app.expense.screen.monthchooser.MonthYearChooserFragment$$ExternalSyntheticLambda1
        ...
        if (binding2 != null && (linearLayout2 = binding2.llMonth) != null) {
            linearLayout2.setOnClickListener(new View.OnClickListener() { // from class: com.rebuilt.app.expense.screen.monthchooser.MonthYearChooserFragment$$ExternalSyntheticLambda2
                @Override // android.view.View.OnClickListener
                public final void onClick(View view) {
        ...
        if (binding3 != null && (linearLayout = binding3.llYear) != null) {
            linearLayout.setOnClickListener(new View.OnClickListener() { // from class: com.rebuilt.app.expense.screen.monthchooser.MonthYearChooserFragment$$ExternalSyntheticLambda3
                @Override // android.view.View.OnClickListener
                public final void onClick(View view) {
        ...
        primaryButton.setOnClickListener(new View.OnClickListener() { // from class: com.rebuilt.app.expense.screen.monthchooser.MonthYearChooserFragment$$ExternalSyntheticLambda4
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
    ...
    public static final void setOnClickListeners$lambda$3(final MonthYearChooserFragment this$0, View view) {
        ...
        new AlertDialog.Builder(this$0.requireContext()).setTitle(this$0.getString(C3591R.string.select_month)).setSingleChoiceItems(strArr, this$0.selectedMonth, new DialogInterface.OnClickListener() { // from class: com.rebuilt.app.expense.screen.monthchooser.MonthYearChooserFragment$$ExternalSyntheticLambda0
