...
public final class ItemNativeAdBinding implements ViewBinding {
    ...
    public static ItemNativeAdBinding inflate(LayoutInflater inflater, ViewGroup parent, boolean attachToParent) {
        View viewInflate = inflater.inflate(C3621R.layout.item_native_ad, parent, false);
        if (attachToParent) {
    ...
    public static ItemNativeAdBinding bind(View rootView) {
        ...
        int i = C3621R.id.ad_body;
        TextView textView = (TextView) ViewBindings.findChildViewById(rootView, i);
        if (textView != null) {
            i = C3621R.id.ad_call_to_action;
            Button button = (Button) ViewBindings.findChildViewById(rootView, i);
            if (button != null) {
                i = C3621R.id.ad_headline;
                TextView textView2 = (TextView) ViewBindings.findChildViewById(rootView, i);
                if (textView2 != null) {
                    i = C3621R.id.ad_icon;
                    ImageView imageView = (ImageView) ViewBindings.findChildViewById(rootView, i);
                    if (imageView != null) {
                        i = C3621R.id.ad_image_barrier;
                        Barrier barrier = (Barrier) ViewBindings.findChildViewById(rootView, i);
                        if (barrier != null) {
                            i = C3621R.id.ad_label;
                            TextView textView3 = (TextView) ViewBindings.findChildViewById(rootView, i);
                            if (textView3 != null) {
                                i = C3621R.id.ad_media;
                                MediaView mediaView = (MediaView) ViewBindings.findChildViewById(rootView, i);
                                if (mediaView != null) {
                                    i = C3621R.id.ad_text_container;
                                    LinearLayout linearLayout = (LinearLayout) ViewBindings.findChildViewById(rootView, i);
                                    if (linearLayout != null && (viewFindChildViewById = ViewBindings.findChildViewById(rootView, (i = C3621R.id.divider))) != null) {
