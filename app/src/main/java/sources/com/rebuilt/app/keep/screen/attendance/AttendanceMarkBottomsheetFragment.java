package com.rebuilt.app.keep.screen.attendance;
...
import com.rebuilt.app.keep.databinding.FragmentAttendanceMarkBottomsheetBinding;
...
public final class AttendanceMarkBottomsheetFragment extends BaseBottomsheetFragment<FragmentAttendanceMarkBottomsheetBinding> {
    ...
    public AttendanceMarkBottomsheetFragment() {
        ...
        this.observerUtil = LazyKt.lazy(lazyThreadSafetyMode, (Function0) new Function0<ObserverUtil>() { // from class: com.rebuilt.app.keep.screen.attendance.AttendanceMarkBottomsheetFragment$special$$inlined$inject$default$1
    ...
    private final void setOnClickListeners() {
        ...
        if (binding != null) {
            binding.btnMarkAttendance.setOnClickListener(new View.OnClickListener() { // from class: com.rebuilt.app.keep.screen.attendance.AttendanceMarkBottomsheetFragment$$ExternalSyntheticLambda0
                @Override // android.view.View.OnClickListener
                public final void onClick(View view) {
                    AttendanceMarkBottomsheetFragment.setOnClickListeners$lambda$9$lambda$2(this.f$0, view);
                }
            });
            binding.btnRemoveAttendance.setOnClickListener(new View.OnClickListener() { // from class: com.rebuilt.app.keep.screen.attendance.AttendanceMarkBottomsheetFragment$$ExternalSyntheticLambda1
                @Override // android.view.View.OnClickListener
                public final void onClick(View view) {
            ...
            if (imageView != null) {
                imageView.setOnClickListener(new View.OnClickListener() { // from class: com.rebuilt.app.keep.screen.attendance.AttendanceMarkBottomsheetFragment$$ExternalSyntheticLambda2
                    @Override // android.view.View.OnClickListener
                    public final void onClick(View view) {
            ...
            binding.ivOtPill.setOnClickListener(new View.OnClickListener() { // from class: com.rebuilt.app.keep.screen.attendance.AttendanceMarkBottomsheetFragment$$ExternalSyntheticLambda3
                @Override // android.view.View.OnClickListener
                public final void onClick(View view) {
            ...
            for (final RadioButton radioButton : listListOf) {
                radioButton.setOnClickListener(new View.OnClickListener() { // from class: com.rebuilt.app.keep.screen.attendance.AttendanceMarkBottomsheetFragment$$ExternalSyntheticLambda4
                    @Override // android.view.View.OnClickListener
                    public final void onClick(View view) {
