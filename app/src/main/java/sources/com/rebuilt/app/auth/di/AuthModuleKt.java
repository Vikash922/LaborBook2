package com.rebuilt.app.auth.di;

import com.rebuilt.app.auth.network.AuthNetworkModule;
import com.rebuilt.app.auth.repository.AuthRepository;
import com.rebuilt.app.auth.repository.AuthRepositoryImplementation;
import com.rebuilt.app.auth.screen.login.viewmodel.AuthViewModel;
import com.rebuilt.app.auth.usecase.AuthUseCase;
import com.rebuilt.app.auth.usecase.AuthUseCaseImplementation;
...
@Metadata(d1 = {"\u0000\n\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\"\u0011\u0010\u0000\u001a\u00020\u0001¢\u0006\b\n\u0000\u001a\u0004\b\u0002\u0010\u0003¨\u0006\u0004"}, d2 = {"authModule", "Lorg/koin/core/module/Module;", "getAuthModule", "()Lorg/koin/core/module/Module;", "auth_release"}, k = 2, mv = {2, 0, 0}, xi = 48)
public final class AuthModuleKt {
    private static final Module authModule = ModuleKt.module$default(false, false, new Function1() { // from class: com.rebuilt.app.auth.di.AuthModuleKt$$ExternalSyntheticLambda4
    ...
    public static final Unit authModule$lambda$4(Module module) {
        ...
        Function2 function2 = new Function2() { // from class: com.rebuilt.app.auth.di.AuthModuleKt$$ExternalSyntheticLambda0
        ...
        Function2 function22 = new Function2() { // from class: com.rebuilt.app.auth.di.AuthModuleKt$$ExternalSyntheticLambda1
            @Override // kotlin.jvm.functions.Function2
            public final Object invoke(Object obj, Object obj2) {
        ...
        Function2 function23 = new Function2() { // from class: com.rebuilt.app.auth.di.AuthModuleKt$$ExternalSyntheticLambda2
            @Override // kotlin.jvm.functions.Function2
            public final Object invoke(Object obj, Object obj2) {
        ...
        Function2 function24 = new Function2() { // from class: com.rebuilt.app.auth.di.AuthModuleKt$$ExternalSyntheticLambda3
            @Override // kotlin.jvm.functions.Function2
            public final Object invoke(Object obj, Object obj2) {
