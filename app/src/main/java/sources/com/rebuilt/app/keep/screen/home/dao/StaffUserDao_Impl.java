package com.rebuilt.app.keep.screen.home.dao;
...
public final class StaffUserDao_Impl implements StaffUserDao {
    ...
    public StaffUserDao_Impl(final RoomDatabase __db) {
        this.__db = __db;
        this.__insertionAdapterOfStaffUser = new EntityInsertionAdapter<StaffUser>(__db) { // from class: com.rebuilt.app.keep.screen.home.dao.StaffUserDao_Impl.1
        ...
        this.__preparedStmtOfDeleteAllStaffs = new SharedSQLiteStatement(__db) { // from class: com.rebuilt.app.keep.screen.home.dao.StaffUserDao_Impl.2
            @Override // androidx.room.SharedSQLiteStatement
    ...
    @Override // com.rebuilt.app.keep.screen.home.dao.StaffUserDao
    public Object insertStaffUsers(final List<StaffUser> users, final Continuation<? super Unit> $completion) {
        return CoroutinesRoom.execute(this.__db, true, new Callable<Unit>() { // from class: com.rebuilt.app.keep.screen.home.dao.StaffUserDao_Impl.3
    ...
    public Object deleteAllStaffs(final Continuation<? super Unit> $completion) {
        return CoroutinesRoom.execute(this.__db, true, new Callable<Unit>() { // from class: com.rebuilt.app.keep.screen.home.dao.StaffUserDao_Impl.4
            @Override // java.util.concurrent.Callable
            public Unit call() throws Exception {
    ...
    public Object getAllStaffUsers(final Continuation<? super List<StaffUser>> $completion) {
        ...
        return CoroutinesRoom.execute(this.__db, false, DBUtil.createCancellationSignal(), new Callable<List<StaffUser>>() { // from class: com.rebuilt.app.keep.screen.home.dao.StaffUserDao_Impl.5
            @Override // java.util.concurrent.Callable
