...
import com.rebuilt.app.keep.databinding.FragmentAdvanceDetailsBottomsheetBinding;
...
public final class AdvanceDetailsBottomsheetFragment extends BaseBottomsheetFragment<FragmentAdvanceDetailsBottomsheetBinding> {
    ...
    */
    private final void setupViews() {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.rebuilt.app.keep.screen.advance.AdvanceDetailsBottomsheetFragment.setupViews():void");
    }
    ...
    private final void setupClicks() {
        ...
        if (binding != null && (imageView = binding.ivClose) != null) {
            imageView.setOnClickListener(new View.OnClickListener() { // from class: com.rebuilt.app.keep.screen.advance.AdvanceDetailsBottomsheetFragment$$ExternalSyntheticLambda0
        ...
        if (binding2 != null && (primaryButton = binding2.btnOk) != null) {
            primaryButton.setOnClickListener(new View.OnClickListener() { // from class: com.rebuilt.app.keep.screen.advance.AdvanceDetailsBottomsheetFragment$$ExternalSyntheticLambda1
                @Override // android.view.View.OnClickListener
                public final void onClick(View view) {
        ...
        textViewBold12.setOnClickListener(new View.OnClickListener() { // from class: com.rebuilt.app.keep.screen.advance.AdvanceDetailsBottomsheetFragment$$ExternalSyntheticLambda2
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
    ...
    public static final void setupClicks$lambda$6(final AdvanceDetailsBottomsheetFragment this$0, View view) {
        ...
        try {
            ...
            decorView.postDelayed(new Runnable() { // from class: com.rebuilt.app.keep.screen.advance.AdvanceDetailsBottomsheetFragment$$ExternalSyntheticLambda3
