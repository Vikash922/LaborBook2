...
import com.laborbook.keep.databinding.FragmentDeleteStaffBottomsheetBinding;
...
public final class DeleteStaffBottomsheetFragment extends BaseBottomsheetFragment<FragmentDeleteStaffBottomsheetBinding> {
    ...
    public DeleteStaffBottomsheetFragment() {
        ...
        this.viewModel = LazyKt.lazy(lazyThreadSafetyMode, (Function0) new Function0<DeleteStaffViewModel>() { // from class: com.laborbook.keep.screen.deletestaff.DeleteStaffBottomsheetFragment$special$$inlined$viewModel$default$1
            ...
            /* JADX WARN: Type inference failed for: r0v1, types: [androidx.lifecycle.ViewModel, com.laborbook.keep.screen.deletestaff.viewmodel.DeleteStaffViewModel] */
        ...
        this.observerUtil = LazyKt.lazy(lazyThreadSafetyMode2, (Function0) new Function0<ObserverUtil>() { // from class: com.laborbook.keep.screen.deletestaff.DeleteStaffBottomsheetFragment$special$$inlined$inject$default$1
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            {
                super(0);
            }
    ...
    private final void viewModelObserver() {
        getViewModel().uiState().observe(getViewLifecycleOwner(), new C3775xe609f0fc(new Function1() { // from class: com.laborbook.keep.screen.deletestaff.DeleteStaffBottomsheetFragment$$ExternalSyntheticLambda0
    ...
    private final void setOnClickListeners() {
        ...
        if (binding != null && (imageView = binding.ivClose) != null) {
            imageView.setOnClickListener(new View.OnClickListener() { // from class: com.laborbook.keep.screen.deletestaff.DeleteStaffBottomsheetFragment$$ExternalSyntheticLambda1
        ...
        swipeButton.setOnActiveListener(new OnActiveListener() { // from class: com.laborbook.keep.screen.deletestaff.DeleteStaffBottomsheetFragment$$ExternalSyntheticLambda2
