...
public final class ReferFriendBottomSheetFragment extends BaseBottomsheetFragment<FragmentReferFriendBottomsheetBinding> {
    ...
    private final void startConfettiAnimation() {
        ...
        confettiView.postDelayed(new Runnable() { // from class: com.laborbook.keep.screen.home.fragment.ReferFriendBottomSheetFragment$$ExternalSyntheticLambda1
    ...
    private final void setupClickListeners() {
        ...
        textViewBoldGreen16.setOnClickListener(new View.OnClickListener() { // from class: com.laborbook.keep.screen.home.fragment.ReferFriendBottomSheetFragment$$ExternalSyntheticLambda0
