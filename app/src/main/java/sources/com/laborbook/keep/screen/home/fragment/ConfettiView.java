...
public final class ConfettiView extends View {
    ...
    public final void startConfettiAnimation() {
        ...
        valueAnimatorOfFloat.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: com.laborbook.keep.screen.home.fragment.ConfettiView$$ExternalSyntheticLambda0
            @Override // android.animation.ValueAnimator.AnimatorUpdateListener
            public final void onAnimationUpdate(ValueAnimator valueAnimator) {
                ConfettiView.startConfettiAnimation$lambda$1$lambda$0(this.f$0, valueAnimator);
            }
        });
        valueAnimatorOfFloat.addListener(new AnimatorListenerAdapter() { // from class: com.laborbook.keep.screen.home.fragment.ConfettiView$startConfettiAnimation$animator$1$2
    ...
    protected void onAttachedToWindow() {
        ...
        post(new Runnable() { // from class: com.laborbook.keep.screen.home.fragment.ConfettiView$$ExternalSyntheticLambda2
    ...
    protected void onSizeChanged(int w, int h, int oldw, int oldh) {
        ...
        post(new Runnable() { // from class: com.laborbook.keep.screen.home.fragment.ConfettiView$$ExternalSyntheticLambda1
            @Override // java.lang.Runnable
            public final void run() {
