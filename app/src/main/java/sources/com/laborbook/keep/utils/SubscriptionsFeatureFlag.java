...
@Deprecated(message = "Use com.laborbook.base.utils.SubscriptionsFeatureFlag instead", replaceWith = @ReplaceWith(expression = "BaseSubscriptionsFeatureFlag", imports = {}))
...
public final class SubscriptionsFeatureFlag {
    ...
    public final boolean isSubscriptionsEnabled(FirebaseRemoteConfig remoteConfig) {
        ...
        return com.laborbook.base.utils.SubscriptionsFeatureFlag.INSTANCE.isSubscriptionsEnabled(remoteConfig);
    }

    public final int getFreeUserMaxStaffCount(FirebaseRemoteConfig remoteConfig) {
        Intrinsics.checkNotNullParameter(remoteConfig, "remoteConfig");
        return com.laborbook.base.utils.SubscriptionsFeatureFlag.INSTANCE.getFreeUserMaxStaffCount(remoteConfig);
    }
}
