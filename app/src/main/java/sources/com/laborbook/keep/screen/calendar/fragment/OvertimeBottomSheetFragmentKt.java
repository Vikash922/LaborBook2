...
public final class OvertimeBottomSheetFragmentKt {
    ...
    public static final void applyConsistentStyling(NumberPicker numberPicker, Context context) {
        ...
        numberPicker.setFormatter(new NumberPicker.Formatter() { // from class: com.laborbook.keep.screen.calendar.fragment.OvertimeBottomSheetFragmentKt$$ExternalSyntheticLambda0
