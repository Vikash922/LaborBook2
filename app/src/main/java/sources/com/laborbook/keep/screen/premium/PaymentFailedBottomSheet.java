...
public final class PaymentFailedBottomSheet extends BottomSheetDialogFragment {
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        if (bottomsheetPaymentFailedBinding != null) {
            ...
            bottomsheetPaymentFailedBinding.ivClose.setOnClickListener(new View.OnClickListener() { // from class: com.laborbook.keep.screen.premium.PaymentFailedBottomSheet$$ExternalSyntheticLambda0
                @Override // android.view.View.OnClickListener
                public final void onClick(View view2) {
                    PaymentFailedBottomSheet.onViewCreated$lambda$2$lambda$0(this.f$0, view2);
                }
            });
            bottomsheetPaymentFailedBinding.btnTryAgain.setOnClickListener(new View.OnClickListener() { // from class: com.laborbook.keep.screen.premium.PaymentFailedBottomSheet$$ExternalSyntheticLambda1
                @Override // android.view.View.OnClickListener
                public final void onClick(View view2) {
