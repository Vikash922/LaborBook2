...
import com.laborbook.keep.databinding.FragmentEditProfileBottomsheetBinding;
...
public final class EditProfileBottomsheetFragment extends BaseBottomsheetFragment<FragmentEditProfileBottomsheetBinding> {
    ...
    public EditProfileBottomsheetFragment() {
        ...
        this.viewModel = LazyKt.lazy(lazyThreadSafetyMode, (Function0) new Function0<EditProfileViewModel>() { // from class: com.laborbook.keep.screen.profile.fragment.EditProfileBottomsheetFragment$special$$inlined$viewModel$default$1
            ...
            /* JADX WARN: Type inference failed for: r0v1, types: [androidx.lifecycle.ViewModel, com.laborbook.keep.screen.profile.viewmodel.EditProfileViewModel] */
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        getViewModel().getUpdateResult().observe(getViewLifecycleOwner(), new EditProfileBottomsheetFragment$sam$androidx_lifecycle_Observer$0(new Function1() { // from class: com.laborbook.keep.screen.profile.fragment.EditProfileBottomsheetFragment$$ExternalSyntheticLambda0
    ...
    private final void setupSalaryTypeToggle() {
        ...
        radioGroup.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() { // from class: com.laborbook.keep.screen.profile.fragment.EditProfileBottomsheetFragment$$ExternalSyntheticLambda3
    ...
    private final void setupTextChangeListeners() {
        ...
        if (binding != null && (editText2 = binding.etStaffName) != null) {
            editText2.addTextChangedListener(new TextWatcher() { // from class: com.laborbook.keep.screen.profile.fragment.EditProfileBottomsheetFragment$setupTextChangeListeners$$inlined$addTextChangedListener$default$1
        ...
        editText.addTextChangedListener(new TextWatcher() { // from class: com.laborbook.keep.screen.profile.fragment.EditProfileBottomsheetFragment$setupTextChangeListeners$$inlined$addTextChangedListener$default$2
            @Override // android.text.TextWatcher
            public void beforeTextChanged(CharSequence text, int start, int count, int after) {
            }
    ...
    private final void setOnClickListeners() {
        ...
        if (binding != null && (imageView = binding.ivClose) != null) {
            imageView.setOnClickListener(new View.OnClickListener() { // from class: com.laborbook.keep.screen.profile.fragment.EditProfileBottomsheetFragment$$ExternalSyntheticLambda1
        ...
        primaryButton.setOnClickListener(new View.OnClickListener() { // from class: com.laborbook.keep.screen.profile.fragment.EditProfileBottomsheetFragment$$ExternalSyntheticLambda2
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
