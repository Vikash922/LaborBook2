...
public final class ContactDatabase_Impl extends ContactDatabase {
    ...
    protected SupportSQLiteOpenHelper createOpenHelper(final DatabaseConfiguration config) {
        return config.sqliteOpenHelperFactory.create(SupportSQLiteOpenHelper.Configuration.builder(config.context).name(config.name).callback(new RoomOpenHelper(config, new RoomOpenHelper.Delegate(1) { // from class: com.laborbook.keep.screen.addstaff.model.ContactDatabase_Impl.1
            ...
            public RoomOpenHelper.ValidationResult onValidateSchema(final SupportSQLiteDatabase db) {
                ...
                if (!tableInfo.equals(tableInfo2)) {
                    return new RoomOpenHelper.ValidationResult(false, "contacts(com.laborbook.keep.screen.addstaff.model.ContactItem).\n Expected:\n" + tableInfo + "\n Found:\n" + tableInfo2);
                }
    ...
    @Override // com.laborbook.keep.screen.addstaff.model.ContactDatabase
