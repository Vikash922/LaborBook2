...
import com.laborbook.base.databinding.ActivityWebviewBinding;
...
public final class WebViewActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        activityWebviewBinding.ivBack.setOnClickListener(new View.OnClickListener() { // from class: com.laborbook.base.WebViewActivity$$ExternalSyntheticLambda1
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                WebViewActivity.onCreate$lambda$0(this.f$0, view);
            }
        });
        getOnBackPressedDispatcher().addCallback(this, new OnBackPressedCallback() { // from class: com.laborbook.base.WebViewActivity.onCreate.2
            {
                super(true);
            }
    ...
    private final void enableEdgeToEdge() {
        ...
        ViewCompat.setOnApplyWindowInsetsListener(activityWebviewBinding.getRoot(), new OnApplyWindowInsetsListener() { // from class: com.laborbook.base.WebViewActivity$$ExternalSyntheticLambda0
    ...
    private final void setupWebView(String url) {
        ...
        webView.setWebViewClient(new WebViewClient() { // from class: com.laborbook.base.WebViewActivity$setupWebView$1$1
