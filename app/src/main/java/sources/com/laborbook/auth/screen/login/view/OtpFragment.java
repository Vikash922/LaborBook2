...
import com.laborbook.auth.common.sms.AuthOTPBroadcastReceiver;
import com.laborbook.auth.common.sms.SMSListener;
...
public final class OtpFragment extends BaseFragment<FragmentOtpBinding> {
    ...
    public OtpFragment() {
        ...
        this.viewModel = LazyKt.lazy(lazyThreadSafetyMode, (Function0) new Function0<AuthViewModel>() { // from class: com.laborbook.auth.screen.login.view.OtpFragment$special$$inlined$viewModel$default$1
    ...
    private final void registerOnClickListeners() {
        ...
        if (binding != null) {
            binding.btnVerifyOtp.setOnClickListener(new View.OnClickListener() { // from class: com.laborbook.auth.screen.login.view.OtpFragment$$ExternalSyntheticLambda4
                @Override // android.view.View.OnClickListener
                public final void onClick(View view) {
                    OtpFragment.registerOnClickListeners$lambda$6$lambda$3(this.f$0, binding, view);
                }
            });
            binding.toolbar.ivBack.setOnClickListener(new View.OnClickListener() { // from class: com.laborbook.auth.screen.login.view.OtpFragment$$ExternalSyntheticLambda5
                @Override // android.view.View.OnClickListener
                public final void onClick(View view) {
                    OtpFragment.registerOnClickListeners$lambda$6$lambda$4(this.f$0, view);
                }
            });
            binding.ivResendOtp.setOnClickListener(new View.OnClickListener() { // from class: com.laborbook.auth.screen.login.view.OtpFragment$$ExternalSyntheticLambda6
                @Override // android.view.View.OnClickListener
                public final void onClick(View view) {
    ...
    private final void viewModelObserver() {
        getViewModel().uiState().observe(getViewLifecycleOwner(), new OtpFragmentKt$sam$androidx_lifecycle_Observer$0(new Function1() { // from class: com.laborbook.auth.screen.login.view.OtpFragment$$ExternalSyntheticLambda3
    ...
    */
    public final java.lang.Object storeUserDetails(com.laborbook.auth.model.request.AuthResponse r19, kotlin.coroutines.Continuation<? super kotlin.Unit> r20) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.laborbook.auth.screen.login.view.OtpFragment.storeUserDetails(com.laborbook.auth.model.request.AuthResponse, kotlin.coroutines.Continuation):java.lang.Object");
    }
    ...
    private final void initSMSRetriever() {
        ...
        final Function1 function1 = new Function1() { // from class: com.laborbook.auth.screen.login.view.OtpFragment$$ExternalSyntheticLambda0
            @Override // kotlin.jvm.functions.Function1
            public final Object invoke(Object obj) {
                return OtpFragment.initSMSRetriever$lambda$11(this.f$0, (Void) obj);
            }
        };
        taskStartSmsRetriever.addOnSuccessListener(new OnSuccessListener() { // from class: com.laborbook.auth.screen.login.view.OtpFragment$$ExternalSyntheticLambda1
            @Override // com.google.android.gms.tasks.OnSuccessListener
            public final void onSuccess(Object obj) {
                OtpFragment.initSMSRetriever$lambda$12(function1, obj);
            }
        });
        taskStartSmsRetriever.addOnFailureListener(new OnFailureListener() { // from class: com.laborbook.auth.screen.login.view.OtpFragment$$ExternalSyntheticLambda2
    ...
    public static final Unit initSMSRetriever$lambda$11(final OtpFragment this$0, Void r2) {
        Intrinsics.checkNotNullParameter(this$0, "this$0");
        AuthOTPBroadcastReceiver.INSTANCE.initSMSListener(new SMSListener() { // from class: com.laborbook.auth.screen.login.view.OtpFragment$initSMSRetriever$1$1
            @Override // com.laborbook.auth.common.sms.SMSListener
