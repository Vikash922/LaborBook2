...
public final class GooglePlayInstallReferrerReader {
    ...
    public final Object getInstallReferrer(Context context, Continuation<? super Result> continuation) {
        ...
        cancellableContinuationImpl2.invokeOnCancellation(new Function1<Throwable, Unit>() { // from class: com.laborbook.GooglePlayInstallReferrerReader$getInstallReferrer$2$1
        ...
        installReferrerClientBuild.startConnection(new InstallReferrerStateListener() { // from class: com.laborbook.GooglePlayInstallReferrerReader$getInstallReferrer$2$2
