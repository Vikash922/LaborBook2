...
public final class AttendanceReminderReceiver extends BroadcastReceiver implements KoinComponent {
    ...
    public AttendanceReminderReceiver() {
        ...
        this.analytics = LazyKt.lazy(lazyThreadSafetyModeDefaultLazyMode, (Function0) new Function0<Analytics>() { // from class: com.laborbook.receiver.AttendanceReminderReceiver$special$$inlined$inject$default$1
