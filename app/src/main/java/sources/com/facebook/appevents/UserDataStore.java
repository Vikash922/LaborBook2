    ...
    */
    ...
    private final String normalizeData(String type, String data) {
        ...
        try {
            ...
            if (!Intrinsics.areEqual(XfdfConstants.f2852F, strSubstring) && !Intrinsics.areEqual(SvgConstants.Attributes.PATH_DATA_REL_MOVE_TO, strSubstring)) {
