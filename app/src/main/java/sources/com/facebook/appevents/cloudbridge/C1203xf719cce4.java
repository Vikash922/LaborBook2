...
@Metadata(m2721d1 = {"\u0000\u0016\n\u0000\n\u0002\u0010\u0002\n\u0000\n\u0002\u0010\u000e\n\u0000\n\u0002\u0010\b\n\u0002\b\u0002\u0010\u0000\u001a\u00020\u00012\b\u0010\u0002\u001a\u0004\u0018\u00010\u00032\b\u0010\u0004\u001a\u0004\u0018\u00010\u0005H\n¢\u0006\u0004\b\u0006\u0010\u0007"}, m2722d2 = {"<anonymous>", "", "<anonymous parameter 0>", "", "responseCode", "", "invoke", "(Ljava/lang/String;Ljava/lang/Integer;)V"}, m2723k = 3, m2724mv = {1, 8, 0}, m2726xi = 48)
final class C1203xf719cce4 extends Lambda implements Function2<String, Integer, Unit> {
    final /* synthetic */ List<Map<String, Object>> $processedEvents;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    /* JADX WARN: Multi-variable type inference failed */
    C1203xf719cce4(List<? extends Map<String, ? extends Object>> list) {
        super(2);
    ...
    public final void invoke2(String str, final Integer num) {
        ...
        Utility.runOnNonUiThread(new Runnable() { // from class: com.facebook.appevents.cloudbridge.AppEventsConversionsAPITransformerWebRequests$transformGraphRequestAndSendToCAPIGEndPoint$1$1$$ExternalSyntheticLambda0
            ...
            public final void run() {
                C1203xf719cce4.invoke$lambda$0(num, list);
            }
        });
    }
