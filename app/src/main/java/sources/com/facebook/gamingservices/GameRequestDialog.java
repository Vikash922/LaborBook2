...
public class GameRequestDialog extends FacebookDialogBase<GameRequestContent, Result> {
    ...
    public static final class Result {
        ...
        private Result(Bundle bundle) {
            ...
            this.f239to = new ArrayList();
            while (bundle.containsKey(String.format(ShareConstants.WEB_DIALOG_RESULT_PARAM_TO_ARRAY_MEMBER, Integer.valueOf(this.f239to.size())))) {
                List<String> list = this.f239to;
        ...
        private Result(GraphResponse graphResponse) {
            try {
                ...
                for (int i = 0; i < jSONArray.length(); i++) {
                    this.f239to.add(jSONArray.getString(i));
                }
