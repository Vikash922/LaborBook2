...
/* JADX INFO: renamed from: com.boilerplate.analytics.c */
/* JADX INFO: loaded from: classes3.dex */
public final class C1091c extends SuspendLambda implements Function2 {
    ...
    public C1091c(AnalyticsManagerImpl analyticsManagerImpl, String str, Map<String, ? extends Object> map, Continuation<? super C1091c> continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new C1091c(this.this$0, this.$platform, this.$userProperties, continuation);
    }
    ...
    public final Object invoke(CoroutineScope coroutineScope, Continuation<? super Unit> continuation) {
        return ((C1091c) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
}
