...
public final class a extends SuspendLambda implements Function2 {
    ...
    public a(AnalyticsManagerImpl analyticsManagerImpl, String str, String str2, HashMap<String, Object> map, Continuation<? super a> continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new a(this.this$0, this.$platform, this.$eventName, this.$properties, continuation);
    }
