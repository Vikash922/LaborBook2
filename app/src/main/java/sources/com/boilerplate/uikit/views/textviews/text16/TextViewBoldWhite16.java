...
public final class TextViewBoldWhite16 extends AppCompatTextView {
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public TextViewBoldWhite16(Context context) {
        super(context);
        Intrinsics.checkNotNullParameter(context, "context");
        setTextAppearance(C1111R.style.textview_bold_white_16);
    }

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public TextViewBoldWhite16(Context context, AttributeSet attributeSet) {
    ...
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public TextViewBoldWhite16(Context context, AttributeSet attributeSet, int i) {
