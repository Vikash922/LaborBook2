...
public class a {
    ...
    private final HashMap<View, String> f49a = new HashMap<>();
    private final HashMap<View, C0059a> b = new HashMap<>();
    ...
    public static class C0059a {
        ...
        public C0059a(e eVar, String str) {
            this.f50a = eVar;
            a(str);
        }
    ...
    private void a(e eVar, com.iab.omid.library.inmobi.adsession.a aVar) {
        ...
        C0059a c0059a = this.b.get(view);
        if (c0059a != null) {
            c0059a.a(aVar.getAdSessionId());
        } else {
            this.b.put(view, new C0059a(eVar, aVar.getAdSessionId()));
        }
    }
    ...
    public String c(View view) {
        ...
        String str = this.f49a.get(view);
        if (str != null) {
            this.f49a.remove(view);
        }
        return str;
    }
                ...
                if (aVar.f()) {
                    ...
                    if (viewC != null) {
                        ...
                        if (strA == null) {
                            ...
                            this.f49a.put(viewC, adSessionId);
                            a(aVar);
