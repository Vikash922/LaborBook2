...
public final class GranularRoundedCorners extends BitmapTransformation {
    ...
    private static final String f204ID = "com.bumptech.glide.load.resource.bitmap.GranularRoundedCorners";
    private static final byte[] ID_BYTES = f204ID.getBytes(CHARSET);
    ...
    @Override // com.bumptech.glide.load.Key
    public int hashCode() {
        return Util.hashCode(this.bottomLeft, Util.hashCode(this.bottomRight, Util.hashCode(this.topRight, Util.hashCode(f204ID.hashCode(), Util.hashCode(this.topLeft)))));
    }
