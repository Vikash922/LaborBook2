...
class BaseConfig {
    ...
    private Boolean $$II__1$l_;
    private String $$_$I1l1_;
    private String $I__I;
    private String $l$I1I11I1;
    private JSONObject $l_I$1;
    private String $lll$_lIl;
    private String I1I_l1;
    private String I1lII;
    private int II1$II$_1;
    private boolean IIII$1$_I;
    private String I__1l;
    private int Il__I1Il;
    private boolean _$_l_$1l$;
    private String _1__;
    private boolean __Il11I1l;
    private String ___I1$lI;
    private boolean ___Il$;
    private boolean __l1_;
    private boolean _l_1l__;
    private String _l_l_1IlI;
    private String _llI;
    private String l$$$11Il1;
    private String l$1_I$l$;
    private String l$Illl;
    private ArrayList<String> lI$$I1$l;

    @Deprecated
    private boolean lI_l1Il_;
    private boolean l_lIl;
    private JSONObject llIl;
    private String ll_$$111;
    private Set<String> __II$$ = new HashSet();
    private boolean $lIII_$$ = true;
        ...
        try {
            ...
            if (str__l1_ == null) {
                ...
                try {
                    ...
                    str__l1_ = stringWriter.toString();
                } catch (Throwable th) {
                    inputStreamOpenRawResource.close();
                    throw th;
                }
            }
            return new JSONObject(str__l1_);
        } catch (Exception unused) {
            return null;
        }
    }
    ...
    private void l$1_I$l$(JSONObject jSONObject) throws Exception {
        this.lI_l1Il_ = ((Boolean) BaseUtils.getJsonValue("analytics.lumberjack.enable", jSONObject, true)).booleanValue();
        this._$_l_$1l$ = ((Boolean) BaseUtils.getJsonValue("analytics.lumberjack.isLumberjackEnabled", jSONObject, true)).booleanValue();
        this._1__ = (String) BaseUtils.getJsonValue("analytics.lumberjack.key", jSONObject, "");
        this.$l$I1I11I1 = (String) BaseUtils.getJsonValue("analytics.lumberjack.end_point", jSONObject, "");
        this.$I__I = (String) BaseUtils.getJsonValue("analytics.lumberjack.sdk_identifier", jSONObject, "");
        this.IIII$1$_I = ((Boolean) BaseUtils.getJsonValue("analytics.lumberjack.use_v2_table", jSONObject, false)).booleanValue();
        this.$lll$_lIl = (String) BaseUtils.getJsonValue("analytics.lumberjack.allowed_events_regex", jSONObject, "");
        this.__II$$ = new HashSet();
        try {
            JSONArray jSONArray = jSONObject.getJSONObject("analytics").getJSONObject("lumberjack").getJSONArray("blocked_versions");
            for (int i = 0; i < jSONArray.length(); i++) {
                this.__II$$.add(jSONArray.getString(i));
            }
        } catch (Exception unused) {
        }
    }

    private void __l1_(JSONObject jSONObject) throws Exception {
        this.Il__I1Il = ((Integer) BaseUtils.getJsonValue("update_sdk_config.latest_version", jSONObject, 1)).intValue();
        this.l$Illl = (String) BaseUtils.getJsonValue("update_sdk_config.msg", jSONObject, "");
        this.l_lIl = ((Boolean) BaseUtils.getJsonValue("update_sdk_config.enable_alert", jSONObject, true)).booleanValue();
    }

    private void _llI(JSONObject jSONObject) throws Exception {
        this.l$1_I$l$ = (String) BaseUtils.getJsonValue("config_end_point", jSONObject, "");
        this.__l1_ = ((Boolean) BaseUtils.getJsonValue("enable", jSONObject, "")).booleanValue();
    }

    private void _l_1l__(JSONObject jSONObject) throws Exception {
        this._llI = (String) BaseUtils.getJsonValue("features.hosted_frame_build", jSONObject, "d5571273fa2170fe6dcdaa9ead463d039fef74dc");
    }

    private void I__1l(JSONObject jSONObject) throws Exception {
        this._l_1l__ = ((Boolean) BaseUtils.getJsonValue("features.webview_warmup_enabled", jSONObject, false)).booleanValue();
    }

    private void _1__(JSONObject jSONObject) throws Exception {
        setCheckoutEndPoint((String) BaseUtils.getJsonValue("checkout.end_point", jSONObject, ""));
    }

    private void $I__I(JSONObject jSONObject) throws Exception {
        this.__Il11I1l = ((Boolean) BaseUtils.getJsonValue("otpelf.v2.enable", jSONObject, true)).booleanValue();
        this.$l_I$1 = (JSONObject) BaseUtils.getJsonValue("otpelf.v2.settings", jSONObject, new JSONObject());
        this.I1lII = (String) BaseUtils.getJsonValue("otpelf.v2.endpoint", jSONObject, "https://cdn.razorpay.com/static/otpelf/");
        this.$$_$I1l1_ = (String) BaseUtils.getJsonValue("otpelf.v2.version_file_name", jSONObject, "version.json");
        this.l$$$11Il1 = (String) BaseUtils.getJsonValue("otpelf.v2.js_file_name", jSONObject, "otpelf.js");
    }

    private void $l$I1I11I1(JSONObject jSONObject) throws Exception {
        this.___Il$ = ((Boolean) BaseUtils.getJsonValue("magic.enable", jSONObject, true)).booleanValue();
        this.llIl = (JSONObject) BaseUtils.getJsonValue("magic.settings", jSONObject, new JSONObject());
        this.I1I_l1 = (String) BaseUtils.getJsonValue("magic.endpoint", jSONObject, "https://cdn.razorpay.com/static/magic/");
        this.ll_$$111 = (String) BaseUtils.getJsonValue("magic.version_file_name", jSONObject, "version.json");
        this._l_l_1IlI = (String) BaseUtils.getJsonValue("magic.js_file_name", jSONObject, "magic.js");
    }

    private void lI_l1Il_(JSONObject jSONObject) throws Exception {
        this.___I1$lI = (String) BaseUtils.getJsonValue("permissions.custom_message", jSONObject, "");
        this.$$II__1$l_ = Boolean.valueOf(((Boolean) BaseUtils.getJsonValue("permissions.enable_custom_message", jSONObject, false)).booleanValue());
        this.II1$II$_1 = ((Integer) BaseUtils.getJsonValue("permissions.max_ask_count", jSONObject, 0)).intValue();
    }

    private void _$_l_$1l$(JSONObject jSONObject) {
        try {
            this.lI$$I1$l = new ArrayList<>();
            JSONArray jSONArray = (JSONArray) BaseUtils.getJsonValue("wallets.redirection", jSONObject, new JSONArray());
            for (int i = 0; i < jSONArray.length(); i++) {
                this.lI$$I1$l.add(jSONArray.getString(i));
            }
            if (jSONArray.length() == 0) {
                this.lI$$I1$l.add("my.com.tngdigital.ewallet");
            }
            this.$lIII_$$ = ((Boolean) BaseUtils.getJsonValue("features.enable_tng_deeplink_redirection", jSONObject, true)).booleanValue();
        } catch (Exception unused) {
            ArrayList<String> arrayList = new ArrayList<>();
            this.lI$$I1$l = arrayList;
    ...
    Boolean isLumberJackEnabled() {
        return Boolean.valueOf(this.lI_l1Il_);
    }

    Boolean isLumberjackEnabled() {
        return Boolean.valueOf(this._$_l_$1l$);
    }

    boolean isVersionBlocked(String str) {
        return str != null && this.__II$$.contains(str);
    }

    Boolean isLumberjackV2Enabled() {
        return Boolean.valueOf(this.IIII$1$_I);
    }
    ...
    String getPermissionCustomMessage() {
        return this.___I1$lI;
    }

    Boolean isPermissionCustomMessageEnabled() {
        return this.$$II__1$l_;
    }

    int getSmsPermissionMaxAskCount() {
        return this.II1$II$_1;
    }

    Boolean isOTPElfEnabled() {
        return Boolean.valueOf(this.__Il11I1l);
    }
    ...
    String getCheckoutEndpoint() {
        return "https://api.razorpay.com" + this.I__1l;
    }
    ...
    String getOtpElfVersionUrl() {
        return getOTPElfBaseEndPoint() + this.$$_$I1l1_;
    }

    String getHostedFrameBuild() {
        return "/v1/checkout/build/" + this._llI;
    }
    ...
    String getOtpElfJsUrl() {
        return getOTPElfBaseEndPoint() + this.l$$$11Il1;
    }
    ...
    static void fetchConfig(String str, final String str2, final Map<String, String> map, final Context context) {
        Owl.get(str, map, new Callback() { // from class: com.razorpay.BaseConfig.1
            ...
            public void run(ResponseObject responseObject) {
                if (!BaseConfig.l$1_I$l$(responseObject)) {
                    BaseConfig.l$1_I$l$(responseObject, context);
                } else {
                    Logger.m2690d("Config fetch failed on primary URL (code=" + responseObject.getResponseCode() + "), falling back to: " + str2);
                    Owl.get(str2, map, new Callback() { // from class: com.razorpay.BaseConfig.1.1
                        @Override // com.razorpay.Callback
                        public void run(ResponseObject responseObject2) {
                            BaseConfig.l$1_I$l$(responseObject2, context);
                        }
                    });
                }
            }
    ...
    public static boolean l$1_I$l$(ResponseObject responseObject) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static void l$1_I$l$(ResponseObject responseObject, Context context) {
        String str;
        try {
            if (responseObject.getResponseCode() == 200) {
                JSONObject jSONObject = new JSONObject(responseObject.getResponseResult());
                __l1_(context, jSONObject.toString());
    ...
    String getMagicJsFileName() {
        return this._l_l_1IlI;
    }

    public String getMagicVersionUrl() {
        return getMagicBaseEndPoint() + this.ll_$$111;
    }

    public String getMagicJsUrl() {
        return getMagicBaseEndPoint() + this._l_l_1IlI;
    }
