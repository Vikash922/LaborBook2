...
public final class WireFormat {
    ...
    public static class FieldType {
        ...
        /* synthetic */ FieldType(String str, int i, JavaType javaType, int i2, C25641 c25641) {
    ...
    enum Utf8Validation {
        ...
        /* synthetic */ Utf8Validation(C25641 c25641) {
            this();
        }
    }
    ...
    static Object readPrimitiveField(CodedInputStream codedInputStream, FieldType fieldType, Utf8Validation utf8Validation) throws IOException {
        switch (C25641.$SwitchMap$com$google$protobuf$WireFormat$FieldType[fieldType.ordinal()]) {
            case 1:
