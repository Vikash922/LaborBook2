...
final class zzfy {
    ...
    private static void zzd(zzfw zzfwVar, StringBuilder sb, int i) {
        ...
        for (String str : treeSet) {
            ...
            if (((Method) map2.get(SvgConstants.Tags.SET.concat(String.valueOf(strSubstring)))) != null && (!strSubstring.endsWith("Bytes") || !map.containsKey("get".concat(String.valueOf(strSubstring.substring(0, strSubstring.length() - 5)))))) {
