...
public final class zzfdn implements zzfdm {
    ...
    public zzfdn(com.google.android.gms.ads.internal.client.zzm zzmVar, String str, int i, String str2, com.google.android.gms.ads.internal.client.zzx zzxVar) {
        ...
        if (hashSet.contains(MediaFeature.ORIENTATION)) {
            if (zzxVar != null) {
    ...
    private static String zza(Bundle bundle) {
        ...
        while (it.hasNext()) {
            ...
            sb.append(obj == null ? Constants.ATTENDANCE_STATUS_NULL : obj instanceof Bundle ? zza((Bundle) obj) : obj.toString());
        }
        return sb.toString();
    }
    ...
    public final String toString() {
        ...
        return "[PoolKey#" + Arrays.hashCode(objArr) + StringUtils.SPACE + Arrays.toString(objArr) + "]";
    }
}
