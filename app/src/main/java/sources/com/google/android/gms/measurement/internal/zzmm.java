...
public final class zzmm implements ServiceConnection, BaseGmsClient.BaseConnectionCallbacks, BaseGmsClient.BaseOnConnectionFailedListener {
    ...
    public final void onConnectionFailed(ConnectionResult connectionResult) {
        ...
        zzgi zzgiVarZzm = this.zza.zzu.zzm();
        if (zzgiVarZzm != null) {
            zzgiVarZzm.zzu().zza("Service connection failed", connectionResult);
        }
        synchronized (this) {
            this.zzb = false;
            this.zzc = null;
    ...
    public final void onConnectionSuspended(int i) {
        ...
        this.zza.zzl().zzb(new zzmq(this));
    }
    ...
    public final void onServiceDisconnected(ComponentName componentName) {
        ...
        this.zza.zzl().zzb(new zzmo(this, componentName));
    }
}
