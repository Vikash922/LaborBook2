...
public class StreetViewPanoramaCamera extends AbstractSafeParcelable implements ReflectedParcelable {
    ...
    public String toString() {
        return Objects.toStringHelper(this).add(AnimationType.ZOOM, Float.valueOf(this.zoom)).add("tilt", Float.valueOf(this.tilt)).add("bearing", Float.valueOf(this.bearing)).toString();
    }
}
