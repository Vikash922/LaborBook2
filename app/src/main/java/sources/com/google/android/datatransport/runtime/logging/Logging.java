...
public final class Logging {
    ...
    public static void m94d(String str, String str2) {
    ...
    /* JADX INFO: renamed from: d */
    public static void m95d(String str, String str2, Object obj) {
        String tag = getTag(str);
        if (Log.isLoggable(tag, 3)) {
    ...
    /* JADX INFO: renamed from: d */
    public static void m96d(String str, String str2, Object obj, Object obj2) {
        String tag = getTag(str);
        if (Log.isLoggable(tag, 3)) {
    ...
    /* JADX INFO: renamed from: d */
    public static void m97d(String str, String str2, Object... objArr) {
        String tag = getTag(str);
        if (Log.isLoggable(tag, 3)) {
    ...
    public static void m99i(String str, String str2, Object obj) {
        String tag = getTag(str);
    ...
    public static void m98e(String str, String str2, Throwable th) {
        String tag = getTag(str);
    ...
    public static void m100w(String str, String str2, Object obj) {
        String tag = getTag(str);
