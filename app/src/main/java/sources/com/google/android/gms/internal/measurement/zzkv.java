...
final class zzkv<T extends zzkx<T>> {
    ...
    static int zza(zzof zzofVar, int i, Object obj) {
        int iZzi = zzkl.zzi(i);
        if (zzofVar == zzof.zzj) {
            zzle.zza((zzml) obj);
            iZzi <<= 1;
    ...
    public static int zza(zzkx<?> zzkxVar, Object obj) {
        ...
        if (zzkxVar.zze()) {
            ...
            return zzkl.zzi(iZza) + iZza3 + zzkl.zzj(iZza3);
        }
    ...
    public final Iterator<Map.Entry<T, Object>> zzd() {
        ...
        if (this.zzd) {
            return new zzlq(this.zza.entrySet().iterator());
        }
    ...
    private final void zzb(Map.Entry<T, Object> entry) {
        ...
        T key = entry.getKey();
        Object value = entry.getValue();
        boolean z = value instanceof zzlp;
        if (key.zze()) {
            if (z) {
        ...
        if (objZza2 instanceof zzmq) {
            zzmlVarZzai = key.zza((zzmq) objZza2, (zzmq) value);
        } else {
            zzmlVarZzai = key.zza(((zzml) objZza2).zzcj(), (zzml) value).zzai();
        }
        this.zza.put(key, zzmlVarZzai);
    }
    ...
    static void zza(zzkl zzklVar, zzof zzofVar, int i, Object obj) throws IOException {
        if (zzofVar == zzof.zzj) {
