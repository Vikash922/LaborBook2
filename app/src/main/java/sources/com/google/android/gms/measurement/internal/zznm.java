...
public final class zznm extends zznr {
    ...
    private final PendingIntent zzw() {
        ...
        return com.google.android.gms.internal.measurement.zzct.zza(contextZza, 0, new Intent().setClassName(contextZza, "com.google.android.gms.measurement.AppMeasurementReceiver").setAction("com.google.android.gms.measurement.UPLOAD"), com.google.android.gms.internal.measurement.zzct.zza);
    }
    ...
    public final void zza(long j) {
        ...
        com.google.android.gms.internal.measurement.zzcw.zza(contextZza2, new JobInfo.Builder(iZzv, componentName).setMinimumLatency(j).setOverrideDeadline(j << 1).setExtras(persistableBundle).build(), "com.google.android.gms", "UploadAlarm");
    }
