...
public class zzl {
    ...
    public static Boolean requestGoogleAccountsAccess(Context context) throws GoogleAuthException, IOException {
        ...
        if (zzhs.zze() && zzo(context)) {
            try {
                ...
                zzd.m149w("isUserRecoverableError status: " + String.valueOf(zzbyVarZza), new Object[0]);
    ...
    private static TokenData zzg(Bundle bundle) throws GoogleAuthException, IOException {
        ...
        zzby zzbyVarZza = zzby.zza(string);
        if (zzby.zzb(zzbyVarZza)) {
            zzd.m149w("isUserRecoverableError status: ".concat(String.valueOf(String.valueOf(zzbyVarZza))), new Object[0]);
            throw new UserRecoverableAuthException(string, intent);
        }
    ...
    private static Object zzj(Object obj) throws IOException {
        ...
        zzd.m149w("Service call returned null.", new Object[0]);
    ...
    private static void zzl(ApiException apiException, String str) {
        zzd.m149w("%s failed via GoogleAuthServiceClient, falling back to previous approach:\n%s", str, Log.getStackTraceString(apiException));
    }
