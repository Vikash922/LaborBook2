...
public class AppMeasurement {
    ...
    public static class ConditionalUserProperty {
        ...
        ConditionalUserProperty(Bundle bundle) {
            ...
            this.mActive = ((Boolean) zziz.zza(bundle, "active", Boolean.class, false)).booleanValue();
    ...
    /* JADX INFO: compiled from: com.google.android.gms:play-services-measurement-impl@@22.1.0 */
    static abstract class zza implements zzky {
        private zza() {
        }
    ...
    private static zzky zza(Context context, Bundle bundle) {
        try {
            return (zzky) Class.forName("com.google.firebase.analytics.FirebaseAnalytics").getDeclaredMethod("getScionFrontendApiImplementation", Context.class, Bundle.class).invoke(null, context, null);
    ...
    public void setConditionalUserProperty(ConditionalUserProperty conditionalUserProperty) {
        ...
        if (conditionalUserProperty.mValue != null) {
            zziz.zza(bundle, conditionalUserProperty.mValue);
        }
