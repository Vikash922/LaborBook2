...
abstract class BaseMotionStrategy implements MotionStrategy {
    ...
    AnimatorSet createAnimator(MotionSpec motionSpec) {
        ...
        if (motionSpec.hasPropertyValues(CommonCssConstants.SCALE)) {
            arrayList.add(motionSpec.getAnimator(CommonCssConstants.SCALE, this.fab, View.SCALE_Y));
            arrayList.add(motionSpec.getAnimator(CommonCssConstants.SCALE, this.fab, View.SCALE_X));
        }
