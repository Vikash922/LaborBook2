...
public final class zznw {
    ...
    public final int zza() {
        ...
        for (int i3 = 0; i3 < this.zzb; i3++) {
            ...
            int i6 = i4 & 7;
            if (i6 == 0) {
                iZzg = zzkl.zzg(i5, ((Long) this.zzd[i3]).longValue());
            } else if (i6 == 1) {
                iZzg = zzkl.zzc(i5, ((Long) this.zzd[i3]).longValue());
            } else if (i6 == 2) {
                iZzg = zzkl.zzc(i5, (zzjs) this.zzd[i3]);
            } else if (i6 == 3) {
                iZzg = (zzkl.zzi(i5) << 1) + ((zznw) this.zzd[i3]).zza();
            } else {
                if (i6 != 5) {
                    throw new IllegalStateException(zzlk.zza());
                }
                iZzg = zzkl.zzf(i5, ((Integer) this.zzd[i3]).intValue());
            }
            i2 += iZzg;
        }
        this.zze = i2;
    ...
    static zznw zza(zznw zznwVar, zznw zznwVar2) {
    ...
    private zznw(int i, int[] iArr, Object[] objArr, boolean z) {
        this.zze = -1;
        this.zzb = i;
        this.zzc = iArr;
        this.zzd = objArr;
    ...
    final void zza(zzos zzosVar) throws IOException {
        if (zzosVar.zza() == 2) {
    ...
    public final void zzb(zzos zzosVar) throws IOException {
        if (this.zzb == 0) {
            return;
        }
        if (zzosVar.zza() == 1) {
