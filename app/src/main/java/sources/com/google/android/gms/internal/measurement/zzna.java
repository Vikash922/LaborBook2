...
interface zzna {
    ...
    <T> void zza(T t, zznd<T> zzndVar, zzkp zzkpVar) throws IOException;

    void zza(List<Boolean> list) throws IOException;

    @Deprecated
    <T> void zza(List<T> list, zznd<T> zzndVar, zzkp zzkpVar) throws IOException;

    <K, V> void zza(Map<K, V> map, zzmc<K, V> zzmcVar, zzkp zzkpVar) throws IOException;

    float zzb() throws IOException;

    <T> void zzb(T t, zznd<T> zzndVar, zzkp zzkpVar) throws IOException;

    void zzb(List<zzjs> list) throws IOException;

    <T> void zzb(List<T> list, zznd<T> zzndVar, zzkp zzkpVar) throws IOException;
