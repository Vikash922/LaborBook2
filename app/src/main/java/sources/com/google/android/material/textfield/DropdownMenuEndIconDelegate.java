...
class DropdownMenuEndIconDelegate extends EndIconDelegate {
    ...
    /* synthetic */ void m242x87c2e556(boolean z) {
    ...
    DropdownMenuEndIconDelegate(EndCompoundLayout endCompoundLayout) {
        ...
        this.touchExplorationStateChangeListener = new AccessibilityManagerCompat.TouchExplorationStateChangeListener() { // from class: com.google.android.material.textfield.DropdownMenuEndIconDelegate$$ExternalSyntheticLambda5
            ...
            public final void onTouchExplorationStateChanged(boolean z) {
                this.f$0.m242x87c2e556(z);
            }
        };
        this.dropdownPopupActivatedAt = Long.MAX_VALUE;
        this.animationFadeInDuration = MotionUtils.resolveThemeDuration(endCompoundLayout.getContext(), C1346R.attr.motionDurationShort3, 67);
        this.animationFadeOutDuration = MotionUtils.resolveThemeDuration(endCompoundLayout.getContext(), C1346R.attr.motionDurationShort3, 50);
        this.animationFadeInterpolator = MotionUtils.resolveThemeInterpolator(endCompoundLayout.getContext(), C1346R.attr.motionEasingLinearInterpolator, AnimationUtils.LINEAR_INTERPOLATOR);
    }
    ...
    int getIconDrawableResId() {
        return IS_LOLLIPOP ? C1346R.drawable.mtrl_dropdown_arrow : C1346R.drawable.mtrl_ic_arrow_drop_down;
    }

    @Override // com.google.android.material.textfield.EndIconDelegate
    int getIconContentDescriptionResId() {
        return C1346R.string.exposed_dropdown_menu_content_description;
    }
    ...
    private void setUpDropdownShowHideBehavior() {
        this.autoCompleteTextView.setOnTouchListener(new View.OnTouchListener() { // from class: com.google.android.material.textfield.DropdownMenuEndIconDelegate$$ExternalSyntheticLambda1
            ...
            public final boolean onTouch(View view, MotionEvent motionEvent) {
                return this.f$0.m243x5f2e2537(view, motionEvent);
            }
        });
        if (IS_LOLLIPOP) {
    ...
    /* synthetic */ boolean m243x5f2e2537(View view, MotionEvent motionEvent) {
    ...
    private ValueAnimator getAlphaAnimator(int i, float... fArr) {
        ...
        valueAnimatorOfFloat.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: com.google.android.material.textfield.DropdownMenuEndIconDelegate$$ExternalSyntheticLambda0
            ...
            public final void onAnimationUpdate(ValueAnimator valueAnimator) {
                this.f$0.m239x6b943a83(valueAnimator);
            }
        });
    ...
    /* synthetic */ void m239x6b943a83(ValueAnimator valueAnimator) {
