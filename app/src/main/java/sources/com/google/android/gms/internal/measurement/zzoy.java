...
public final class zzoy implements zzov {
    ...
    static {
        ...
        zza = zzizVarZza.zza("measurement.ad_id_cache_time", WorkRequest.MIN_BACKOFF_MILLIS);
        zzb = zzizVarZza.zza("measurement.app_uninstalled_additional_ad_id_cache_time", DateUtils.MILLIS_PER_HOUR);
        ...
        zze = zzizVarZza.zza("measurement.config.cache_time", DateUtils.MILLIS_PER_DAY);
        ...
        zzi = zzizVarZza.zza("measurement.session.engagement_interval", DateUtils.MILLIS_PER_HOUR);
        ...
        zzu = zzizVarZza.zza("measurement.alarm_manager.minimum_interval", DateUtils.MILLIS_PER_MINUTE);
        zzv = zzizVarZza.zza("measurement.upload.minimum_delay", 500L);
        zzw = zzizVarZza.zza("measurement.monitoring.sample_period_millis", DateUtils.MILLIS_PER_DAY);
        ...
        zzz = zzizVarZza.zza("measurement.upload.realtime_upload_interval", WorkRequest.MIN_BACKOFF_MILLIS);
        zzaa = zzizVarZza.zza("measurement.upload.refresh_blacklisted_config_interval", 604800000L);
        zzizVarZza.zza("measurement.config.cache_time.service", DateUtils.MILLIS_PER_HOUR);
        ...
        zzad = zzizVarZza.zza("measurement.upload.stale_data_deletion_interval", DateUtils.MILLIS_PER_DAY);
        ...
        zzan = zzizVarZza.zza("measurement.upload.interval", DateUtils.MILLIS_PER_HOUR);
        zzao = zzizVarZza.zza("measurement.upload.max_bundle_size", PlaybackStateCompat.ACTION_PREPARE_FROM_SEARCH);
        ...
        zzax = zzizVarZza.zza("measurement.upload.max_batch_size", PlaybackStateCompat.ACTION_PREPARE_FROM_SEARCH);
        ...
        zzbb = zzizVarZza.zza("measurement.upload.window_interval", DateUtils.MILLIS_PER_HOUR);
