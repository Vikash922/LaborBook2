...
public abstract class zzkg {
    ...
    public abstract int zza(int i) throws zzlk;

    public abstract float zzb() throws IOException;

    public abstract void zzb(int i) throws zzlk;
    ...
    static zzkg zza(byte[] bArr, int i, int i2, boolean z) {
        zzkf zzkfVar = new zzkf(bArr, i2);
        try {
            zzkfVar.zza(i2);
            return zzkfVar;
        } catch (zzlk e) {
