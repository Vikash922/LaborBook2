...
final class Murmur3_128HashFunction extends AbstractHashFunction implements Serializable {
    ...
    private static final class Murmur3_128Hasher extends AbstractStreamingHasher {
        ...
        private static final long f433C1 = -8663945395140668459L;

        /* JADX INFO: renamed from: C2 */
        private static final long f434C2 = 5545529020109919103L;
        ...
        private void bmix64(long j, long j2) {
            long jMixK1 = mixK1(j) ^ this.f435h1;
            this.f435h1 = jMixK1;
            long jRotateLeft = Long.rotateLeft(jMixK1, 27);
            long j3 = this.f436h2;
            this.f435h1 = ((jRotateLeft + j3) * 5) + 1390208809;
            long jMixK2 = mixK2(j2) ^ j3;
            this.f436h2 = jMixK2;
            this.f436h2 = ((Long.rotateLeft(jMixK2, 31) + this.f435h1) * 5) + 944331445;
        }
        ...
        protected void processRemaining(ByteBuffer byteBuffer) {
            ...
            switch (byteBuffer.remaining()) {
                case 1:
                    ...
                    this.f435h1 = mixK1(j7) ^ this.f435h1;
                    this.f436h2 ^= mixK2(j8);
                    return;
                case 2:
                    j2 = 0;
        ...
        protected HashCode makeHash() {
            ...
            int i = this.length;
            long j2 = j ^ ((long) i);
            long j3 = this.f436h2 ^ ((long) i);
            long j4 = j2 + j3;
            this.f435h1 = j4;
            this.f436h2 = j3 + j4;
            this.f435h1 = fmix64(j4);
            long jFmix64 = fmix64(this.f436h2);
            long j5 = this.f435h1 + jFmix64;
            this.f435h1 = j5;
            this.f436h2 = jFmix64 + j5;
            return HashCode.fromBytesNoCopy(ByteBuffer.wrap(new byte[16]).order(ByteOrder.LITTLE_ENDIAN).putLong(this.f435h1).putLong(this.f436h2).array());
        }

        private static long mixK1(long j) {
            return Long.rotateLeft(j * f433C1, 31) * f434C2;
        }

        private static long mixK2(long j) {
            return Long.rotateLeft(j * f434C2, 33) * f433C1;
        }
    }
}
