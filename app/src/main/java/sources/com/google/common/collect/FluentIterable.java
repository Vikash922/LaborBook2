...
public abstract class FluentIterable<E> implements Iterable<E> {
    ...
    FluentIterable(Iterable<E> iterable) {
        this.iterableDelegate = Optional.m259of(iterable);
    }

    private Iterable<E> getDelegate() {
        return this.iterableDelegate.mo253or(this);
    }
    ...
    public static <E> FluentIterable<E> m271of() {
        return from(Collections.emptyList());
    }

    /* JADX INFO: renamed from: of */
    public static <E> FluentIterable<E> m272of(@ParametricNullness E e, E... eArr) {
    ...
    public final Optional<E> first() {
        ...
        return it.hasNext() ? Optional.m259of(it.next()) : Optional.absent();
    }
    ...
    public final Optional<E> last() {
        ...
        if (delegate instanceof List) {
            ...
            return Optional.m259of(list.get(list.size() - 1));
        }
        ...
        if (delegate instanceof SortedSet) {
            return Optional.m259of(((SortedSet) delegate).last());
        }
        do {
            next = it.next();
        } while (it.hasNext());
        return Optional.m259of(next);
    }
