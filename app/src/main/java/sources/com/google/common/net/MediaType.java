...
public final class MediaType {
    ...
    private static final ImmutableListMultimap<String, String> UTF_8_CONSTANT_PARAMETERS = ImmutableListMultimap.m300of(CHARSET_ATTRIBUTE, Ascii.toLowerCase(Charsets.UTF_8.name()));
    ...
    public static final MediaType I_CALENDAR_UTF_8 = createConstantUtf8("text", ConstantEventNames.CALENDAR);
    ...
    private static final Joiner.MapJoiner PARAMETER_JOINER = Joiner.m258on("; ").withKeyValueSeparator("=");

    private static MediaType createConstant(String str, String str2) {
        MediaType mediaTypeAddKnownType = addKnownType(new MediaType(str, str2, ImmutableListMultimap.m299of()));
    ...
    private static MediaType createConstantUtf8(String str, String str2) {
        ...
        mediaTypeAddKnownType.parsedCharset = Optional.m259of(Charsets.UTF_8);
        return mediaTypeAddKnownType;
    }
    ...
    public Optional<Charset> charset() {
        ...
        if (optionalAbsent == null) {
            ...
            while (it.hasNext()) {
                String next = it.next();
                if (str == null) {
                    optionalAbsent = Optional.m259of(Charset.forName(next));
                    str = next;
    ...
    public MediaType withParameter(String str, String str2) {
        return withParameters(str, ImmutableSet.m334of(str2));
    }

    public MediaType withCharset(Charset charset) {
        Preconditions.checkNotNull(charset);
        MediaType mediaTypeWithParameter = withParameter(CHARSET_ATTRIBUTE, charset.name());
        mediaTypeWithParameter.parsedCharset = Optional.m259of(charset);
    ...
    public boolean m411is(MediaType mediaType) {
    ...
    public static MediaType create(String str, String str2) {
        MediaType mediaTypeCreate = create(str, str2, ImmutableListMultimap.m299of());
