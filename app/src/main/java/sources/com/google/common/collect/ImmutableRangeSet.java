...
public final class ImmutableRangeSet<C extends Comparable> extends AbstractRangeSet<C> implements Serializable {
    ...
    private static final ImmutableRangeSet<Comparable<?>> EMPTY = new ImmutableRangeSet<>(ImmutableList.m286of());
    private static final ImmutableRangeSet<Comparable<?>> ALL = new ImmutableRangeSet<>(ImmutableList.m287of(Range.all()));
    ...
    public static <C extends Comparable> ImmutableRangeSet<C> m331of() {
        return EMPTY;
    }

    /* JADX INFO: renamed from: of */
    public static <C extends Comparable> ImmutableRangeSet<C> m332of(Range<C> range) {
        ...
        return new ImmutableRangeSet<>(ImmutableList.m287of(range));
    }
    ...
    public ImmutableRangeSet<C> complement() {
        ...
        if (this.ranges.size() == 1 && this.ranges.get(0).equals(Range.all())) {
            ImmutableRangeSet<C> immutableRangeSetM331of = m331of();
            this.complement = immutableRangeSetM331of;
            return immutableRangeSetM331of;
        }
    ...
    public ImmutableSortedSet<C> asSet(DiscreteDomain<C> discreteDomain) {
        ...
        if (isEmpty()) {
            return ImmutableSortedSet.m381of();
        }
    ...
    public static class Builder<C extends Comparable<?>> {
        ...
        public ImmutableRangeSet<C> build() {
            ...
            if (immutableListBuild.isEmpty()) {
                return ImmutableRangeSet.m331of();
            }
    ...
    private static final class SerializedForm<C extends Comparable> implements Serializable {
        ...
        Object readResolve() {
            ...
            if (this.ranges.equals(ImmutableList.m287of(Range.all()))) {
                return ImmutableRangeSet.all();
            }
