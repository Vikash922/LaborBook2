...
public final class ArrayTable<R, C, V> extends AbstractTable<R, C, V> implements Serializable {
    ...
    private static abstract class ArrayMap<K, V> extends Maps.IteratorBasedAbstractMap<K, V> {
        ...
        public V put(K k, @ParametricNullness V v) {
            ...
            if (num == null) {
                ...
                throw new IllegalArgumentException(new StringBuilder(String.valueOf(keyRole).length() + 9 + String.valueOf(strValueOf).length() + String.valueOf(strValueOf2).length()).append(keyRole).append(StringUtils.SPACE).append(strValueOf).append(" not in ").append(strValueOf2).toString());
            }
    ...
    public V get(@CheckForNull Object obj, @CheckForNull Object obj2) {
        ...
        return m270at(num.intValue(), num2.intValue());
    }
    ...
    public Table.Cell<R, C, V> getCell(int i) {
        return new Tables.AbstractCell<R, C, V>(i) { // from class: com.google.common.collect.ArrayTable.2
            ...
            @CheckForNull
            public V getValue() {
                return (V) ArrayTable.this.m270at(this.rowIndex, this.columnIndex);
            }
        };
    }
    ...
    public V getValue(int i) {
        return m270at(i / this.columnList.size(), i % this.columnList.size());
    }
    ...
    private class Column extends ArrayMap<R, V> {
        ...
        @CheckForNull
        V getValue(int i) {
            return (V) ArrayTable.this.m270at(i, this.columnIndex);
        }
    ...
    private class Row extends ArrayMap<C, V> {
        ...
        @CheckForNull
        V getValue(int i) {
            return (V) ArrayTable.this.m270at(this.rowIndex, i);
        }
