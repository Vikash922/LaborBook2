...
public final class SessionLifecycleClient {
    ...
    @DebugMetadata(m2734c = "com.google.firebase.sessions.SessionLifecycleClient$sendLifecycleEvents$1", m2735f = "SessionLifecycleClient.kt", m2736i = {}, m2737l = {Opcodes.DCMPL}, m2738m = "invokeSuspend", m2739n = {}, m2740s = {})
    static final class C23631 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C23631(List<Message> list, Continuation<? super C23631> continuation) {
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return SessionLifecycleClient.this.new C23631(this.$messages, continuation);
        }
    ...
    public final Job sendLifecycleEvents(List<Message> messages) {
        return BuildersKt__Builders_commonKt.launch$default(CoroutineScopeKt.CoroutineScope(this.backgroundDispatcher), null, null, new C23631(messages, null), 3, null);
    }
