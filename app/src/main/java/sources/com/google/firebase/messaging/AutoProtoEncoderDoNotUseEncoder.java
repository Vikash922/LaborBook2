...
public final class AutoProtoEncoderDoNotUseEncoder implements Configurator {
    ...
    private static final class ProtoEncoderDoNotUseEncoder implements ObjectEncoder<ProtoEncoderDoNotUse> {
        ...
        private static final FieldDescriptor MESSAGINGCLIENTEVENTEXTENSION_DESCRIPTOR = FieldDescriptor.m477of("messagingClientEventExtension");
    ...
    private static final class MessagingClientEventEncoder implements ObjectEncoder<MessagingClientEvent> {
        ...
        private static final FieldDescriptor TTL_DESCRIPTOR = FieldDescriptor.builder(VerificationDataBundle.KEY_TTL).withProperty(AtProtobuf.builder().tag(9).build()).build();
