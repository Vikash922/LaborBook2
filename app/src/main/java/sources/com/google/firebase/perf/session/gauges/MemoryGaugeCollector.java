...
import com.google.firebase.perf.p015v1.AndroidMemoryReading;
...
public class MemoryGaugeCollector {
    ...
    /* JADX INFO: renamed from: lambda$scheduleMemoryMetricCollectionWithRate$0$com-google-firebase-perf-session-gauges-MemoryGaugeCollector */
    /* synthetic */ void m512x5ca50e9a(Timer timer) {
    ...
    /* JADX INFO: renamed from: lambda$scheduleMemoryMetricCollectionOnce$1$com-google-firebase-perf-session-gauges-MemoryGaugeCollector */
    /* synthetic */ void m511x5390f99e(Timer timer) {
        AndroidMemoryReading androidMemoryReadingSyncCollectMemoryMetric = syncCollectMemoryMetric(timer);
        if (androidMemoryReadingSyncCollectMemoryMetric != null) {
            this.memoryMetricReadings.add(androidMemoryReadingSyncCollectMemoryMetric);
        }
