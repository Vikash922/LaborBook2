...
public final class AutoSessionEventEncoder implements Configurator {
    ...
    private static final class SessionEventEncoder implements ObjectEncoder<SessionEvent> {
        ...
        private static final FieldDescriptor EVENTTYPE_DESCRIPTOR = FieldDescriptor.m477of("eventType");
        private static final FieldDescriptor SESSIONDATA_DESCRIPTOR = FieldDescriptor.m477of("sessionData");
        private static final FieldDescriptor APPLICATIONINFO_DESCRIPTOR = FieldDescriptor.m477of("applicationInfo");
    ...
    private static final class SessionInfoEncoder implements ObjectEncoder<SessionInfo> {
        ...
        private static final FieldDescriptor SESSIONID_DESCRIPTOR = FieldDescriptor.m477of("sessionId");
        private static final FieldDescriptor FIRSTSESSIONID_DESCRIPTOR = FieldDescriptor.m477of("firstSessionId");
        private static final FieldDescriptor SESSIONINDEX_DESCRIPTOR = FieldDescriptor.m477of("sessionIndex");
        private static final FieldDescriptor EVENTTIMESTAMPUS_DESCRIPTOR = FieldDescriptor.m477of("eventTimestampUs");
        private static final FieldDescriptor DATACOLLECTIONSTATUS_DESCRIPTOR = FieldDescriptor.m477of("dataCollectionStatus");
    ...
    private static final class DataCollectionStatusEncoder implements ObjectEncoder<DataCollectionStatus> {
        ...
        private static final FieldDescriptor PERFORMANCE_DESCRIPTOR = FieldDescriptor.m477of("performance");
        private static final FieldDescriptor CRASHLYTICS_DESCRIPTOR = FieldDescriptor.m477of("crashlytics");
        private static final FieldDescriptor SESSIONSAMPLINGRATE_DESCRIPTOR = FieldDescriptor.m477of("sessionSamplingRate");
    ...
    private static final class ApplicationInfoEncoder implements ObjectEncoder<ApplicationInfo> {
        ...
        private static final FieldDescriptor APPID_DESCRIPTOR = FieldDescriptor.m477of(RemoteConfigConstants.RequestFieldKey.APP_ID);
        private static final FieldDescriptor DEVICEMODEL_DESCRIPTOR = FieldDescriptor.m477of("deviceModel");
        private static final FieldDescriptor SESSIONSDKVERSION_DESCRIPTOR = FieldDescriptor.m477of("sessionSdkVersion");
        private static final FieldDescriptor OSVERSION_DESCRIPTOR = FieldDescriptor.m477of("osVersion");
        private static final FieldDescriptor LOGENVIRONMENT_DESCRIPTOR = FieldDescriptor.m477of("logEnvironment");
        private static final FieldDescriptor ANDROIDAPPINFO_DESCRIPTOR = FieldDescriptor.m477of("androidAppInfo");
    ...
    private static final class AndroidApplicationInfoEncoder implements ObjectEncoder<AndroidApplicationInfo> {
        ...
        private static final FieldDescriptor PACKAGENAME_DESCRIPTOR = FieldDescriptor.m477of("packageName");
        private static final FieldDescriptor VERSIONNAME_DESCRIPTOR = FieldDescriptor.m477of("versionName");
        private static final FieldDescriptor APPBUILDVERSION_DESCRIPTOR = FieldDescriptor.m477of("appBuildVersion");
        private static final FieldDescriptor DEVICEMANUFACTURER_DESCRIPTOR = FieldDescriptor.m477of("deviceManufacturer");
