...
public final class SessionsSettings {
    ...
    @DebugMetadata(m2734c = "com.google.firebase.sessions.settings.SessionsSettings", m2735f = "SessionsSettings.kt", m2736i = {0}, m2737l = {Opcodes.L2D, Opcodes.F2I}, m2738m = "updateSettings", m2739n = {"this"}, m2740s = {"L$0"})
    static final class C23671 extends ContinuationImpl {
        Object L$0;
        int label;
        /* synthetic */ Object result;

        C23671(Continuation<? super C23671> continuation) {
            super(continuation);
        }
    ...
    public final long m3105getSessionRestartTimeoutUwyO8pc() {
        Duration durationMo3103getSessionRestartTimeoutFghU774 = this.localOverrideSettings.mo3103getSessionRestartTimeoutFghU774();
        if (durationMo3103getSessionRestartTimeoutFghU774 != null) {
            long rawValue = durationMo3103getSessionRestartTimeoutFghU774.getRawValue();
            if (m3104isValidSessionRestartTimeoutLRDsOJo(rawValue)) {
                return rawValue;
            }
        }
        Duration durationMo3103getSessionRestartTimeoutFghU7742 = this.remoteSettings.mo3103getSessionRestartTimeoutFghU774();
        if (durationMo3103getSessionRestartTimeoutFghU7742 != null) {
            long rawValue2 = durationMo3103getSessionRestartTimeoutFghU7742.getRawValue();
            if (m3104isValidSessionRestartTimeoutLRDsOJo(rawValue2)) {
                return rawValue2;
            }
        }
    ...
    private final boolean m3104isValidSessionRestartTimeoutLRDsOJo(long sessionRestartTimeout) {
        return Duration.m4697isPositiveimpl(sessionRestartTimeout) && Duration.m4692isFiniteimpl(sessionRestartTimeout);
    }
    ...
    */
    public final java.lang.Object updateSettings(kotlin.coroutines.Continuation<? super kotlin.Unit> r6) {
        /*
            r5 = this;
            boolean r0 = r6 instanceof com.google.firebase.sessions.settings.SessionsSettings.C23671
            if (r0 == 0) goto L14
            r0 = r6
            com.google.firebase.sessions.settings.SessionsSettings$updateSettings$1 r0 = (com.google.firebase.sessions.settings.SessionsSettings.C23671) r0
            int r1 = r0.label
