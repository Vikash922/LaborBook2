...
public class RemoteConfigManager {
    ...
    private RemoteConfigManager() {
        this(DeviceCacheManager.getInstance(), new ThreadPoolExecutor(0, 1, 0L, TimeUnit.SECONDS, new LinkedBlockingQueue()), null, 5000 + ((long) new Random().nextInt(RANDOM_APP_START_CONFIG_FETCH_DELAY_MS)), getInitialStartupMillis());
    }
    ...
    public Optional<Double> getDouble(String str) {
        ...
        if (remoteConfigValue != null) {
            try {
                return Optional.m516of(Double.valueOf(remoteConfigValue.asDouble()));
    ...
    public Optional<Long> getLong(String str) {
        ...
        if (remoteConfigValue != null) {
            try {
                return Optional.m516of(Long.valueOf(remoteConfigValue.asLong()));
            } catch (IllegalArgumentException unused) {
                if (!remoteConfigValue.asString().isEmpty()) {
                    logger.debug("Could not parse value: '%s' for key: '%s'.", remoteConfigValue.asString(), str);
                }
    ...
    public Optional<Boolean> getBoolean(String str) {
        ...
        if (remoteConfigValue != null) {
            try {
                return Optional.m516of(Boolean.valueOf(remoteConfigValue.asBoolean()));
            } catch (IllegalArgumentException unused) {
                if (!remoteConfigValue.asString().isEmpty()) {
                    logger.debug("Could not parse value: '%s' for key: '%s'.", remoteConfigValue.asString(), str);
                }
    ...
    public Optional<String> getString(String str) {
        ...
        FirebaseRemoteConfigValue remoteConfigValue = getRemoteConfigValue(str);
        if (remoteConfigValue != null) {
            return Optional.m516of(remoteConfigValue.asString());
        }
        return Optional.absent();
    }
    ...
    public <T> T getRemoteConfigValueOrDefault(String str, T t) {
        ...
        try {
            if (t instanceof Boolean) {
                ...
                objValueOf = Double.valueOf(remoteConfigValue.asDouble());
    ...
    private void triggerFirebaseRemoteConfigFetchAndActivateOnSuccessfulFetch() {
        ...
        this.firebaseRemoteConfig.fetchAndActivate().addOnSuccessListener(this.executor, new OnSuccessListener() { // from class: com.google.firebase.perf.config.RemoteConfigManager$$ExternalSyntheticLambda0
            ...
            public final void onSuccess(Object obj) {
                this.f$0.m498xa8c2d88f((Boolean) obj);
            }
            ...
            public final void onFailure(Exception exc) {
                this.f$0.m499x35fd8a10(exc);
            }
        });
    }

    /* JADX INFO: renamed from: lambda$triggerFirebaseRemoteConfigFetchAndActivateOnSuccessfulFetch$0$com-google-firebase-perf-config-RemoteConfigManager */
    /* synthetic */ void m498xa8c2d88f(Boolean bool) {
        syncConfigValues(this.firebaseRemoteConfig.getAll());
    }

    /* JADX INFO: renamed from: lambda$triggerFirebaseRemoteConfigFetchAndActivateOnSuccessfulFetch$1$com-google-firebase-perf-config-RemoteConfigManager */
    /* synthetic */ void m499x35fd8a10(Exception exc) {
