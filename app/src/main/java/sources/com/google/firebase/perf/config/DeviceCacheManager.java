...
public class DeviceCacheManager {
        ...
        if (this.sharedPref == null && context != null) {
            this.serialExecutor.execute(new Runnable() { // from class: com.google.firebase.perf.config.DeviceCacheManager$$ExternalSyntheticLambda0
                ...
                public final void run() {
                    this.f$0.m497xa0ef4a14(context);
                }
            });
        }
    }

    /* JADX INFO: renamed from: lambda$setContext$0$com-google-firebase-perf-config-DeviceCacheManager */
    /* synthetic */ void m497xa0ef4a14(Context context) {
        if (this.sharedPref != null || context == null) {
            return;
        }
    ...
    public Optional<Boolean> getBoolean(String str) {
        ...
        try {
            return Optional.m516of(Boolean.valueOf(this.sharedPref.getBoolean(str, false)));
    ...
    public Optional<String> getString(String str) {
        ...
        try {
            return Optional.m516of(this.sharedPref.getString(str, ""));
        } catch (ClassCastException e) {
    ...
    public Optional<Double> getDouble(String str) {
        ...
        try {
            try {
                return Optional.m516of(Double.valueOf(Double.longBitsToDouble(this.sharedPref.getLong(str, 0L))));
            } catch (ClassCastException unused) {
                return Optional.m516of(Double.valueOf(Float.valueOf(this.sharedPref.getFloat(str, 0.0f)).doubleValue()));
            }
        } catch (ClassCastException e) {
    ...
    public Optional<Long> getLong(String str) {
        ...
        try {
            return Optional.m516of(Long.valueOf(this.sharedPref.getLong(str, 0L)));
        } catch (ClassCastException e) {
            logger.debug("Key %s from sharedPreferences has type other than long: %s", str, e.getMessage());
            return Optional.absent();
        }
