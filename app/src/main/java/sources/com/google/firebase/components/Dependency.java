...
public final class Dependency {
    ...
    public String toString() {
        ...
        int i = this.type;
        return sbAppend.append(i == 1 ? CommonCssConstants.REQUIRED : i == 0 ? CommonCssConstants.OPTIONAL : SvgConstants.Tags.SET).append(", injection=").append(describeInjection(this.injection)).append("}").toString();
    }
