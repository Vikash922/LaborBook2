...
public class FirebaseRemoteConfig {
    ...
    public Task<Boolean> fetchAndActivate() {
        return fetch().onSuccessTask(this.executor, new SuccessContinuation() { // from class: com.google.firebase.remoteconfig.FirebaseRemoteConfig$$ExternalSyntheticLambda8
            ...
            public final Task then(Object obj) {
                return this.f$0.m518xebd5994c((Void) obj);
            }
        });
    }

    /* JADX INFO: renamed from: lambda$fetchAndActivate$1$com-google-firebase-remoteconfig-FirebaseRemoteConfig */
    /* synthetic */ Task m518xebd5994c(Void r1) throws Exception {
        return activate();
    }
    ...
    public Task<Boolean> activate() {
        ...
        return Tasks.whenAllComplete((Task<?>[]) new Task[]{task, task2}).continueWithTask(this.executor, new Continuation() { // from class: com.google.firebase.remoteconfig.FirebaseRemoteConfig$$ExternalSyntheticLambda0
            ...
            public final Object then(Task task3) {
                return this.f$0.m517x98ca96b0(task, task2, task3);
            }
        });
    }

    /* JADX INFO: renamed from: lambda$activate$2$com-google-firebase-remoteconfig-FirebaseRemoteConfig */
    /* synthetic */ Task m517x98ca96b0(Task task, Task task2, Task task3) throws Exception {
    ...
    public Task<Void> setConfigSettingsAsync(final FirebaseRemoteConfigSettings firebaseRemoteConfigSettings) {
        return Tasks.call(this.executor, new Callable() { // from class: com.google.firebase.remoteconfig.FirebaseRemoteConfig$$ExternalSyntheticLambda5
            @Override // java.util.concurrent.Callable
            public final Object call() {
                return this.f$0.m520xd6203cf5(firebaseRemoteConfigSettings);
            }
        });
    }

    /* JADX INFO: renamed from: lambda$setConfigSettingsAsync$5$com-google-firebase-remoteconfig-FirebaseRemoteConfig */
    /* synthetic */ Void m520xd6203cf5(FirebaseRemoteConfigSettings firebaseRemoteConfigSettings) throws Exception {
    ...
    public Task<Void> reset() {
        return Tasks.call(this.executor, new Callable() { // from class: com.google.firebase.remoteconfig.FirebaseRemoteConfig$$ExternalSyntheticLambda4
            @Override // java.util.concurrent.Callable
            public final Object call() {
                return this.f$0.m519xf98246b6();
            }
        });
    }

    /* JADX INFO: renamed from: lambda$reset$6$com-google-firebase-remoteconfig-FirebaseRemoteConfig */
    /* synthetic */ Void m519xf98246b6() throws Exception {
