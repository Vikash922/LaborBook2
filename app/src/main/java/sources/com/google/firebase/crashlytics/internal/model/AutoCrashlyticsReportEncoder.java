...
public final class AutoCrashlyticsReportEncoder implements Configurator {
    ...
    public void configure(EncoderConfig<?> encoderConfig) {
        ...
        encoderConfig.registerEncoder(C2261x7e3e3ebd.class, CrashlyticsReportSessionEventApplicationExecutionThreadEncoder.INSTANCE);
        encoderConfig.registerEncoder(CrashlyticsReport.Session.Event.Application.Execution.Thread.Frame.class, C2243xc3999712.INSTANCE);
        encoderConfig.registerEncoder(C2262xce3d994b.class, C2243xc3999712.INSTANCE);
        encoderConfig.registerEncoder(CrashlyticsReport.Session.Event.Application.Execution.Exception.class, C2242x55689506.INSTANCE);
        encoderConfig.registerEncoder(C2259xc2f5febc.class, C2242x55689506.INSTANCE);
        ...
        encoderConfig.registerEncoder(C2247xb26d2aa8.class, CrashlyticsReportApplicationExitInfoBuildIdMappingForArchEncoder.INSTANCE);
        ...
        encoderConfig.registerEncoder(C2260x7c929f5b.class, CrashlyticsReportSessionEventApplicationExecutionSignalEncoder.INSTANCE);
        encoderConfig.registerEncoder(CrashlyticsReport.Session.Event.Application.Execution.BinaryImage.class, C2241x99c932db.INSTANCE);
        encoderConfig.registerEncoder(C2258xfe724d07.class, C2241x99c932db.INSTANCE);
        ...
        encoderConfig.registerEncoder(C2263x94fa915f.class, CrashlyticsReportSessionEventApplicationProcessDetailsEncoder.INSTANCE);
        ...
        encoderConfig.registerEncoder(CrashlyticsReport.Session.Event.RolloutAssignment.RolloutVariant.class, C2244x319e1f5b.INSTANCE);
        encoderConfig.registerEncoder(C2267x87204092.class, C2244x319e1f5b.INSTANCE);
    ...
    private static final class CrashlyticsReportEncoder implements ObjectEncoder<CrashlyticsReport> {
        ...
        private static final FieldDescriptor SDKVERSION_DESCRIPTOR = FieldDescriptor.m477of(RemoteConfigConstants.RequestFieldKey.SDK_VERSION);
        private static final FieldDescriptor GMPAPPID_DESCRIPTOR = FieldDescriptor.m477of("gmpAppId");
        private static final FieldDescriptor PLATFORM_DESCRIPTOR = FieldDescriptor.m477of(TrackingOptions.AMP_TRACKING_OPTION_PLATFORM);
        private static final FieldDescriptor INSTALLATIONUUID_DESCRIPTOR = FieldDescriptor.m477of("installationUuid");
        private static final FieldDescriptor FIREBASEINSTALLATIONID_DESCRIPTOR = FieldDescriptor.m477of("firebaseInstallationId");
        private static final FieldDescriptor FIREBASEAUTHENTICATIONTOKEN_DESCRIPTOR = FieldDescriptor.m477of("firebaseAuthenticationToken");
        private static final FieldDescriptor APPQUALITYSESSIONID_DESCRIPTOR = FieldDescriptor.m477of("appQualitySessionId");
        private static final FieldDescriptor BUILDVERSION_DESCRIPTOR = FieldDescriptor.m477of("buildVersion");
        private static final FieldDescriptor DISPLAYVERSION_DESCRIPTOR = FieldDescriptor.m477of("displayVersion");
        private static final FieldDescriptor SESSION_DESCRIPTOR = FieldDescriptor.m477of("session");
        private static final FieldDescriptor NDKPAYLOAD_DESCRIPTOR = FieldDescriptor.m477of("ndkPayload");
        private static final FieldDescriptor APPEXITINFO_DESCRIPTOR = FieldDescriptor.m477of("appExitInfo");
    ...
    private static final class CrashlyticsReportSessionEncoder implements ObjectEncoder<CrashlyticsReport.Session> {
        ...
        private static final FieldDescriptor GENERATOR_DESCRIPTOR = FieldDescriptor.m477of("generator");
        private static final FieldDescriptor IDENTIFIER_DESCRIPTOR = FieldDescriptor.m477of(PdfConst.Identifier);
        private static final FieldDescriptor APPQUALITYSESSIONID_DESCRIPTOR = FieldDescriptor.m477of("appQualitySessionId");
        private static final FieldDescriptor STARTEDAT_DESCRIPTOR = FieldDescriptor.m477of("startedAt");
        private static final FieldDescriptor ENDEDAT_DESCRIPTOR = FieldDescriptor.m477of("endedAt");
        private static final FieldDescriptor CRASHED_DESCRIPTOR = FieldDescriptor.m477of("crashed");
        private static final FieldDescriptor APP_DESCRIPTOR = FieldDescriptor.m477of("app");
        private static final FieldDescriptor USER_DESCRIPTOR = FieldDescriptor.m477of("user");
        private static final FieldDescriptor OS_DESCRIPTOR = FieldDescriptor.m477of("os");
        private static final FieldDescriptor DEVICE_DESCRIPTOR = FieldDescriptor.m477of(DeviceRequestsHelper.DEVICE_INFO_DEVICE);
        private static final FieldDescriptor EVENTS_DESCRIPTOR = FieldDescriptor.m477of(DatabaseConstants.EVENT_TABLE_NAME);
        private static final FieldDescriptor GENERATORTYPE_DESCRIPTOR = FieldDescriptor.m477of("generatorType");
    ...
    private static final class CrashlyticsReportSessionApplicationEncoder implements ObjectEncoder<CrashlyticsReport.Session.Application> {
        ...
        private static final FieldDescriptor IDENTIFIER_DESCRIPTOR = FieldDescriptor.m477of(PdfConst.Identifier);
        private static final FieldDescriptor VERSION_DESCRIPTOR = FieldDescriptor.m477of("version");
        private static final FieldDescriptor DISPLAYVERSION_DESCRIPTOR = FieldDescriptor.m477of("displayVersion");
        private static final FieldDescriptor ORGANIZATION_DESCRIPTOR = FieldDescriptor.m477of("organization");
        private static final FieldDescriptor INSTALLATIONUUID_DESCRIPTOR = FieldDescriptor.m477of("installationUuid");
        private static final FieldDescriptor DEVELOPMENTPLATFORM_DESCRIPTOR = FieldDescriptor.m477of("developmentPlatform");
        private static final FieldDescriptor DEVELOPMENTPLATFORMVERSION_DESCRIPTOR = FieldDescriptor.m477of("developmentPlatformVersion");
    ...
    private static final class CrashlyticsReportSessionApplicationOrganizationEncoder implements ObjectEncoder<CrashlyticsReport.Session.Application.Organization> {
        ...
        private static final FieldDescriptor CLSID_DESCRIPTOR = FieldDescriptor.m477of("clsId");
    ...
    private static final class CrashlyticsReportSessionOperatingSystemEncoder implements ObjectEncoder<CrashlyticsReport.Session.OperatingSystem> {
        ...
        private static final FieldDescriptor VERSION_DESCRIPTOR = FieldDescriptor.m477of("version");
        private static final FieldDescriptor BUILDVERSION_DESCRIPTOR = FieldDescriptor.m477of("buildVersion");
        private static final FieldDescriptor JAILBROKEN_DESCRIPTOR = FieldDescriptor.m477of("jailbroken");
    ...
    private static final class CrashlyticsReportSessionDeviceEncoder implements ObjectEncoder<CrashlyticsReport.Session.Device> {
        ...
        private static final FieldDescriptor ARCH_DESCRIPTOR = FieldDescriptor.m477of("arch");
        private static final FieldDescriptor MODEL_DESCRIPTOR = FieldDescriptor.m477of(DeviceRequestsHelper.DEVICE_INFO_MODEL);
        private static final FieldDescriptor CORES_DESCRIPTOR = FieldDescriptor.m477of("cores");
        private static final FieldDescriptor RAM_DESCRIPTOR = FieldDescriptor.m477of("ram");
        private static final FieldDescriptor DISKSPACE_DESCRIPTOR = FieldDescriptor.m477of("diskSpace");
        private static final FieldDescriptor SIMULATOR_DESCRIPTOR = FieldDescriptor.m477of("simulator");
        private static final FieldDescriptor STATE_DESCRIPTOR = FieldDescriptor.m477of("state");
        private static final FieldDescriptor MANUFACTURER_DESCRIPTOR = FieldDescriptor.m477of("manufacturer");
        private static final FieldDescriptor MODELCLASS_DESCRIPTOR = FieldDescriptor.m477of("modelClass");
    ...
    private static final class CrashlyticsReportSessionEventEncoder implements ObjectEncoder<CrashlyticsReport.Session.Event> {
        ...
        private static final FieldDescriptor TIMESTAMP_DESCRIPTOR = FieldDescriptor.m477of(SDKConstants.PARAM_DEBUG_MESSAGE_TIMESTAMP);
        private static final FieldDescriptor TYPE_DESCRIPTOR = FieldDescriptor.m477of("type");
        private static final FieldDescriptor APP_DESCRIPTOR = FieldDescriptor.m477of("app");
        private static final FieldDescriptor DEVICE_DESCRIPTOR = FieldDescriptor.m477of(DeviceRequestsHelper.DEVICE_INFO_DEVICE);
        private static final FieldDescriptor LOG_DESCRIPTOR = FieldDescriptor.m477of("log");
        private static final FieldDescriptor ROLLOUTS_DESCRIPTOR = FieldDescriptor.m477of("rollouts");
    ...
    private static final class CrashlyticsReportSessionEventApplicationEncoder implements ObjectEncoder<CrashlyticsReport.Session.Event.Application> {
        ...
        private static final FieldDescriptor EXECUTION_DESCRIPTOR = FieldDescriptor.m477of("execution");
        private static final FieldDescriptor CUSTOMATTRIBUTES_DESCRIPTOR = FieldDescriptor.m477of("customAttributes");
        private static final FieldDescriptor INTERNALKEYS_DESCRIPTOR = FieldDescriptor.m477of("internalKeys");
        private static final FieldDescriptor BACKGROUND_DESCRIPTOR = FieldDescriptor.m477of(CommonCssConstants.BACKGROUND);
        private static final FieldDescriptor CURRENTPROCESSDETAILS_DESCRIPTOR = FieldDescriptor.m477of("currentProcessDetails");
        private static final FieldDescriptor APPPROCESSDETAILS_DESCRIPTOR = FieldDescriptor.m477of("appProcessDetails");
        private static final FieldDescriptor UIORIENTATION_DESCRIPTOR = FieldDescriptor.m477of("uiOrientation");
    ...
    private static final class CrashlyticsReportSessionEventApplicationExecutionEncoder implements ObjectEncoder<CrashlyticsReport.Session.Event.Application.Execution> {
        ...
        private static final FieldDescriptor THREADS_DESCRIPTOR = FieldDescriptor.m477of("threads");
        private static final FieldDescriptor EXCEPTION_DESCRIPTOR = FieldDescriptor.m477of("exception");
        private static final FieldDescriptor APPEXITINFO_DESCRIPTOR = FieldDescriptor.m477of("appExitInfo");
        private static final FieldDescriptor SIGNAL_DESCRIPTOR = FieldDescriptor.m477of("signal");
        private static final FieldDescriptor BINARIES_DESCRIPTOR = FieldDescriptor.m477of("binaries");
    ...
    private static final class CrashlyticsReportSessionEventApplicationExecutionThreadEncoder implements ObjectEncoder<CrashlyticsReport.Session.Event.Application.Execution.Thread> {
        ...
        private static final FieldDescriptor NAME_DESCRIPTOR = FieldDescriptor.m477of("name");
        private static final FieldDescriptor IMPORTANCE_DESCRIPTOR = FieldDescriptor.m477of("importance");
        private static final FieldDescriptor FRAMES_DESCRIPTOR = FieldDescriptor.m477of("frames");
    ...
    private static final class C2243xc3999712 implements ObjectEncoder<CrashlyticsReport.Session.Event.Application.Execution.Thread.Frame> {
        static final C2243xc3999712 INSTANCE = new C2243xc3999712();
        private static final FieldDescriptor PC_DESCRIPTOR = FieldDescriptor.m477of(CommonCssConstants.f3302PC);
        private static final FieldDescriptor SYMBOL_DESCRIPTOR = FieldDescriptor.m477of(SvgConstants.Tags.SYMBOL);
        private static final FieldDescriptor FILE_DESCRIPTOR = FieldDescriptor.m477of(ShareInternalUtility.STAGING_PARAM);
        private static final FieldDescriptor OFFSET_DESCRIPTOR = FieldDescriptor.m477of("offset");
        private static final FieldDescriptor IMPORTANCE_DESCRIPTOR = FieldDescriptor.m477of("importance");

        private C2243xc3999712() {
        }
    ...
    private static final class C2242x55689506 implements ObjectEncoder<CrashlyticsReport.Session.Event.Application.Execution.Exception> {
        static final C2242x55689506 INSTANCE = new C2242x55689506();
        private static final FieldDescriptor TYPE_DESCRIPTOR = FieldDescriptor.m477of("type");
        private static final FieldDescriptor REASON_DESCRIPTOR = FieldDescriptor.m477of("reason");
        private static final FieldDescriptor FRAMES_DESCRIPTOR = FieldDescriptor.m477of("frames");
        private static final FieldDescriptor CAUSEDBY_DESCRIPTOR = FieldDescriptor.m477of("causedBy");
        private static final FieldDescriptor OVERFLOWCOUNT_DESCRIPTOR = FieldDescriptor.m477of("overflowCount");

        private C2242x55689506() {
        }
    ...
    private static final class CrashlyticsReportApplicationExitInfoEncoder implements ObjectEncoder<CrashlyticsReport.ApplicationExitInfo> {
        ...
        private static final FieldDescriptor PID_DESCRIPTOR = FieldDescriptor.m477of("pid");
        private static final FieldDescriptor PROCESSNAME_DESCRIPTOR = FieldDescriptor.m477of("processName");
        private static final FieldDescriptor REASONCODE_DESCRIPTOR = FieldDescriptor.m477of("reasonCode");
        private static final FieldDescriptor IMPORTANCE_DESCRIPTOR = FieldDescriptor.m477of("importance");
        private static final FieldDescriptor PSS_DESCRIPTOR = FieldDescriptor.m477of("pss");
        private static final FieldDescriptor RSS_DESCRIPTOR = FieldDescriptor.m477of("rss");
        private static final FieldDescriptor TIMESTAMP_DESCRIPTOR = FieldDescriptor.m477of(SDKConstants.PARAM_DEBUG_MESSAGE_TIMESTAMP);
        private static final FieldDescriptor TRACEFILE_DESCRIPTOR = FieldDescriptor.m477of("traceFile");
        private static final FieldDescriptor BUILDIDMAPPINGFORARCH_DESCRIPTOR = FieldDescriptor.m477of("buildIdMappingForArch");
    ...
    private static final class CrashlyticsReportApplicationExitInfoBuildIdMappingForArchEncoder implements ObjectEncoder<CrashlyticsReport.ApplicationExitInfo.BuildIdMappingForArch> {
        ...
        private static final FieldDescriptor ARCH_DESCRIPTOR = FieldDescriptor.m477of("arch");
        private static final FieldDescriptor LIBRARYNAME_DESCRIPTOR = FieldDescriptor.m477of("libraryName");
        private static final FieldDescriptor BUILDID_DESCRIPTOR = FieldDescriptor.m477of("buildId");
    ...
    private static final class CrashlyticsReportSessionEventApplicationExecutionSignalEncoder implements ObjectEncoder<CrashlyticsReport.Session.Event.Application.Execution.Signal> {
        ...
        private static final FieldDescriptor NAME_DESCRIPTOR = FieldDescriptor.m477of("name");
        private static final FieldDescriptor CODE_DESCRIPTOR = FieldDescriptor.m477of("code");
        private static final FieldDescriptor ADDRESS_DESCRIPTOR = FieldDescriptor.m477of("address");
    ...
    private static final class C2241x99c932db implements ObjectEncoder<CrashlyticsReport.Session.Event.Application.Execution.BinaryImage> {
        static final C2241x99c932db INSTANCE = new C2241x99c932db();
        private static final FieldDescriptor BASEADDRESS_DESCRIPTOR = FieldDescriptor.m477of("baseAddress");
        private static final FieldDescriptor SIZE_DESCRIPTOR = FieldDescriptor.m477of("size");
        private static final FieldDescriptor NAME_DESCRIPTOR = FieldDescriptor.m477of("name");
        private static final FieldDescriptor UUID_DESCRIPTOR = FieldDescriptor.m477of("uuid");

        private C2241x99c932db() {
        }
    ...
    private static final class CrashlyticsReportCustomAttributeEncoder implements ObjectEncoder<CrashlyticsReport.CustomAttribute> {
        ...
        private static final FieldDescriptor KEY_DESCRIPTOR = FieldDescriptor.m477of("key");
        private static final FieldDescriptor VALUE_DESCRIPTOR = FieldDescriptor.m477of("value");
    ...
    private static final class CrashlyticsReportSessionEventApplicationProcessDetailsEncoder implements ObjectEncoder<CrashlyticsReport.Session.Event.Application.ProcessDetails> {
        ...
        private static final FieldDescriptor PID_DESCRIPTOR = FieldDescriptor.m477of("pid");
        private static final FieldDescriptor IMPORTANCE_DESCRIPTOR = FieldDescriptor.m477of("importance");
        private static final FieldDescriptor DEFAULTPROCESS_DESCRIPTOR = FieldDescriptor.m477of("defaultProcess");
    ...
    private static final class CrashlyticsReportSessionEventDeviceEncoder implements ObjectEncoder<CrashlyticsReport.Session.Event.Device> {
        ...
        private static final FieldDescriptor BATTERYLEVEL_DESCRIPTOR = FieldDescriptor.m477of("batteryLevel");
        private static final FieldDescriptor BATTERYVELOCITY_DESCRIPTOR = FieldDescriptor.m477of("batteryVelocity");
        private static final FieldDescriptor PROXIMITYON_DESCRIPTOR = FieldDescriptor.m477of("proximityOn");
        private static final FieldDescriptor ORIENTATION_DESCRIPTOR = FieldDescriptor.m477of(MediaFeature.ORIENTATION);
        private static final FieldDescriptor RAMUSED_DESCRIPTOR = FieldDescriptor.m477of("ramUsed");
        private static final FieldDescriptor DISKUSED_DESCRIPTOR = FieldDescriptor.m477of("diskUsed");
    ...
    private static final class CrashlyticsReportSessionEventLogEncoder implements ObjectEncoder<CrashlyticsReport.Session.Event.Log> {
        ...
        private static final FieldDescriptor CONTENT_DESCRIPTOR = FieldDescriptor.m477of("content");
    ...
    private static final class CrashlyticsReportSessionEventRolloutsStateEncoder implements ObjectEncoder<CrashlyticsReport.Session.Event.RolloutsState> {
        ...
        private static final FieldDescriptor ASSIGNMENTS_DESCRIPTOR = FieldDescriptor.m477of("assignments");
    ...
    private static final class CrashlyticsReportSessionEventRolloutAssignmentEncoder implements ObjectEncoder<CrashlyticsReport.Session.Event.RolloutAssignment> {
        ...
        private static final FieldDescriptor ROLLOUTVARIANT_DESCRIPTOR = FieldDescriptor.m477of("rolloutVariant");
        private static final FieldDescriptor PARAMETERKEY_DESCRIPTOR = FieldDescriptor.m477of("parameterKey");
        private static final FieldDescriptor PARAMETERVALUE_DESCRIPTOR = FieldDescriptor.m477of("parameterValue");
        private static final FieldDescriptor TEMPLATEVERSION_DESCRIPTOR = FieldDescriptor.m477of(RemoteConfigConstants.ResponseFieldKey.TEMPLATE_VERSION_NUMBER);
    ...
    private static final class C2244x319e1f5b implements ObjectEncoder<CrashlyticsReport.Session.Event.RolloutAssignment.RolloutVariant> {
        static final C2244x319e1f5b INSTANCE = new C2244x319e1f5b();
        private static final FieldDescriptor ROLLOUTID_DESCRIPTOR = FieldDescriptor.m477of(ConfigContainer.ROLLOUT_METADATA_ID);
        private static final FieldDescriptor VARIANTID_DESCRIPTOR = FieldDescriptor.m477of("variantId");

        private C2244x319e1f5b() {
        }
    ...
    private static final class CrashlyticsReportFilesPayloadEncoder implements ObjectEncoder<CrashlyticsReport.FilesPayload> {
        ...
        private static final FieldDescriptor FILES_DESCRIPTOR = FieldDescriptor.m477of("files");
        private static final FieldDescriptor ORGID_DESCRIPTOR = FieldDescriptor.m477of("orgId");
    ...
    private static final class CrashlyticsReportFilesPayloadFileEncoder implements ObjectEncoder<CrashlyticsReport.FilesPayload.File> {
        ...
        private static final FieldDescriptor FILENAME_DESCRIPTOR = FieldDescriptor.m477of("filename");
        private static final FieldDescriptor CONTENTS_DESCRIPTOR = FieldDescriptor.m477of(XfdfConstants.CONTENTS);
