...
public final class zzd {
    private static final ImmutableSet<String> zza = ImmutableSet.m339of("_in", "_xa", "_xu", "_aq", "_aa", "_ai", "_ac", FirebaseAnalytics.Event.CAMPAIGN_DETAILS, "_ug", "_iapx", "_exp_set", "_exp_clear", "_exp_activate", "_exp_timeout", "_exp_expire");
    private static final ImmutableList<String> zzb = ImmutableList.m293of("_e", "_f", "_iap", "_s", "_au", "_ui", "_cd");
    private static final ImmutableList<String> zzc = ImmutableList.m289of("auto", "app", "am");
    private static final ImmutableList<String> zzd = ImmutableList.m288of("_r", "_dbg");
    private static final ImmutableList<String> zze = new ImmutableList.Builder().add((Object[]) zzjh.zza).add((Object[]) zzjh.zzb).build();
    private static final ImmutableList<String> zzf = ImmutableList.m288of("^_ltv_[A-Z]{3}$", "^_cc[1-5]{1}$");
    ...
    public static Bundle zza(AnalyticsConnector.ConditionalUserProperty conditionalUserProperty) {
        ...
        if (conditionalUserProperty.value != null) {
            zziz.zza(bundle, conditionalUserProperty.value);
        }
    ...
    public static AnalyticsConnector.ConditionalUserProperty zza(Bundle bundle) {
        ...
        conditionalUserProperty.active = ((Boolean) zziz.zza(bundle, "active", Boolean.class, false)).booleanValue();
    ...
    public static boolean zzb(AnalyticsConnector.ConditionalUserProperty conditionalUserProperty) {
        ...
        if ((conditionalUserProperty.value != null && zzle.zza(conditionalUserProperty.value) == null) || !zzf(str) || !zza(str, conditionalUserProperty.name)) {
            return false;
        }
