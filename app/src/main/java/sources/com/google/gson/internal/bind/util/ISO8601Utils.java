...
public class ISO8601Utils {
    ...
    public static String format(Date date, boolean z, TimeZone timeZone) {
        ...
        StringBuilder sb = new StringBuilder("yyyy-MM-ddThh:mm:ss".length() + (z ? ".sss".length() : 0) + (timeZone.getRawOffset() == 0 ? SvgConstants.Attributes.PATH_DATA_CLOSE_PATH : "+hh:mm").length());
        ...
        sb.append(':');
        padInt(sb, gregorianCalendar.get(12), CommonCssConstants.f3301MM.length());
        sb.append(':');
        ...
        if (offset != 0) {
            ...
            sb.append(':');
            padInt(sb, iAbs2, CommonCssConstants.f3301MM.length());
        } else {
        ...
        try {
            ...
            if (zCheckOffset) {
                ...
                if (str.length() <= i13 || (cCharAt = str.charAt(i13)) == 'Z' || cCharAt == '+' || cCharAt == '-') {
                    ...
                    if (checkOffset(str, i15, ClassUtils.PACKAGE_SEPARATOR_CHAR)) {
                        int i16 = i13 + 3;
