...
public final class Code93Reader extends OneDReader {
    ...
    static {
        int[] iArr = {276, TIFFConstants.TIFFTAG_CONSECUTIVEBADFAXLINES, TIFFConstants.TIFFTAG_TILEOFFSETS, 322, TIFFConstants.TIFFTAG_RESOLUTIONUNIT, TIFFConstants.TIFFTAG_GROUP3OPTIONS, TIFFConstants.TIFFTAG_GRAYRESPONSEUNIT, TIFFConstants.TIFFTAG_DOTRANGE, TIFFConstants.TIFFTAG_ORIENTATION, TIFFConstants.TIFFTAG_FILLORDER, TypedValues.CycleType.TYPE_WAVE_OFFSET, TypedValues.CycleType.TYPE_EASING, 418, WalletConstants.ERROR_CODE_INVALID_PARAMETERS, 402, 394, 360, 356, 354, 308, TIFFConstants.TIFFTAG_XRESOLUTION, 344, TIFFConstants.TIFFTAG_INKSET, TIFFConstants.TIFFTAG_BADFAXLINES, 300, TIFFConstants.TIFFTAG_ROWSPERSTRIP, 436, 434, 428, TypedValues.CycleType.TYPE_CUSTOM_WAVE_SHAPE, WalletConstants.ERROR_CODE_SPENDING_LIMIT_EXCEEDED, WalletConstants.ERROR_CODE_INVALID_TRANSACTION, 364, 358, 310, 314, 302, 468, 466, FacebookRequestErrorClassification.ESC_APP_NOT_INSTALLED, 366, 374, 430, 294, 474, 470, 306, 350};
                ...
                switch (cCharAt) {
                    ...
                    case 'b':
                        if (cCharAt2 >= 'A' && cCharAt2 <= 'E') {
                            ...
                            i = cCharAt2 + SignatureVisitor.EXTENDS;
                        } else {
