...
final class DecodedBitStreamParser {
    ...
    private static final int f581AL = 28;

    /* JADX INFO: renamed from: AS */
    private static final int f582AS = 27;
    ...
    private static final int f583LL = 27;
    ...
    private static final int f584ML = 28;
    ...
    private static final int f585PL = 25;

    /* JADX INFO: renamed from: PS */
    private static final int f586PS = 29;
    ...
    */
    ...
    private static void decodeTextCompaction(int[] iArr, int[] iArr2, int i, StringBuilder sb) {
        ...
        for (int i3 = 0; i3 < i; i3++) {
            int i4 = iArr[i3];
            char c = ' ';
            switch (C26061.f587x45bba1d[mode2.ordinal()]) {
                case 1:
                    if (i4 < 26) {
                        i2 = i4 + 65;
                        c = (char) i2;
    ...
    static /* synthetic */ class C26061 {
        ...
        static {
            ...
            try {
                f587x45bba1d[Mode.LOWER.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f587x45bba1d[Mode.MIXED.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f587x45bba1d[Mode.PUNCT.ordinal()] = 4;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                f587x45bba1d[Mode.ALPHA_SHIFT.ordinal()] = 5;
            } catch (NoSuchFieldError unused5) {
            }
            try {
                f587x45bba1d[Mode.PUNCT_SHIFT.ordinal()] = 6;
