...
public class FlatBufferBuilder {
    ...
    public ByteBuffer createUnintializedVector(int i, int i2, int i3) {
        ...
        ByteBuffer byteBufferOrder = this.f120bb.slice().order(ByteOrder.LITTLE_ENDIAN);
    ...
    public int endTable() {
        ...
        loop2: while (true) {
            ...
            int iCapacity = this.f120bb.capacity() - this.vtables[i5];
            int i6 = this.space;
            short s = this.f120bb.getShort(iCapacity);
            if (s == this.f120bb.getShort(i6)) {
                for (int i7 = 2; i7 < s; i7 += 2) {
                    if (this.f120bb.getShort(iCapacity + i7) != this.f120bb.getShort(i6 + i7)) {
                        break;
                    }
                }
                i = this.vtables[i5];
        ...
        if (i != 0) {
            int iCapacity2 = this.f120bb.capacity() - iOffset;
            this.space = iCapacity2;
            this.f120bb.putInt(iCapacity2, i - iOffset);
        } else {
    ...
    public void required(int i, int i2) {
        int iCapacity = this.f120bb.capacity() - i;
        if (this.f120bb.getShort((iCapacity - this.f120bb.getInt(iCapacity)) + i2) == 0) {
    ...
    public InputStream sizedInputStream() {
        finished();
        ByteBuffer byteBufferDuplicate = this.f120bb.duplicate();
        byteBufferDuplicate.position(this.space);
        byteBufferDuplicate.limit(this.f120bb.capacity());
