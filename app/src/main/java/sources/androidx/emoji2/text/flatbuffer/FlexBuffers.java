...
public class FlexBuffers {
    ...
    public static class Reference {
        ...
        public String asString() {
            if (isString()) {
                int iIndirect = FlexBuffers.indirect(this.f122bb, this.end, this.parentWidth);
                ReadBuf readBuf = this.f122bb;
                int i = this.byteWidth;
                return this.f122bb.getString(iIndirect, (int) FlexBuffers.readUInt(readBuf, iIndirect - i, i));
            }
            if (isKey()) {
                int iIndirect2 = FlexBuffers.indirect(this.f122bb, this.end, this.byteWidth);
                int i2 = iIndirect2;
                while (this.f122bb.get(i2) != 0) {
                    i2++;
                }
                return this.f122bb.getString(iIndirect2, i2 - iIndirect2);
            }
            return "";
        }
        ...
        StringBuilder toString(StringBuilder sb) {
            ...
            if (i != 36) {
                switch (i) {
                    case 0:
                        return sb.append(com.laborbook.keep.screen.calendar.utils.Constants.ATTENDANCE_STATUS_NULL);
                    case 1:
                    case 6:
    ...
    public static class Blob extends Sized {
        ...
        public ByteBuffer data() {
            ByteBuffer byteBufferWrap = ByteBuffer.wrap(this.f121bb.data());
    ...
    public static class Vector extends Sized {
        ...
        public Reference get(int i) {
            ...
            return new Reference(this.f121bb, this.end + (i * this.byteWidth), this.byteWidth, Unsigned.byteToUnsignedInt(this.f121bb.get((int) (((long) this.end) + (size * ((long) this.byteWidth)) + j))));
        }
    }
