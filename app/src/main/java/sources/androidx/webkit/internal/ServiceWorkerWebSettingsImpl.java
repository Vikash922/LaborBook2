...
public class ServiceWorkerWebSettingsImpl extends ServiceWorkerWebSettingsCompat {
    ...
    public void setCacheMode(int i) {
        ApiFeature.C0929N c0929n = WebViewFeatureInternal.SERVICE_WORKER_CACHE_MODE;
    ...
    public void setAllowContentAccess(boolean z) {
        ApiFeature.C0929N c0929n = WebViewFeatureInternal.SERVICE_WORKER_CONTENT_ACCESS;
        if (c0929n.isSupportedByFramework()) {
    ...
    public void setAllowFileAccess(boolean z) {
        ApiFeature.C0929N c0929n = WebViewFeatureInternal.SERVICE_WORKER_FILE_ACCESS;
        if (c0929n.isSupportedByFramework()) {
    ...
    public void setBlockNetworkLoads(boolean z) {
        ApiFeature.C0929N c0929n = WebViewFeatureInternal.SERVICE_WORKER_BLOCK_NETWORK_LOADS;
        if (c0929n.isSupportedByFramework()) {
