...
public abstract class StartupApiFeature {
    ...
    private static Bundle getMetaDataFromWebViewManifestOrNull(Context context) {
        ...
        if (Build.VERSION.SDK_INT >= 33) {
            try {
                return ApiHelperForTiramisu.getServiceInfo(context.getPackageManager(), componentName, ApiHelperForTiramisu.m75of(640L)).metaData;
    ...
    /* JADX INFO: renamed from: androidx.webkit.internal.StartupApiFeature$P */
    public static class C0938P extends StartupApiFeature {
        C0938P(String str, String str2) {
            super(str, str2);
        }
