...
public class WebViewCompat {
    ...
    public static void postVisualStateCallback(WebView webView, long j, VisualStateCallback visualStateCallback) {
        ApiFeature.C0928M c0928m = WebViewFeatureInternal.VISUAL_STATE_CALLBACK;
    ...
    public static WebMessagePortCompat[] createWebMessageChannel(WebView webView) {
        ApiFeature.C0928M c0928m = WebViewFeatureInternal.CREATE_WEB_MESSAGE_CHANNEL;
        if (c0928m.isSupportedByFramework()) {
    ...
    public static void postWebMessage(WebView webView, WebMessageCompat webMessageCompat, Uri uri) {
        ...
        ApiFeature.C0928M c0928m = WebViewFeatureInternal.POST_WEB_MESSAGE;
        if (c0928m.isSupportedByFramework() && webMessageCompat.getType() == 0) {
            ApiHelperForM.postWebMessage(webView, WebMessagePortImpl.compatToFrameworkMessage(webMessageCompat), uri);
        } else {
            if (c0928m.isSupportedByWebView() && WebMessageAdapter.isMessagePayloadTypeSupportedByWebView(webMessageCompat.getType())) {
    ...
    public static WebViewClient getWebViewClient(WebView webView) {
        ApiFeature.C0930O c0930o = WebViewFeatureInternal.GET_WEB_VIEW_CLIENT;
    ...
    public static WebChromeClient getWebChromeClient(WebView webView) {
        ApiFeature.C0930O c0930o = WebViewFeatureInternal.GET_WEB_CHROME_CLIENT;
        if (c0930o.isSupportedByFramework()) {
    ...
    public static WebViewRenderProcess getWebViewRenderProcess(WebView webView) {
        ApiFeature.C0932Q c0932q = WebViewFeatureInternal.GET_WEB_VIEW_RENDERER;
    ...
    public static void setWebViewRenderProcessClient(WebView webView, Executor executor, WebViewRenderProcessClient webViewRenderProcessClient) {
        ApiFeature.C0932Q c0932q = WebViewFeatureInternal.WEB_VIEW_RENDERER_CLIENT_BASIC_USAGE;
        if (c0932q.isSupportedByFramework()) {
