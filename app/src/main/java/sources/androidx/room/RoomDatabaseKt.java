...
public final class RoomDatabaseKt {
    ...
    /* JADX INFO: compiled from: RoomDatabaseExt.kt */
    @Metadata(m2721d1 = {"\u0000\u0012\n\u0000\n\u0002\u0010\u0002\n\u0002\u0018\u0002\n\u0002\u0010\"\n\u0002\u0010\u000e\u0010\u0000\u001a\u00020\u0001*\u000e\u0012\n\u0012\b\u0012\u0004\u0012\u00020\u00040\u00030\u0002H\u008a@"}, m2722d2 = {"<anonymous>", "", "Lkotlinx/coroutines/channels/ProducerScope;", "", ""}, m2723k = 3, m2724mv = {1, 8, 0}, m2726xi = 48)
    @DebugMetadata(m2734c = "androidx.room.RoomDatabaseKt$invalidationTrackerFlow$1", m2735f = "RoomDatabaseExt.kt", m2736i = {}, m2737l = {235}, m2738m = "invokeSuspend", m2739n = {}, m2740s = {})
    static final class C08241 extends SuspendLambda implements Function2<ProducerScope<? super Set<? extends String>>, Continuation<? super Unit>, Object> {
        ...
        C08241(boolean z, RoomDatabase roomDatabase, String[] strArr, Continuation<? super C08241> continuation) {
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            C08241 c08241 = new C08241(this.$emitInitialState, this.$this_invalidationTrackerFlow, this.$tables, continuation);
            c08241.L$0 = obj;
            return c08241;
        }
        ...
        public final Object invoke2(ProducerScope<? super Set<String>> producerScope, Continuation<? super Unit> continuation) {
            return ((C08241) create(producerScope, continuation)).invokeSuspend(Unit.INSTANCE);
        }
            ...
            if (i == 0) {
                ...
                ?? r6 = new InvalidationTracker.Observer(strArr) { // from class: androidx.room.RoomDatabaseKt$invalidationTrackerFlow$1$observer$1
                    ...
                    public void onInvalidated(Set<String> tables) {
                        ...
                        producerScope.mo4818trySendJP2dKIU(tables);
                    }
                };
    ...
    public static final Flow<Set<String>> invalidationTrackerFlow(RoomDatabase roomDatabase, String[] strArr, boolean z) {
        return FlowKt.callbackFlow(new C08241(z, roomDatabase, strArr, null));
    }
    ...
    public static final <R> Object startTransactionCoroutine(final RoomDatabase roomDatabase, final CoroutineContext coroutineContext, final Function2<? super CoroutineScope, ? super Continuation<? super R>, ? extends Object> function2, Continuation<? super R> continuation) {
        ...
        try {
            roomDatabase.getTransactionExecutor().execute(new Runnable() { // from class: androidx.room.RoomDatabaseKt$startTransactionCoroutine$2$1
                ...
                /* JADX INFO: compiled from: RoomDatabaseExt.kt */
                @Metadata(m2721d1 = {"\u0000\f\n\u0000\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\u0010\u0000\u001a\u00020\u0001\"\u0004\b\u0000\u0010\u0002*\u00020\u0003H\u008a@"}, m2722d2 = {"<anonymous>", "", SvgConstants.Attributes.PATH_DATA_CATMULL_CURVE, "Lkotlinx/coroutines/CoroutineScope;"}, m2723k = 3, m2724mv = {1, 8, 0}, m2726xi = 48)
                @DebugMetadata(m2734c = "androidx.room.RoomDatabaseKt$startTransactionCoroutine$2$1$1", m2735f = "RoomDatabaseExt.kt", m2736i = {}, m2737l = {103}, m2738m = "invokeSuspend", m2739n = {}, m2740s = {})
                static final class C08251 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
                    ...
                    C08251(RoomDatabase roomDatabase, CancellableContinuation<? super R> cancellableContinuation, Function2<? super CoroutineScope, ? super Continuation<? super R>, ? extends Object> function2, Continuation<? super C08251> continuation) {
                        super(2, continuation);
                    ...
                    @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
                    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
                        C08251 c08251 = new C08251(this.$this_startTransactionCoroutine, this.$continuation, this.$transactionBlock, continuation);
                        c08251.L$0 = obj;
                        return c08251;
                    }
                    ...
                    public final Object invokeSuspend(Object obj) throws Throwable {
                        ...
                        continuation.resumeWith(Result.m3325constructorimpl(obj));
                        return Unit.INSTANCE;
                    }
                }
                ...
                public final void run() {
                    try {
                        BuildersKt.runBlocking(coroutineContext.minusKey(ContinuationInterceptor.INSTANCE), new C08251(roomDatabase, cancellableContinuationImpl2, function2, null));
                    } catch (Throwable th) {
