...
@Metadata(m2721d1 = {"\u0000\u0010\n\u0000\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\u0010\u0000\u001a\u00020\u0001\"\u0004\b\u0000\u0010\u0002*\r\u0012\t\u0012\u0007H\u0002¢\u0006\u0002\b\u00040\u0003H\u008a@"}, m2722d2 = {"<anonymous>", "", SvgConstants.Attributes.PATH_DATA_CATMULL_CURVE, "Lkotlinx/coroutines/flow/FlowCollector;", "Lkotlin/jvm/JvmSuppressWildcards;"}, m2723k = 3, m2724mv = {1, 8, 0}, m2726xi = 48)
@DebugMetadata(m2734c = "androidx.room.CoroutinesRoom$Companion$createFlow$1", m2735f = "CoroutinesRoom.kt", m2736i = {}, m2737l = {111}, m2738m = "invokeSuspend", m2739n = {}, m2740s = {})
final class CoroutinesRoom$Companion$createFlow$1<R> extends SuspendLambda implements Function2<FlowCollector<R>, Continuation<? super Unit>, Object> {
    ...
    @DebugMetadata(m2734c = "androidx.room.CoroutinesRoom$Companion$createFlow$1$1", m2735f = "CoroutinesRoom.kt", m2736i = {}, m2737l = {Opcodes.L2F}, m2738m = "invokeSuspend", m2739n = {}, m2740s = {})
    static final class C08181 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C08181(boolean z, RoomDatabase roomDatabase, FlowCollector<R> flowCollector, String[] strArr, Callable<R> callable, Continuation<? super C08181> continuation) {
            super(2, continuation);
            this.$inTransaction = z;
            this.$db = roomDatabase;
        ...
        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            C08181 c08181 = new C08181(this.$inTransaction, this.$db, this.$$this$flow, this.$tableNames, this.$callable, continuation);
            c08181.L$0 = obj;
            return c08181;
        }
            ...
            if (i == 0) {
                ...
                ?? r7 = new InvalidationTracker.Observer(strArr) { // from class: androidx.room.CoroutinesRoom$Companion$createFlow$1$1$observer$1
                    ...
                    public void onInvalidated(Set<String> tables) {
                        channelChannel$default.mo4818trySendJP2dKIU(Unit.INSTANCE);
                    }
                };
                channelChannel$default.mo4818trySendJP2dKIU(Unit.INSTANCE);
        ...
        /* JADX INFO: compiled from: CoroutinesRoom.kt */
        @Metadata(m2721d1 = {"\u0000\f\n\u0000\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\u0010\u0000\u001a\u00020\u0001\"\u0004\b\u0000\u0010\u0002*\u00020\u0003H\u008a@"}, m2722d2 = {"<anonymous>", "", SvgConstants.Attributes.PATH_DATA_CATMULL_CURVE, "Lkotlinx/coroutines/CoroutineScope;"}, m2723k = 3, m2724mv = {1, 8, 0}, m2726xi = 48)
        @DebugMetadata(m2734c = "androidx.room.CoroutinesRoom$Companion$createFlow$1$1$1", m2735f = "CoroutinesRoom.kt", m2736i = {}, m2737l = {128, 130}, m2738m = "invokeSuspend", m2739n = {}, m2740s = {})
            ...
            */
            public final java.lang.Object invokeSuspend(java.lang.Object r8) {
                ...
                L7f:
                    ...
                    throw r8
                */
                throw new UnsupportedOperationException("Method not decompiled: androidx.room.CoroutinesRoom$Companion$createFlow$1.C08181.AnonymousClass1.invokeSuspend(java.lang.Object):java.lang.Object");
            }
        }
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            this.label = 1;
            if (CoroutineScopeKt.coroutineScope(new C08181(this.$inTransaction, this.$db, flowCollector, this.$tableNames, this.$callable, null), this) == coroutine_suspended) {
                return coroutine_suspended;
            }
        } else {
            if (i != 1) {
