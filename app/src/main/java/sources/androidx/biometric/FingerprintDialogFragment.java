...
public class FingerprintDialogFragment extends DialogFragment {
    ...
    public void onCreate(Bundle bundle) {
        ...
        if (Build.VERSION.SDK_INT >= 26) {
            ...
            this.mErrorTextColor = context != null ? ContextCompat.getColor(context, C0178R.color.biometric_error_color) : 0;
        }
    ...
    public Dialog onCreateDialog(Bundle bundle) {
        ...
        View viewInflate = LayoutInflater.from(builder.getContext()).inflate(C0178R.layout.fingerprint_dialog_layout, (ViewGroup) null);
        TextView textView = (TextView) viewInflate.findViewById(C0178R.id.fingerprint_subtitle);
        if (textView != null) {
        ...
        TextView textView2 = (TextView) viewInflate.findViewById(C0178R.id.fingerprint_description);
        if (textView2 != null) {
        ...
        this.mFingerprintIcon = (ImageView) viewInflate.findViewById(C0178R.id.fingerprint_icon);
        this.mHelpMessageView = (TextView) viewInflate.findViewById(C0178R.id.fingerprint_error);
        if (AuthenticatorUtils.isDeviceCredentialAllowed(this.mViewModel.getAllowedAuthenticators())) {
            negativeButtonText = getString(C0178R.string.confirm_device_credential_password);
        } else {
    ...
    public void onResume() {
        ...
        this.mViewModel.setFingerprintDialogHelpMessage(getString(C0178R.string.fingerprint_dialog_touch_sensor));
    }
    ...
    void resetDialog() {
        ...
        if (context == null) {
            ...
            this.mViewModel.setFingerprintDialogState(1);
            this.mViewModel.setFingerprintDialogHelpMessage(context.getString(C0178R.string.fingerprint_dialog_touch_sensor));
        }
    }
    ...
    private Drawable getAssetForTransition(int i, int i2) {
        ...
        if (i == 0 && i2 == 1) {
            i3 = C0178R.drawable.fingerprint_dialog_fp_icon;
        } else if (i == 1 && i2 == 2) {
            i3 = C0178R.drawable.fingerprint_dialog_error;
        } else if (i == 2 && i2 == 1) {
            i3 = C0178R.drawable.fingerprint_dialog_fp_icon;
        } else {
            if (i != 1 || i2 != 3) {
