    ...
    */
    ...
    private static void dumpKeyframes(Object[] objArr, String str) {
        ...
        for (int i = 0; i < length; i++) {
            ...
            Object value = Constants.ATTENDANCE_STATUS_NULL;
            StringBuilder sbAppend2 = sbAppend.append(fraction < 0.0f ? Constants.ATTENDANCE_STATUS_NULL : Float.valueOf(keyframe.getFraction())).append(", , value : ");
