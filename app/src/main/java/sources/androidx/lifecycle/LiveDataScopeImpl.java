...
public final class LiveDataScopeImpl<T> implements LiveDataScope<T> {
    ...
    /* JADX INFO: compiled from: CoroutineLiveData.kt */
    @Metadata(m2721d1 = {"\u0000\f\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\u0010\u0000\u001a\u00020\u0001\"\u0004\b\u0000\u0010\u0002*\u00020\u0003H\u008a@"}, m2722d2 = {"<anonymous>", "Lkotlinx/coroutines/DisposableHandle;", "T", "Lkotlinx/coroutines/CoroutineScope;"}, m2723k = 3, m2724mv = {1, 8, 0}, m2726xi = 48)
    @DebugMetadata(m2734c = "androidx.lifecycle.LiveDataScopeImpl$emitSource$2", m2735f = "CoroutineLiveData.kt", m2736i = {}, m2737l = {94}, m2738m = "invokeSuspend", m2739n = {}, m2740s = {})
    static final class C06572 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super DisposableHandle>, Object> {
        final /* synthetic */ LiveData<T> $source;
        int label;
        final /* synthetic */ LiveDataScopeImpl<T> this$0;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C06572(LiveDataScopeImpl<T> liveDataScopeImpl, LiveData<T> liveData, Continuation<? super C06572> continuation) {
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return new C06572(this.this$0, this.$source, continuation);
        }
    ...
    public Object emitSource(LiveData<T> liveData, Continuation<? super DisposableHandle> continuation) {
        return BuildersKt.withContext(this.coroutineContext, new C06572(this, liveData, null), continuation);
    }
    ...
    @DebugMetadata(m2734c = "androidx.lifecycle.LiveDataScopeImpl$emit$2", m2735f = "CoroutineLiveData.kt", m2736i = {}, m2737l = {99}, m2738m = "invokeSuspend", m2739n = {}, m2740s = {})
    static final class C06562 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        final /* synthetic */ T $value;
        int label;
        final /* synthetic */ LiveDataScopeImpl<T> this$0;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C06562(LiveDataScopeImpl<T> liveDataScopeImpl, T t, Continuation<? super C06562> continuation) {
            super(2, continuation);
            this.this$0 = liveDataScopeImpl;
            this.$value = t;
        }
        ...
        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return new C06562(this.this$0, this.$value, continuation);
        }
    ...
    public Object emit(T t, Continuation<? super Unit> continuation) throws Throwable {
        Object objWithContext = BuildersKt.withContext(this.coroutineContext, new C06562(this, t, null), continuation);
