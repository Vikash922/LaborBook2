...
public final class PausingDispatcherKt {
    ...
    @DebugMetadata(m2734c = "androidx.lifecycle.PausingDispatcherKt$whenStateAtLeast$2", m2735f = "PausingDispatcher.jvm.kt", m2736i = {0}, m2737l = {205}, m2738m = "invokeSuspend", m2739n = {"controller"}, m2740s = {"L$0"})
    static final class C06582<T> extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super T>, Object> {
        ...
        C06582(Lifecycle lifecycle, Lifecycle.State state, Function2<? super CoroutineScope, ? super Continuation<? super T>, ? extends Object> function2, Continuation<? super C06582> continuation) {
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            C06582 c06582 = new C06582(this.$this_whenStateAtLeast, this.$minState, this.$block, continuation);
            c06582.L$0 = obj;
            return c06582;
        }
    ...
    public static final <T> Object whenStateAtLeast(Lifecycle lifecycle, Lifecycle.State state, Function2<? super CoroutineScope, ? super Continuation<? super T>, ? extends Object> function2, Continuation<? super T> continuation) {
        return BuildersKt.withContext(Dispatchers.getMain().getImmediate(), new C06582(lifecycle, state, function2, null), continuation);
    }
}
