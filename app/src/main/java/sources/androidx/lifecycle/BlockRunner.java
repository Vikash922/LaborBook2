...
public final class BlockRunner<T> {
    ...
    public final void maybeRun() {
        ...
        this.runningJob = BuildersKt__Builders_commonKt.launch$default(this.scope, null, null, new C06411(this, null), 3, null);
    }
    ...
    @DebugMetadata(m2734c = "androidx.lifecycle.BlockRunner$maybeRun$1", m2735f = "CoroutineLiveData.kt", m2736i = {}, m2737l = {Opcodes.RETURN}, m2738m = "invokeSuspend", m2739n = {}, m2740s = {})
    static final class C06411 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        C06411(BlockRunner<T> blockRunner, Continuation<? super C06411> continuation) {
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            C06411 c06411 = new C06411(this.this$0, continuation);
            c06411.L$0 = obj;
            return c06411;
        }
    ...
    public final void cancel() {
        if (this.cancellationJob == null) {
            this.cancellationJob = BuildersKt__Builders_commonKt.launch$default(this.scope, Dispatchers.getMain().getImmediate(), null, new C06401(this, null), 2, null);
            return;
        }
    ...
    /* JADX INFO: compiled from: CoroutineLiveData.kt */
    @Metadata(m2721d1 = {"\u0000\f\n\u0000\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\u0010\u0000\u001a\u00020\u0001\"\u0004\b\u0000\u0010\u0002*\u00020\u0003H\u008a@"}, m2722d2 = {"<anonymous>", "", "T", "Lkotlinx/coroutines/CoroutineScope;"}, m2723k = 3, m2724mv = {1, 8, 0}, m2726xi = 48)
    @DebugMetadata(m2734c = "androidx.lifecycle.BlockRunner$cancel$1", m2735f = "CoroutineLiveData.kt", m2736i = {}, m2737l = {188}, m2738m = "invokeSuspend", m2739n = {}, m2740s = {})
    static final class C06401 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        int label;
        final /* synthetic */ BlockRunner<T> this$0;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C06401(BlockRunner<T> blockRunner, Continuation<? super C06401> continuation) {
            super(2, continuation);
            this.this$0 = blockRunner;
        }
        ...
        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return new C06401(this.this$0, continuation);
        }
