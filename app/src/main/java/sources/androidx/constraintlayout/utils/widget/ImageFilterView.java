...
public class ImageFilterView extends AppCompatImageView {
    ...
    static class ImageMatrix {
        ...
        void updateMatrix(ImageView view) {
            ...
            if (f != 1.0f) {
                saturation(f);
                this.mColorMatrix.set(this.f64m);
                z = true;
            } else {
                z = false;
            }
            ...
            if (f3 != 1.0f) {
                warmth(f3);
                this.mTmpColorMatrix.set(this.f64m);
                this.mColorMatrix.postConcat(this.mTmpColorMatrix);
                z = true;
            }
    ...
    private void init(Context context, AttributeSet attrs) {
        if (attrs != null) {
            TypedArray typedArrayObtainStyledAttributes = getContext().obtainStyledAttributes(attrs, C0257R.styleable.ImageFilterView);
            int indexCount = typedArrayObtainStyledAttributes.getIndexCount();
            this.mAltDrawable = typedArrayObtainStyledAttributes.getDrawable(C0257R.styleable.ImageFilterView_altSrc);
            for (int i = 0; i < indexCount; i++) {
                ...
                } else if (index == C0257R.styleable.ImageFilterView_brightness) {
                ...
                } else if (index == C0257R.styleable.ImageFilterView_imagePanX) {
                    setImagePanX(typedArrayObtainStyledAttributes.getFloat(index, this.mPanX));
                } else if (index == C0257R.styleable.ImageFilterView_imagePanY) {
                    setImagePanY(typedArrayObtainStyledAttributes.getFloat(index, this.mPanY));
                } else if (index == C0257R.styleable.ImageFilterView_imageRotate) {
                    setImageRotate(typedArrayObtainStyledAttributes.getFloat(index, this.mRotate));
                } else if (index == C0257R.styleable.ImageFilterView_imageZoom) {
