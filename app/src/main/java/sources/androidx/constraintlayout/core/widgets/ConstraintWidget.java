...
public class ConstraintWidget {
    ...
    private void serializeSize(StringBuilder sb, String str, int i, int i2, int i3, int i4, int i5, int i6, float f, float f2) {
        ...
        serializeAttribute(sb, MediaRuleConstants.MIN, i2, 0);
        serializeAttribute(sb, MediaRuleConstants.MAX, i3, Integer.MAX_VALUE);
    ...
    public StringBuilder serialize(StringBuilder sb) {
        ...
        serializeAnchor(sb, CommonCssConstants.BOTTOM, this.mBottom);
        serializeAnchor(sb, CommonCssConstants.BASELINE, this.mBaseline);
    ...
    public String toString() {
        return (this.mType != null ? "type: " + this.mType + StringUtils.SPACE : "") + (this.mDebugName != null ? "id: " + this.mDebugName + StringUtils.SPACE : "") + "(" + this.f46mX + ", " + this.f47mY + ") - (" + this.mWidth + " x " + this.mHeight + ")";
    }

    public int getX() {
        ConstraintWidget constraintWidget = this.mParent;
        if (constraintWidget != null && (constraintWidget instanceof ConstraintWidgetContainer)) {
            return ((ConstraintWidgetContainer) constraintWidget).mPaddingLeft + this.f46mX;
        }
        return this.f46mX;
    }
    ...
    public int getY() {
        ConstraintWidget constraintWidget = this.mParent;
        if (constraintWidget != null && (constraintWidget instanceof ConstraintWidgetContainer)) {
            return ((ConstraintWidgetContainer) constraintWidget).mPaddingTop + this.f47mY;
        }
        return this.f47mY;
    }
    ...
    public void setGoneMargin(ConstraintAnchor.Type type, int i) {
        int i2 = C02291.f48x6930e354[type.ordinal()];
        if (i2 == 1) {
    ...
    */
    ...
    public ConstraintAnchor getAnchor(ConstraintAnchor.Type type) {
        switch (C02291.f48x6930e354[type.ordinal()]) {
            case 1:
                return this.mLeft;
            case 2:
                return this.mTop;
    ...
    */
    ...
    /* JADX WARN: Removed duplicated region for block: B:322:0x04c9  */
    ...
    */
    ...
    static /* synthetic */ class C02291 {
        ...
        static final /* synthetic */ int[] f49x6d00e4a2;
        ...
        static {
            ...
            try {
                f49x6d00e4a2[DimensionBehaviour.WRAP_CONTENT.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f49x6d00e4a2[DimensionBehaviour.MATCH_PARENT.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f49x6d00e4a2[DimensionBehaviour.MATCH_CONSTRAINT.ordinal()] = 4;
            ...
            try {
                f48x6930e354[ConstraintAnchor.Type.TOP.ordinal()] = 2;
            } catch (NoSuchFieldError unused6) {
            }
            try {
                f48x6930e354[ConstraintAnchor.Type.RIGHT.ordinal()] = 3;
    ...
    public void copy(ConstraintWidget constraintWidget, HashMap<ConstraintWidget, ConstraintWidget> map) {
        ...
        this.f46mX = constraintWidget.f46mX;
        this.f47mY = constraintWidget.f47mY;
    ...
    public void getSceneString(StringBuilder sb) {
        ...
        sb.append(StringUtils.f4768LF);
        sb.append("    actualLeft:" + this.f46mX);
        sb.append(StringUtils.f4768LF);
        sb.append("    actualTop:" + this.f47mY);
        sb.append(StringUtils.f4768LF);
        getSceneString(sb, "left", this.mLeft);
        getSceneString(sb, "top", this.mTop);
        getSceneString(sb, "right", this.mRight);
        getSceneString(sb, CommonCssConstants.BOTTOM, this.mBottom);
        getSceneString(sb, CommonCssConstants.BASELINE, this.mBaseline);
