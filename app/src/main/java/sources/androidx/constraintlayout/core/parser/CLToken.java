...
public class CLToken extends CLElement {
    ...
    public CLToken(char[] cArr) {
        ...
        this.tokenNull = Constants.ATTENDANCE_STATUS_NULL.toCharArray();
    }
    ...
    public boolean validate(char c, long j) {
        int i = C02221.$SwitchMap$androidx$constraintlayout$core$parser$CLToken$Type[this.type.ordinal()];
        if (i == 1) {
