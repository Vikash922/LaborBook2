...
public class SolverVariable implements Comparable<SolverVariable> {
    ...
    private static String getUniqueName(Type type, String str) {
        ...
        int i = C02171.$SwitchMap$androidx$constraintlayout$core$SolverVariable$Type[type.ordinal()];
        if (i == 1) {
        ...
        if (i == 2) {
            StringBuilder sb2 = new StringBuilder(SvgConstants.Attributes.PATH_DATA_CURVE_TO);
    ...
    public int compareTo(SolverVariable solverVariable) {
        return this.f21id - solverVariable.f21id;
    }
