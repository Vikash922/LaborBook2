...
public class Debug {
    public static void logStack(String tag, String msg, int n) {
        ...
        for (int i = 1; i <= iMin; i++) {
            ...
            String str2 = ".(" + stackTrace[i].getFileName() + ":" + stackTrace[i].getLineNumber() + ") " + stackTrace[i].getMethodName();
    ...
    public static void dumpPoc(Object obj) {
        ...
        for (Field field : cls.getFields()) {
            try {
                ...
                if (field.getName().startsWith("layout_constraint") && ((!(obj2 instanceof Integer) || !obj2.toString().equals("-1")) && ((!(obj2 instanceof Integer) || !obj2.toString().equals(AppEventsConstants.EVENT_PARAM_VALUE_NO)) && ((!(obj2 instanceof Float) || !obj2.toString().equals(BuildConfig.VERSION_NAME)) && (!(obj2 instanceof Float) || !obj2.toString().equals(com.truecaller.android.sdk.BuildConfig.TRUESDK_MIN_VERSION)))))) {
