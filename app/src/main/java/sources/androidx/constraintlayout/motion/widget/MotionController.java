...
public class MotionController {
    ...
    public float getStartX() {
        return this.mStartMotionPath.f62x;
    }

    public float getStartY() {
        return this.mStartMotionPath.f63y;
    }

    public float getFinalX() {
        return this.mEndMotionPath.f62x;
    }

    public float getFinalY() {
        return this.mEndMotionPath.f63y;
    }
    ...
    KeyPositionBase getPositionKeyframe(int layoutWidth, int layoutHeight, float x, float y) {
        ...
        rectF.left = this.mStartMotionPath.f62x;
        rectF.top = this.mStartMotionPath.f63y;
        rectF.right = rectF.left + this.mStartMotionPath.width;
        rectF.bottom = rectF.top + this.mStartMotionPath.height;
        RectF rectF2 = new RectF();
        rectF2.left = this.mEndMotionPath.f62x;
        rectF2.top = this.mEndMotionPath.f63y;
    ...
    float getKeyFrameParameter(int type, float x, float y) {
        float f = this.mEndMotionPath.f62x - this.mStartMotionPath.f62x;
        float f2 = this.mEndMotionPath.f63y - this.mStartMotionPath.f63y;
        float f3 = this.mStartMotionPath.f62x + (this.mStartMotionPath.width / 2.0f);
        float f4 = this.mStartMotionPath.f63y + (this.mStartMotionPath.height / 2.0f);
    ...
    public void setup(int parentWidth, int parentHeight, float transitionDuration, long currentTime) {
        ...
        while (true) {
            ...
            while (i15 < i) {
                if (motionPathsArr[i15].hasCustomData(str10)) {
                    ...
                    motionPathsArr[i15].getCustomData(str10, dArr5[i16], 0);
                    i16++;
                } else {
                    dArr = dArr2;
                }
        ...
        if (motionPathsArr[0].mPathMotionArc != Key.UNSET) {
            ...
            for (int i17 = 0; i17 < i; i17++) {
                ...
                dArr7[i17][0] = motionPathsArr[i17].f62x;
                dArr7[i17][1] = motionPathsArr[i17].f63y;
            }
    ...
    public String toString() {
        return " start: x: " + this.mStartMotionPath.f62x + " y: " + this.mStartMotionPath.f63y + " end: x: " + this.mEndMotionPath.f62x + " y: " + this.mEndMotionPath.f63y;
    }
    ...
    boolean interpolate(View child, float global_position, long time, KeyCache keyCache) {
        ...
        if (curveFitArr != null) {
            ...
            i = 1;
            float f4 = this.mStartMotionPath.f62x + ((this.mEndMotionPath.f62x - this.mStartMotionPath.f62x) * f3);
            float f5 = f4 + 0.5f;
            int i4 = (int) f5;
            float f6 = this.mStartMotionPath.f63y + ((this.mEndMotionPath.f63y - this.mStartMotionPath.f63y) * f3) + 0.5f;
            int i5 = (int) f6;
    ...
    void getDpDt(float position, float locationX, float locationY, float[] mAnchorDpDt) {
        ...
        float f2 = this.mEndMotionPath.f62x - this.mStartMotionPath.f62x;
        float f3 = this.mEndMotionPath.f63y - this.mStartMotionPath.f63y;
