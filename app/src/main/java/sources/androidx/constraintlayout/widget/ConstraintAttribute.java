...
public class ConstraintAttribute {
    ...
    public boolean isContinuous() {
        int i = C02551.f65x66adad53[this.mType.ordinal()];
    ...
    public void setValue(float[] value) {
        switch (C02551.f65x66adad53[this.mType.ordinal()]) {
            case 1:
            case 6:
    ...
    public static void setAttributes(View view, HashMap<String, ConstraintAttribute> map) {
        ...
        for (String str : map.keySet()) {
            ...
            String str2 = !constraintAttribute.mMethod ? SvgConstants.Tags.SET + str : str;
            try {
                switch (C02551.f65x66adad53[constraintAttribute.mType.ordinal()]) {
                    case 1:
    ...
    public void applyCustom(View view) {
        ...
        String str2 = !this.mMethod ? SvgConstants.Tags.SET + str : str;
        try {
            switch (C02551.f65x66adad53[this.mType.ordinal()]) {
                case 1:
                case 6:
    ...
    public static void parse(Context context, XmlPullParser parser, HashMap<String, ConstraintAttribute> custom) {
        ...
        Object objValueOf;
        TypedArray typedArrayObtainStyledAttributes = context.obtainStyledAttributes(Xml.asAttributeSet(parser), C0257R.styleable.CustomAttribute);
        ...
        for (int i = 0; i < indexCount; i++) {
            ...
            if (index == C0257R.styleable.CustomAttribute_attributeName) {
            ...
            } else if (index == C0257R.styleable.CustomAttribute_methodName) {
                string = typedArrayObtainStyledAttributes.getString(index);
                z = true;
                ...
                } else if (index == C0257R.styleable.CustomAttribute_customReference) {
