    ...
    */
    private void load(android.content.Context r9, org.xmlpull.v1.XmlPullParser r10) {
        /*
            ...
            int[] r1 = androidx.constraintlayout.widget.C0257R.styleable.StateSet
        ...
        L10:
            ...
            int r5 = androidx.constraintlayout.widget.C0257R.styleable.StateSet_defaultState
            if (r4 != r5) goto L22
    ...
    static class State {
        ...
        public State(Context context, XmlPullParser parser) {
            ...
            TypedArray typedArrayObtainStyledAttributes = context.obtainStyledAttributes(Xml.asAttributeSet(parser), C0257R.styleable.State);
    ...
    static class Variant {
        ...
        public Variant(Context context, XmlPullParser parser) {
            ...
            this.mConstraintID = -1;
            this.mIsLayout = false;
            TypedArray typedArrayObtainStyledAttributes = context.obtainStyledAttributes(Xml.asAttributeSet(parser), C0257R.styleable.Variant);
            int indexCount = typedArrayObtainStyledAttributes.getIndexCount();
            for (int i = 0; i < indexCount; i++) {
                int index = typedArrayObtainStyledAttributes.getIndex(i);
