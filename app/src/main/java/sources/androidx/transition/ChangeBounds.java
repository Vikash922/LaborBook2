...
public class ChangeBounds extends Transition {
    ...
    private static final Property<View, PointF> POSITION_PROPERTY = new Property<View, PointF>(PointF.class, CommonCssConstants.POSITION) { // from class: androidx.transition.ChangeBounds.5
    ...
    public void captureStartValues(TransitionValues transitionValues) {
        ...
        if (!this.mResizeClip || (rect = (Rect) transitionValues.view.getTag(C0874R.id.transition_clip)) == null) {
            return;
        }
    ...
    /* JADX WARN: Type update failed for variable: r4v3 ??, new type: android.view.View
    jadx.core.utils.exceptions.JadxOverflowException: Type inference error: updates count limit reached with updateSeq = 4821. Try increasing type updates limit count.
    ...
    private static class ClipListener extends AnimatorListenerAdapter implements Transition.TransitionListener {
        ...
        public void onTransitionPause(Transition transition) {
            this.mView.setTag(C0874R.id.transition_clip, this.mView.getClipBounds());
            this.mView.setClipBounds(this.mEndClipIsNull ? null : this.mEndClip);
        }

        @Override // androidx.transition.Transition.TransitionListener
        public void onTransitionResume(Transition transition) {
            Rect rect = (Rect) this.mView.getTag(C0874R.id.transition_clip);
            this.mView.setTag(C0874R.id.transition_clip, null);
            this.mView.setClipBounds(rect);
        }
    }
