...
public class TransitionSet extends Transition {
    ...
    */
    ...
    String toString(String str) {
        ...
        for (int i = 0; i < this.mTransitions.size(); i++) {
            string = string + StringUtils.f4768LF + this.mTransitions.get(i).toString(str + "  ");
        }
        return string;
    }
    ...
    public Transition mo2994clone() {
        TransitionSet transitionSet = (TransitionSet) super.mo2994clone();
        transitionSet.mTransitions = new ArrayList<>();
        int size = this.mTransitions.size();
        for (int i = 0; i < size; i++) {
            transitionSet.addTransitionInternal(this.mTransitions.get(i).mo2994clone());
        }
