...
public final class SharedPreferencesMigration<T> implements DataMigration<T> {
    ...
    @DebugMetadata(m2734c = "androidx.datastore.migrations.SharedPreferencesMigration", m2735f = "SharedPreferencesMigration.android.kt", m2736i = {0}, m2737l = {Opcodes.DCMPL}, m2738m = "shouldMigrate", m2739n = {"this"}, m2740s = {"L$0"})
    static final class C04291 extends ContinuationImpl {
        ...
        C04291(SharedPreferencesMigration<T> sharedPreferencesMigration, Continuation<? super C04291> continuation) {
            super(continuation);
    ...
    /* JADX INFO: compiled from: SharedPreferencesMigration.android.kt */
    @Metadata(m2721d1 = {"\u0000\n\n\u0000\n\u0002\u0010\u000b\n\u0002\b\u0002\u0010\u0000\u001a\u00020\u0001\"\u0004\b\u0000\u0010\u00022\u0006\u0010\u0003\u001a\u0002H\u0002H\u008a@"}, m2722d2 = {"<anonymous>", "", "T", "it"}, m2723k = 3, m2724mv = {1, 8, 0}, m2726xi = 48)
    @DebugMetadata(m2734c = "androidx.datastore.migrations.SharedPreferencesMigration$1", m2735f = "SharedPreferencesMigration.android.kt", m2736i = {}, m2737l = {}, m2738m = "invokeSuspend", m2739n = {}, m2740s = {})
    static final class C04251 extends SuspendLambda implements Function2<T, Continuation<? super Boolean>, Object> {
        int label;
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return new C04251(continuation);
        }

        @Override // kotlin.jvm.functions.Function2
        public final Object invoke(T t, Continuation<? super Boolean> continuation) {
            return ((C04251) create(t, continuation)).invokeSuspend(Unit.INSTANCE);
        }
    ...
    /* synthetic */ SharedPreferencesMigration(Function0 function0, Set set, C04251 c04251, Function3 function3, Context context, String str, int i, DefaultConstructorMarker defaultConstructorMarker) {
        this((Function0<? extends SharedPreferences>) function0, (Set<String>) set, (i & 4) != 0 ? new C04251(null) : c04251, function3, context, str);
    }
    ...
    /* JADX INFO: compiled from: SharedPreferencesMigration.android.kt */
    @Metadata(m2721d1 = {"\u0000\n\n\u0000\n\u0002\u0010\u000b\n\u0002\b\u0002\u0010\u0000\u001a\u00020\u0001\"\u0004\b\u0000\u0010\u00022\u0006\u0010\u0003\u001a\u0002H\u0002H\u008a@"}, m2722d2 = {"<anonymous>", "", "T", "it"}, m2723k = 3, m2724mv = {1, 8, 0}, m2726xi = 48)
    @DebugMetadata(m2734c = "androidx.datastore.migrations.SharedPreferencesMigration$2", m2735f = "SharedPreferencesMigration.android.kt", m2736i = {}, m2737l = {}, m2738m = "invokeSuspend", m2739n = {}, m2740s = {})
    public static final class C04262 extends SuspendLambda implements Function2<T, Continuation<? super Boolean>, Object> {
        int label;

        C04262(Continuation<? super C04262> continuation) {
            super(2, continuation);
        }

        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return new C04262(continuation);
        }

        @Override // kotlin.jvm.functions.Function2
        public final Object invoke(T t, Continuation<? super Boolean> continuation) {
            return ((C04262) create(t, continuation)).invokeSuspend(Unit.INSTANCE);
        }
    ...
    public /* synthetic */ SharedPreferencesMigration(Function0 function0, Set set, C04262 c04262, Function3 function3, int i, DefaultConstructorMarker defaultConstructorMarker) {
        this((Function0<? extends SharedPreferences>) function0, (Set<String>) ((i & 2) != 0 ? SharedPreferencesMigration_androidKt.getMIGRATE_ALL_KEYS() : set), (i & 4) != 0 ? new C04262(null) : c04262, function3);
    }
    ...
    /* JADX INFO: compiled from: SharedPreferencesMigration.android.kt */
    @Metadata(m2721d1 = {"\u0000\n\n\u0000\n\u0002\u0010\u000b\n\u0002\b\u0002\u0010\u0000\u001a\u00020\u0001\"\u0004\b\u0000\u0010\u00022\u0006\u0010\u0003\u001a\u0002H\u0002H\u008a@"}, m2722d2 = {"<anonymous>", "", "T", "it"}, m2723k = 3, m2724mv = {1, 8, 0}, m2726xi = 48)
    @DebugMetadata(m2734c = "androidx.datastore.migrations.SharedPreferencesMigration$3", m2735f = "SharedPreferencesMigration.android.kt", m2736i = {}, m2737l = {}, m2738m = "invokeSuspend", m2739n = {}, m2740s = {})
    public static final class C04273 extends SuspendLambda implements Function2<T, Continuation<? super Boolean>, Object> {
        int label;

        C04273(Continuation<? super C04273> continuation) {
            super(2, continuation);
        }

        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return new C04273(continuation);
        }

        @Override // kotlin.jvm.functions.Function2
        public final Object invoke(T t, Continuation<? super Boolean> continuation) {
            return ((C04273) create(t, continuation)).invokeSuspend(Unit.INSTANCE);
        }
    ...
    public /* synthetic */ SharedPreferencesMigration(Context context, String str, Set set, C04273 c04273, Function3 function3, int i, DefaultConstructorMarker defaultConstructorMarker) {
        this(context, str, (i & 4) != 0 ? SharedPreferencesMigration_androidKt.getMIGRATE_ALL_KEYS() : set, (i & 8) != 0 ? new C04273(null) : c04273, function3);
    }
    ...
    */
    public java.lang.Object shouldMigrate(T r5, kotlin.coroutines.Continuation<? super java.lang.Boolean> r6) {
        /*
            r4 = this;
            boolean r0 = r6 instanceof androidx.datastore.migrations.SharedPreferencesMigration.C04291
            if (r0 == 0) goto L14
            r0 = r6
            androidx.datastore.migrations.SharedPreferencesMigration$shouldMigrate$1 r0 = (androidx.datastore.migrations.SharedPreferencesMigration.C04291) r0
            int r1 = r0.label
    ...
    /* JADX INFO: compiled from: SharedPreferencesMigration.android.kt */
    @Metadata(m2721d1 = {"\u0000\u001e\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0010\u000b\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u000e\n\u0000\bÃ\u0002\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002J\u0018\u0010\u0003\u001a\u00020\u00042\u0006\u0010\u0005\u001a\u00020\u00062\u0006\u0010\u0007\u001a\u00020\bH\u0007¨\u0006\t"}, m2722d2 = {"Landroidx/datastore/migrations/SharedPreferencesMigration$Api24Impl;", "", "()V", "deleteSharedPreferences", "", "context", "Landroid/content/Context;", "name", "", "datastore_release"}, m2723k = 1, m2724mv = {1, 8, 0}, m2726xi = 48)
