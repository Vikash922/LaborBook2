...
public final class SingleProcessCoordinator implements InterProcessCoordinator {
    ...
    @DebugMetadata(m2734c = "androidx.datastore.core.SingleProcessCoordinator", m2735f = "SingleProcessCoordinator.kt", m2736i = {0, 0, 1}, m2737l = {66, 41}, m2738m = "lock", m2739n = {"block", "$this$withLock_u24default$iv", "$this$withLock_u24default$iv"}, m2740s = {"L$0", "L$1", "L$0"})
    static final class C04131<T> extends ContinuationImpl {
        Object L$0;
        Object L$1;
        int label;
    ...
    /* JADX INFO: compiled from: SingleProcessCoordinator.kt */
    @Metadata(m2723k = 3, m2724mv = {1, 8, 0}, m2726xi = 48)
    @DebugMetadata(m2734c = "androidx.datastore.core.SingleProcessCoordinator", m2735f = "SingleProcessCoordinator.kt", m2736i = {0, 0}, m2737l = {50}, m2738m = "tryLock", m2739n = {"$this$withTryLock_u24default$iv", "locked$iv"}, m2740s = {"L$0", "Z$0"})
    static final class C04141<T> extends ContinuationImpl {
        Object L$0;
        boolean Z$0;
        int label;
        /* synthetic */ Object result;

        C04141(Continuation<? super C04141> continuation) {
            super(continuation);
        }
    ...
    */
    public <T> java.lang.Object lock(kotlin.jvm.functions.Function1<? super kotlin.coroutines.Continuation<? super T>, ? extends java.lang.Object> r8, kotlin.coroutines.Continuation<? super T> r9) throws java.lang.Throwable {
        /*
            r7 = this;
            boolean r0 = r9 instanceof androidx.datastore.core.SingleProcessCoordinator.C04131
            if (r0 == 0) goto L14
            r0 = r9
            androidx.datastore.core.SingleProcessCoordinator$lock$1 r0 = (androidx.datastore.core.SingleProcessCoordinator.C04131) r0
            int r1 = r0.label
    ...
    */
    public <T> java.lang.Object tryLock(kotlin.jvm.functions.Function2<? super java.lang.Boolean, ? super kotlin.coroutines.Continuation<? super T>, ? extends java.lang.Object> r7, kotlin.coroutines.Continuation<? super T> r8) throws java.lang.Throwable {
        /*
            r6 = this;
            boolean r0 = r8 instanceof androidx.datastore.core.SingleProcessCoordinator.C04141
            if (r0 == 0) goto L14
            r0 = r8
            androidx.datastore.core.SingleProcessCoordinator$tryLock$1 r0 = (androidx.datastore.core.SingleProcessCoordinator.C04141) r0
            int r1 = r0.label
            r2 = -2147483648(0xffffffff80000000, float:-0.0)
            r1 = r1 & r2
            if (r1 == 0) goto L14
