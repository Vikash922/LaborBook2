...
@DebugMetadata(m2734c = "androidx.datastore.core.DataStoreImpl$InitDataStore$doRun$initData$1$api$1", m2735f = "DataStoreImpl.kt", m2736i = {0, 0, 1, 2, 2}, m2737l = {MetaDo.META_FILLREGION, 455, 457}, m2738m = "updateData", m2739n = {"transform", "$this$withLock_u24default$iv", "$this$withLock_u24default$iv", "$this$withLock_u24default$iv", "newData"}, m2740s = {"L$0", "L$1", "L$0", "L$0", "L$2"})
