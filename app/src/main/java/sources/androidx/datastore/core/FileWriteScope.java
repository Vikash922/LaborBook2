...
public final class FileWriteScope<T> extends FileReadScope<T> implements WriteScope<T> {
    ...
    @DebugMetadata(m2734c = "androidx.datastore.core.FileWriteScope", m2735f = "FileStorage.kt", m2736i = {0}, m2737l = {200}, m2738m = "writeData", m2739n = {"stream"}, m2740s = {"L$1"})
    static final class C04001 extends ContinuationImpl {
        ...
        C04001(FileWriteScope<T> fileWriteScope, Continuation<? super C04001> continuation) {
            super(continuation);
    ...
    */
    public java.lang.Object writeData(T r7, kotlin.coroutines.Continuation<? super kotlin.Unit> r8) {
        /*
            r6 = this;
            boolean r0 = r8 instanceof androidx.datastore.core.FileWriteScope.C04001
            if (r0 == 0) goto L14
            r0 = r8
            androidx.datastore.core.FileWriteScope$writeData$1 r0 = (androidx.datastore.core.FileWriteScope.C04001) r0
            int r1 = r0.label
        ...
        L6a:
            ...
            r7 = 0
            kotlin.p024io.CloseableKt.closeFinally(r0, r7)
