...
public final class KotlinExtensions {
    ...
    @DebugMetadata(m2734c = "retrofit2.KotlinExtensions", m2735f = "KotlinExtensions.kt", m2736i = {0}, m2737l = {119}, m2738m = "suspendAndThrow", m2739n = {"$this$suspendAndThrow"}, m2740s = {"L$0"})
    static final class C49161 extends ContinuationImpl {
        Object L$0;
        int label;
        /* synthetic */ Object result;

        C49161(Continuation<? super C49161> continuation) {
            super(continuation);
        }
    ...
    */
    public static final java.lang.Object suspendAndThrow(final java.lang.Throwable r4, kotlin.coroutines.Continuation<?> r5) {
        /*
            boolean r0 = r5 instanceof retrofit2.KotlinExtensions.C49161
            if (r0 == 0) goto L14
            r0 = r5
            retrofit2.KotlinExtensions$suspendAndThrow$1 r0 = (retrofit2.KotlinExtensions.C49161) r0
            int r1 = r0.label
            ...
            public void onResponse(Call<T> call2, Response<T> response) {
                ...
                if (response.isSuccessful()) {
                    ...
                    if (tBody == null) {
                        ...
                        KotlinNullPointerException kotlinNullPointerException = new KotlinNullPointerException("Response from " + invocation.service().getName() + ClassUtils.PACKAGE_SEPARATOR_CHAR + invocation.method().getName() + " was null but response body type was declared as non-null");
                        CancellableContinuation<T> cancellableContinuation = cancellableContinuationImpl2;
                        Result.Companion companion = Result.INSTANCE;
                        cancellableContinuation.resumeWith(Result.m3325constructorimpl(ResultKt.createFailure(kotlinNullPointerException)));
                        return;
                    }
                    CancellableContinuation<T> cancellableContinuation2 = cancellableContinuationImpl2;
                    Result.Companion companion2 = Result.INSTANCE;
                    cancellableContinuation2.resumeWith(Result.m3325constructorimpl(tBody));
                    return;
                }
                CancellableContinuation<T> cancellableContinuation3 = cancellableContinuationImpl2;
                Result.Companion companion3 = Result.INSTANCE;
                cancellableContinuation3.resumeWith(Result.m3325constructorimpl(ResultKt.createFailure(new HttpException(response))));
            }
        ...
        call.enqueue(new Callback<T>() { // from class: retrofit2.KotlinExtensions$await$4$2
            ...
            public void onResponse(Call<T> call2, Response<T> response) {
                ...
                if (response.isSuccessful()) {
                    CancellableContinuation<T> cancellableContinuation = cancellableContinuationImpl2;
                    Result.Companion companion = Result.INSTANCE;
                    cancellableContinuation.resumeWith(Result.m3325constructorimpl(response.body()));
                } else {
                    CancellableContinuation<T> cancellableContinuation2 = cancellableContinuationImpl2;
                    Result.Companion companion2 = Result.INSTANCE;
                    cancellableContinuation2.resumeWith(Result.m3325constructorimpl(ResultKt.createFailure(new HttpException(response))));
                }
            }
    ...
    public static final <T> Object awaitResponse(final Call<T> call, Continuation<? super Response<T>> continuation) {
        ...
        call.enqueue(new Callback<T>() { // from class: retrofit2.KotlinExtensions$awaitResponse$2$2
            ...
            public void onResponse(Call<T> call2, Response<T> response) {
                ...
                Result.Companion companion = Result.INSTANCE;
                cancellableContinuation.resumeWith(Result.m3325constructorimpl(response));
            }
