...
final class ScalarXMapZHelper {
    ...
    static <T> boolean tryAsCompletable(Object obj, Function<? super T, ? extends CompletableSource> function, CompletableObserver completableObserver) {
        ...
        try {
            ...
            CompletableSource completableSource = permission_groupVar != null ? (CompletableSource) ObjectHelper.requireNonNull(function.apply(permission_groupVar), "The mapper returned a null CompletableSource") : null;
    ...
    static <T, R> boolean tryAsMaybe(Object obj, Function<? super T, ? extends MaybeSource<? extends R>> function, Observer<? super R> observer) {
        ...
        try {
            Manifest.permission_group permission_groupVar = (Object) ((Callable) obj).call();
            MaybeSource maybeSource = permission_groupVar != null ? (MaybeSource) ObjectHelper.requireNonNull(function.apply(permission_groupVar), "The mapper returned a null MaybeSource") : null;
            if (maybeSource == null) {
    ...
    static <T, R> boolean tryAsSingle(Object obj, Function<? super T, ? extends SingleSource<? extends R>> function, Observer<? super R> observer) {
        ...
        try {
            Manifest.permission_group permission_groupVar = (Object) ((Callable) obj).call();
            SingleSource singleSource = permission_groupVar != null ? (SingleSource) ObjectHelper.requireNonNull(function.apply(permission_groupVar), "The mapper returned a null SingleSource") : null;
