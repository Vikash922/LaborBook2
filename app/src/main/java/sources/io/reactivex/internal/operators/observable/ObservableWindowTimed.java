...
public final class ObservableWindowTimed<T> extends AbstractObservableWithUpstream<T, Observable<T>> {
                ...
                if (z2) {
                    ...
                    if (j >= this.maxSize) {
                        ...
                        if (this.restartTimerOnMaxSize) {
                            ...
                            if (!LifecycleKt$$ExternalSyntheticBackportWithForwarding0.m60m(this.timer, disposable, disposableSchedulePeriodically)) {
    ...
    static final class WindowSkipObserver<T> extends QueueDrainObserver<T, Object, Observable<T>> implements Disposable, Runnable {
            ...
            while (!this.terminated) {
                ...
                if (z2) {
                    ...
                    if (subjectWork.open) {
                        ...
                        list.remove(subjectWork.f3596w);
                        subjectWork.f3596w.onComplete();
        ...
        static final class SubjectWork<T> {
            ...
            final UnicastSubject<T> f3596w;

            SubjectWork(UnicastSubject<T> unicastSubject, boolean z) {
                this.f3596w = unicastSubject;
                this.open = z;
            }
        }
        ...
        final class CompletionTask implements Runnable {
            ...
            /* JADX INFO: renamed from: w */
            private final UnicastSubject<T> f3595w;

            CompletionTask(UnicastSubject<T> unicastSubject) {
                this.f3595w = unicastSubject;
            }

            @Override // java.lang.Runnable
            public void run() {
                WindowSkipObserver.this.complete(this.f3595w);
            }
        }
    }
}
