...
.method static constructor <clinit>()V
    ...
    const-string v2, "CLOSED_LINE"

    const/4 v3, 0x1

    invoke-direct {v1, v2, v3}, Lcom/itextpdf/kernel/pdf/canvas/parser/clipper/IClipper$EndType;-><init>(Ljava/lang/String;I)V
    ...
    new-instance v2, Lcom/itextpdf/kernel/pdf/canvas/parser/clipper/IClipper$EndType;

    const-string v3, "OPEN_BUTT"

    const/4 v4, 0x2

    invoke-direct {v2, v3, v4}, Lcom/itextpdf/kernel/pdf/canvas/parser/clipper/IClipper$EndType;-><init>(Ljava/lang/String;I)V

    sput-object v2, Lcom/itextpdf/kernel/pdf/canvas/parser/clipper/IClipper$EndType;->OPEN_BUTT:Lcom/itextpdf/kernel/pdf/canvas/parser/clipper/IClipper$EndType;

    new-instance v3, Lcom/itextpdf/kernel/pdf/canvas/parser/clipper/IClipper$EndType;

    const-string v4, "OPEN_SQUARE"

    const/4 v5, 0x3

    invoke-direct {v3, v4, v5}, Lcom/itextpdf/kernel/pdf/canvas/parser/clipper/IClipper$EndType;-><init>(Ljava/lang/String;I)V

    sput-object v3, Lcom/itextpdf/kernel/pdf/canvas/parser/clipper/IClipper$EndType;->OPEN_SQUARE:Lcom/itextpdf/kernel/pdf/canvas/parser/clipper/IClipper$EndType;

    new-instance v4, Lcom/itextpdf/kernel/pdf/canvas/parser/clipper/IClipper$EndType;

    const-string v5, "OPEN_ROUND"

    const/4 v6, 0x4

    invoke-direct {v4, v5, v6}, Lcom/itextpdf/kernel/pdf/canvas/parser/clipper/IClipper$EndType;-><init>(Ljava/lang/String;I)V

    sput-object v4, Lcom/itextpdf/kernel/pdf/canvas/parser/clipper/IClipper$EndType;->OPEN_ROUND:Lcom/itextpdf/kernel/pdf/canvas/parser/clipper/IClipper$EndType;
...
.method public static valueOf(Ljava/lang/String;)Lcom/itextpdf/kernel/pdf/canvas/parser/clipper/IClipper$EndType;
    ...
    check-cast p0, Lcom/itextpdf/kernel/pdf/canvas/parser/clipper/IClipper$EndType;
