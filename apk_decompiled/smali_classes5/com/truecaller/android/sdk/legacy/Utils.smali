.class public Lcom/truecaller/android/sdk/legacy/Utils;
...
.field static final PARTNER_KEY_PROPERTY:Ljava/lang/String; = "com.truecaller.android.sdk.PartnerKey"
...
.method public static getApplicationSignature(Landroid/content/Context;)Ljava/lang/String;
    ...
    .line 82
    invoke-static {p0, v0, v1}, Lcom/truecaller/android/sdk/legacy/Utils;->getPackageInfo(Landroid/content/Context;Ljava/lang/String;I)Landroid/content/pm/PackageInfo;
    ...
    invoke-static {p0}, Lcom/truecaller/android/sdk/legacy/Utils;->getSha1hash([B)Ljava/lang/String;
...
.method static getSha1hash([B)Ljava/lang/String;
    ...
    invoke-static {v0, p0}, Lcom/truecaller/android/sdk/legacy/Utils;->hashWithAlgorithm(Ljava/lang/String;[B)Ljava/lang/String;
...
.method private static hashWithAlgorithm(Ljava/lang/String;[B)Ljava/lang/String;
    ...
    .line 116
    invoke-static {p0, p1}, Lcom/truecaller/android/sdk/legacy/Utils;->hashBytes(Ljava/security/MessageDigest;[B)Ljava/lang/String;
...
.method public static parseError(Lokhttp3/ResponseBody;)Lcom/truecaller/android/sdk/common/ErrorResponse;
    .locals 3

    .line 193
    new-instance v0, Lcom/truecaller/android/sdk/common/ErrorResponse;

    invoke-direct {v0}, Lcom/truecaller/android/sdk/common/ErrorResponse;-><init>()V
    ...
    const-class v2, Lcom/truecaller/android/sdk/common/ErrorResponse;

    invoke-virtual {v1, p0, v2}, Lcom/google/gson/Gson;->fromJson(Ljava/io/Reader;Ljava/lang/Class;)Ljava/lang/Object;

    move-result-object p0

    check-cast p0, Lcom/truecaller/android/sdk/common/ErrorResponse;
    :try_end_0
    ...
    .line 196
    :try_start_1
    invoke-virtual {p0}, Lcom/truecaller/android/sdk/common/ErrorResponse;->getMessage()Ljava/lang/String;
