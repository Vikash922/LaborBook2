...
public final class StackTraceRecoveryKt {
    ...
    static {
        ...
        try {
            ...
            objM3325constructorimpl = Result.m3325constructorimpl(Class.forName(baseContinuationImplClass).getCanonicalName());
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            objM3325constructorimpl = Result.m3325constructorimpl(ResultKt.createFailure(th));
        }
        if (Result.m3328exceptionOrNullimpl(objM3325constructorimpl) == null) {
            obj2 = objM3325constructorimpl;
        }
        baseContinuationImplClassName = (String) obj2;
        try {
            Result.Companion companion3 = Result.INSTANCE;
            objM3325constructorimpl2 = Result.m3325constructorimpl(Class.forName(stackTraceRecoveryClass).getCanonicalName());
        } catch (Throwable th2) {
            Result.Companion companion4 = Result.INSTANCE;
            objM3325constructorimpl2 = Result.m3325constructorimpl(ResultKt.createFailure(th2));
        }
        if (Result.m3328exceptionOrNullimpl(objM3325constructorimpl2) == null) {
            obj = objM3325constructorimpl2;
        }
        ...
        if (cause != null && Intrinsics.areEqual(cause.getClass(), e.getClass())) {
            ...
            for (StackTraceElement stackTraceElement : stackTrace) {
                if (isArtificial(stackTraceElement)) {
                    return TuplesKt.m2729to(cause, stackTrace);
                }
            }
            return TuplesKt.m2729to(e, new StackTraceElement[0]);
        }
        return TuplesKt.m2729to(e, new StackTraceElement[0]);
    }
