...
public final class RxAwaitKt {
    ...
    /* JADX INFO: renamed from: kotlinx.coroutines.rx3.RxAwaitKt$awaitOrDefault$1 */
    /* JADX INFO: compiled from: RxAwait.kt */
    @Metadata(m2723k = 3, m2724mv = {1, 9, 0}, m2726xi = 48)
    @DebugMetadata(m2734c = "kotlinx.coroutines.rx3.RxAwaitKt", m2735f = "RxAwait.kt", m2736i = {0}, m2737l = {105}, m2738m = "awaitOrDefault", m2739n = {"default"}, m2740s = {"L$0"})
    static final class C42991<T> extends ContinuationImpl {
        Object L$0;
        int label;
        /* synthetic */ Object result;
    ...
    /* JADX INFO: renamed from: kotlinx.coroutines.rx3.RxAwaitKt$awaitSingle$1 */
    /* JADX INFO: compiled from: RxAwait.kt */
    @Metadata(m2723k = 3, m2724mv = {1, 9, 0}, m2726xi = 48)
    @DebugMetadata(m2734c = "kotlinx.coroutines.rx3.RxAwaitKt", m2735f = "RxAwait.kt", m2736i = {}, m2737l = {59}, m2738m = "awaitSingle", m2739n = {}, m2740s = {})
    static final class C43001<T> extends ContinuationImpl {
        int label;
        /* synthetic */ Object result;

        C43001(Continuation<? super C43001> continuation) {
            super(continuation);
        }
    ...
    */
    public static final <T> java.lang.Object awaitSingle(io.reactivex.rxjava3.core.MaybeSource<T> r4, kotlin.coroutines.Continuation<? super T> r5) {
        /*
            boolean r0 = r5 instanceof kotlinx.coroutines.rx3.RxAwaitKt.C43001
            if (r0 == 0) goto L14
            r0 = r5
            kotlinx.coroutines.rx3.RxAwaitKt$awaitSingle$1 r0 = (kotlinx.coroutines.rx3.RxAwaitKt.C43001) r0
            int r1 = r0.label
    ...
    */
    public static final /* synthetic */ java.lang.Object awaitOrDefault(io.reactivex.rxjava3.core.MaybeSource r4, java.lang.Object r5, kotlin.coroutines.Continuation r6) {
        /*
            boolean r0 = r6 instanceof kotlinx.coroutines.rx3.RxAwaitKt.C42991
            if (r0 == 0) goto L14
            r0 = r6
            kotlinx.coroutines.rx3.RxAwaitKt$awaitOrDefault$1 r0 = (kotlinx.coroutines.rx3.RxAwaitKt.C42991) r0
            int r1 = r0.label
            r2 = -2147483648(0xffffffff80000000, float:-0.0)
            r1 = r1 & r2
            if (r1 == 0) goto L14
    ...
    */
    public static final <T> java.lang.Object awaitFirstOrElse(io.reactivex.rxjava3.core.ObservableSource<T> r7, kotlin.jvm.functions.Function0<? extends T> r8, kotlin.coroutines.Continuation<? super T> r9) {
        /*
            boolean r0 = r9 instanceof kotlinx.coroutines.rx3.RxAwaitKt.C42981
            if (r0 == 0) goto L14
            r0 = r9
            kotlinx.coroutines.rx3.RxAwaitKt$awaitFirstOrElse$1 r0 = (kotlinx.coroutines.rx3.RxAwaitKt.C42981) r0
            int r1 = r0.label
            r2 = -2147483648(0xffffffff80000000, float:-0.0)
            r1 = r1 & r2
            if (r1 == 0) goto L14
    ...
    public static final Object await(CompletableSource completableSource, Continuation<? super Unit> continuation) {
        ...
        completableSource.subscribe(new CompletableObserver() { // from class: kotlinx.coroutines.rx3.RxAwaitKt$await$2$1
            ...
            public void onComplete() {
                ...
                cancellableContinuation.resumeWith(Result.m3325constructorimpl(Unit.INSTANCE));
            }
            ...
            public void onError(Throwable e) {
                CancellableContinuation<Unit> cancellableContinuation = cancellableContinuationImpl2;
                Result.Companion companion = Result.INSTANCE;
                cancellableContinuation.resumeWith(Result.m3325constructorimpl(ResultKt.createFailure(e)));
            }
        });
    ...
    public static final <T> Object awaitSingleOrNull(MaybeSource<T> maybeSource, Continuation<? super T> continuation) {
        ...
        maybeSource.subscribe(new MaybeObserver<T>() { // from class: kotlinx.coroutines.rx3.RxAwaitKt$awaitSingleOrNull$2$1
            ...
            public void onComplete() {
                ...
                Result.Companion companion = Result.INSTANCE;
                cancellableContinuation.resumeWith(Result.m3325constructorimpl(null));
            }
            ...
            public void onSuccess(T t) {
                CancellableContinuation<T> cancellableContinuation = cancellableContinuationImpl2;
                Result.Companion companion = Result.INSTANCE;
                cancellableContinuation.resumeWith(Result.m3325constructorimpl(t));
            }
            ...
            public void onError(Throwable error) {
                CancellableContinuation<T> cancellableContinuation = cancellableContinuationImpl2;
                Result.Companion companion = Result.INSTANCE;
                cancellableContinuation.resumeWith(Result.m3325constructorimpl(ResultKt.createFailure(error)));
            }
        });
        Object result = cancellableContinuationImpl.getResult();
        if (result == IntrinsicsKt.getCOROUTINE_SUSPENDED()) {
        ...
        observableSource.subscribe(new Observer<T>() { // from class: kotlinx.coroutines.rx3.RxAwaitKt$awaitOne$2$1
            ...
            public void onNext(T t2) {
                ...
                if (i == 1 || i == 2) {
                    ...
                    CancellableContinuation<T> cancellableContinuation = cancellableContinuationImpl2;
                    Result.Companion companion = Result.INSTANCE;
                    cancellableContinuation.resumeWith(Result.m3325constructorimpl(t2));
                ...
                if (i == 3 || i == 4) {
                    if (mode == Mode.SINGLE && this.seenValue) {
                        if (cancellableContinuationImpl2.isActive()) {
                            ...
                            cancellableContinuation2.resumeWith(Result.m3325constructorimpl(ResultKt.createFailure(new IllegalArgumentException("More than one onNext value for " + mode))));
                        }
            ...
            public void onComplete() {
                if (this.seenValue) {
                    if (cancellableContinuationImpl2.isActive()) {
                        CancellableContinuation<T> cancellableContinuation = cancellableContinuationImpl2;
                        Result.Companion companion = Result.INSTANCE;
                        cancellableContinuation.resumeWith(Result.m3325constructorimpl(this.value));
                        return;
                    }
                    return;
                }
                if (mode == Mode.FIRST_OR_DEFAULT) {
                    CancellableContinuation<T> cancellableContinuation2 = cancellableContinuationImpl2;
                    Result.Companion companion2 = Result.INSTANCE;
                    cancellableContinuation2.resumeWith(Result.m3325constructorimpl(t));
                    ...
                    cancellableContinuation3.resumeWith(Result.m3325constructorimpl(ResultKt.createFailure(new NoSuchElementException("No value received via onNext for " + mode))));
                }
            }
