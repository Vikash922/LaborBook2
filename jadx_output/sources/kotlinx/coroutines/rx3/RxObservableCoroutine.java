...
final class RxObservableCoroutine<T> extends AbstractCoroutine<Unit> implements ProducerScope<T> {
    ...
    /* JADX INFO: renamed from: kotlinx.coroutines.rx3.RxObservableCoroutine$send$1 */
    /* JADX INFO: compiled from: RxObservable.kt */
    @Metadata(m2723k = 3, m2724mv = {1, 9, 0}, m2726xi = 48)
    @DebugMetadata(m2734c = "kotlinx.coroutines.rx3.RxObservableCoroutine", m2735f = "RxObservable.kt", m2736i = {0, 0}, m2737l = {113}, m2738m = "send", m2739n = {"this", "element"}, m2740s = {"L$0", "L$1"})
    static final class C43101 extends ContinuationImpl {
        Object L$0;
        Object L$1;
        int label;
        ...
        C43101(RxObservableCoroutine<T> rxObservableCoroutine, Continuation<? super C43101> continuation) {
            super(continuation);
    ...
    public /* bridge */ /* synthetic */ void mo4887invokeOnClose(Function1 function1) {
    ...
    public final void registerSelectForSend(SelectInstance<?> select, Object element) {
        if (!Mutex.DefaultImpls.tryLock$default(this.mutex, null, 1, null)) {
            BuildersKt__Builders_commonKt.launch$default(this, null, null, new C43091(this, select, null), 3, null);
        } else {
            select.selectInRegistrationPhase(Unit.INSTANCE);
        }
    }

    /* JADX INFO: renamed from: kotlinx.coroutines.rx3.RxObservableCoroutine$registerSelectForSend$1 */
    /* JADX INFO: compiled from: RxObservable.kt */
    @Metadata(m2721d1 = {"\u0000\u0010\n\u0000\n\u0002\u0010\u0002\n\u0000\n\u0002\u0010\u0000\n\u0002\u0018\u0002\u0010\u0000\u001a\u00020\u0001\"\b\b\u0000\u0010\u0002*\u00020\u0003*\u00020\u0004H\u008a@"}, m2722d2 = {"<anonymous>", "", "T", "", "Lkotlinx/coroutines/CoroutineScope;"}, m2723k = 3, m2724mv = {1, 9, 0}, m2726xi = 48)
    @DebugMetadata(m2734c = "kotlinx.coroutines.rx3.RxObservableCoroutine$registerSelectForSend$1", m2735f = "RxObservable.kt", m2736i = {}, m2737l = {89}, m2738m = "invokeSuspend", m2739n = {}, m2740s = {})
    static final class C43091 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        final /* synthetic */ SelectInstance<?> $select;
        int label;
        final /* synthetic */ RxObservableCoroutine<T> this$0;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C43091(RxObservableCoroutine<T> rxObservableCoroutine, SelectInstance<?> selectInstance, Continuation<? super C43091> continuation) {
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return new C43091(this.this$0, this.$select, continuation);
        }
    ...
    public Object mo4818trySendJP2dKIU(T element) {
        if (!Mutex.DefaultImpls.tryLock$default(this.mutex, null, 1, null)) {
        ...
        return ChannelResult.INSTANCE.m4842closedJP2dKIU(thDoLockedNext);
    }
    ...
    */
    public java.lang.Object send(T r5, kotlin.coroutines.Continuation<? super kotlin.Unit> r6) throws java.lang.Throwable {
        /*
            r4 = this;
            boolean r0 = r6 instanceof kotlinx.coroutines.rx3.RxObservableCoroutine.C43101
            if (r0 == 0) goto L14
            r0 = r6
            kotlinx.coroutines.rx3.RxObservableCoroutine$send$1 r0 = (kotlinx.coroutines.rx3.RxObservableCoroutine.C43101) r0
            int r1 = r0.label
