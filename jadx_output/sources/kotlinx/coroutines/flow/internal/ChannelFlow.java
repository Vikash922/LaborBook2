...
public abstract class ChannelFlow<T> implements FusibleFlow<T> {
    ...
    */
    ...
    @DebugMetadata(m2734c = "kotlinx.coroutines.flow.internal.ChannelFlow$collect$2", m2735f = "ChannelFlow.kt", m2736i = {}, m2737l = {119}, m2738m = "invokeSuspend", m2739n = {}, m2740s = {})
    static final class C42662 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        C42662(FlowCollector<? super T> flowCollector, ChannelFlow<T> channelFlow, Continuation<? super C42662> continuation) {
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            C42662 c42662 = new C42662(this.$collector, this.this$0, continuation);
            c42662.L$0 = obj;
            return c42662;
        }
        ...
        public final Object invoke(CoroutineScope coroutineScope, Continuation<? super Unit> continuation) {
            return ((C42662) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
        }
    ...
    static /* synthetic */ <T> Object collect$suspendImpl(ChannelFlow<T> channelFlow, FlowCollector<? super T> flowCollector, Continuation<? super Unit> continuation) {
        Object objCoroutineScope = CoroutineScopeKt.coroutineScope(new C42662(flowCollector, channelFlow, null), continuation);
