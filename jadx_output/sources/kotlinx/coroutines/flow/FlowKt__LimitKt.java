...
final /* synthetic */ class FlowKt__LimitKt {
    ...
    @DebugMetadata(m2734c = "kotlinx.coroutines.flow.FlowKt__LimitKt", m2735f = "Limit.kt", m2736i = {0}, m2737l = {133}, m2738m = "collectWhile", m2739n = {"collector"}, m2740s = {"L$0"})
    static final class C41961<T> extends ContinuationImpl {
        Object L$0;
        int label;
        /* synthetic */ Object result;

        C41961(Continuation<? super C41961> continuation) {
            super(continuation);
        }
    ...
    */
    ...
    /* JADX INFO: compiled from: Limit.kt */
    /* JADX INFO: loaded from: classes5.dex */
    @Metadata(m2721d1 = {"\u0000\u000e\n\u0000\n\u0002\u0010\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\u0010\u0000\u001a\u00020\u0001\"\u0004\b\u0000\u0010\u0002\"\u0004\b\u0001\u0010\u0003*\b\u0012\u0004\u0012\u0002H\u00030\u0004H\u008a@"}, m2722d2 = {"<anonymous>", "", "T", SvgConstants.Attributes.PATH_DATA_CATMULL_CURVE, "Lkotlinx/coroutines/flow/FlowCollector;"}, m2723k = 3, m2724mv = {1, 9, 0}, m2726xi = 48)
    @DebugMetadata(m2734c = "kotlinx.coroutines.flow.FlowKt__LimitKt$transformWhile$1", m2735f = "Limit.kt", m2736i = {0}, m2737l = {Opcodes.FCMPL}, m2738m = "invokeSuspend", m2739n = {"collector$iv"}, m2740s = {"L$0"})
    static final class C42001<R> extends SuspendLambda implements Function2<FlowCollector<? super R>, Continuation<? super Unit>, Object> {
        ...
        C42001(Flow<? extends T> flow, Function3<? super FlowCollector<? super R>, ? super T, ? super Continuation<? super Boolean>, ? extends Object> function3, Continuation<? super C42001> continuation) {
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            C42001 c42001 = new C42001(this.$this_transformWhile, this.$transform, continuation);
            c42001.L$0 = obj;
            return c42001;
        }
        ...
        public final Object invoke(FlowCollector<? super R> flowCollector, Continuation<? super Unit> continuation) {
            return ((C42001) create(flowCollector, continuation)).invokeSuspend(Unit.INSTANCE);
        }

        /* JADX WARN: Type inference incomplete: some casts might be missing */
        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Object invokeSuspend(Object obj) {
            C4201xdf1aa1b6 c4201xdf1aa1b6;
            ...
            if (i == 0) {
                ...
                C4201xdf1aa1b6 c4201xdf1aa1b62 = new C4201xdf1aa1b6(this.$transform, flowCollector);
                try {
                    this.L$0 = c4201xdf1aa1b62;
                    this.label = 1;
                    if (flow.collect(c4201xdf1aa1b62, this) == coroutine_suspended) {
                        return coroutine_suspended;
                    }
                } catch (AbortFlowException e) {
                    e = e;
                    c4201xdf1aa1b6 = c4201xdf1aa1b62;
                    FlowExceptions_commonKt.checkOwnership(e, c4201xdf1aa1b6);
                }
            } else {
                if (i != 1) {
                    throw new IllegalStateException("call to 'resume' before 'invoke' with coroutine");
                }
                c4201xdf1aa1b6 = (C4201xdf1aa1b6) this.L$0;
                try {
                    ResultKt.throwOnFailure(obj);
    ...
    public static final <T, R> Flow<R> transformWhile(Flow<? extends T> flow, Function3<? super FlowCollector<? super R>, ? super T, ? super Continuation<? super Boolean>, ? extends Object> function3) {
        return FlowKt.flow(new C42001(flow, function3, null));
    }
    ...
    */
    public static final <T> java.lang.Object collectWhile(kotlinx.coroutines.flow.Flow<? extends T> r4, kotlin.jvm.functions.Function2<? super T, ? super kotlin.coroutines.Continuation<? super java.lang.Boolean>, ? extends java.lang.Object> r5, kotlin.coroutines.Continuation<? super kotlin.Unit> r6) {
        /*
            boolean r0 = r6 instanceof kotlinx.coroutines.flow.FlowKt__LimitKt.C41961
            if (r0 == 0) goto L14
            r0 = r6
            kotlinx.coroutines.flow.FlowKt__LimitKt$collectWhile$1 r0 = (kotlinx.coroutines.flow.FlowKt__LimitKt.C41961) r0
            int r1 = r0.label
            r2 = -2147483648(0xffffffff80000000, float:-0.0)
            r1 = r1 & r2
            if (r1 == 0) goto L14
