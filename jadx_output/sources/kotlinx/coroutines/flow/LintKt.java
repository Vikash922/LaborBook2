...
public final class LintKt {
    ...
    private static final <T> Flow<T> m4859catch(SharedFlow<? extends T> sharedFlow, Function3<? super FlowCollector<? super T>, ? super Throwable, ? super Continuation<? super Unit>, ? extends Object> function3) {
        ...
        return FlowKt.m4847catch(sharedFlow, function3);
    }

    /* JADX INFO: renamed from: kotlinx.coroutines.flow.LintKt$retry$1 */
    /* JADX INFO: compiled from: Lint.kt */
    @Metadata(m2721d1 = {"\u0000\u000e\n\u0000\n\u0002\u0010\u000b\n\u0002\b\u0002\n\u0002\u0010\u0003\u0010\u0000\u001a\u00020\u0001\"\u0004\b\u0000\u0010\u00022\u0006\u0010\u0003\u001a\u00020\u0004H\u008a@"}, m2722d2 = {"<anonymous>", "", "T", "it", ""}, m2723k = 3, m2724mv = {1, 9, 0}, m2726xi = Opcodes.ARETURN)
    @DebugMetadata(m2734c = "kotlinx.coroutines.flow.LintKt$retry$1", m2735f = "Lint.kt", m2736i = {}, m2737l = {}, m2738m = "invokeSuspend", m2739n = {}, m2740s = {})
    public static final class C42581 extends SuspendLambda implements Function2<Throwable, Continuation<? super Boolean>, Object> {
        int label;

        public C42581(Continuation<? super C42581> continuation) {
            super(2, continuation);
        }

        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return new C42581(continuation);
        }

        @Override // kotlin.jvm.functions.Function2
        public final Object invoke(Throwable th, Continuation<? super Boolean> continuation) {
            return ((C42581) create(th, continuation)).invokeSuspend(Unit.INSTANCE);
        }
