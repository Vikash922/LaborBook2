...
final /* synthetic */ class FlowKt__CollectionKt {
    ...
    @DebugMetadata(m2734c = "kotlinx.coroutines.flow.FlowKt__CollectionKt", m2735f = "Collection.kt", m2736i = {0}, m2737l = {22}, m2738m = "toCollection", m2739n = {"destination"}, m2740s = {"L$0"})
    static final class C41731<T, C extends Collection<? super T>> extends ContinuationImpl {
        Object L$0;
        int label;
        /* synthetic */ Object result;

        C41731(Continuation<? super C41731> continuation) {
            super(continuation);
        }
    ...
    */
    public static final <T, C extends java.util.Collection<? super T>> java.lang.Object toCollection(kotlinx.coroutines.flow.Flow<? extends T> r4, final C r5, kotlin.coroutines.Continuation<? super C> r6) {
        /*
            boolean r0 = r6 instanceof kotlinx.coroutines.flow.FlowKt__CollectionKt.C41731
            if (r0 == 0) goto L14
            r0 = r6
            kotlinx.coroutines.flow.FlowKt__CollectionKt$toCollection$1 r0 = (kotlinx.coroutines.flow.FlowKt__CollectionKt.C41731) r0
            int r1 = r0.label
