...
@DebugMetadata(m2734c = "kotlinx.coroutines.flow.FlowKt__ShareKt$launchSharing$1", m2735f = "Share.kt", m2736i = {}, m2737l = {210, 214, 215, 221}, m2738m = "invokeSuspend", m2739n = {}, m2740s = {})
final class FlowKt__ShareKt$launchSharing$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    */
    ...
    @Metadata(m2721d1 = {"\u0000\u000e\n\u0000\n\u0002\u0010\u000b\n\u0002\b\u0002\n\u0002\u0010\b\u0010\u0000\u001a\u00020\u0001\"\u0004\b\u0000\u0010\u00022\u0006\u0010\u0003\u001a\u00020\u0004H\u008a@"}, m2722d2 = {"<anonymous>", "", "T", "it", ""}, m2723k = 3, m2724mv = {1, 9, 0}, m2726xi = 48)
    @DebugMetadata(m2734c = "kotlinx.coroutines.flow.FlowKt__ShareKt$launchSharing$1$1", m2735f = "Share.kt", m2736i = {}, m2737l = {}, m2738m = "invokeSuspend", m2739n = {}, m2740s = {})
    static final class C42271 extends SuspendLambda implements Function2<Integer, Continuation<? super Boolean>, Object> {
        /* synthetic */ int I$0;
        int label;

        C42271(Continuation<? super C42271> continuation) {
            super(2, continuation);
        }

        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            C42271 c42271 = new C42271(continuation);
            c42271.I$0 = ((Number) obj).intValue();
            return c42271;
        }

        public final Object invoke(int i, Continuation<? super Boolean> continuation) {
            return ((C42271) create(Integer.valueOf(i), continuation)).invokeSuspend(Unit.INSTANCE);
        }
    ...
    /* JADX INFO: compiled from: Share.kt */
    @Metadata(m2721d1 = {"\u0000\u000e\n\u0000\n\u0002\u0010\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\u0010\u0000\u001a\u00020\u0001\"\u0004\b\u0000\u0010\u00022\u0006\u0010\u0003\u001a\u00020\u0004H\u008a@"}, m2722d2 = {"<anonymous>", "", "T", "it", "Lkotlinx/coroutines/flow/SharingCommand;"}, m2723k = 3, m2724mv = {1, 9, 0}, m2726xi = 48)
    @DebugMetadata(m2734c = "kotlinx.coroutines.flow.FlowKt__ShareKt$launchSharing$1$2", m2735f = "Share.kt", m2736i = {}, m2737l = {223}, m2738m = "invokeSuspend", m2739n = {}, m2740s = {})
    static final class C42282 extends SuspendLambda implements Function2<SharingCommand, Continuation<? super Unit>, Object> {
        final /* synthetic */ T $initialValue;
        final /* synthetic */ MutableSharedFlow<T> $shared;
        final /* synthetic */ Flow<T> $upstream;
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        /* JADX WARN: Multi-variable type inference failed */
        C42282(Flow<? extends T> flow, MutableSharedFlow<T> mutableSharedFlow, T t, Continuation<? super C42282> continuation) {
            super(2, continuation);
            this.$upstream = flow;
            this.$shared = mutableSharedFlow;
            this.$initialValue = t;
        ...
        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            C42282 c42282 = new C42282(this.$upstream, this.$shared, this.$initialValue, continuation);
            c42282.L$0 = obj;
            return c42282;
        }
        ...
        public final Object invoke(SharingCommand sharingCommand, Continuation<? super Unit> continuation) {
            return ((C42282) create(sharingCommand, continuation)).invokeSuspend(Unit.INSTANCE);
        }
        ...
        public final java.lang.Object invokeSuspend(java.lang.Object r5) {
            ...
            L17:
                ...
                int[] r1 = kotlinx.coroutines.flow.FlowKt__ShareKt$launchSharing$1.C42282.WhenMappings.$EnumSwitchMapping$0
                int r5 = r5.ordinal()
                r5 = r1[r5]
                if (r5 == r2) goto L40
                r0 = 3
            ...
            L52:
                ...
                return r5
            */
            throw new UnsupportedOperationException("Method not decompiled: kotlinx.coroutines.flow.FlowKt__ShareKt$launchSharing$1.C42282.invokeSuspend(java.lang.Object):java.lang.Object");
        }
    }
}
