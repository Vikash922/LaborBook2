...
final class StateFlowSlot extends AbstractSharedFlowSlot<StateFlowImpl<?>> {
    ...
    public final void makePending() {
        ...
        while (true) {
            ...
            if (value == StateFlowKt.NONE) {
                if (LifecycleKt$$ExternalSyntheticBackportWithForwarding0.m60m(this._state, value, StateFlowKt.PENDING)) {
                    return;
                }
            } else if (LifecycleKt$$ExternalSyntheticBackportWithForwarding0.m60m(this._state, value, StateFlowKt.NONE)) {
                Result.Companion companion = Result.INSTANCE;
                ((CancellableContinuationImpl) value).resumeWith(Result.m3325constructorimpl(Unit.INSTANCE));
                return;
            }
        }
    }
    ...
    public final Object awaitPending(Continuation<? super Unit> continuation) {
        ...
        if (!LifecycleKt$$ExternalSyntheticBackportWithForwarding0.m60m(this._state, StateFlowKt.NONE, cancellableContinuationImpl2)) {
