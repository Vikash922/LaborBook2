...
public class SelectImplementation<R> implements CancelHandler, SelectBuilder<R>, SelectInstanceInternal<R> {
    ...
    @DebugMetadata(m2734c = "kotlinx.coroutines.selects.SelectImplementation", m2735f = "Select.kt", m2736i = {0}, m2737l = {438, 441}, m2738m = "doSelectSuspend", m2739n = {"this"}, m2740s = {"L$0"})
    static final class C43121 extends ContinuationImpl {
        Object L$0;
        int label;
        ...
        C43121(SelectImplementation<R> selectImplementation, Continuation<? super C43121> continuation) {
            super(continuation);
    ...
    /* JADX INFO: compiled from: Select.kt */
    @Metadata(m2723k = 3, m2724mv = {1, 9, 0}, m2726xi = 48)
    @DebugMetadata(m2734c = "kotlinx.coroutines.selects.SelectImplementation", m2735f = "Select.kt", m2736i = {}, m2737l = {712}, m2738m = "processResultAndInvokeBlockRecoveringException", m2739n = {}, m2740s = {})
    static final class C43131 extends ContinuationImpl {
        int label;
        /* synthetic */ Object result;
        final /* synthetic */ SelectImplementation<R> this$0;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C43131(SelectImplementation<R> selectImplementation, Continuation<? super C43131> continuation) {
            super(continuation);
            this.this$0 = selectImplementation;
        }
    ...
    */
    public final java.lang.Object doSelectSuspend(kotlin.coroutines.Continuation<? super R> r6) {
        /*
            r5 = this;
            boolean r0 = r6 instanceof kotlinx.coroutines.selects.SelectImplementation.C43121
            if (r0 == 0) goto L14
            r0 = r6
            kotlinx.coroutines.selects.SelectImplementation$doSelectSuspend$1 r0 = (kotlinx.coroutines.selects.SelectImplementation.C43121) r0
            int r1 = r0.label
        ...
        while (true) {
            ...
            if (!(obj instanceof CancellableContinuation)) {
                ...
                if (Intrinsics.areEqual(obj, SelectKt.STATE_REG)) {
                    if (C0214xc40028dd.m8m(state$volatile$FU, this, obj, CollectionsKt.listOf(clauseObject))) {
                        return 1;
                    }
                } else {
                    ...
                    if (C0214xc40028dd.m8m(state$volatile$FU, this, obj, CollectionsKt.plus((Collection<? extends Object>) obj, clauseObject))) {
                        return 1;
                    }
                }
            } else {
                ...
                if (clauseDataFindClause == null) {
                    ...
                    if (C0214xc40028dd.m8m(state$volatile$FU, this, obj, clauseDataFindClause)) {
                        this.internalResult = internalResult;
    ...
    */
    public final java.lang.Object processResultAndInvokeBlockRecoveringException(kotlinx.coroutines.selects.SelectImplementation<R>.ClauseData r5, java.lang.Object r6, kotlin.coroutines.Continuation<? super R> r7) throws java.lang.Throwable {
        /*
            r4 = this;
            boolean r0 = r7 instanceof kotlinx.coroutines.selects.SelectImplementation.C43131
            if (r0 == 0) goto L14
            r0 = r7
            kotlinx.coroutines.selects.SelectImplementation$processResultAndInvokeBlockRecoveringException$1 r0 = (kotlinx.coroutines.selects.SelectImplementation.C43131) r0
            int r1 = r0.label
            r2 = -2147483648(0xffffffff80000000, float:-0.0)
            r1 = r1 & r2
            if (r1 == 0) goto L14
    ...
    public void invoke(Throwable cause) {
        ...
        } while (!C0214xc40028dd.m8m(atomicReferenceFieldUpdater, this, obj, SelectKt.STATE_CANCELLED));
        List<SelectImplementation<R>.ClauseData> list = this.clauses;
        if (list == null) {
            return;
        }
    ...
    */
    public final java.lang.Object waitUntilSelected(kotlin.coroutines.Continuation<? super kotlin.Unit> r7) {
        ...
        L14:
            ...
            boolean r3 = androidx.concurrent.futures.C0214xc40028dd.m8m(r4, r6, r3, r1)
            if (r3 == 0) goto L14
            r2 = r6
        ...
        L2f:
            ...
            boolean r4 = androidx.concurrent.futures.C0214xc40028dd.m8m(r4, r6, r3, r5)
            if (r4 == 0) goto L14
            r4 = r3
