...
public class ChannelCoroutine<E> extends AbstractCoroutine<Unit> implements Channel<E> {
    ...
    public void mo4887invokeOnClose(Function1<? super Throwable, Unit> handler) {
        this._channel.mo4887invokeOnClose(handler);
    }
    ...
    public Object mo4822receiveCatchingJP2dKIU(Continuation<? super ChannelResult<? extends E>> continuation) {
        Object obj = this._channel.mo4822receiveCatchingJP2dKIU(continuation);
    ...
    public Object mo4823tryReceivePtdJZtk() {
        return this._channel.mo4823tryReceivePtdJZtk();
    }

    @Override // kotlinx.coroutines.channels.SendChannel
    /* JADX INFO: renamed from: trySend-JP2dKIU */
    public Object mo4818trySendJP2dKIU(E element) {
        return this._channel.mo4818trySendJP2dKIU(element);
    }
