...
public abstract class Observable<T> implements ObservableSource<T> {
    ...
    public final <R> R m2706as(ObservableConverter<T, ? extends R> observableConverter) {
    ...
    public final <R> R m2707to(Function<? super Observable<T>, R> function) {
        try {
    ...
    public final Flowable<T> toFlowable(BackpressureStrategy backpressureStrategy) {
        ...
        int i = C39681.$SwitchMap$io$reactivex$BackpressureStrategy[backpressureStrategy.ordinal()];
        if (i == 1) {
