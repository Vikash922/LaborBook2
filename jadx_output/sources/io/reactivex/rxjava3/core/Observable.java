...
public abstract class Observable<T> implements ObservableSource<T> {
    ...
    public final <R> R m2715to(ObservableConverter<T, ? extends R> observableConverter) {
    ...
    public final Flowable<T> toFlowable(BackpressureStrategy strategy) {
        ...
        int i = C39831.$SwitchMap$io$reactivex$rxjava3$core$BackpressureStrategy[strategy.ordinal()];
        if (i == 1) {
