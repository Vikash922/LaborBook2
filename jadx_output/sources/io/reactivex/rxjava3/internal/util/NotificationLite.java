...
public enum NotificationLite {
    ...
    static final class ErrorNotification implements Serializable {
        ...
        public String toString() {
            return "NotificationLite.Error[" + this.f3729e + "]";
        }

        public int hashCode() {
            return this.f3729e.hashCode();
        }

        public boolean equals(Object obj) {
            if (obj instanceof ErrorNotification) {
                return Objects.equals(this.f3729e, ((ErrorNotification) obj).f3729e);
            }
            return false;
        }
    }
    ...
    public static Throwable getError(Object o) {
        return ((ErrorNotification) o).f3729e;
    }
    ...
    public static <T> boolean accept(Object o, Subscriber<? super T> s) {
        ...
        if (o instanceof ErrorNotification) {
            s.onError(((ErrorNotification) o).f3729e);
            return true;
        }
        s.onNext(o);
        return false;
    ...
    public static <T> boolean accept(Object o, Observer<? super T> observer) {
        ...
        if (o instanceof ErrorNotification) {
            observer.onError(((ErrorNotification) o).f3729e);
            return true;
        }
        observer.onNext(o);
        return false;
