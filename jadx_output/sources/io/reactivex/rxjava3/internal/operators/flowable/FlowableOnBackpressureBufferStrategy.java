...
public final class FlowableOnBackpressureBufferStrategy<T> extends AbstractFlowableWithUpstream<T, T> {
        ...
        public void onNext(T t) {
            ...
            synchronized (deque) {
                ...
                if (deque.size() == this.bufferSize) {
                    int i = C39881.f3665x8ef22ea[this.strategy.ordinal()];
                    z2 = true;
                    if (i == 1) {
                        deque.pollLast();
                        deque.offer(t);
    ...
    static /* synthetic */ class C39881 {
        ...
        /* JADX INFO: renamed from: $SwitchMap$io$reactivex$rxjava3$core$BackpressureOverflowStrategy */
        static final /* synthetic */ int[] f3665x8ef22ea;
        ...
        static {
            ...
            try {
                f3665x8ef22ea[BackpressureOverflowStrategy.DROP_OLDEST.ordinal()] = 2;
