...
final class InstantPeriodicTask implements Callable<Void>, Disposable {
    ...
    void setFirst(Future<?> f) {
        ...
        } while (!LifecycleKt$$ExternalSyntheticBackportWithForwarding0.m60m(this.first, future, f));
    }
    ...
    void setRest(Future<?> f) {
        ...
        } while (!LifecycleKt$$ExternalSyntheticBackportWithForwarding0.m60m(this.rest, future, f));
    }
}
