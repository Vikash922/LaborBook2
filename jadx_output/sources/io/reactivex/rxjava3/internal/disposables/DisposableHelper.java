...
public enum DisposableHelper implements Disposable {
    ...
    public static boolean set(AtomicReference<Disposable> field, Disposable d) {
        ...
        } while (!LifecycleKt$$ExternalSyntheticBackportWithForwarding0.m60m(field, disposable, d));
        if (disposable == null) {
            return true;
        }
        disposable.dispose();
    ...
    public static boolean setOnce(AtomicReference<Disposable> field, Disposable d) {
        ...
        if (LifecycleKt$$ExternalSyntheticBackportWithForwarding0.m60m(field, null, d)) {
            return true;
        }
        d.dispose();
