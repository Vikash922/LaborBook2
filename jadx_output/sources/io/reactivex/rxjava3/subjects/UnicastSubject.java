...
public final class UnicastSubject<T> extends Subject<T> {
    ...
    void doTerminate() {
        ...
        if (runnable == null || !LifecycleKt$$ExternalSyntheticBackportWithForwarding0.m60m(this.onTerminate, runnable, null)) {
            return;
        }
        runnable.run();
    }
    ...
    boolean failedFast(final SimpleQueue<T> q, Observer<? super T> a2) {
        Throwable th = this.error;
        if (th == null) {
            return false;
        }
