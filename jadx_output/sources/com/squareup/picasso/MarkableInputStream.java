...
final class MarkableInputStream extends InputStream {
    ...
    private final InputStream f3512in;
    private long limit;
    ...
    private MarkableInputStream(InputStream inputStream, int i, int i2) {
        ...
        this.f3512in = inputStream.markSupported() ? inputStream : new BufferedInputStream(inputStream, i);
    ...
    private void setLimit(long j) {
        try {
            ...
            if (j2 < j3 && j3 <= this.limit) {
                this.f3512in.reset();
                this.f3512in.mark((int) (j - this.reset));
                skip(this.reset, this.offset);
            } else {
                this.reset = j3;
                this.f3512in.mark((int) (j - j3));
            }
            this.limit = j;
        } catch (IOException e) {
    ...
    private void skip(long j, long j2) throws IOException {
        while (j < j2) {
            long jSkip = this.f3512in.skip(j2 - j);
            if (jSkip == 0) {
                if (read() == -1) {
                    return;
                } else {
    ...
    public int read(byte[] bArr, int i, int i2) throws IOException {
        ...
        int i3 = this.f3512in.read(bArr, i, i2);
        if (i3 != -1) {
            this.offset += (long) i3;
        }
        return i3;
    ...
    public long skip(long j) throws IOException {
        ...
        long jSkip = this.f3512in.skip(j);
        this.offset += jSkip;
        return jSkip;
    }
    ...
    public boolean markSupported() {
        return this.f3512in.markSupported();
    }
}
