...
public class TrueTypeCollection {
    ...
    public TrueTypeCollection(String str) throws IOException {
        if (!FileUtil.fileExists(str)) {
            throw new com.itextpdf.io.exceptions.IOException(com.itextpdf.io.exceptions.IOException.FontFile1NotFound).setMessageParams(str);
        }
    ...
    public FontProgram getFontByTccIndex(int i) throws IOException {
        if (i > this.TTCSize - 1) {
            throw new com.itextpdf.io.exceptions.IOException(com.itextpdf.io.exceptions.IOException.TtcIndexDoesNotExistInThisTtcFile);
        }
    ...
    private void initFontSize() throws IOException {
        if (!this.raf.readString(4, "Cp1252").equals("ttcf")) {
            throw new com.itextpdf.io.exceptions.IOException(com.itextpdf.io.exceptions.IOException.InvalidTtcFile);
        }
