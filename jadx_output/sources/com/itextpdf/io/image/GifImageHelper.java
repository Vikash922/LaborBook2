...
public final class GifImageHelper {
    ...
    public static void processImage(GifImageData gifImageData, int i) {
        ...
        try {
            ...
            throw new com.itextpdf.io.exceptions.IOException(com.itextpdf.io.exceptions.IOException.GifImageException, (Throwable) e);
        }
    }
    ...
    private static void process(InputStream inputStream, GifParameters gifParameters, int i) throws IOException {
        ...
        if (gifParameters.currentFrame <= i) {
            throw new com.itextpdf.io.exceptions.IOException(com.itextpdf.io.exceptions.IOException.CannotFind1Frame).setMessageParams(Integer.valueOf(i));
        }
    }
    ...
    private static boolean decodeImageData(GifParameters gifParameters) throws IOException {
        ...
        while (i16 < i4) {
            ...
            int i32 = i31 + 1;
            if (i32 >= gifParameters.iw) {
                int i33 = i30 + i5;
                if (i33 < gifParameters.ih) {
                    i22 = i33;
                    i4 = i;
                    i10 = i2;
                    z = true;
