...
public final class SignExceptionMessageConstant {
    ...
    public static final String CANNOT_BE_VERIFIED_CERTIFICATE_CHAIN = "Cannot be verified against the KeyStore or the certificate chain.";
    ...
    /* JADX INFO: renamed from: CERTIFICATION_SIGNATURE_CREATION_FAILED_DOC_SHALL_NOT_CONTAIN_SIGS */
    public static final String f3293xaeea04c1 = "Certification signature creation failed. Document shall not contain any certification or approval signatures before signing with certification signature.";
    ...
    public static final String INVALID_STATE_WHILE_CHECKING_CERT_CHAIN = "Invalid state. Possible circular certificate chain.";
    ...
    /* JADX INFO: renamed from: SIGNATURE_WITH_THIS_NAME_IS_NOT_THE_LAST_IT_DOES_NOT_COVER_WHOLE_DOCUMENT */
    public static final String f3294xbf0eb368 = "Signature with name {0} is not the last. It doesn't cover the whole document.";
    ...
    /* JADX INFO: renamed from: THIS_PKCS7_OBJECT_HAS_MULTIPLE_SIGNERINFOS_ONLY_ONE_IS_SUPPORTED_AT_THIS_TIME */
    public static final String f3295x99cb1fbe = "This PKCS#7 object has multiple SignerInfos. Only one is supported at this time.";
