...
import com.itextpdf.p017io.util.FilterUtil;
...
class PngImageHelper {
    ...
    public static void processImage(ImageData imageData) throws Throwable {
        ...
        try {
            ...
            throw new com.itextpdf.p017io.exceptions.IOException(com.itextpdf.p017io.exceptions.IOException.PngImageException, (Throwable) e);
        } catch (Throwable th2) {
            th = th2;
            byteArrayInputStream2 = byteArrayInputStream;
    ...
    private static void processPng(InputStream inputStream, PngParameters pngParameters) throws IOException {
        ...
        if (pngParameters.iccProfile != null && pngParameters.iccProfile.getNumComponents() != getExpectedNumberOfColorComponents(pngParameters)) {
            LoggerFactory.getLogger((Class<?>) PngImageHelper.class).warn(IoLogMessageConstant.f2898xe55b147c);
        }
        try {
    ...
    */
    private static void readPng(java.io.InputStream r19, com.itextpdf.io.image.PngImageHelper.PngParameters r20) throws java.io.IOException {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.itextpdf.p017io.image.PngImageHelper.readPng(java.io.InputStream, com.itextpdf.io.image.PngImageHelper$PngParameters):void");
    }
        ...
        while (i10 < i6) {
            ...
            if (i7 != 0) {
                if (i7 == 1) {
                    ...
                    throw new com.itextpdf.p017io.exceptions.IOException(com.itextpdf.p017io.exceptions.IOException.UnknownPngFilter);
                }
            }
    ...
    */
    private static void processPixels(byte[] r23, int r24, int r25, int r26, int r27, com.itextpdf.io.image.PngImageHelper.PngParameters r28) {
        /*
            ...
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: com.itextpdf.p017io.image.PngImageHelper.processPixels(byte[], int, int, int, int, com.itextpdf.io.image.PngImageHelper$PngParameters):void");
    }
