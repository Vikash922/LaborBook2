...
final class BmpImageHelper {
    ...
    public static void processImage(ImageData imageData) {
        ...
        try {
            ...
            throw new com.itextpdf.p017io.exceptions.IOException(com.itextpdf.p017io.exceptions.IOException.BmpImageException, (Throwable) e);
        }
    }
    ...
    private static void process(BmpParameters bmpParameters, InputStream inputStream) throws IOException {
        ...
        if (!bmpParameters.image.isNoHeader()) {
            if (readUnsignedByte(bmpParameters.inputStream) != 66 || readUnsignedByte(bmpParameters.inputStream) != 77) {
                throw new com.itextpdf.p017io.exceptions.IOException(com.itextpdf.p017io.exceptions.IOException.InvalidMagicValueForBmpFileMustBeBM);
            }
        ...
        if (dWord == 12) {
            ...
            if (dWord == 40 || dWord == 52 || dWord == 56) {
                ...
                if (i9 == 0 || i9 == 1 || i9 == 2) {
                    ...
                    throw new com.itextpdf.p017io.exceptions.IOException(com.itextpdf.p017io.exceptions.IOException.InvalidBmpFileCompression);
                }
            } else if (dWord == 108) {
    ...
    private static void readPalette(int i, BmpParameters bmpParameters) throws IOException {
        ...
        while (i2 < i) {
            ...
            if (i3 < 0) {
                throw new com.itextpdf.p017io.exceptions.IOException(com.itextpdf.p017io.exceptions.IOException.IncompletePalette);
            }
            i2 += i3;
        }
    ...
    */
    private static void read1632Bit(boolean r21, com.itextpdf.io.image.BmpImageHelper.BmpParameters r22) throws java.io.IOException {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.itextpdf.p017io.image.BmpImageHelper.read1632Bit(boolean, com.itextpdf.io.image.BmpImageHelper$BmpParameters):void");
    }
        ...
        for (int i10 = 0; i10 < bmpParameters.height; i10++) {
            for (int i11 = 0; i11 < bmpParameters.width; i11++) {
                if ((i11 & 1) == 0) {
                    ...
                    int i12 = (i11 / 2) + i9;
                    bArr3[i12] = (byte) (((byte) (bArrDecodeRLE[i8] & Ascii.f393SI)) | bArr3[i12]);
                    i8++;
                }
            }
            i9 += i7;
            ...
            try {
                ...
                if (i6 != 0) {
                    ...
                    if (z) {
                        ...
                        while (i9 < i6) {
                            int i10 = i4 + 1;
                            bArr2[i4] = (byte) ((i9 & 1) == 1 ? b & Ascii.f393SI : (i7 >>> 4) & 15);
                            i9++;
                            i4 = i10;
                        }
                    }
