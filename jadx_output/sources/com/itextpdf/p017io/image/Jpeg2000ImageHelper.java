        ...
        try {
            ...
            if (jpeg2000Box.length == 12) {
                ...
                if (JP2_JP != jpeg2000Box.type) {
                    throw new com.itextpdf.p017io.exceptions.IOException(com.itextpdf.p017io.exceptions.IOException.ExpectedJpMarker);
                }
                if (218793738 != cio_read(4, byteArrayInputStream)) {
                    throw new com.itextpdf.p017io.exceptions.IOException(com.itextpdf.p017io.exceptions.IOException.ErrorWithJpMarker);
                }
                jp2_read_boxhdr(jpeg2000Box, byteArrayInputStream);
                if (JP2_FTYP != jpeg2000Box.type) {
                    throw new com.itextpdf.p017io.exceptions.IOException(com.itextpdf.p017io.exceptions.IOException.ExpectedFtypMarker);
                }
                ...
                do {
                    if (JP2_JP2H != jpeg2000Box.type) {
                        if (jpeg2000Box.type == JP2_JP2C) {
                            throw new com.itextpdf.p017io.exceptions.IOException(com.itextpdf.p017io.exceptions.IOException.ExpectedJp2hMarker);
                        }
                ...
                if (JP2_IHDR != jpeg2000Box.type) {
                    throw new com.itextpdf.p017io.exceptions.IOException(com.itextpdf.p017io.exceptions.IOException.ExpectedIhdrMarker);
                }
            ...
            throw new com.itextpdf.p017io.exceptions.IOException(com.itextpdf.p017io.exceptions.IOException.InvalidJpeg2000File);
        } catch (IOException e) {
            throw new com.itextpdf.p017io.exceptions.IOException(com.itextpdf.p017io.exceptions.IOException.Jpeg2000ImageException, (Throwable) e);
        }
    }
    ...
    private static void jp2_read_boxhdr(Jpeg2000Box jpeg2000Box, InputStream inputStream) throws IOException {
        ...
        if (jpeg2000Box.length == 1) {
            if (cio_read(4, inputStream) != 0) {
                throw new com.itextpdf.p017io.exceptions.IOException(com.itextpdf.p017io.exceptions.IOException.CannotHandleBoxSizesHigherThan2_32);
            }
            jpeg2000Box.length = cio_read(4, inputStream);
            if (jpeg2000Box.length == 0) {
                throw new com.itextpdf.p017io.exceptions.IOException(com.itextpdf.p017io.exceptions.IOException.UnsupportedBoxSizeEqEq0);
            }
            return;
        }
        if (jpeg2000Box.length == 0) {
