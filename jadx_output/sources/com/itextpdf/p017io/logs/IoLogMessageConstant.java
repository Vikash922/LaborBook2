package com.itextpdf.p017io.logs;
...
public final class IoLogMessageConstant {
    ...
    /* JADX INFO: renamed from: ENCRYPTED_PAYLOAD_FILE_SPEC_SHALL_HAVE_AFRELATIONSHIP_FILED_EQUAL_TO_ENCRYPTED_PAYLOAD */
    public static final String f2892xfdc6407c = "Encrypted payload file spec shall have 'AFRelationship' filed equal to 'EncryptedPayload'";

    /* JADX INFO: renamed from: ENCRYPTION_ENTRIES_P_AND_ENCRYPT_METADATA_NOT_CORRESPOND_PERMS_ENTRY */
    public static final String f2893x3e742566 = "Encryption dictionary entries P and EncryptMetadata have value that does not correspond to encrypted values in Perms key.";
    ...
    public static final String FILTER_WAS_ALREADY_FLUSHED = "{0} {1} R stream object filter was already flushed, stream compression will remain as in original file. Try to flush object containing filter before the PdfDocument#close() method so that stream compression would be processed as intended.";
    public static final String FLEX_ITEM_LAYOUT_RESULT_IS_NOT_FULL = "Flex item layout result isn't full, but it must be. The cross size of the flex item will be 0.";
    ...
    /* JADX INFO: renamed from: IMAGE_HAS_ICC_PROFILE_WITH_INCOMPATIBLE_NUMBER_OF_COLOR_COMPONENTS_COMPARED_TO_BASE_COLOR_SPACE_IN_INDEXED_COLOR_SPACE */
    public static final String f2894xe908ea8 = "Image has icc profile with incompatible number of color components compared to base color space in image indexed color space. The icc profile will be ignored.";

    /* JADX INFO: renamed from: IMAGE_HAS_ICC_PROFILE_WITH_INCOMPATIBLE_NUMBER_OF_COLOR_COMPONENTS_COMPARED_TO_COLOR_SPACE */
    public static final String f2895x4563ea8d = "Image has icc profile with incompatible number of color components compared to image color space. The icc profile will be ignored.";

    /* JADX INFO: renamed from: IMAGE_HAS_INCORRECT_OR_UNSUPPORTED_BASE_COLOR_SPACE_IN_INDEXED_COLOR_SPACE_OVERRIDDEN_BY_ICC_PROFILE */
    public static final String f2896x3d959059 = "Image has incorrect or unsupported base color space in indexed color space, it will be overridden by one based on embedded icc profile.";

    /* JADX INFO: renamed from: IMAGE_HAS_INCORRECT_OR_UNSUPPORTED_COLOR_SPACE_OVERRIDDEN_BY_ICC_PROFILE */
    public static final String f2897xbd0142fe = "Image has incorrect or unsupported color space, that will be overridden by one based on embedded icc profile.";
    ...
    public static final String PAGE_WAS_FLUSHED_ACTION_WILL_NOT_BE_PERFORMED = "Page was flushed. {0} will not be performed.";
    ...
    /* JADX INFO: renamed from: PNG_IMAGE_HAS_ICC_PROFILE_WITH_INCOMPATIBLE_NUMBER_OF_COLOR_COMPONENTS */
    public static final String f2898xe55b147c = "Png image has color profile with incompatible number of color components.";
    ...
    public static final String TYPOGRAPHY_NOT_FOUND = "Cannot find pdfCalligraph module, which was implicitly required by one of the layout properties";

    /* JADX INFO: renamed from: UNABLE_TO_APPLY_PAGE_DEPENDENT_PROP_UNKNOWN_PAGE_ON_WHICH_ELEMENT_IS_DRAWN */
    public static final String f2899x4ac94ef4 = "Unable to apply page dependent property, because the page on which element is drawn is unknown. Usually this means that element was added to the Canvas instance that was created not with constructor taking PdfPage as argument. Not processed property: {0}";
