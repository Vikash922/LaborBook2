...
public abstract class OpenTypeFontTableReader {
    ...
    protected final RandomAccessFileOrArray f2875rf;
    ...
    protected OpenTypeFontTableReader(RandomAccessFileOrArray randomAccessFileOrArray, int i, OpenTypeGdefTableReader openTypeGdefTableReader, Map<Integer, Glyph> map, int i2) {
        this.f2875rf = randomAccessFileOrArray;
    ...
    protected TagAndLocation[] readTagAndLocations(int i) throws IOException {
        ...
        for (int i2 = 0; i2 < unsignedShort; i2++) {
            ...
            tagAndLocation.tag = this.f2875rf.readString(4, "utf-8");
            tagAndLocation.location = this.f2875rf.readUnsignedShort() + i;
    ...
    final void startReadingTable() throws FontReadingException {
        try {
            this.f2875rf.seek(this.tableLocation);
            this.f2875rf.readInt();
            int unsignedShort = this.f2875rf.readUnsignedShort();
            int unsignedShort2 = this.f2875rf.readUnsignedShort();
            int unsignedShort3 = this.f2875rf.readUnsignedShort();
    ...
    private void readLookupListTable(int i) throws IOException {
        ...
        this.f2875rf.seek(i);
        for (int i2 : readUShortArray(this.f2875rf.readUnsignedShort(), i)) {
            if (i2 != 0) {
                readLookupTable(i2);
            }
        }
    ...
    private void readLookupTable(int i) throws IOException {
        this.f2875rf.seek(i);
        this.lookupList.add(readLookupTable(this.f2875rf.readUnsignedShort(), this.f2875rf.readUnsignedShort(), readUShortArray(this.f2875rf.readUnsignedShort(), i)));
    }
}
