...
final class Decode {
    ...
    */
    static void readHuffmanCode(int r16, int[] r17, int r18, com.itextpdf.p017io.codec.brotli.dec.BitReader r19) {
        /*
            Method dump skipped, instruction units count: 215
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: com.itextpdf.p017io.codec.brotli.dec.Decode.readHuffmanCode(int, int[], int, com.itextpdf.io.codec.brotli.dec.BitReader):void");
    }
    ...
    private static void decodeBlockTypeAndLength(State state, int i) {
        int i2;
        BitReader bitReader = state.f2863br;
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    static void decompress(com.itextpdf.p017io.codec.brotli.dec.State r19) {
        /*
            Method dump skipped, instruction units count: 974
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: com.itextpdf.p017io.codec.brotli.dec.Decode.decompress(com.itextpdf.io.codec.brotli.dec.State):void");
    }
}
