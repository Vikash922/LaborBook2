...
public class TIFFDirectory {
    ...
    public TIFFDirectory(RandomAccessFileOrArray randomAccessFileOrArray, int i) throws IOException {
        ...
        if (!isValidEndianTag(unsignedShort)) {
            throw new com.itextpdf.p017io.exceptions.IOException(com.itextpdf.p017io.exceptions.IOException.BadEndiannessTag0x4949Or0x4d4d);
        }
        this.isBigEndian = unsignedShort == 19789;
        if (readUnsignedShort(randomAccessFileOrArray) != 42) {
            throw new com.itextpdf.p017io.exceptions.IOException(com.itextpdf.p017io.exceptions.IOException.BadMagicNumberShouldBe42);
        }
        long unsignedInt = readUnsignedInt(randomAccessFileOrArray);
        for (int i2 = 0; i2 < i; i2++) {
            if (unsignedInt == 0) {
                throw new com.itextpdf.p017io.exceptions.IOException(com.itextpdf.p017io.exceptions.IOException.DirectoryNumberIsTooLarge);
            }
    ...
    */
    private void initialize(com.itextpdf.p017io.source.RandomAccessFileOrArray r20) throws java.io.IOException {
        /*
            Method dump skipped, instruction units count: 356
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: com.itextpdf.p017io.codec.TIFFDirectory.initialize(com.itextpdf.io.source.RandomAccessFileOrArray):void");
    }
