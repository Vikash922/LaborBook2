...
public abstract class SampleExtractor {
    ...
    public static SampleExtractor createExtractor(int i) {
        if (i == 1 || i == 2 || i == 4) {
    ...
    private static final class SampleBitsExtractor extends SampleExtractor {
    ...
    private static final class SampleBytesExtractor extends SampleExtractor {
    ...
    private static final class Sample12BitsExtractor extends SampleExtractor {
