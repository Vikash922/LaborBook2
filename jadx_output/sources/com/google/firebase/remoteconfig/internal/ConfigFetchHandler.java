...
public class ConfigFetchHandler {
    ...
    public Task<FetchResponse> fetch(final long j) {
        ...
        return this.fetchedConfigsCache.get().continueWithTask(this.executor, new Continuation() { // from class: com.google.firebase.remoteconfig.internal.ConfigFetchHandler$$ExternalSyntheticLambda0
            ...
            public final Object then(Task task) {
                return this.f$0.m524x7459e696(j, map, task);
            }
        });
    }
    ...
    public Task<FetchResponse> fetchNowWithTypeAndAttemptNumber(FetchType fetchType, int i) {
        ...
        return this.fetchedConfigsCache.get().continueWithTask(this.executor, new Continuation() { // from class: com.google.firebase.remoteconfig.internal.ConfigFetchHandler$$ExternalSyntheticLambda3
            @Override // com.google.android.gms.tasks.Continuation
            public final Object then(Task task) {
                return this.f$0.m527xdbe8963a(map, task);
            }
        });
    }

    /* JADX INFO: renamed from: lambda$fetchNowWithTypeAndAttemptNumber$1$com-google-firebase-remoteconfig-internal-ConfigFetchHandler */
    /* synthetic */ Task m527xdbe8963a(Map map, Task task) throws Exception {
        return m524x7459e696(task, 0L, map);
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* JADX INFO: renamed from: fetchIfCacheExpiredAndNotThrottled, reason: merged with bridge method [inline-methods] */
    public Task<FetchResponse> m524x7459e696(Task<ConfigContainer> task, long j, final Map<String, String> map) {
        ...
        if (backoffEndTimeInMillis != null) {
            ...
            taskContinueWithTask = Tasks.whenAllComplete((Task<?>[]) new Task[]{id, token}).continueWithTask(this.executor, new Continuation() { // from class: com.google.firebase.remoteconfig.internal.ConfigFetchHandler$$ExternalSyntheticLambda1
                ...
                public final Object then(Task task2) {
                    return this.f$0.m525x5d615250(id, token, date, map, task2);
                }
            });
        }
        return taskContinueWithTask.continueWithTask(this.executor, new Continuation() { // from class: com.google.firebase.remoteconfig.internal.ConfigFetchHandler$$ExternalSyntheticLambda2
            @Override // com.google.android.gms.tasks.Continuation
            public final Object then(Task task2) {
                return this.f$0.m526xf19fc1ef(date, task2);
            }
        });
    }

    /* JADX INFO: renamed from: lambda$fetchIfCacheExpiredAndNotThrottled$2$com-google-firebase-remoteconfig-internal-ConfigFetchHandler */
    /* synthetic */ Task m525x5d615250(Task task, Task task2, Date date, Map map, Task task3) throws Exception {
    ...
    /* JADX INFO: renamed from: lambda$fetchIfCacheExpiredAndNotThrottled$3$com-google-firebase-remoteconfig-internal-ConfigFetchHandler */
    /* synthetic */ Task m526xf19fc1ef(Date date, Task task) throws Exception {
