...
public final class C2306x3dbbb29c implements Factory<Provider<TransportFactory>> {
    private final FirebasePerformanceModule module;

    public C2306x3dbbb29c(FirebasePerformanceModule firebasePerformanceModule) {
    ...
    public static C2306x3dbbb29c create(FirebasePerformanceModule firebasePerformanceModule) {
        return new C2306x3dbbb29c(firebasePerformanceModule);
    }
