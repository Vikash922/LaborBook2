...
public class FrameMetricsRecorder {
    ...
    public Optional<FrameMetricsCalculator.PerfFrameMetrics> stopFragment(Fragment fragment) {
        ...
        return Optional.m516of(optionalSnapshot.get().deltaFrameMetricsFromSnapshot(perfFrameMetricsRemove));
    }
    ...
    private Optional<FrameMetricsCalculator.PerfFrameMetrics> snapshot() {
        ...
        return Optional.m516of(FrameMetricsCalculator.calculateFrameMetrics(metrics));
    }
}
