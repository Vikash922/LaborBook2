...
public class CrashlyticsReportJsonTransform {
        ...
        while (jsonReader.hasNext()) {
            ...
            switch (strNextName.hashCode()) {
                ...
                case 1047652060:
                    ...
                    break;
                case 1874684019:
                    if (strNextName.equals(TrackingOptions.AMP_TRACKING_OPTION_PLATFORM)) {
                        b = 9;
                    }
                    break;
                case 1975623094:
        ...
        while (jsonReader.hasNext()) {
            ...
            switch (strNextName.hashCode()) {
                ...
                case -1907185581:
                    ...
                    break;
                case -1618432855:
                    if (strNextName.equals(PdfConst.Identifier)) {
                        b = 2;
                    }
                    break;
                case -1606742899:
                    ...
                    break;
                case -1335157162:
                    if (strNextName.equals(DeviceRequestsHelper.DEVICE_INFO_DEVICE)) {
                        b = 4;
                    }
                    break;
                case -1291329255:
                    if (strNextName.equals(DatabaseConstants.EVENT_TABLE_NAME)) {
                        b = 5;
                    }
                    break;
                case 3556:
    ...
    public static CrashlyticsReport.FilesPayload.File parseFile(JsonReader jsonReader) throws IOException {
        ...
        while (jsonReader.hasNext()) {
            ...
            } else if (strNextName.equals(XfdfConstants.CONTENTS)) {
    ...
    private static CrashlyticsReport.Session.User parseUser(JsonReader jsonReader) throws IOException {
        ...
        jsonReader.beginObject();
        while (jsonReader.hasNext()) {
            if (jsonReader.nextName().equals(PdfConst.Identifier)) {
