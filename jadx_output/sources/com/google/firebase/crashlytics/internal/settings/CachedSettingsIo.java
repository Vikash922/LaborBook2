...
public class CachedSettingsIo {
    ...
    public JSONObject readCachedSettings() throws Throwable {
        ...
        Logger.getLogger().m462d("Checking for cached settings...");
            ...
            try {
                ...
                if (settingsFile.exists()) {
                    ...
                    try {
                        ...
                        e = e;
                        Logger.getLogger().m465e("Failed to fetch cached settings", e);
                        CommonUtils.closeOrLog(fileInputStream, "Error while closing settings cache file.");
                        return null;
                    }
                } else {
                    Logger.getLogger().m468v("Settings file does not exist.");
                    jSONObject = null;
                }
    ...
    public void writeCachedSettings(long j, JSONObject jSONObject) throws Throwable {
        ...
        Logger.getLogger().m468v("Writing settings to cache file...");
        if (jSONObject != null) {
            ...
            try {
                ...
                Logger.getLogger().m465e("Failed to cache settings", e);
