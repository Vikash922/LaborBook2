...
final class DecodedBitStreamParser {
    ...
    private static final char f572FS = 28;

    /* JADX INFO: renamed from: GS */
    private static final char f573GS = 29;
    ...
    private static final char f574NS = 65531;
    private static final char PAD = 65532;

    /* JADX INFO: renamed from: RS */
    private static final char f575RS = 30;
    ...
    static DecoderResult decode(byte[] bArr, int i) {
        ...
        if (i == 2 || i == 3) {
            ...
            if (sb.toString().startsWith("[)>\u001e01\u001d")) {
                sb.insert(9, postCode3 + f573GS + str + f573GS + str2 + f573GS);
            } else {
                sb.insert(0, postCode3 + f573GS + str + f573GS + str2 + f573GS);
            }
        } else if (i == 4) {
    ...
    private static int getPostCode2Length(byte[] bArr) {
        return getInt(bArr, new byte[]{39, 40, 41, 42, Ascii.f396US, 32});
    }

    private static int getPostCode2(byte[] bArr) {
        return getInt(bArr, new byte[]{33, 34, 35, 36, Ascii.f385EM, Ascii.SUB, Ascii.ESC, Ascii.f387FS, Ascii.f388GS, Ascii.f392RS, 19, Ascii.DC4, Ascii.NAK, Ascii.SYN, Ascii.ETB, Ascii.CAN, Ascii.f384CR, Ascii.f394SO, Ascii.f393SI, 16, 17, Ascii.DC2, 7, 8, 9, 10, Ascii.f397VT, Ascii.f386FF, 1, 2});
    }

    private static String getPostCode3(byte[] bArr) {
        String[] strArr = SETS;
        return String.valueOf(new char[]{strArr[0].charAt(getInt(bArr, new byte[]{39, 40, 41, 42, Ascii.f396US, 32})), strArr[0].charAt(getInt(bArr, new byte[]{33, 34, 35, 36, Ascii.f385EM, Ascii.SUB})), strArr[0].charAt(getInt(bArr, new byte[]{Ascii.ESC, Ascii.f387FS, Ascii.f388GS, Ascii.f392RS, 19, Ascii.DC4})), strArr[0].charAt(getInt(bArr, new byte[]{Ascii.NAK, Ascii.SYN, Ascii.ETB, Ascii.CAN, Ascii.f384CR, Ascii.f394SO})), strArr[0].charAt(getInt(bArr, new byte[]{Ascii.f393SI, 16, 17, Ascii.DC2, 7, 8})), strArr[0].charAt(getInt(bArr, new byte[]{9, 10, Ascii.f397VT, Ascii.f386FF, 1, 2}))});
    }
        ...
        while (i3 < i + i2) {
            ...
            switch (cCharAt) {
                ...
                default:
                    ...
                    break;
                case 65531:
                    int i7 = (bArr[i3 + 1] << Ascii.CAN) + (bArr[i3 + 2] << Ascii.DC2) + (bArr[i3 + 3] << Ascii.f386FF) + (bArr[i3 + 4] << 6);
                    i3 += 5;
