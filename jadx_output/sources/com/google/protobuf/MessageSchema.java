...
final class MessageSchema<T> implements Schema<T> {
    ...
    static <T> MessageSchema<T> newSchemaForMessageInfo(StructuralMessageInfo structuralMessageInfo, NewInstanceSchema newInstanceSchema, ListFieldSchema listFieldSchema, UnknownFieldSchema<?, ?> unknownFieldSchema, ExtensionSchema<?> extensionSchema, MapFieldSchema mapFieldSchema) {
        ...
        for (FieldInfo fieldInfo : fields) {
            if (fieldInfo.getType() == FieldType.MAP) {
                i2++;
            } else if (fieldInfo.getType().m535id() >= 18 && fieldInfo.getType().m535id() <= 49) {
                i3++;
            }
        }
        ...
        while (i4 < fields.length) {
            ...
            if (fieldInfo2.getType() == FieldType.MAP) {
                ...
                if (fieldInfo2.getType().m535id() >= 18 && fieldInfo2.getType().m535id() <= 49) {
                    i = i5;
    ...
    */
    ...
    private int getSerializedSizeProto2(T t) {
        ...
        while (i5 < this.buffer.length) {
            ...
            if (iType <= 17) {
                ...
                i = (!this.useCachedSizeField || iType < FieldType.DOUBLE_LIST_PACKED.m535id() || iType > FieldType.SINT64_LIST_PACKED.m535id()) ? 0 : this.buffer[i5 + 2] & i3;
                i2 = 0;
            }
            long jOffset = offset(iTypeAndOffsetAt);
            switch (iType) {
    ...
    private int getSerializedSizeProto3(T t) {
        ...
        for (int i2 = 0; i2 < this.buffer.length; i2 += 3) {
            ...
            long jOffset = offset(iTypeAndOffsetAt);
            int i3 = (iType < FieldType.DOUBLE_LIST_PACKED.m535id() || iType > FieldType.SINT64_LIST_PACKED.m535id()) ? 0 : this.buffer[i2 + 2] & 1048575;
            switch (iType) {
                case 0:
    ...
    */
    ...
    private int decodeMapEntryValue(byte[] bArr, int i, int i2, WireFormat.FieldType fieldType, Class<?> cls, ArrayDecoders.Registers registers) throws IOException {
        switch (C25391.$SwitchMap$com$google$protobuf$WireFormat$FieldType[fieldType.ordinal()]) {
            case 1:
                    ...
                    if (iType <= 17) {
                        ...
                        switch (iType) {
                            ...
                            case 9:
                                ...
                                i18 = i34;
                                if (i31 == 2) {
                                    Object objMutableMessageFieldForMerge = messageSchema2.mutableMessageFieldForMerge(t3, i19);
                                    iDecodeUnknownField = ArrayDecoders.mergeMessageField(objMutableMessageFieldForMerge, messageSchema2.getMessageFieldSchema(i19), bArr, i29, i2, registers);
                                    messageSchema2.storeMessageField(t3, i19, objMutableMessageFieldForMerge);
                                    i26 = i15 | i36;
                                    i23 = i3;
                                    i24 = i19;
                                    i25 = i18;
                            ...
                            case 12:
                                ...
                                if (i31 == 0) {
                                    ...
                                    if (enumFieldVerifier == null || enumFieldVerifier.isInRange(i38)) {
                                        ...
                                        getMutableUnknownFields(t).storeField(i18, Long.valueOf(i38));
                                        i24 = i19;
                                        i26 = i15;
                                        i25 = i18;
                                        i27 = i10;
