...
public enum FieldType {
    ...
    static {
        ...
        for (FieldType fieldType : fieldTypeArrValues) {
            VALUES[fieldType.f521id] = fieldType;
        }
    }
    ...
    FieldType(int i, Collection collection, JavaType javaType) {
        ...
        int i3 = C25281.$SwitchMap$com$google$protobuf$FieldType$Collection[collection.ordinal()];
        if (i3 == 1 || i3 == 2) {
            this.elementType = javaType.getBoxedType();
        } else {
            this.elementType = null;
        }
        this.primitiveScalar = (collection != Collection.SCALAR || (i2 = C25281.$SwitchMap$com$google$protobuf$JavaType[javaType.ordinal()]) == 1 || i2 == 2 || i2 == 3) ? false : true;
    }

    /* JADX INFO: renamed from: com.google.protobuf.FieldType$1 */
    static /* synthetic */ class C25281 {
