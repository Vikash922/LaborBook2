...
final class FieldInfo implements Comparable<FieldInfo> {
    ...
    public static FieldInfo forField(java.lang.reflect.Field field, int i, FieldType fieldType, boolean z) {
        checkFieldNumber(i);
        Internal.checkNotNull(field, XfdfConstants.FIELD);
    ...
    public Class<?> getMessageFieldClass() {
        int i = C25251.$SwitchMap$com$google$protobuf$FieldType[this.type.ordinal()];
        if (i == 1 || i == 2) {
    ...
    public static final class Builder {
        ...
        /* synthetic */ Builder(C25251 c25251) {
            this();
        }
