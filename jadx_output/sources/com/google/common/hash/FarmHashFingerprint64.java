...
final class FarmHashFingerprint64 extends AbstractNonStreamingHashFunction {
    ...
    private static final long f426K0 = -4348849565147123417L;

    /* JADX INFO: renamed from: K1 */
    private static final long f427K1 = -5435081209227447693L;

    /* JADX INFO: renamed from: K2 */
    private static final long f428K2 = -7286425919675154353L;
    ...
    private static long hashLength0to16(byte[] bArr, int i, int i2) {
        if (i2 >= 8) {
            long j = ((long) (i2 * 2)) + f428K2;
            long jLoad64 = LittleEndianByteArray.load64(bArr, i) + f428K2;
        ...
        if (i2 >= 4) {
            return hashLength16(((long) i2) + ((((long) LittleEndianByteArray.load32(bArr, i)) & BodyPartID.bodyIdMax) << 3), ((long) LittleEndianByteArray.load32(bArr, (i + i2) - 4)) & BodyPartID.bodyIdMax, ((long) (i2 * 2)) + f428K2);
        }
        if (i2 <= 0) {
            return f428K2;
        }
        return shiftMix((((long) ((bArr[i] & 255) + ((bArr[(i2 >> 1) + i] & 255) << 8))) * f428K2) ^ (((long) (i2 + ((bArr[i + (i2 - 1)] & 255) << 2))) * f426K0)) * f428K2;
    }

    private static long hashLength17to32(byte[] bArr, int i, int i2) {
        long j = ((long) (i2 * 2)) + f428K2;
        long jLoad64 = LittleEndianByteArray.load64(bArr, i) * f427K1;
        long jLoad642 = LittleEndianByteArray.load64(bArr, i + 8);
        int i3 = i + i2;
        long jLoad643 = LittleEndianByteArray.load64(bArr, i3 - 8) * j;
        return hashLength16((LittleEndianByteArray.load64(bArr, i3 - 16) * f428K2) + Long.rotateRight(jLoad64 + jLoad642, 43) + Long.rotateRight(jLoad643, 30), jLoad64 + Long.rotateRight(jLoad642 + f428K2, 18) + jLoad643, j);
    }
    ...
    private static long hashLength33To64(byte[] bArr, int i, int i2) {
        ...
        int i3 = i + i2;
        long jLoad643 = LittleEndianByteArray.load64(bArr, i3 - 8) * j;
        long jRotateRight = Long.rotateRight(jLoad64 + jLoad642, 43) + Long.rotateRight(jLoad643, 30) + (LittleEndianByteArray.load64(bArr, i3 - 16) * f428K2);
        long jHashLength16 = hashLength16(jRotateRight, jLoad643 + Long.rotateRight(jLoad642 + f428K2, 18) + jLoad64, j);
    ...
    private static long hashLength65Plus(byte[] bArr, int i, int i2) {
        long j = 81;
        long j2 = (j * f427K1) + 113;
        long jShiftMix = shiftMix((j2 * f428K2) + 113) * f428K2;
        long[] jArr = new long[2];
        long[] jArr2 = new long[2];
        long jLoad64 = (j * f428K2) + LittleEndianByteArray.load64(bArr, i);
        int i3 = i2 - 1;
        int i4 = i + ((i3 / 64) * 64);
        int i5 = i3 & 63;
        int i6 = i4 + i5;
        ...
        int i8 = i;
        while (true) {
            long jRotateRight = Long.rotateRight(jLoad64 + j2 + jArr[0] + LittleEndianByteArray.load64(bArr, i8 + 8), 37) * f427K1;
            long jRotateRight2 = Long.rotateRight(j2 + jArr[1] + LittleEndianByteArray.load64(bArr, i8 + 48), 42) * f427K1;
            long j3 = jRotateRight ^ jArr2[1];
            long jLoad642 = jRotateRight2 + jArr[0] + LittleEndianByteArray.load64(bArr, i8 + 40);
            long jRotateRight3 = Long.rotateRight(jShiftMix + jArr2[0], 33) * f427K1;
            weakHashLength32WithSeeds(bArr, i8, jArr[1] * f427K1, j3 + jArr2[0], jArr);
            weakHashLength32WithSeeds(bArr, i8 + 32, jRotateRight3 + jArr2[1], jLoad642 + LittleEndianByteArray.load64(bArr, i8 + 16), jArr2);
            int i9 = i8 + 64;
            if (i9 == i4) {
                long j4 = f427K1 + ((j3 & 255) << 1);
                ...
                return hashLength16(hashLength16(jArr[0], jArr2[0], j4) + (shiftMix(jLoad643) * f426K0) + j7, hashLength16(jArr[1], jArr2[1], j4) + jRotateRight6, j4);
            }
            i8 = i9;
            jShiftMix = j3;
            j2 = jLoad642;
