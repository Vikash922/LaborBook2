...
abstract class AbstractBaseGraph<N> implements BaseGraph<N> {
    ...
    public Set<EndpointPair<N>> edges() {
        return new AbstractSet<EndpointPair<N>>() { // from class: com.google.common.graph.AbstractBaseGraph.1
            ...
            public UnmodifiableIterator<EndpointPair<N>> iterator() {
                return EndpointPairIterator.m401of(AbstractBaseGraph.this);
            }
    ...
    public Set<EndpointPair<N>> incidentEdges(N n) {
        ...
        return new C20032(this, this, n);
    }

    /* JADX INFO: renamed from: com.google.common.graph.AbstractBaseGraph$2 */
    class C20032 extends IncidentEdgeSet<N> {
        C20032(AbstractBaseGraph abstractBaseGraph, BaseGraph baseGraph, Object obj) {
            super(baseGraph, obj);
        }
        ...
        public UnmodifiableIterator<EndpointPair<N>> iterator() {
            if (this.graph.isDirected()) {
                return Iterators.unmodifiableIterator(Iterators.concat(Iterators.transform(this.graph.predecessors((Object) this.node).iterator(), new Function() { // from class: com.google.common.graph.AbstractBaseGraph$2$$ExternalSyntheticLambda0
                    ...
                    public final Object apply(Object obj) {
                        return this.f$0.m3075lambda$iterator$0$comgooglecommongraphAbstractBaseGraph$2(obj);
                    }
                }), Iterators.transform(Sets.difference(this.graph.successors((Object) this.node), ImmutableSet.m334of(this.node)).iterator(), new Function() { // from class: com.google.common.graph.AbstractBaseGraph$2$$ExternalSyntheticLambda1
                    @Override // com.google.common.base.Function
                    public final Object apply(Object obj) {
                        return this.f$0.m3076lambda$iterator$1$comgooglecommongraphAbstractBaseGraph$2(obj);
                    }
                })));
            }
            return Iterators.unmodifiableIterator(Iterators.transform(this.graph.adjacentNodes(this.node).iterator(), new Function() { // from class: com.google.common.graph.AbstractBaseGraph$2$$ExternalSyntheticLambda2
                @Override // com.google.common.base.Function
                public final Object apply(Object obj) {
                    return this.f$0.m3077lambda$iterator$2$comgooglecommongraphAbstractBaseGraph$2(obj);
                }
            }));
        }

        /* JADX INFO: renamed from: lambda$iterator$0$com-google-common-graph-AbstractBaseGraph$2, reason: not valid java name */
        /* synthetic */ EndpointPair m3075lambda$iterator$0$comgooglecommongraphAbstractBaseGraph$2(Object obj) {
        ...
        /* synthetic */ EndpointPair m3076lambda$iterator$1$comgooglecommongraphAbstractBaseGraph$2(Object obj) {
        ...
        /* synthetic */ EndpointPair m3077lambda$iterator$2$comgooglecommongraphAbstractBaseGraph$2(Object obj) {
