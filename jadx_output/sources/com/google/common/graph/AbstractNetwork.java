...
public abstract class AbstractNetwork<N, E> implements Network<N, E> {
    ...
    class C20051 extends AbstractGraph<N> {
        C20051() {
        }
        ...
        public Set<EndpointPair<N>> edges() {
            ...
            return new AbstractSet<EndpointPair<N>>() { // from class: com.google.common.graph.AbstractNetwork.1.1
                ...
                public boolean contains(@CheckForNull Object obj) {
                    ...
                    return C20051.this.isOrderingCompatible(endpointPair) && C20051.this.nodes().contains(endpointPair.nodeU()) && C20051.this.successors(endpointPair.nodeU()).contains(endpointPair.nodeV());
                }
            };
        }
    ...
    public Set<E> adjacentEdges(E e) {
        ...
        return Sets.difference(Sets.union(incidentEdges(endpointPairIncidentNodes.nodeU()), incidentEdges(endpointPairIncidentNodes.nodeV())), ImmutableSet.m334of((Object) e));
    }
