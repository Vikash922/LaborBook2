...
public abstract class CharMatcher implements Predicate<Character> {
    ...
    public static CharMatcher m255is(char c) {
        return new C1738Is(c);
    }
    ...
    public static CharMatcher anyOf(CharSequence charSequence) {
        ...
        if (length == 1) {
            return m255is(charSequence.charAt(0));
        }
        if (length == 2) {
    ...
    public CharMatcher mo256or(CharMatcher charMatcher) {
        return new C1739Or(this, charMatcher);
    }
    ...
    private static CharMatcher precomputedPositive(int i, BitSet bitSet, String str) {
        ...
        if (i == 1) {
            return m255is((char) bitSet.nextSetBit(0));
        }
        if (i == 2) {
    ...
    private static final class C1739Or extends CharMatcher {
        final CharMatcher first;
        final CharMatcher second;
        ...
        C1739Or(CharMatcher charMatcher, CharMatcher charMatcher2) {
            this.first = (CharMatcher) Preconditions.checkNotNull(charMatcher);
            this.second = (CharMatcher) Preconditions.checkNotNull(charMatcher2);
        }
    ...
    private static final class C1738Is extends FastMatcher {
        ...
        /* JADX INFO: renamed from: or */
        public CharMatcher mo256or(CharMatcher charMatcher) {
            return charMatcher.matches(this.match) ? charMatcher : super.mo256or(charMatcher);
        }
