...
public final class Functions {
    ...
    private static class FunctionComposition<A, B, C> implements Function<A, C>, Serializable {
        ...
        private final Function<A, ? extends B> f398f;

        /* JADX INFO: renamed from: g */
        private final Function<B, C> f399g;

        public FunctionComposition(Function<B, C> function, Function<A, ? extends B> function2) {
            this.f399g = (Function) Preconditions.checkNotNull(function);
            this.f398f = (Function) Preconditions.checkNotNull(function2);
        }

        @Override // com.google.common.base.Function
        @ParametricNullness
        public C apply(@ParametricNullness A a2) {
            return (C) this.f399g.apply(this.f398f.apply(a2));
        }
        ...
        public boolean equals(@CheckForNull Object obj) {
            ...
            return this.f398f.equals(functionComposition.f398f) && this.f399g.equals(functionComposition.f399g);
        }

        public int hashCode() {
            return this.f398f.hashCode() ^ this.f399g.hashCode();
        }

        public String toString() {
            String strValueOf = String.valueOf(this.f399g);
            String strValueOf2 = String.valueOf(this.f398f);
