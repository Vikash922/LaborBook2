...
public final class Stopwatch {
    ...
    public String toString() {
        ...
        return new StringBuilder(String.valueOf(compact4Digits).length() + 1 + String.valueOf(strAbbreviate).length()).append(compact4Digits).append(StringUtils.SPACE).append(strAbbreviate).toString();
    }
    ...
    private static String abbreviate(TimeUnit timeUnit) {
        switch (C17591.$SwitchMap$java$util$concurrent$TimeUnit[timeUnit.ordinal()]) {
            case 1:
                return "ns";
            case 2:
                return "μs";
