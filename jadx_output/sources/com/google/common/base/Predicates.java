...
public final class Predicates {
    ...
    public static <T> Predicate<T> m262or(Iterable<? extends Predicate<? super T>> iterable) {
        return new OrPredicate(defensiveCopy(iterable));
    }

    @SafeVarargs
    /* JADX INFO: renamed from: or */
    public static <T> Predicate<T> m263or(Predicate<? super T>... predicateArr) {
        return new OrPredicate(defensiveCopy(predicateArr));
    }

    /* JADX INFO: renamed from: or */
    public static <T> Predicate<T> m261or(Predicate<? super T> predicate, Predicate<? super T> predicate2) {
    ...
    public static <T> Predicate<T> m260in(Collection<? extends T> collection) {
    ...
    private static class AndPredicate<T> implements Predicate<T>, Serializable {
        ...
        public String toString() {
            return Predicates.toStringHelper(MediaRuleConstants.AND, this.components);
        }
    }
    ...
    private static class CompositionPredicate<A, B> implements Predicate<A>, Serializable {
        ...
        final Function<A, ? extends B> f400f;

        /* JADX INFO: renamed from: p */
        final Predicate<B> f401p;

        private CompositionPredicate(Predicate<B> predicate, Function<A, ? extends B> function) {
            this.f401p = (Predicate) Preconditions.checkNotNull(predicate);
            this.f400f = (Function) Preconditions.checkNotNull(function);
        }

        @Override // com.google.common.base.Predicate
        public boolean apply(@ParametricNullness A a2) {
            return this.f401p.apply(this.f400f.apply(a2));
        }
        ...
        public boolean equals(@CheckForNull Object obj) {
            ...
            return this.f400f.equals(compositionPredicate.f400f) && this.f401p.equals(compositionPredicate.f401p);
        }

        public int hashCode() {
            return this.f400f.hashCode() ^ this.f401p.hashCode();
        }

        public String toString() {
            String strValueOf = String.valueOf(this.f401p);
            String strValueOf2 = String.valueOf(this.f400f);
