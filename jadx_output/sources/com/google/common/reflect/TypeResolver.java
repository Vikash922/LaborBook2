...
public final class TypeResolver {
    ...
    private static class WildcardCapturer {
        ...
        private final AtomicInteger f472id;
        ...
        TypeVariable<?> captureAsTypeVariable(Type[] typeArr) {
            int iIncrementAndGet = this.f472id.incrementAndGet();
            String strJoin = Joiner.m257on(Typography.amp).join(typeArr);
        ...
        private WildcardCapturer forTypeVariable(final TypeVariable<?> typeVariable) {
            return new WildcardCapturer(this, this.f472id) { // from class: com.google.common.reflect.TypeResolver.WildcardCapturer.1
        ...
        private WildcardCapturer notForTypeVariable() {
            return new WildcardCapturer(this.f472id);
        }
