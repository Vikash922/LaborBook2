...
public final class InternetDomainName {
    ...
    private static final Splitter DOT_SPLITTER = Splitter.m264on(ClassUtils.PACKAGE_SEPARATOR_CHAR);
    private static final Joiner DOT_JOINER = Joiner.m257on(ClassUtils.PACKAGE_SEPARATOR_CHAR);
    ...
    static {
        ...
        CharMatcher charMatcherMo256or = CharMatcher.inRange('a', 'z').mo256or(CharMatcher.inRange('A', Matrix.MATRIX_TYPE_ZERO));
        LETTER_MATCHER = charMatcherMo256or;
        PART_CHAR_MATCHER = charMatcherInRange.mo256or(charMatcherMo256or).mo256or(charMatcherAnyOf);
    }
    ...
    InternetDomainName(String str) {
        ...
        this.registrySuffixIndex = findSuffixOfType(Optional.m259of(PublicSuffixType.REGISTRY));
    }
