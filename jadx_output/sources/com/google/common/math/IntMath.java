...
public final class IntMath {
    ...
    public static int ceilingPowerOfTwo(int i) {
        MathPreconditions.checkPositive(SvgConstants.Attributes.f3330X, i);
        if (i > 1073741824) {
    ...
    public static int log2(int i, RoundingMode roundingMode) {
        MathPreconditions.checkPositive(SvgConstants.Attributes.f3330X, i);
        switch (C20741.$SwitchMap$java$math$RoundingMode[roundingMode.ordinal()]) {
            case 1:
    ...
    public static int sqrt(int i, RoundingMode roundingMode) {
        int iLessThanBranchFree;
        MathPreconditions.checkNonNegative(SvgConstants.Attributes.f3330X, i);
    ...
    public static int gcd(int i, int i2) {
        ...
        MathPreconditions.checkNonNegative(SvgConstants.Attributes.PATH_DATA_REL_BEARING, i2);
        if (i == 0) {
            return i2;
        }
        if (i2 == 0) {
