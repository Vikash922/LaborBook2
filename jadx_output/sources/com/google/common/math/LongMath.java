...
public final class LongMath {
    ...
    static final byte[] maxLog10ForLeadingZeros = {19, Ascii.DC2, Ascii.DC2, Ascii.DC2, Ascii.DC2, 17, 17, 17, 16, 16, 16, Ascii.f393SI, Ascii.f393SI, Ascii.f393SI, Ascii.f393SI, Ascii.f394SO, Ascii.f394SO, Ascii.f394SO, Ascii.f384CR, Ascii.f384CR, Ascii.f384CR, Ascii.f386FF, Ascii.f386FF, Ascii.f386FF, Ascii.f386FF, Ascii.f397VT, Ascii.f397VT, Ascii.f397VT, 10, 10, 10, 9, 9, 9, 9, 8, 8, 8, 7, 7, 7, 6, 6, 6, 6, 5, 5, 5, 4, 4, 4, 3, 3, 3, 3, 2, 2, 2, 1, 1, 1, 0, 0, 0};
    ...
    static final int[] biggestBinomials = {Integer.MAX_VALUE, Integer.MAX_VALUE, Integer.MAX_VALUE, 3810779, 121977, 16175, 4337, 1733, 887, 534, 361, TIFFConstants.TIFFTAG_CELLLENGTH, 206, Opcodes.RET, Opcodes.D2L, 125, 111, 101, 94, 88, 83, 79, 76, 74, 72, 70, 69, 68, 67, 67, 66, 66, 66, 66};
    static final int[] biggestSimpleBinomials = {Integer.MAX_VALUE, Integer.MAX_VALUE, Integer.MAX_VALUE, 2642246, 86251, 11724, 3218, MetaDo.META_TEXTOUT, 684, 419, TIFFConstants.TIFFTAG_YPOSITION, 214, Opcodes.RET, Opcodes.F2I, 119, 105, 95, 87, 81, 76, 73, 70, 68, 66, 64, 63, 62, 62, 61, 61, 61};
    ...
    public static long ceilingPowerOfTwo(long j) {
        MathPreconditions.checkPositive(SvgConstants.Attributes.f3330X, j);
    ...
    public static int log2(long j, RoundingMode roundingMode) {
        MathPreconditions.checkPositive(SvgConstants.Attributes.f3330X, j);
        switch (C20761.$SwitchMap$java$math$RoundingMode[roundingMode.ordinal()]) {
            case 1:
    ...
    public static long sqrt(long j, RoundingMode roundingMode) {
        MathPreconditions.checkNonNegative(SvgConstants.Attributes.f3330X, j);
        if (fitsInInt(j)) {
    ...
    public static long gcd(long j, long j2) {
        ...
        MathPreconditions.checkNonNegative(SvgConstants.Attributes.PATH_DATA_REL_BEARING, j2);
        if (j == 0) {
            return j2;
        }
        if (j2 == 0) {
    ...
    private enum MillerRabinTester {
        ...
        /* synthetic */ MillerRabinTester(C20761 c20761) {
            this();
        }
    ...
    public static double roundToDouble(long j, RoundingMode roundingMode) {
        ...
        switch (C20761.$SwitchMap$java$math$RoundingMode[roundingMode.ordinal()]) {
            ...
            case 8:
                ...
                int i = C20761.$SwitchMap$java$math$RoundingMode[roundingMode.ordinal()];
                if (i == 6) {
