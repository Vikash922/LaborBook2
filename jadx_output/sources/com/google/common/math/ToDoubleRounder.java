...
abstract class ToDoubleRounder<X extends Number & Comparable<X>> {
    ...
    final double roundToDouble(X x, RoundingMode roundingMode) {
        Number x2;
        double dNextUp;
        Preconditions.checkNotNull(x, SvgConstants.Attributes.f3330X);
        ...
        if (Double.isInfinite(dRoundToDoubleArbitrarily)) {
            switch (C20801.$SwitchMap$java$math$RoundingMode[roundingMode.ordinal()]) {
                case 1:
                case 2:
                case 3:
                case 4:
        ...
        switch (C20801.$SwitchMap$java$math$RoundingMode[roundingMode.ordinal()]) {
            ...
            case 4:
                ...
                int i = C20801.$SwitchMap$java$math$RoundingMode[roundingMode.ordinal()];
                if (i == 2) {
