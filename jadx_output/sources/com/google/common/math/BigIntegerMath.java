...
public final class BigIntegerMath {
    ...
    public static int log2(BigInteger bigInteger, RoundingMode roundingMode) {
        MathPreconditions.checkPositive(SvgConstants.Attributes.f3330X, (BigInteger) Preconditions.checkNotNull(bigInteger));
        int iBitLength = bigInteger.bitLength();
        int i = iBitLength - 1;
        switch (C20721.$SwitchMap$java$math$RoundingMode[roundingMode.ordinal()]) {
            case 1:
    ...
    public static int log10(BigInteger bigInteger, RoundingMode roundingMode) {
        int iCompareTo;
        MathPreconditions.checkPositive(SvgConstants.Attributes.f3330X, bigInteger);
    ...
    public static BigInteger sqrt(BigInteger bigInteger, RoundingMode roundingMode) {
        MathPreconditions.checkNonNegative(SvgConstants.Attributes.f3330X, bigInteger);
        if (fitsInLong(bigInteger)) {
