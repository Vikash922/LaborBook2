...
public final class Stats implements Serializable {
    ...
    public static Stats m406of(Iterable<? extends Number> iterable) {
    ...
    /* JADX INFO: renamed from: of */
    public static Stats m407of(Iterator<? extends Number> it) {
        StatsAccumulator statsAccumulator = new StatsAccumulator();
    ...
    /* JADX INFO: renamed from: of */
    public static Stats m408of(double... dArr) {
        StatsAccumulator statsAccumulator = new StatsAccumulator();
    ...
    /* JADX INFO: renamed from: of */
    public static Stats m409of(int... iArr) {
        StatsAccumulator statsAccumulator = new StatsAccumulator();
    ...
    /* JADX INFO: renamed from: of */
    public static Stats m410of(long... jArr) {
        StatsAccumulator statsAccumulator = new StatsAccumulator();
    ...
    public String toString() {
        if (count() > 0) {
            return MoreObjects.toStringHelper(this).add("count", this.count).add("mean", this.mean).add("populationStandardDeviation", populationStandardDeviation()).add(MediaRuleConstants.MIN, this.min).add(MediaRuleConstants.MAX, this.max).toString();
        }
