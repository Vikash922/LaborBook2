...
public abstract class AbstractFuture<V> extends InternalFutureFailureAccess implements ListenableFuture<V> {
    ...
    public V get(long j, TimeUnit timeUnit) throws ExecutionException, InterruptedException, TimeoutException {
        ...
        String string2 = new StringBuilder(String.valueOf(lowerCase2).length() + 28).append("Waited ").append(j).append(StringUtils.SPACE).append(lowerCase2).toString();
        if (nanos + 1000 < 0) {
            ...
            if (jConvert > 0) {
                ...
                String string3 = new StringBuilder(String.valueOf(strValueOf).length() + 21 + String.valueOf(lowerCase).length()).append(strValueOf).append(jConvert).append(StringUtils.SPACE).append(lowerCase).toString();
                if (z) {
                    string3 = String.valueOf(string3).concat(",");
                }
                strConcat = String.valueOf(string3).concat(StringUtils.SPACE);
            }
            if (z) {
    ...
    private static final class UnsafeAtomicHelper extends AtomicHelper {
        ...
        boolean casWaiters(AbstractFuture<?> abstractFuture, @CheckForNull Waiter waiter, @CheckForNull Waiter waiter2) {
            return zzgaj$$ExternalSyntheticBackportWithForwarding0.m150m(UNSAFE, abstractFuture, WAITERS_OFFSET, waiter, waiter2);
        }

        @Override // com.google.common.util.concurrent.AbstractFuture.AtomicHelper
        boolean casListeners(AbstractFuture<?> abstractFuture, @CheckForNull Listener listener, Listener listener2) {
            return zzgaj$$ExternalSyntheticBackportWithForwarding0.m150m(UNSAFE, abstractFuture, LISTENERS_OFFSET, listener, listener2);
        }
        ...
        boolean casValue(AbstractFuture<?> abstractFuture, @CheckForNull Object obj, Object obj2) {
            return zzgaj$$ExternalSyntheticBackportWithForwarding0.m150m(UNSAFE, abstractFuture, VALUE_OFFSET, obj, obj2);
        }
    }
    ...
    private static final class SafeAtomicHelper extends AtomicHelper {
        ...
        @Override // com.google.common.util.concurrent.AbstractFuture.AtomicHelper
        boolean casWaiters(AbstractFuture<?> abstractFuture, @CheckForNull Waiter waiter, @CheckForNull Waiter waiter2) {
            return C0214xc40028dd.m8m(this.waitersUpdater, abstractFuture, waiter, waiter2);
        }

        @Override // com.google.common.util.concurrent.AbstractFuture.AtomicHelper
        boolean casListeners(AbstractFuture<?> abstractFuture, @CheckForNull Listener listener, Listener listener2) {
            return C0214xc40028dd.m8m(this.listenersUpdater, abstractFuture, listener, listener2);
        }
        ...
        @Override // com.google.common.util.concurrent.AbstractFuture.AtomicHelper
        boolean casValue(AbstractFuture<?> abstractFuture, @CheckForNull Object obj, Object obj2) {
            return C0214xc40028dd.m8m(this.valueUpdater, abstractFuture, obj, obj2);
        }
    }
