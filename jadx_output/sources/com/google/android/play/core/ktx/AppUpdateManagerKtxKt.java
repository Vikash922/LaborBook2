...
public final class AppUpdateManagerKtxKt {
    ...
    /* JADX INFO: renamed from: com.google.android.play.core.ktx.AppUpdateManagerKtxKt$requestUpdateFlow$1 */
    /* JADX INFO: compiled from: com.google.android.play:app-update-ktx@@2.1.0 */
    @Metadata(m2721d1 = {"\u0000\u000e\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0010\u0002\n\u0000\u0010\u0003\u001a\u00020\u0002*\b\u0012\u0004\u0012\u00020\u00010\u0000H\u008a@"}, m2722d2 = {"Lkotlinx/coroutines/channels/ProducerScope;", "Lcom/google/android/play/core/ktx/AppUpdateResult;", "", "<anonymous>"}, m2723k = 3, m2724mv = {1, 8, 0})
    @DebugMetadata(m2734c = "com.google.android.play.core.ktx.AppUpdateManagerKtxKt$requestUpdateFlow$1", m2735f = "AppUpdateManagerKtx.kt", m2736i = {}, m2737l = {90}, m2738m = "invokeSuspend", m2739n = {}, m2740s = {})
    static final class C16641 extends SuspendLambda implements Function2<ProducerScope<? super AppUpdateResult>, Continuation<? super Unit>, Object> {
        final /* synthetic */ AppUpdateManager $this_requestUpdateFlow;
        private /* synthetic */ Object L$0;
        int label;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C16641(AppUpdateManager appUpdateManager, Continuation<? super C16641> continuation) {
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            C16641 c16641 = new C16641(this.$this_requestUpdateFlow, continuation);
            c16641.L$0 = obj;
            return c16641;
        }
        ...
        public final Object invoke(ProducerScope<? super AppUpdateResult> producerScope, Continuation<? super Unit> continuation) {
            return ((C16641) create(producerScope, continuation)).invokeSuspend(Unit.INSTANCE);
        }
    ...
    */
    public static final java.lang.Object requestAppUpdateInfo(com.google.android.play.core.appupdate.AppUpdateManager r4, kotlin.coroutines.Continuation<? super com.google.android.play.core.appupdate.AppUpdateInfo> r5) {
        /*
            boolean r0 = r5 instanceof com.google.android.play.core.ktx.AppUpdateManagerKtxKt.C16631
            if (r0 == 0) goto L14
            r0 = r5
            com.google.android.play.core.ktx.AppUpdateManagerKtxKt$requestAppUpdateInfo$1 r0 = (com.google.android.play.core.ktx.AppUpdateManagerKtxKt.C16631) r0
            int r1 = r0.label
    ...
    public static final <T> Object runTask(Task<T> task, final Function0<Unit> function0, Continuation<? super T> continuation) {
        ...
        if (task.isComplete()) {
            if (task.isSuccessful()) {
                cancellableContinuationImpl2.resumeWith(Result.m3325constructorimpl(task.getResult()));
            } else {
                Exception exception = task.getException();
                Intrinsics.checkNotNull(exception);
                cancellableContinuationImpl2.resumeWith(Result.m3325constructorimpl(ResultKt.createFailure(exception)));
            }
        } else {
            task.addOnSuccessListener(new OnSuccessListener() { // from class: com.google.android.play.core.ktx.AppUpdateManagerKtxKt$runTask$3$2
                ...
                public final void onSuccess(T t) {
                    cancellableContinuationImpl2.resumeWith(Result.m3325constructorimpl(t));
                }
            });
            task.addOnFailureListener(new OnFailureListener() { // from class: com.google.android.play.core.ktx.AppUpdateManagerKtxKt$runTask$3$3
                ...
                public final void onFailure(Exception exception2) {
                    ...
                    cancellableContinuationImpl2.resumeWith(Result.m3325constructorimpl(ResultKt.createFailure(exception2)));
                }
            });
        }
    ...
    public static final Flow<AppUpdateResult> requestUpdateFlow(AppUpdateManager appUpdateManager) throws InstallException {
        ...
        return FlowKt.conflate(FlowKt.callbackFlow(new C16641(appUpdateManager, null)));
    }
    ...
    public static final <E> boolean tryOffer(SendChannel<? super E> sendChannel, E e) {
        ...
        return ChannelResult.m4839isSuccessimpl(sendChannel.mo4818trySendJP2dKIU(e));
    }
}
