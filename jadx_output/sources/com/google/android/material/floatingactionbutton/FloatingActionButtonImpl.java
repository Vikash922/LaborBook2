...
class FloatingActionButtonImpl {
    ...
    private static final int SHOW_ANIM_DURATION_ATTR = C1346R.attr.motionDurationLong2;
    private static final int SHOW_ANIM_EASING_ATTR = C1346R.attr.motionEasingEmphasizedInterpolator;
    private static final int HIDE_ANIM_DURATION_ATTR = C1346R.attr.motionDurationMedium1;
    private static final int HIDE_ANIM_EASING_ATTR = C1346R.attr.motionEasingEmphasizedAccelerateInterpolator;
    ...
    private AnimatorSet createAnimator(MotionSpec motionSpec, float f, float f2, float f3) {
        ...
        motionSpec.getTiming(CommonCssConstants.SCALE).apply(objectAnimatorOfFloat2);
        ...
        motionSpec.getTiming(CommonCssConstants.SCALE).apply(objectAnimatorOfFloat3);
    ...
    private AnimatorSet createDefaultAnimator(final float f, final float f2, final float f3, int i, int i2) {
        ...
        AnimatorSetCompat.playTogether(animatorSet, arrayList);
        animatorSet.setDuration(MotionUtils.resolveThemeDuration(this.view.getContext(), i, this.view.getContext().getResources().getInteger(C1346R.integer.material_motion_duration_long_1)));
