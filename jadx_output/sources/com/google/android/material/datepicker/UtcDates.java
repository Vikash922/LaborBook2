...
class UtcDates {
    ...
    static String getDefaultTextInputHint(Resources resources, SimpleDateFormat simpleDateFormat) {
        ...
        String string = resources.getString(C1346R.string.mtrl_picker_text_input_year_abbr);
        String string2 = resources.getString(C1346R.string.mtrl_picker_text_input_month_abbr);
        String string3 = resources.getString(C1346R.string.mtrl_picker_text_input_day_abbr);
        if (Locale.getDefault().getLanguage().equals(Locale.KOREAN.getLanguage())) {
            pattern = pattern.replaceAll("d+", SvgConstants.Attributes.f3323D).replaceAll("M+", "M").replaceAll("y+", SvgConstants.Attributes.f3333Y);
        }
        return pattern.replace(SvgConstants.Attributes.f3323D, string3).replace("M", string2).replace(SvgConstants.Attributes.f3333Y, string);
    }
