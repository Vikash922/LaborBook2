...
final class ColorResourcesTableCreator {
    ...
    private static class PackageChunk {
        ...
        void writeTo(ByteArrayOutputStream byteArrayOutputStream) throws IOException {
            this.header.writeTo(byteArrayOutputStream);
            byteArrayOutputStream.write(ColorResourcesTableCreator.intToByteArray(this.packageInfo.f295id));
            ...
            byteArrayOutputStream.write(ColorResourcesTableCreator.intToByteArray(TIFFConstants.TIFFTAG_FREEOFFSETS));
            byteArrayOutputStream.write(ColorResourcesTableCreator.intToByteArray(0));
            byteArrayOutputStream.write(ColorResourcesTableCreator.intToByteArray(this.typeStrings.getChunkSize() + TIFFConstants.TIFFTAG_FREEOFFSETS));
            byteArrayOutputStream.write(ColorResourcesTableCreator.intToByteArray(0));
            byteArrayOutputStream.write(ColorResourcesTableCreator.intToByteArray(0));
        ...
        int getChunkSize() {
            return this.typeStrings.getChunkSize() + TIFFConstants.TIFFTAG_FREEOFFSETS + this.keyStrings.getChunkSize() + this.typeSpecChunk.getChunkSizeWithTypeChunk();
        }
    }
