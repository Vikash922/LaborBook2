...
final class zzfoc implements zzfmu {
    ...
    public final synchronized String zza(Context context, String str, String str2, View view, Activity activity) {
        Map mapZza;
        mapZza = this.zzc.zza();
        mapZza.put(XfdfConstants.f2852F, SvgConstants.Attributes.PATH_DATA_REL_CURVE_TO);
    ...
    public final synchronized String zzb(Context context, String str, View view, Activity activity) {
        Map mapZzc;
        mapZzc = this.zzc.zzc();
        mapZzc.put(XfdfConstants.f2852F, SvgConstants.Attributes.PATH_DATA_REL_LINE_TO_V);
    ...
    public final synchronized String zzc(Context context, String str) {
        Map mapZzb;
        mapZzb = this.zzc.zzb();
        mapZzb.put(XfdfConstants.f2852F, "q");
    ...
    public final synchronized void zzg() throws zzfom {
        try {
            ...
            this.zzd.zzd(AuthApiStatusCodes.AUTH_API_ACCESS_FORBIDDEN, System.currentTimeMillis() - jCurrentTimeMillis);
        } catch (Exception e) {
