...
public final class zzdvb {
    ...
    public static final void zzb(Context context, ViewGroup viewGroup, NativeAd nativeAd) {
        ...
        linearLayout.addView(zzc(context, resourcesZze == null ? "Headline" : resourcesZze.getString(C1313R.string.native_headline), "headline_header_tag"));
        ...
        linearLayout.addView(zzc(context, resourcesZze == null ? "Body" : resourcesZze.getString(C1313R.string.native_body), "body_header_tag"));
        ...
        linearLayout.addView(zzc(context, resourcesZze == null ? "Media View" : resourcesZze.getString(C1313R.string.native_media_view), "media_view_header_tag"));
