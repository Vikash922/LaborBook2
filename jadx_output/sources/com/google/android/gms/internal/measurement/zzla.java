...
public abstract class zzla<T extends zzkp> {
    ...
    static <T extends zzkp> T zza(Class<T> cls) {
        String str;
        ...
        try {
            ...
            while (it.hasNext()) {
                try {
                    ...
                    Logger.getLogger(zzkl.class.getName()).logp(Level.SEVERE, "com.google.protobuf.GeneratedExtensionRegistryLoader", "load", "Unable to load " + cls.getSimpleName(), (Throwable) e5);
                }
            }
            if (arrayList.size() == 1) {
