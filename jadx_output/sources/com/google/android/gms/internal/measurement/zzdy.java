...
final class zzdy extends zzdv.zzb {
    ...
    zzdy(zzdv zzdvVar, String str, String str2, Context context, Bundle bundle) {
        super(zzdvVar);
        this.zzc = str;
        this.zzd = str2;
        this.zze = context;
    ...
    public final void zza() {
        ...
        try {
            ...
            zzdvVar.zzj = zzdvVar.zza(this.zze, true);
            ...
            ((zzdk) Preconditions.checkNotNull(this.zzg.zzj)).initialize(ObjectWrapper.wrap(this.zze), new zzdt(102001L, Math.max(localVersion, r0), DynamiteModule.getRemoteVersion(this.zze, ModuleDescriptor.MODULE_ID) < localVersion, str, str2, str3, this.zzf, com.google.android.gms.measurement.internal.zzhq.zza(this.zze)), this.zza);
        } catch (Exception e) {
