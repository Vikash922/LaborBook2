...
public final class zziz {
    ...
    public final zzir<Boolean> zza(String str, boolean z) {
        return zzir.zza(this, str, Boolean.valueOf(z), true);
    }
    ...
    private zziz(String str, Uri uri, String str2, String str3, boolean z, boolean z2, boolean z3, boolean z4, @Nullable Function<Context, Boolean> function) {
        this.zza = str;
        this.zzb = uri;
        this.zzc = str2;
        this.zzd = str3;
