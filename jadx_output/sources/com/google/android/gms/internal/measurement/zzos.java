...
interface zzos {
    ...
    void zza(int i, zzjs zzjsVar) throws IOException;

    <K, V> void zza(int i, zzmc<K, V> zzmcVar, Map<K, V> map) throws IOException;

    void zza(int i, Object obj) throws IOException;

    @Deprecated
    void zza(int i, Object obj, zznd zzndVar) throws IOException;

    void zza(int i, String str) throws IOException;

    void zza(int i, List<zzjs> list) throws IOException;

    @Deprecated
    void zza(int i, List<?> list, zznd zzndVar) throws IOException;
    ...
    void zzb(int i, Object obj, zznd zzndVar) throws IOException;

    void zzb(int i, List<String> list) throws IOException;

    void zzb(int i, List<?> list, zznd zzndVar) throws IOException;
