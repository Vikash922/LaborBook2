...
final class zzlb extends zzjm<Float> implements zzll<Float>, zzmx, RandomAccess {
    ...
    public final /* synthetic */ zzll<Float> zza(int i) {
        if (i < this.zzb) {
            throw new IllegalArgumentException();
        }
        return new zzlb(Arrays.copyOf(this.zza, i), this.zzb, true);
    }
    ...
    private zzlb(float[] fArr, int i, boolean z) {
        super(z);
        this.zza = fArr;
        this.zzb = i;
    }
    ...
    public final boolean addAll(Collection<? extends Float> collection) {
        ...
        System.arraycopy(zzlbVar.zza, 0, this.zza, this.zzb, zzlbVar.zzb);
        this.zzb = i3;
        this.modCount++;
        return true;
    }
    ...
    public final boolean equals(Object obj) {
        ...
        if (this.zzb != zzlbVar.zzb) {
            return false;
        }
        float[] fArr = zzlbVar.zza;
        for (int i = 0; i < this.zzb; i++) {
