...
public abstract class zzir<T> {
    ...
    static /* synthetic */ zzir zza(zziz zzizVar, String str, Boolean bool, boolean z) {
        return new zziu(zzizVar, str, bool, true);
    }

    static /* synthetic */ zzir zza(zziz zzizVar, String str, Double d, boolean z) {
        return new zzix(zzizVar, str, d, true);
    }

    static /* synthetic */ zzir zza(zziz zzizVar, String str, Long l, boolean z) {
        return new zziv(zzizVar, str, l, true);
    }

    static /* synthetic */ zzir zza(zziz zzizVar, String str, String str2, boolean z) {
    ...
    */
    public final T zza() {
        /*
            ...
            boolean r0 = r8.zzk
            if (r0 != 0) goto L11
            com.google.android.gms.internal.measurement.zzjc r0 = com.google.android.gms.internal.measurement.zzir.zzd
        ...
        L11:
            java.util.concurrent.atomic.AtomicInteger r0 = com.google.android.gms.internal.measurement.zzir.zze
            int r0 = r0.get()
            int r1 = r8.zzi
            if (r1 >= r0) goto L9b
            monitor-enter(r8)
            ...
            if (r1 >= r0) goto L96
            com.google.android.gms.internal.measurement.zziy r1 = com.google.android.gms.internal.measurement.zzir.zzb     // Catch: java.lang.Throwable -> L98
            ...
            com.google.android.gms.internal.measurement.zzil r3 = (com.google.android.gms.internal.measurement.zzil) r3     // Catch: java.lang.Throwable -> L98
            com.google.android.gms.internal.measurement.zziz r4 = r8.zzf     // Catch: java.lang.Throwable -> L98
            android.net.Uri r4 = r4.zzb     // Catch: java.lang.Throwable -> L98
            com.google.android.gms.internal.measurement.zziz r5 = r8.zzf     // Catch: java.lang.Throwable -> L98
            java.lang.String r5 = r5.zza     // Catch: java.lang.Throwable -> L98
            com.google.android.gms.internal.measurement.zziz r6 = r8.zzf     // Catch: java.lang.Throwable -> L98
    ...
    private final T zza(zziy zziyVar) {
        if (!this.zzf.zze && (this.zzf.zzh == null || this.zzf.zzh.apply(zziyVar.zza()).booleanValue())) {
            Object objZza = zzik.zza(zziyVar.zza()).zza(this.zzf.zze ? null : zza(this.zzf.zzc));
            if (objZza != null) {
                return zza(objZza);
            }
        }
    ...
    private final T zzb(zziy zziyVar) {
        ...
        if (this.zzf.zzb != null) {
            if (!zzip.zza(zziyVar.zza(), this.zzf.zzb)) {
                zzifVarZza = null;
            } else if (this.zzf.zzg) {
                zzifVarZza = zzic.zza(zziyVar.zza().getContentResolver(), zzio.zza(zzio.zza(zziyVar.zza(), this.zzf.zzb.getLastPathSegment())), new Runnable() { // from class: com.google.android.gms.internal.measurement.zziq
                ...
                zzifVarZza = zzic.zza(zziyVar.zza().getContentResolver(), this.zzf.zzb, new Runnable() { // from class: com.google.android.gms.internal.measurement.zziq
                    @Override // java.lang.Runnable
                    public final void run() {
                        zzir.zzc();
                    }
            ...
            zzifVarZza = zzja.zza(zziyVar.zza(), this.zzf.zza, new Runnable() { // from class: com.google.android.gms.internal.measurement.zziq
                @Override // java.lang.Runnable
                public final void run() {
                    zzir.zzc();
                }
