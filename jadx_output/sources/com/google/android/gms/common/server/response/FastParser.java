...
public class FastParser<T extends FastJsonResponse> {
    ...
    private static final char[] zab = {'r', 'u', Barcode128.CODE_BC_TO_A};
    private static final char[] zac = {'r', 'u', Barcode128.CODE_BC_TO_A, Typography.quote};
    private static final char[] zad = {'a', 'l', 's', Barcode128.CODE_BC_TO_A};
    private static final char[] zae = {'a', 'l', 's', Barcode128.CODE_BC_TO_A, Typography.quote};
