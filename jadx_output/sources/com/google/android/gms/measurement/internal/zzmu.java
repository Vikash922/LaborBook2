...
public final class zzmu<T extends Context & zzmy> {
    ...
    public final int zza(final Intent intent, int i, final int i2) {
        final zzgi zzgiVarZzj = zzhw.zza(this.zza, null, null).zzj();
        if (intent == null) {
        ...
        if ("com.google.android.gms.measurement.UPLOAD".equals(action)) {
            zza(new Runnable() { // from class: com.google.android.gms.measurement.internal.zzmw
                ...
                public final void run() {
                    this.zza.zza(i2, zzgiVarZzj, intent);
                }
            });
        }
        return 2;
    ...
    final /* synthetic */ void zza(int i, zzgi zzgiVar, Intent intent) {
        if (this.zza.zza(i)) {
    ...
    final /* synthetic */ void zza(zzgi zzgiVar, JobParameters jobParameters) {
    ...
    public final boolean zza(final JobParameters jobParameters) {
        ...
        zza(new Runnable() { // from class: com.google.android.gms.measurement.internal.zzmx
            @Override // java.lang.Runnable
            public final void run() {
                this.zza.zza(zzgiVarZzj, jobParameters);
            }
        });
        return true;
    }
