...
public final class zzop extends zzix {
    ...
    */
    ...
    final int zza(String str) {
        ...
        if (zza("event", zzjf.zza, zzjf.zzb, str)) {
    ...
    final long zzh() {
        ...
        if (Build.VERSION.SDK_INT < 30) {
            ...
            j = zzc() < zzbj.zzax.zza(null).intValue() ? 16L : 0L;
        }
    ...
    */
    final long zza(android.content.Context r7, java.lang.String r8) {
        /*
            ...
            r2 = -1
            if (r1 != 0) goto L23
            com.google.android.gms.measurement.internal.zzgi r7 = r6.zzj()
        ...
        L23:
            ...
            goto L77
        L5a:
            com.google.android.gms.measurement.internal.zzgi r7 = r6.zzj()     // Catch: android.content.pm.PackageManager.NameNotFoundException -> L68
            com.google.android.gms.measurement.internal.zzgk r7 = r7.zzu()     // Catch: android.content.pm.PackageManager.NameNotFoundException -> L68
            java.lang.String r8 = "Could not get signatures"
            r7.zza(r8)     // Catch: android.content.pm.PackageManager.NameNotFoundException -> L68
            goto L77
        L68:
            r7 = move-exception
            com.google.android.gms.measurement.internal.zzgi r8 = r6.zzj()
        ...
        L77:
            return r2
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.measurement.internal.zzop.zza(android.content.Context, java.lang.String):long");
    }
    ...
    public static Bundle zza(List<zzok> list) {
        ...
        for (zzok zzokVar : list) {
            if (zzokVar.zzd != null) {
                bundle.putString(zzokVar.zza, zzokVar.zzd);
            } else if (zzokVar.zzc != null) {
                bundle.putLong(zzokVar.zza, zzokVar.zzc.longValue());
            } else if (zzokVar.zzf != null) {
                bundle.putDouble(zzokVar.zza, zzokVar.zzf.doubleValue());
            }
        }
        return bundle;
    }
    ...
    final Bundle zza(String str, String str2, Bundle bundle, List<String> list, boolean z) {
        ...
        int i;
        zzop zzopVar = this;
        boolean zZza = zza(str2, zzjf.zzd);
        if (bundle == null) {
            return null;
        }
        Bundle bundle2 = new Bundle(bundle);
        ...
        for (String str3 : new TreeSet(bundle.keySet())) {
            if (list == null || !list.contains(str3)) {
                iZzl = !z ? zzopVar.zzl(str3) : 0;
                if (iZzl == 0) {
                    iZzl = zzopVar.zzk(str3);
                }
            } else {
                iZzl = 0;
            }
    ...
    final zzbh zza(String str, String str2, Bundle bundle, String str3, long j, boolean z, boolean z2) {
        ...
        return new zzbh(str2, new zzbc(bundleZza), str3, j);
    }
    ...
    public static ArrayList<Bundle> zzb(List<zzaf> list) {
        ...
        for (zzaf zzafVar : list) {
            Bundle bundle = new Bundle();
            bundle.putString("app_id", zzafVar.zza);
            bundle.putString("origin", zzafVar.zzb);
            bundle.putLong(AppMeasurementSdk.ConditionalUserProperty.CREATION_TIMESTAMP, zzafVar.zzd);
            bundle.putString("name", zzafVar.zzc.zza);
            zziz.zza(bundle, Preconditions.checkNotNull(zzafVar.zzc.zza()));
            bundle.putBoolean("active", zzafVar.zze);
            if (zzafVar.zzf != null) {
                bundle.putString(AppMeasurementSdk.ConditionalUserProperty.TRIGGER_EVENT_NAME, zzafVar.zzf);
            }
            if (zzafVar.zzg != null) {
                zzbh zzbhVar = zzafVar.zzg;
                bundle.putString(AppMeasurementSdk.ConditionalUserProperty.TIMED_OUT_EVENT_NAME, zzbhVar.zza);
                if (zzbhVar.zzb != null) {
                    bundle.putBundle(AppMeasurementSdk.ConditionalUserProperty.TIMED_OUT_EVENT_PARAMS, zzbhVar.zzb.zzb());
                }
            }
            bundle.putLong(AppMeasurementSdk.ConditionalUserProperty.TRIGGER_TIMEOUT, zzafVar.zzh);
            if (zzafVar.zzi != null) {
                zzbh zzbhVar2 = zzafVar.zzi;
                bundle.putString(AppMeasurementSdk.ConditionalUserProperty.TRIGGERED_EVENT_NAME, zzbhVar2.zza);
                if (zzbhVar2.zzb != null) {
                    bundle.putBundle(AppMeasurementSdk.ConditionalUserProperty.TRIGGERED_EVENT_PARAMS, zzbhVar2.zzb.zzb());
                }
            }
            bundle.putLong(AppMeasurementSdk.ConditionalUserProperty.TRIGGERED_TIMESTAMP, zzafVar.zzc.zzb);
            bundle.putLong(AppMeasurementSdk.ConditionalUserProperty.TIME_TO_LIVE, zzafVar.zzj);
            if (zzafVar.zzk != null) {
                zzbh zzbhVar3 = zzafVar.zzk;
                bundle.putString(AppMeasurementSdk.ConditionalUserProperty.EXPIRED_EVENT_NAME, zzbhVar3.zza);
                if (zzbhVar3.zzb != null) {
                    bundle.putBundle(AppMeasurementSdk.ConditionalUserProperty.EXPIRED_EVENT_PARAMS, zzbhVar3.zzb.zzb());
                }
            }
    ...
    public static void zza(zzlh zzlhVar, Bundle bundle, boolean z) {
        if (bundle == null || zzlhVar == null || (bundle.containsKey("_sc") && !z)) {
            if (bundle != null && zzlhVar == null && z) {
                bundle.remove("_sn");
                bundle.remove("_sc");
                bundle.remove("_si");
                return;
        ...
        if (zzlhVar.zza != null) {
            bundle.putString("_sn", zzlhVar.zza);
        } else {
            bundle.remove("_sn");
        }
        if (zzlhVar.zzb != null) {
            bundle.putString("_sc", zzlhVar.zzb);
        } else {
            bundle.remove("_sc");
        }
        bundle.putLong("_si", zzlhVar.zzc);
    }
    ...
    final void zza(Parcelable[] parcelableArr, int i, boolean z) {
        ...
        for (Parcelable parcelable : parcelableArr) {
            ...
            for (String str : new TreeSet(bundle.keySet())) {
                if (zzh(str) && !zza(str, zzje.zzd) && (i2 = i2 + 1) > i) {
                    if (z) {
    ...
    final void zza(zzgm zzgmVar, int i) {
        int i2 = 0;
        for (String str : new TreeSet(zzgmVar.zzd.keySet())) {
            if (zzh(str) && (i2 = i2 + 1) > i) {
                zzj().zzh().zza("Event can't contain more than " + i + " params", zzi().zza(zzgmVar.zza), zzi().zza(zzgmVar.zzd));
                zzb(zzgmVar.zzd, 5);
                zzgmVar.zzd.remove(str);
            }
        }
    }

    public static void zza(zzoo zzooVar, int i, String str, String str2, int i2) {
        zza(zzooVar, (String) null, i, str, str2, i2);
    }

    static void zza(zzoo zzooVar, String str, int i, String str2, String str3, int i2) {
        Bundle bundle = new Bundle();
        zzb(bundle, i);
    ...
    public final void zza(com.google.android.gms.internal.measurement.zzdl zzdlVar, boolean z) {
        Bundle bundle = new Bundle();
    ...
    public final void zza(com.google.android.gms.internal.measurement.zzdl zzdlVar, ArrayList<Bundle> arrayList) {
        Bundle bundle = new Bundle();
    ...
    public final void zza(com.google.android.gms.internal.measurement.zzdl zzdlVar, Bundle bundle) {
        try {
            zzdlVar.zza(bundle);
        } catch (RemoteException e) {
    ...
    public final void zza(com.google.android.gms.internal.measurement.zzdl zzdlVar, byte[] bArr) {
        Bundle bundle = new Bundle();
    ...
    public final void zza(com.google.android.gms.internal.measurement.zzdl zzdlVar, int i) {
        Bundle bundle = new Bundle();
        bundle.putInt("r", i);
        try {
            zzdlVar.zza(bundle);
    ...
    public final void zza(com.google.android.gms.internal.measurement.zzdl zzdlVar, long j) {
        Bundle bundle = new Bundle();
        bundle.putLong("r", j);
        try {
            zzdlVar.zza(bundle);
    ...
    public final void zza(com.google.android.gms.internal.measurement.zzdl zzdlVar, String str) {
        Bundle bundle = new Bundle();
    ...
    */
    private final boolean zzy() {
        ...
        L3c:
            ...
            r0 = r6
        L3f:
            com.google.android.gms.measurement.internal.zzgi r3 = r7.zzj()
            ...
            r7.zzg = r1
        L52:
            com.google.android.gms.measurement.internal.zzgi r1 = r7.zzj()
        ...
        L5f:
            ...
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.measurement.internal.zzop.zzy():boolean");
    }
