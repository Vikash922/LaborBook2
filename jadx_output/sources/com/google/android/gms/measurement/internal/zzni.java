...
public final class zzni {
    ...
    public final Bundle zza() {
        ...
        if (str.length() > 6 && iZze >= 4) {
            bundle.putString(zzjc.zza.AD_USER_DATA.zze, (str.charAt(0) == '1' && str.charAt(6) == '1') ? "granted" : "denied");
        }
        return bundle;
    }
    ...
    public static zzni zza(SharedPreferences sharedPreferences) {
        ...
        if (!EventsFileManager.DELIMITER.equals(strZzb) && strZzb.length() > 754) {
        ...
        if (!EventsFileManager.DELIMITER.equals(strZzb2)) {
    ...
    private static String zzb(SharedPreferences sharedPreferences, String str) {
        try {
            return sharedPreferences.getString(str, EventsFileManager.DELIMITER);
        } catch (ClassCastException unused) {
            return EventsFileManager.DELIMITER;
        }
    }
