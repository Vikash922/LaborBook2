...
final class zzmk implements Runnable {
    ...
    private final /* synthetic */ com.google.android.gms.internal.measurement.zzdl zzd;
    private final /* synthetic */ zzlp zze;

    zzmk(zzlp zzlpVar, String str, String str2, zzp zzpVar, com.google.android.gms.internal.measurement.zzdl zzdlVar) {
        this.zza = str;
        this.zzb = str2;
        this.zzc = zzpVar;
        this.zzd = zzdlVar;
    ...
    public final void run() {
        ...
        try {
            ...
            ArrayList<Bundle> arrayListZzb = zzop.zzb(zzgbVar.zza(this.zza, this.zzb, this.zzc));
            this.zze.zzar();
