...
public final class zzau {
    ...
    static void zza(zzgi zzgiVar, SQLiteDatabase sQLiteDatabase, String str, String str2, String str3, String[] strArr) throws SQLiteException {
        if (zzgiVar == null) {
    ...
    static void zza(zzgi zzgiVar, SQLiteDatabase sQLiteDatabase) {
        if (zzgiVar == null) {
            throw new IllegalArgumentException("Monitor must not be null");
        }
