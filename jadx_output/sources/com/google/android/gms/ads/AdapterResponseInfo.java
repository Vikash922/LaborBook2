...
public final class AdapterResponseInfo {
    ...
    public final JSONObject zzb() throws JSONException {
        ...
        if (adSourceName == null) {
            jSONObject.put("Ad Source Name", Constants.ATTENDANCE_STATUS_NULL);
        } else {
            jSONObject.put("Ad Source Name", adSourceName);
        }
        String adSourceId = getAdSourceId();
        if (adSourceId == null) {
            jSONObject.put("Ad Source ID", Constants.ATTENDANCE_STATUS_NULL);
        } else {
            jSONObject.put("Ad Source ID", adSourceId);
        }
        String adSourceInstanceName = getAdSourceInstanceName();
        if (adSourceInstanceName == null) {
            jSONObject.put("Ad Source Instance Name", Constants.ATTENDANCE_STATUS_NULL);
        } else {
            jSONObject.put("Ad Source Instance Name", adSourceInstanceName);
        }
        String adSourceInstanceId = getAdSourceInstanceId();
        if (adSourceInstanceId == null) {
            jSONObject.put("Ad Source Instance ID", Constants.ATTENDANCE_STATUS_NULL);
        } else {
        ...
        if (adError == null) {
            jSONObject.put("Ad Error", Constants.ATTENDANCE_STATUS_NULL);
        } else {
