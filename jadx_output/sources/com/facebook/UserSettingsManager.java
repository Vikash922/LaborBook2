...
public final class UserSettingsManager {
    ...
    public static final void initializeCodelessSetupEnabledAsync$lambda$0(long j) {
        ...
        try {
            if (advertiserIDCollectionEnabled.m3006getValue() && (fetchedAppSettingsQueryAppSettings = FetchedAppSettingsManager.queryAppSettings(FacebookSdk.getApplicationId(), false)) != null && fetchedAppSettingsQueryAppSettings.getCodelessEventsEnabled()) {
    ...
    private final void logIfSDKSettingsChanged() {
        ...
        try {
            if (isInitialized.get() && FacebookSdk.isInitialized()) {
                Context applicationContext = FacebookSdk.getApplicationContext();
                int i3 = 0;
                int i4 = (autoInitEnabled.m3006getValue() ? 1 : 0) | ((autoLogAppEventsEnabledLocally.m3006getValue() ? 1 : 0) << 1) | ((advertiserIDCollectionEnabled.m3006getValue() ? 1 : 0) << 2) | ((monitorEnabled.m3006getValue() ? 1 : 0) << 3);
                SharedPreferences sharedPreferences = userSettingPref;
                ...
                if (i5 != i4) {
                    ...
                    if (applicationInfo.metaData != null) {
                        ...
                        bundle.putInt(CommonCssConstants.INITIAL, i2);
                    ...
                    bundle2.putInt(CommonCssConstants.INITIAL, i2);
                    ...
                    bundle22.putInt(CommonCssConstants.INITIAL, i2);
    ...
    public static final boolean getAutoInitEnabled() {
        ...
        try {
            INSTANCE.initializeIfNotInitialized();
            return autoInitEnabled.m3006getValue();
        } catch (Throwable th) {
            CrashShieldHandler.handleThrowable(th, UserSettingsManager.class);
            return false;
        }
    ...
    private final boolean checkAutoLogAppEventsEnabled() {
        ...
        try {
            ...
            return autoLogAppEventsEnabledLocally.m3006getValue();
        } catch (Throwable th) {
            CrashShieldHandler.handleThrowable(th, this);
            return false;
        }
    ...
    public static final boolean getAdvertiserIDCollectionEnabled() {
        ...
        try {
            INSTANCE.initializeIfNotInitialized();
            return advertiserIDCollectionEnabled.m3006getValue();
        } catch (Throwable th) {
            CrashShieldHandler.handleThrowable(th, UserSettingsManager.class);
            return false;
        }
    ...
    public static final boolean getCodelessSetupEnabled() {
        ...
        try {
            INSTANCE.initializeIfNotInitialized();
            return codelessSetupEnabled.m3006getValue();
        } catch (Throwable th) {
            CrashShieldHandler.handleThrowable(th, UserSettingsManager.class);
            return false;
        }
    ...
    public static final boolean getMonitorEnabled() {
        ...
        try {
            INSTANCE.initializeIfNotInitialized();
            return monitorEnabled.m3006getValue();
        } catch (Throwable th) {
            CrashShieldHandler.handleThrowable(th, UserSettingsManager.class);
            return false;
        }
    ...
    /* JADX INFO: compiled from: UserSettingsManager.kt */
    @Metadata(m2721d1 = {"\u0000 \n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0000\n\u0002\u0010\u000b\n\u0000\n\u0002\u0010\u000e\n\u0002\b\n\n\u0002\u0010\t\n\u0002\b\u000b\b\u0002\u0018\u00002\u00020\u0001B\u0015\u0012\u0006\u0010\u0002\u001a\u00020\u0003\u0012\u0006\u0010\u0004\u001a\u00020\u0005¢\u0006\u0002\u0010\u0006J\u0006\u0010\u0016\u001a\u00020\u0003R\u001a\u0010\u0002\u001a\u00020\u0003X\u0086\u000e¢\u0006\u000e\n\u0000\u001a\u0004\b\u0007\u0010\b\"\u0004\b\t\u0010\nR\u001a\u0010\u0004\u001a\u00020\u0005X\u0086\u000e¢\u0006\u000e\n\u0000\u001a\u0004\b\u000b\u0010\f\"\u0004\b\r\u0010\u000eR\u001a\u0010\u000f\u001a\u00020\u0010X\u0086\u000e¢\u0006\u000e\n\u0000\u001a\u0004\b\u0011\u0010\u0012\"\u0004\b\u0013\u0010\u0014R\u001e\u0010\u0015\u001a\u0004\u0018\u00010\u0003X\u0086\u000e¢\u0006\u0010\n\u0002\u0010\u001a\u001a\u0004\b\u0016\u0010\u0017\"\u0004\b\u0018\u0010\u0019¨\u0006\u001b"}, m2722d2 = {"Lcom/facebook/UserSettingsManager$UserSetting;", "", "defaultVal", "", "key", "", "(ZLjava/lang/String;)V", "getDefaultVal", "()Z", "setDefaultVal", "(Z)V", "getKey", "()Ljava/lang/String;", "setKey", "(Ljava/lang/String;)V", "lastTS", "", "getLastTS", "()J", "setLastTS", "(J)V", "value", "getValue", "()Ljava/lang/Boolean;", "setValue", "(Ljava/lang/Boolean;)V", "Ljava/lang/Boolean;", "facebook-core_release"}, m2723k = 1, m2724mv = {1, 8, 0}, m2726xi = 48)
    private static final class UserSetting {
        ...
        public final boolean m3006getValue() {
