...
public final class AuthenticationTokenHeader implements Parcelable {
    ...
    public int hashCode() {
        return ((((MetaDo.META_OFFSETWINDOWORG + this.alg.hashCode()) * 31) + this.typ.hashCode()) * 31) + this.kid.hashCode();
    }
