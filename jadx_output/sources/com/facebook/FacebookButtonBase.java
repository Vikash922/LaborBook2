...
public abstract class FacebookButtonBase extends Button {
    ...
    protected FacebookButtonBase(Context context, AttributeSet attributeSet, int i, int i2, String analyticsButtonCreatedEventName, String analyticsButtonTappedEventName) {
        ...
        configureButton(context, attributeSet, i, i2 == 0 ? C1217R.style.com_facebook_button : i2);
        ...
        try {
            ...
            try {
                if (typedArrayObtainStyledAttributes.hasValue(0)) {
                    ...
                    setBackgroundColor(ContextCompat.getColor(context, C1217R.color.com_facebook_blue));
                }
            } finally {
