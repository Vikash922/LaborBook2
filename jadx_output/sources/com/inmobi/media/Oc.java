...
public final class Oc {
    ...
    public final Rc f207a;
    public final LinkedHashSet b;

    public Oc(Rc networkRequest, LinkedHashSet inMobiUnifiedIdInterfaceSet) {
        Intrinsics.checkNotNullParameter(networkRequest, "networkRequest");
        Intrinsics.checkNotNullParameter(inMobiUnifiedIdInterfaceSet, "inMobiUnifiedIdInterfaceSet");
        this.f207a = networkRequest;
    ...
    public final void a(Object obj) {
        ...
        synchronized (Nc.class) {
            ...
            Nc.a();
            AbstractC0523u5.b(Pc.a(jSONObject, AbstractC0523u5.b()));
            JSONObject jSONObjectA = Pc.a(AbstractC0523u5.b());
            for (InMobiUnifiedIdInterface inMobiUnifiedIdInterface : this.b) {
                if (jSONObjectA == null) {
                    Pc.a(inMobiUnifiedIdInterface, null, new Error(InMobiUnifiedIdInterface.NO_LOCAL_DATA_PRESENT));
                } else {
    ...
    public final void a(C0350i9 c0350i9) {
        EnumC0250c4 enumC0250c4;
        synchronized (Nc.class) {
            if (c0350i9 != null) {
                try {
                    enumC0250c4 = c0350i9.f385a;
                } catch (Throwable th) {
                    throw th;
                }
            } else {
            ...
            Objects.toString(enumC0250c4);
            Objects.toString(c0350i9 != null ? c0350i9.f385a : null);
            LinkedHashMap linkedHashMap = new LinkedHashMap();
            if (c0350i9 != null) {
                linkedHashMap.put("errorCode", c0350i9.f385a);
            }
            C0353ic c0353ic = C0353ic.f388a;
            C0353ic.b("UnifiedIdNetworkResponseFailure", linkedHashMap, EnumC0415mc.f426a);
            if (this.f207a.A.get()) {
                return;
            }
            Nc.a();
    ...
    */
    public final void a() {
        /*
            ...
            org.json.JSONObject r1 = com.inmobi.media.AbstractC0523u5.b()
