...
public final class U5 {
    ...
    public static final boolean a(JSONObject jSONObject, JSONObject jSONObject2) {
        return T5.a(jSONObject, jSONObject2);
    }
    ...
    public final U5 a(C0529ub key, AbstractC0515tb types) {
        Intrinsics.checkNotNullParameter(key, "key");
        Intrinsics.checkNotNullParameter(types, "types");
        this.f254a.put(key, types);
        return this;
    }
        ...
        try {
            ...
            for (Field field : declaredFields) {
                ...
                if (field.get(obj) == null) {
                    ...
                    if (!Modifier.isStatic(field.getModifiers()) && !field.isAnnotationPresent(H4.class)) {
                                                    ...
                                                    if (!Intrinsics.areEqual(String.class, type) && !Intrinsics.areEqual(JSONObject.class, type) && !Intrinsics.areEqual(JSONArray.class, type)) {
                                                        ...
                                                        if (!Intrinsics.areEqual(cls8, type) && !Intrinsics.areEqual(cls8, type) && !Intrinsics.areEqual(Short.class, type)) {
                                                            if (Map.class.isAssignableFrom(type)) {
                                                                ...
                                                                AbstractC0515tb abstractC0515tb = (AbstractC0515tb) map.get(new C0529ub(name, cls));
                                                                if (abstractC0515tb instanceof Q6) {
                                                                    JSONObject jSONObject2 = new JSONObject();
                                                                    Object obj2 = field.get(obj);
                                                                    if (obj2 != null) {
                                                                        Map map2 = (Map) obj2;
                                                                        Q6 q6 = (Q6) abstractC0515tb;
                                                                        for (Object obj3 : map2.keySet()) {
                                                                            q6.getClass();
                                                                            Intrinsics.checkNotNullParameter(map2, "map");
                                                                            Object objA = map2.get(obj3);
                                                                            if (objA != null) {
                                                                                if (!T5.b(objA.getClass()) && !T5.a(objA.getClass())) {
                                                                ...
                                                                HashMap map3 = this.f254a;
                                                                Intrinsics.checkNotNull(name);
                                                                Object obj4 = map3.get(new C0529ub(name, cls));
                                                                Intrinsics.checkNotNull(obj4);
                                                                if (((AbstractC0515tb) obj4) instanceof C0538v6) {
                                                                    JSONArray jSONArray = new JSONArray();
                                                                    Object obj5 = field.get(obj);
                                                                    if (obj5 != null) {
                                                                        for (Object obj6 : (List) obj5) {
                                                                            if (obj6 != null) {
                                                                                Object objA2 = (T5.b(obj6.getClass()) || T5.a(obj6.getClass())) ? obj6 : a(obj6, (Class) obj6.getClass());
                                                                                if (objA2 == null) {
    ...
    public final Object a(JSONObject jSONObject, Class cls, Object obj, Object obj2) {
        ...
        try {
            ...
            while (i5 < length3) {
                ...
                String name = field.getName();
                if (Intrinsics.areEqual(name, "shadow$_klass_") || Modifier.isStatic(field.getModifiers()) || field.isAnnotationPresent(H4.class)) {
                    obj3 = obj4;
                                                ...
                                                if (!Intrinsics.areEqual(cls9, type) && !Intrinsics.areEqual(cls9, type) && !Intrinsics.areEqual(Short.class, type)) {
                                                    if (Intrinsics.areEqual(JSONObject.class, type)) {
                                                        ...
                                                        try {
                                                            ...
                                                            if (abstractC0515tb instanceof Q6) {
                                                                ...
                                                                if (jSONObjectOptJSONObject != null) {
                                                                    ...
                                                                    Map map2 = (Map) ((Q6) abstractC0515tb).a().construct();
                                                                    ...
                                                                    while (itKeys.hasNext()) {
                                                                        ...
                                                                        Object objA = T5.a(jSONObjectOptJSONObject, next, ((Q6) abstractC0515tb).b);
                                                                        int i6 = length3;
                                                                        if (T5.b(((Q6) abstractC0515tb).b)) {
                                                                            objA = ((Q6) abstractC0515tb).b.cast(objA);
                                                                        } else if (!T5.a(((Q6) abstractC0515tb).b)) {
                                                                            JSONObject jSONObject4 = jSONObjectOptJSONObject.getJSONObject(next);
                                                                            Intrinsics.checkNotNullExpressionValue(jSONObject4, "getJSONObject(...)");
                                                                            Class<Object> cls10 = q6.b;
                                                        ...
                                                        if (List.class.isAssignableFrom(type)) {
                                                            HashMap map4 = this.f254a;
                                                            Intrinsics.checkNotNull(name);
                                                            AbstractC0515tb abstractC0515tb2 = (AbstractC0515tb) map4.get(new C0529ub(name, cls));
                                                            if ((abstractC0515tb2 instanceof C0538v6) && (jSONArrayOptJSONArray = jSONObject.optJSONArray(name)) != null) {
                                                                List<Object> listB = ((C0538v6) abstractC0515tb2).b();
                                                                ...
                                                                for (int i7 = 0; i7 < length4; i7++) {
                                                                    Object objA2 = T5.a(jSONArrayOptJSONArray, i7, ((C0538v6) abstractC0515tb2).c());
                                                                    if (T5.b(objA2.getClass())) {
                                                                        objA2 = ((C0538v6) abstractC0515tb2).c().cast(objA2);
                                                                    } else if (!T5.a(objA2.getClass())) {
                                                                        ...
                                                                        Class<Object> clsC = ((C0538v6) abstractC0515tb2).c();
                    ...
                    fieldArr = declaredFields;
                    i = length3;
                    if (field.isAnnotationPresent(InterfaceC0472q9.class)) {
