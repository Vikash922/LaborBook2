...
public final class S9 extends T1 {
    ...
    public final Bitmap a() throws InterruptedException {
        ...
        PixelCopy.request(this.b, rect, bitmapCreateBitmap, new PixelCopy.OnPixelCopyFinishedListener() { // from class: com.inmobi.media.S9$$ExternalSyntheticLambda0
            @Override // android.view.PixelCopy.OnPixelCopyFinishedListener
            public final void onPixelCopyFinished(int i) {
                S9.a(booleanRef, this, i);
            }
    ...
    public static final void a(Ref.BooleanRef isSuccess, S9 this$0, int i) {
