...
public class c {
    ...
    private static WindowManager f43a;
    private static String[] b = {SvgConstants.Attributes.X, SvgConstants.Attributes.Y, "width", "height"};
    ...
    private static b a(JSONObject jSONObject) {
        ...
        if (f43a != null) {
            ...
            f43a.getDefaultDisplay().getRealSize(point);
            fA = a(point.x);
            fA2 = a(point.y);
        } else {
            fA = 0.0f;
    ...
    public static JSONObject a(int i, int i2, int i3, int i4) {
        ...
        try {
            jSONObject.put(SvgConstants.Attributes.X, a(i));
            jSONObject.put(SvgConstants.Attributes.Y, a(i2));
    ...
    public static void a(Context context) {
        if (context != null) {
            ...
            f43a = (WindowManager) context.getSystemService("window");
        }
    }
    ...
    public static void a(JSONObject jSONObject, a.C0059a c0059a) {
        com.iab.omid.library.inmobi.internal.e eVarA = c0059a.a();
        JSONArray jSONArray = new JSONArray();
        Iterator<String> it = c0059a.b().iterator();
        while (it.hasNext()) {
    ...
    private static boolean a(OutputDeviceStatus outputDeviceStatus) {
        return a.f44a[outputDeviceStatus.ordinal()] == 1;
    }
    ...
    public static void b(JSONObject jSONObject) {
        ...
        try {
            jSONObject.put("width", bVarA.f45a);
