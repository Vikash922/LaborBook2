...
public final class AdSessionContext {
    ...
    public static AdSessionContext createHtmlAdSessionContext(Partner partner, WebView webView, String str, String str2) {
        ...
        if (str2 != null) {
            C2654g.m724a(str2, 256, "CustomReferenceData is greater than 256 characters");
        }
    ...
    public static AdSessionContext createNativeAdSessionContext(Partner partner, String str, List<VerificationScriptResource> list, String str2, String str3) {
        C2654g.m723a(partner, "Partner is null");
        C2654g.m723a((Object) str, "OM SDK JS script content is null");
        C2654g.m723a(list, "VerificationScriptResources is null");
        if (str3 != null) {
            C2654g.m724a(str3, 256, "CustomReferenceData is greater than 256 characters");
        }
