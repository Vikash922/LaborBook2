...
public final class d extends SuspendLambda implements Function2 {
    ...
    public d(List<String> list, AnalyticsManagerImpl analyticsManagerImpl, Map<String, ? extends Object> map, Continuation<? super d> continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        d dVar = new d(this.$userPropertyPlatforms, this.this$0, this.$userProperties, continuation);
        dVar.L$0 = obj;
        return dVar;
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            while (it.hasNext()) {
                arrayList.add(BuildersKt__Builders_commonKt.async$default(coroutineScope, null, null, new c(analyticsManagerImpl, (String) it.next(), map, null), 3, null));
            }
            this.label = 1;
