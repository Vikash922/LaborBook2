...
public final class TextViewBoldGreen16 extends AppCompatTextView {
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public TextViewBoldGreen16(Context context) {
        super(context);
        Intrinsics.checkNotNullParameter(context, "context");
        setTextAppearance(C1111R.style.textview_bold_green_16);
    }

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public TextViewBoldGreen16(Context context, AttributeSet attributeSet) {
    ...
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public TextViewBoldGreen16(Context context, AttributeSet attributeSet, int i) {
