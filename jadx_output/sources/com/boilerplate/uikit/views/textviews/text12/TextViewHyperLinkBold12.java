...
public final class TextViewHyperLinkBold12 extends AppCompatTextView {
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public TextViewHyperLinkBold12(Context context) {
        super(context);
        Intrinsics.checkNotNullParameter(context, "context");
        setTextAppearance(C1111R.style.textview_bold_12_hyperlink);
    }

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public TextViewHyperLinkBold12(Context context, AttributeSet attributeSet) {
    ...
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public TextViewHyperLinkBold12(Context context, AttributeSet attributeSet, int i) {
