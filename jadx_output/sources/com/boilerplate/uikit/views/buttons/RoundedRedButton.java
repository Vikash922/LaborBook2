...
@Metadata(m2721d1 = {"\u0000\u001e\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\b\n\u0002\b\u0005\u0018\u00002\u00020\u0001B#\b\u0016\u0012\u0006\u0010\u0002\u001a\u00020\u0003\u0012\b\u0010\u0004\u001a\u0004\u0018\u00010\u0005\u0012\u0006\u0010\u0006\u001a\u00020\u0007¢\u0006\u0004\b\b\u0010\tB\u001b\b\u0016\u0012\u0006\u0010\u0002\u001a\u00020\u0003\u0012\b\u0010\u0004\u001a\u0004\u0018\u00010\u0005¢\u0006\u0004\b\b\u0010\nB\u0011\b\u0016\u0012\u0006\u0010\u0002\u001a\u00020\u0003¢\u0006\u0004\b\b\u0010\u000b¨\u0006\f"}, m2722d2 = {"Lcom/boilerplate/uikit/views/buttons/RoundedRedButton;", "Lcom/boilerplate/uikit/views/buttons/ActionButton;", "context", "Landroid/content/Context;", "attrs", "Landroid/util/AttributeSet;", "defStyle", "", "<init>", "(Landroid/content/Context;Landroid/util/AttributeSet;I)V", "(Landroid/content/Context;Landroid/util/AttributeSet;)V", "(Landroid/content/Context;)V", "uikit_release"}, m2723k = 1, m2724mv = {2, 0, 0}, m2726xi = 48)
public final class RoundedRedButton extends ActionButton {
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public RoundedRedButton(Context context) {
        super(context);
        ...
        setBackgroundTintList(ColorStateList.valueOf(utils.getThemeAttrData(context4, C1111R.attr.buttonRedColor)));
        Context context5 = getContext();
        Intrinsics.checkNotNullExpressionValue(context5, "getContext(...)");
        setTextColor(utils.getThemeAttrData(context5, C1111R.attr.buttonEnabledTextColor));
        Context context6 = getContext();
        Intrinsics.checkNotNullExpressionValue(context6, "getContext(...)");
        setEnabledBackgroundTintColor(Integer.valueOf(utils.getThemeAttrData(context6, C1111R.attr.buttonRedColor)));
    ...
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public RoundedRedButton(Context context, AttributeSet attributeSet, int i) {
