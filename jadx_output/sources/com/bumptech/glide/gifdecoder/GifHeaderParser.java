...
public class GifHeaderParser {
    ...
    private void readBitmap() {
        this.header.currentFrame.f189ix = readShort();
        this.header.currentFrame.f190iy = readShort();
        this.header.currentFrame.f188iw = readShort();
        this.header.currentFrame.f187ih = readShort();
        int i = read();
        boolean z = (i & 128) != 0;
