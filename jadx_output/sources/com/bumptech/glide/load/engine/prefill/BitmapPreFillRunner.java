    ...
    boolean allocate() {
        ...
        while (!this.toPrefill.isEmpty() && !isGcDetected(jNow)) {
            ...
            if (Log.isLoggable(TAG, 3)) {
                Log.d(TAG, "allocated [" + preFillTypeRemove.getWidth() + SvgConstants.Attributes.f3330X + preFillTypeRemove.getHeight() + "] " + preFillTypeRemove.getConfig() + " size: " + bitmapByteSize);
            }
        }
