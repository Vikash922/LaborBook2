...
public final class RoundedCorners extends BitmapTransformation {
    ...
    private static final String f206ID = "com.bumptech.glide.load.resource.bitmap.RoundedCorners";
    private static final byte[] ID_BYTES = f206ID.getBytes(CHARSET);
    ...
    @Override // com.bumptech.glide.load.Key
    public int hashCode() {
        return Util.hashCode(f206ID.hashCode(), Util.hashCode(this.roundingRadius));
    }
