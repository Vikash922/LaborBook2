...
public final class DefaultOnHeaderDecodedListener implements ImageDecoder.OnHeaderDecodedListener {
    ...
    public void onHeaderDecoded(ImageDecoder imageDecoder, ImageDecoder.ImageInfo imageInfo, ImageDecoder.Source source) {
        ...
        if (Log.isLoggable(TAG, 2)) {
            Log.v(TAG, "Resizing from [" + size.getWidth() + SvgConstants.Attributes.f3330X + size.getHeight() + "] to [" + iRound + SvgConstants.Attributes.f3330X + iRound2 + "] scaleFactor: " + scaleFactor);
        }
