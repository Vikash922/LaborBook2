            ...
            for (Field field : cls.getFields()) {
                if (Modifier.isStatic(field.getModifiers()) && field.getType() == Integer.TYPE) {
                    try {
                        ...
                        MPLog.m2683e(LOGTAG, "Can't read built-in id name from " + cls.getName(), e);
                    }
                }
            }
        } catch (IllegalAccessException e2) {
            MPLog.m2683e(LOGTAG, "Can't read built-in id names from " + cls.getName(), e2);
        }
    }
