...
public class MPConfig {
    ...
    MPConfig(Bundle bundle, Context context) {
        ...
        try {
            ...
            MPLog.m2685i(LOGTAG, "System has no SSL support. Built-in events editor will not be available", e);
        }
        ...
        if (bundle.containsKey("com.mixpanel.android.MPConfig.DebugFlushInterval")) {
            MPLog.m2688w(LOGTAG, "We do not support com.mixpanel.android.MPConfig.DebugFlushInterval anymore. There will only be one flush interval. Please, update your AndroidManifest.xml.");
        }
        ...
        if (obj != null) {
            try {
                ...
                MPLog.m2683e(LOGTAG, "Error parsing com.mixpanel.android.MPConfig.DataExpiration meta-data value", e2);
        ...
        if (string != null) {
            setEventsEndpoint(zContainsKey ? getEndPointWithIpTrackingParam(string, getUseIpAddressForGeolocation()) : string);
        } else {
            setEventsEndpointWithBaseURL(MPConstants.URL.MIXPANEL_API);
        }
        String string2 = bundle.getString("com.mixpanel.android.MPConfig.PeopleEndpoint");
        if (string2 != null) {
            setPeopleEndpoint(zContainsKey ? getEndPointWithIpTrackingParam(string2, getUseIpAddressForGeolocation()) : string2);
        } else {
            setPeopleEndpointWithBaseURL(MPConstants.URL.MIXPANEL_API);
        }
        String string3 = bundle.getString("com.mixpanel.android.MPConfig.GroupsEndpoint");
        if (string3 != null) {
            setGroupsEndpoint(zContainsKey ? getEndPointWithIpTrackingParam(string3, getUseIpAddressForGeolocation()) : string3);
        } else {
            setGroupsEndpointWithBaseURL(MPConstants.URL.MIXPANEL_API);
        }
        MPLog.m2686v(LOGTAG, toString());
    }
    ...
    private String getEndPointWithIpTrackingParam(String str, boolean z) {
        ...
        if (zContains) {
            StringBuilder sbAppend = new StringBuilder().append(str.substring(0, str.indexOf("?ip="))).append("?ip=");
            if (!z) {
                str2 = AppEventsConstants.EVENT_PARAM_VALUE_NO;
            }
            return sbAppend.append(str2).toString();
        }
        StringBuilder sbAppend2 = new StringBuilder().append(str).append("?ip=");
        if (!z) {
            str2 = AppEventsConstants.EVENT_PARAM_VALUE_NO;
        }
