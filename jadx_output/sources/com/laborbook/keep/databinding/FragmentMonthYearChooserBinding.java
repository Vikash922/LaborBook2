...
public final class FragmentMonthYearChooserBinding implements ViewBinding {
    ...
    public static FragmentMonthYearChooserBinding inflate(LayoutInflater inflater, ViewGroup parent, boolean attachToParent) {
        View viewInflate = inflater.inflate(C3656R.layout.fragment_month_year_chooser, parent, false);
        if (attachToParent) {
    ...
    public static FragmentMonthYearChooserBinding bind(View rootView) {
        ...
        if (primaryButton != null) {
            ...
            if (constraintLayout != null && (viewFindChildViewById = ViewBindings.findChildViewById(rootView, (i = C3656R.id.divider_2))) != null) {
                ...
                if (imageView != null) {
                    i = C3656R.id.ll_month;
                    LinearLayout linearLayout = (LinearLayout) ViewBindings.findChildViewById(rootView, i);
                    if (linearLayout != null) {
                        i = C3656R.id.ll_year;
                        LinearLayout linearLayout2 = (LinearLayout) ViewBindings.findChildViewById(rootView, i);
                        if (linearLayout2 != null) {
                            i = C3656R.id.tv_month;
