...
public final class CoachMarkManager implements KoinComponent {
    ...
    /* JADX INFO: renamed from: com.laborbook.keep.utils.CoachMarkManager$shouldShowCoachMark$1 */
    /* JADX INFO: compiled from: CoachMarkManager.kt */
    @Metadata(m2723k = 3, m2724mv = {2, 0, 0}, m2726xi = 48)
    @DebugMetadata(m2734c = "com.laborbook.keep.utils.CoachMarkManager", m2735f = "CoachMarkManager.kt", m2736i = {}, m2737l = {34}, m2738m = "shouldShowCoachMark", m2739n = {}, m2740s = {})
    ...
    public CoachMarkManager() {
        ...
        this.dataStore = LazyKt.lazy(lazyThreadSafetyModeDefaultLazyMode, (Function0) new Function0<DataStoreManager>() { // from class: com.laborbook.keep.utils.CoachMarkManager$special$$inlined$inject$default$1
    ...
    */
    public final java.lang.Object shouldShowCoachMark(android.content.Context r5, kotlin.coroutines.Continuation<? super java.lang.Boolean> r6) {
        /*
            r4 = this;
            boolean r5 = r6 instanceof com.laborbook.keep.utils.CoachMarkManager.C38621
            if (r5 == 0) goto L14
            r5 = r6
            com.laborbook.keep.utils.CoachMarkManager$shouldShowCoachMark$1 r5 = (com.laborbook.keep.utils.CoachMarkManager.C38621) r5
            int r0 = r5.label
            ...
            goto L19
        L14:
            com.laborbook.keep.utils.CoachMarkManager$shouldShowCoachMark$1 r5 = new com.laborbook.keep.utils.CoachMarkManager$shouldShowCoachMark$1
            r5.<init>(r6)
        L19:
        ...
        L32:
            kotlin.ResultKt.throwOnFailure(r6)
            com.laborbook.base.datastore.DataStoreManager r6 = r4.getDataStore()
            androidx.datastore.preferences.core.Preferences$Key<java.lang.Boolean> r1 = com.laborbook.keep.utils.CoachMarkManager.COACH_MARK_SHOWN_KEY
            r3 = 0
        ...
        L4d:
            ...
            return r5
        */
        throw new UnsupportedOperationException("Method not decompiled: com.laborbook.keep.utils.CoachMarkManager.shouldShowCoachMark(android.content.Context, kotlin.coroutines.Continuation):java.lang.Object");
    }
    ...
    public final void showEditButtonCoachMark(Activity activity, View targetView, final Function0<Unit> onDismiss) {
        ...
        popupWindow.setOnDismissListener(new PopupWindow.OnDismissListener() { // from class: com.laborbook.keep.utils.CoachMarkManager$$ExternalSyntheticLambda0
        ...
        textView3.setOnClickListener(new View.OnClickListener() { // from class: com.laborbook.keep.utils.CoachMarkManager$$ExternalSyntheticLambda1
