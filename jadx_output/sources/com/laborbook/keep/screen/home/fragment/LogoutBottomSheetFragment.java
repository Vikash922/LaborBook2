...
public final class LogoutBottomSheetFragment extends BaseBottomsheetFragment<FragmentLogoutBottomsheetBinding> {
    ...
    private final void setOnClickListeners() {
        FragmentLogoutBottomsheetBinding binding = getBinding();
        if (binding != null) {
            binding.ivClose.setOnClickListener(new View.OnClickListener() { // from class: com.laborbook.keep.screen.home.fragment.LogoutBottomSheetFragment$$ExternalSyntheticLambda0
                @Override // android.view.View.OnClickListener
                public final void onClick(View view) {
                    LogoutBottomSheetFragment.setOnClickListeners$lambda$3$lambda$0(this.f$0, view);
                }
            });
            binding.btnNo.setOnClickListener(new View.OnClickListener() { // from class: com.laborbook.keep.screen.home.fragment.LogoutBottomSheetFragment$$ExternalSyntheticLambda1
                @Override // android.view.View.OnClickListener
                public final void onClick(View view) {
                    LogoutBottomSheetFragment.setOnClickListeners$lambda$3$lambda$1(this.f$0, view);
                }
            });
            binding.btnYes.setOnClickListener(new View.OnClickListener() { // from class: com.laborbook.keep.screen.home.fragment.LogoutBottomSheetFragment$$ExternalSyntheticLambda2
                @Override // android.view.View.OnClickListener
                public final void onClick(View view) {
    ...
    /* JADX INFO: renamed from: com.laborbook.keep.screen.home.fragment.LogoutBottomSheetFragment$handleLogout$1 */
    /* JADX INFO: compiled from: LogoutBottomSheetFragment.kt */
    @Metadata(m2721d1 = {"\u0000\n\n\u0000\n\u0002\u0010\u0002\n\u0002\u0018\u0002\u0010\u0000\u001a\u00020\u0001*\u00020\u0002H\n"}, m2722d2 = {"<anonymous>", "", "Lkotlinx/coroutines/CoroutineScope;"}, m2723k = 3, m2724mv = {2, 0, 0}, m2726xi = 48)
    @DebugMetadata(m2734c = "com.laborbook.keep.screen.home.fragment.LogoutBottomSheetFragment$handleLogout$1", m2735f = "LogoutBottomSheetFragment.kt", m2736i = {1, 2}, m2737l = {76, 80, 81, 82, 85}, m2738m = "invokeSuspend", m2739n = {"database", "database"}, m2740s = {"L$0", "L$0"})
    static final class C37931 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        */
        public final java.lang.Object invokeSuspend(java.lang.Object r9) {
            ...
            */
            throw new UnsupportedOperationException("Method not decompiled: com.laborbook.keep.screen.home.fragment.LogoutBottomSheetFragment.C37931.invokeSuspend(java.lang.Object):java.lang.Object");
        }
    }
