...
import com.laborbook.keep.databinding.FragmentAppBackupBottomsheetBinding;
...
public final class AppBackupBottomSheetFragment extends BaseBottomsheetFragment<FragmentAppBackupBottomsheetBinding> {
    ...
    private final void setOnClickListeners() {
        FragmentAppBackupBottomsheetBinding binding = getBinding();
        if (binding != null) {
            binding.ivClose.setOnClickListener(new View.OnClickListener() { // from class: com.laborbook.keep.screen.home.fragment.AppBackupBottomSheetFragment$$ExternalSyntheticLambda0
                @Override // android.view.View.OnClickListener
                public final void onClick(View view) {
                    AppBackupBottomSheetFragment.setOnClickListeners$lambda$3$lambda$1(this.f$0, view);
                }
            });
            binding.btnOk.setOnClickListener(new View.OnClickListener() { // from class: com.laborbook.keep.screen.home.fragment.AppBackupBottomSheetFragment$$ExternalSyntheticLambda1
                @Override // android.view.View.OnClickListener
                public final void onClick(View view) {
