...
public final class UpiSelectionBottomSheet extends BottomSheetDialogFragment {
    ...
    private final void setupRecyclerView() {
        ...
        this.adapter = new UpiAppAdapter(this.installedUpiAppsList, this.selectedPackageName, new Function1() { // from class: com.laborbook.keep.screen.premium.UpiSelectionBottomSheet$$ExternalSyntheticLambda0
