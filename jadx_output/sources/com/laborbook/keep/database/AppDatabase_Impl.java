...
import com.laborbook.keep.screen.calendar.dao.AttendanceUserDao_Impl;
import com.laborbook.keep.screen.calendar.dao.CalendarItemDao;
import com.laborbook.keep.screen.calendar.dao.CalendarItemDao_Impl;
import com.laborbook.keep.screen.home.dao.StaffUserDao;
import com.laborbook.keep.screen.home.dao.StaffUserDao_Impl;
...
public final class AppDatabase_Impl extends AppDatabase {
    ...
    protected SupportSQLiteOpenHelper createOpenHelper(final DatabaseConfiguration config) {
        return config.sqliteOpenHelperFactory.create(SupportSQLiteOpenHelper.Configuration.builder(config.context).name(config.name).callback(new RoomOpenHelper(config, new RoomOpenHelper.Delegate(4) { // from class: com.laborbook.keep.database.AppDatabase_Impl.1
            ...
            public RoomOpenHelper.ValidationResult onValidateSchema(final SupportSQLiteDatabase db) {
                ...
                if (!tableInfo.equals(tableInfo2)) {
                    return new RoomOpenHelper.ValidationResult(false, "staffs(com.laborbook.keep.model.StaffUser).\n Expected:\n" + tableInfo + "\n Found:\n" + tableInfo2);
                }
                ...
                if (!tableInfo3.equals(tableInfo4)) {
                    return new RoomOpenHelper.ValidationResult(false, "attendance_user(com.laborbook.keep.model.AttendanceUser).\n Expected:\n" + tableInfo3 + "\n Found:\n" + tableInfo4);
                }
                ...
                if (!tableInfo5.equals(tableInfo6)) {
                    return new RoomOpenHelper.ValidationResult(false, "calendar_item(com.laborbook.keep.model.CalendarItem).\n Expected:\n" + tableInfo5 + "\n Found:\n" + tableInfo6);
                }
    ...
    @Override // com.laborbook.keep.database.AppDatabase
