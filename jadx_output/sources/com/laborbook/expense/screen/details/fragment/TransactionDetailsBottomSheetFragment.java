package com.laborbook.expense.screen.details.fragment;
...
import com.laborbook.expense.databinding.FragmentTransactionDetailsBinding;
...
import com.laborbook.expense.screen.home.fragment.ExpenseFragment;
...
public final class TransactionDetailsBottomSheetFragment extends BaseBottomsheetFragment<FragmentTransactionDetailsBinding> {
    ...
    public TransactionDetailsBottomSheetFragment() {
        ...
        this.expenseObserverUtil = LazyKt.lazy(lazyThreadSafetyMode, (Function0) new Function0<ExpenseObserverUtil>() { // from class: com.laborbook.expense.screen.details.fragment.TransactionDetailsBottomSheetFragment$special$$inlined$inject$default$1
    ...
    private final void setupClicks() {
        ...
        if (binding != null && (imageView = binding.ivClose) != null) {
            imageView.setOnClickListener(new View.OnClickListener() { // from class: com.laborbook.expense.screen.details.fragment.TransactionDetailsBottomSheetFragment$$ExternalSyntheticLambda2
        ...
        if (binding2 != null && (primaryButton = binding2.btnOk) != null) {
            primaryButton.setOnClickListener(new View.OnClickListener() { // from class: com.laborbook.expense.screen.details.fragment.TransactionDetailsBottomSheetFragment$$ExternalSyntheticLambda3
                @Override // android.view.View.OnClickListener
                public final void onClick(View view) {
        ...
        textViewBold12.setOnClickListener(new View.OnClickListener() { // from class: com.laborbook.expense.screen.details.fragment.TransactionDetailsBottomSheetFragment$$ExternalSyntheticLambda4
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
    ...
    public static final void setupClicks$lambda$6(final TransactionDetailsBottomSheetFragment this$0, View view) {
        ...
        try {
            ...
            decorView.postDelayed(new Runnable() { // from class: com.laborbook.expense.screen.details.fragment.TransactionDetailsBottomSheetFragment$$ExternalSyntheticLambda5
    ...
    private final void setupObserverCallbacks() {
        ...
        if (expenseFragmentFindExpenseFragment != null) {
            getExpenseObserverUtil().setOnExpenseAddedOrUpdated(new Function2() { // from class: com.laborbook.expense.screen.details.fragment.TransactionDetailsBottomSheetFragment$$ExternalSyntheticLambda0
            ...
            getExpenseObserverUtil().setOnExpenseDeleted(new Function1() { // from class: com.laborbook.expense.screen.details.fragment.TransactionDetailsBottomSheetFragment$$ExternalSyntheticLambda1
