...
public class InstructionAdapter extends MethodVisitor {
                        ...
                        default:
                            switch (i) {
                                ...
                                case 127:
                                    ...
                                    return;
                                case 128:
                                    m2901or(Type.INT_TYPE);
                                    return;
                                case 129:
                                    m2901or(Type.LONG_TYPE);
                                    return;
                                case 130:
                                    xor(Type.INT_TYPE);
                                    return;
    ...
    public void nop() {
        this.f4754mv.visitInsn(0);
    }

    public void aconst(Object obj) {
        if (obj == null) {
            this.f4754mv.visitInsn(1);
        } else {
            this.f4754mv.visitLdcInsn(obj);
        }
    }

    public void iconst(int i) {
        if (i >= -1 && i <= 5) {
            this.f4754mv.visitInsn(i + 3);
            return;
        }
        if (i >= -128 && i <= 127) {
            this.f4754mv.visitIntInsn(16, i);
        } else if (i >= -32768 && i <= 32767) {
            this.f4754mv.visitIntInsn(17, i);
        } else {
            this.f4754mv.visitLdcInsn(Integer.valueOf(i));
        }
    }

    public void lconst(long j) {
        if (j == 0 || j == 1) {
            this.f4754mv.visitInsn(((int) j) + 9);
        } else {
            this.f4754mv.visitLdcInsn(Long.valueOf(j));
        }
    }
    ...
    public void fconst(float f) {
        ...
        if (iFloatToIntBits == 0 || iFloatToIntBits == 1065353216 || iFloatToIntBits == 1073741824) {
            this.f4754mv.visitInsn(((int) f) + 11);
        } else {
            this.f4754mv.visitLdcInsn(Float.valueOf(f));
        }
    }
    ...
    public void dconst(double d) {
        ...
        if (jDoubleToLongBits == 0 || jDoubleToLongBits == 4607182418800017408L) {
            this.f4754mv.visitInsn(((int) d) + 14);
        } else {
            this.f4754mv.visitLdcInsn(Double.valueOf(d));
        }
    }

    public void tconst(Type type) {
        this.f4754mv.visitLdcInsn(type);
    }

    public void hconst(Handle handle) {
        this.f4754mv.visitLdcInsn(handle);
    }

    public void cconst(ConstantDynamic constantDynamic) {
        this.f4754mv.visitLdcInsn(constantDynamic);
    }

    public void load(int i, Type type) {
        this.f4754mv.visitVarInsn(type.getOpcode(21), i);
    }

    public void aload(Type type) {
        this.f4754mv.visitInsn(type.getOpcode(46));
    }

    public void store(int i, Type type) {
        this.f4754mv.visitVarInsn(type.getOpcode(54), i);
    }

    public void astore(Type type) {
        this.f4754mv.visitInsn(type.getOpcode(79));
    }

    public void pop() {
        this.f4754mv.visitInsn(87);
    }

    public void pop2() {
        this.f4754mv.visitInsn(88);
    }

    public void dup() {
        this.f4754mv.visitInsn(89);
    }

    public void dup2() {
        this.f4754mv.visitInsn(92);
    }

    public void dupX1() {
        this.f4754mv.visitInsn(90);
    }

    public void dupX2() {
        this.f4754mv.visitInsn(91);
    }

    public void dup2X1() {
        this.f4754mv.visitInsn(93);
    }

    public void dup2X2() {
        this.f4754mv.visitInsn(94);
    }

    public void swap() {
        this.f4754mv.visitInsn(95);
    }

    public void add(Type type) {
        this.f4754mv.visitInsn(type.getOpcode(96));
    }

    public void sub(Type type) {
        this.f4754mv.visitInsn(type.getOpcode(100));
    }

    public void mul(Type type) {
        this.f4754mv.visitInsn(type.getOpcode(104));
    }

    public void div(Type type) {
        this.f4754mv.visitInsn(type.getOpcode(108));
    }

    public void rem(Type type) {
        this.f4754mv.visitInsn(type.getOpcode(112));
    }

    public void neg(Type type) {
        this.f4754mv.visitInsn(type.getOpcode(116));
    }

    public void shl(Type type) {
        this.f4754mv.visitInsn(type.getOpcode(120));
    }

    public void shr(Type type) {
        this.f4754mv.visitInsn(type.getOpcode(122));
    }

    public void ushr(Type type) {
        this.f4754mv.visitInsn(type.getOpcode(124));
    }

    public void and(Type type) {
        this.f4754mv.visitInsn(type.getOpcode(126));
    }

    /* JADX INFO: renamed from: or */
    public void m2901or(Type type) {
        this.f4754mv.visitInsn(type.getOpcode(128));
    }

    public void xor(Type type) {
        this.f4754mv.visitInsn(type.getOpcode(130));
    }

    public void iinc(int i, int i2) {
        this.f4754mv.visitIincInsn(i, i2);
    }

    public void cast(Type type, Type type2) {
        cast(this.f4754mv, type, type2);
    }
    ...
    public void lcmp() {
        this.f4754mv.visitInsn(Opcodes.LCMP);
    }

    public void cmpl(Type type) {
        this.f4754mv.visitInsn(type == Type.FLOAT_TYPE ? Opcodes.FCMPL : Opcodes.DCMPL);
    }

    public void cmpg(Type type) {
        this.f4754mv.visitInsn(type == Type.FLOAT_TYPE ? Opcodes.FCMPG : Opcodes.DCMPG);
    }

    public void ifeq(Label label) {
        this.f4754mv.visitJumpInsn(153, label);
    }

    public void ifne(Label label) {
        this.f4754mv.visitJumpInsn(154, label);
    }

    public void iflt(Label label) {
        this.f4754mv.visitJumpInsn(155, label);
    }

    public void ifge(Label label) {
        this.f4754mv.visitJumpInsn(156, label);
    }

    public void ifgt(Label label) {
        this.f4754mv.visitJumpInsn(157, label);
    }

    public void ifle(Label label) {
        this.f4754mv.visitJumpInsn(158, label);
    }

    public void ificmpeq(Label label) {
        this.f4754mv.visitJumpInsn(Opcodes.IF_ICMPEQ, label);
    }

    public void ificmpne(Label label) {
        this.f4754mv.visitJumpInsn(Opcodes.IF_ICMPNE, label);
    }

    public void ificmplt(Label label) {
        this.f4754mv.visitJumpInsn(Opcodes.IF_ICMPLT, label);
    }

    public void ificmpge(Label label) {
        this.f4754mv.visitJumpInsn(Opcodes.IF_ICMPGE, label);
    }

    public void ificmpgt(Label label) {
        this.f4754mv.visitJumpInsn(Opcodes.IF_ICMPGT, label);
    }

    public void ificmple(Label label) {
        this.f4754mv.visitJumpInsn(Opcodes.IF_ICMPLE, label);
    }

    public void ifacmpeq(Label label) {
        this.f4754mv.visitJumpInsn(Opcodes.IF_ACMPEQ, label);
    }

    public void ifacmpne(Label label) {
        this.f4754mv.visitJumpInsn(Opcodes.IF_ACMPNE, label);
    }

    public void goTo(Label label) {
        this.f4754mv.visitJumpInsn(Opcodes.GOTO, label);
    }

    public void jsr(Label label) {
        this.f4754mv.visitJumpInsn(Opcodes.JSR, label);
    }

    public void ret(int i) {
        this.f4754mv.visitVarInsn(Opcodes.RET, i);
    }

    public void tableswitch(int i, int i2, Label label, Label... labelArr) {
        this.f4754mv.visitTableSwitchInsn(i, i2, label, labelArr);
    }

    public void lookupswitch(Label label, int[] iArr, Label[] labelArr) {
        this.f4754mv.visitLookupSwitchInsn(label, iArr, labelArr);
    }

    public void areturn(Type type) {
        this.f4754mv.visitInsn(type.getOpcode(Opcodes.IRETURN));
    }

    public void getstatic(String str, String str2, String str3) {
        this.f4754mv.visitFieldInsn(Opcodes.GETSTATIC, str, str2, str3);
    }

    public void putstatic(String str, String str2, String str3) {
        this.f4754mv.visitFieldInsn(Opcodes.PUTSTATIC, str, str2, str3);
    }

    public void getfield(String str, String str2, String str3) {
        this.f4754mv.visitFieldInsn(Opcodes.GETFIELD, str, str2, str3);
    }

    public void putfield(String str, String str2, String str3) {
        this.f4754mv.visitFieldInsn(Opcodes.PUTFIELD, str, str2, str3);
    }
    ...
    public void invokevirtual(String str, String str2, String str3) {
        if (this.api >= 327680) {
            ...
            this.f4754mv.visitMethodInsn(Opcodes.INVOKEVIRTUAL, str, str2, str3);
        }
    }

    public void invokevirtual(String str, String str2, String str3, boolean z) {
        if (this.api >= 327680) {
            this.f4754mv.visitMethodInsn(Opcodes.INVOKEVIRTUAL, str, str2, str3, z);
        } else {
            if (z) {
    ...
    public void invokespecial(String str, String str2, String str3) {
        if (this.api >= 327680) {
            ...
            this.f4754mv.visitMethodInsn(Opcodes.INVOKESPECIAL, str, str2, str3, false);
        }
    }

    public void invokespecial(String str, String str2, String str3, boolean z) {
        if (this.api >= 327680) {
            this.f4754mv.visitMethodInsn(Opcodes.INVOKESPECIAL, str, str2, str3, z);
        } else {
            if (z) {
    ...
    public void invokestatic(String str, String str2, String str3) {
        if (this.api >= 327680) {
            ...
            this.f4754mv.visitMethodInsn(Opcodes.INVOKESTATIC, str, str2, str3, false);
        }
    }

    public void invokestatic(String str, String str2, String str3, boolean z) {
        if (this.api >= 327680) {
            this.f4754mv.visitMethodInsn(Opcodes.INVOKESTATIC, str, str2, str3, z);
        } else {
            if (z) {
    ...
    public void invokeinterface(String str, String str2, String str3) {
        this.f4754mv.visitMethodInsn(Opcodes.INVOKEINTERFACE, str, str2, str3, true);
    }

    public void invokedynamic(String str, String str2, Handle handle, Object[] objArr) {
        this.f4754mv.visitInvokeDynamicInsn(str, str2, handle, objArr);
    }

    public void anew(Type type) {
        this.f4754mv.visitTypeInsn(Opcodes.NEW, type.getInternalName());
    }

    public void newarray(Type type) {
        newarray(this.f4754mv, type);
    }
    ...
    public void arraylength() {
        this.f4754mv.visitInsn(190);
    }

    public void athrow() {
        this.f4754mv.visitInsn(Opcodes.ATHROW);
    }

    public void checkcast(Type type) {
        this.f4754mv.visitTypeInsn(192, type.getInternalName());
    }

    public void instanceOf(Type type) {
        this.f4754mv.visitTypeInsn(Opcodes.INSTANCEOF, type.getInternalName());
    }

    public void monitorenter() {
        this.f4754mv.visitInsn(Opcodes.MONITORENTER);
    }

    public void monitorexit() {
        this.f4754mv.visitInsn(Opcodes.MONITOREXIT);
    }

    public void multianewarray(String str, int i) {
        this.f4754mv.visitMultiANewArrayInsn(str, i);
    }

    public void ifnull(Label label) {
        this.f4754mv.visitJumpInsn(Opcodes.IFNULL, label);
    }

    public void ifnonnull(Label label) {
        this.f4754mv.visitJumpInsn(Opcodes.IFNONNULL, label);
    }

    public void mark(Label label) {
        this.f4754mv.visitLabel(label);
    }
}
