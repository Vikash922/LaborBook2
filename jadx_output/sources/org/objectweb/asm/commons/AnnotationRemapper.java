...
public class AnnotationRemapper extends AnnotationVisitor {
    ...
    public AnnotationVisitor visitAnnotation(String str, String str2) {
        ...
        return annotationVisitorVisitAnnotation == this.f4750av ? this : createAnnotationRemapper(str2, annotationVisitorVisitAnnotation);
    }
    ...
    public AnnotationVisitor visitArray(String str) {
        ...
        return annotationVisitorVisitArray == this.f4750av ? this : createAnnotationRemapper(null, annotationVisitorVisitArray);
    }
    ...
    final AnnotationVisitor orDeprecatedValue(AnnotationVisitor annotationVisitor) {
        if (annotationVisitor.getClass() == getClass()) {
            ...
            if (annotationRemapper.api == this.api && annotationRemapper.f4750av == this.f4750av && annotationRemapper.remapper == this.remapper) {
                return this;
            }
        }
