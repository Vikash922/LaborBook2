...
public class ClassReader {
    ...
    */
    ...
    private int readMethod(ClassVisitor classVisitor, Context context, int i) {
        ...
        while (true) {
            ...
            int i19 = i5 + 6;
            int i20 = i6;
            if (StandardRoles.CODE.equals(utf8)) {
    ...
    /* JADX WARN: Type update failed for variable: r42v0 org.objectweb.asm.MethodVisitor, new type: org.objectweb.asm.MethodVisitor
    jadx.core.utils.exceptions.JadxOverflowException: Type inference error: updates count limit reached with updateSeq = 34381. Try increasing type updates limit count.
    ...
    */
    ...
    public long readLong(int i) {
        return (((long) readInt(i)) << 32) | (((long) readInt(i + 4)) & BodyPartID.bodyIdMax);
    }
        ...
        while (i < i4) {
            ...
            if ((b & 128) == 0) {
                ...
                if ((b & 224) == 192) {
                    i3 = i5 + 1;
                    i += 2;
                    cArr[i5] = (char) (((b & Ascii.f396US) << 6) + (bArr[i6] & Utf8.REPLACEMENT_BYTE));
                } else {
                    i3 = i5 + 1;
                    int i7 = i + 2;
                    i += 3;
                    cArr[i5] = (char) (((b & Ascii.f393SI) << 12) + ((bArr[i6] & Utf8.REPLACEMENT_BYTE) << 6) + (bArr[i7] & Utf8.REPLACEMENT_BYTE));
                }
                i5 = i3;
            }
        }
