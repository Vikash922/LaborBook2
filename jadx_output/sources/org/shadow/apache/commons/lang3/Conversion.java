...
public class Conversion {
    ...
    */
    public static boolean[] hexDigitToBinary(char r3) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: org.shadow.apache.commons.lang3.Conversion.hexDigitToBinary(char):boolean[]");
    }
    ...
    */
    public static boolean[] hexDigitMsb0ToBinary(char r3) {
        /*
            ...
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: org.shadow.apache.commons.lang3.Conversion.hexDigitMsb0ToBinary(char):boolean[]");
    }
    ...
    public static char binaryToHexDigit(boolean[] zArr, int i) {
        ...
        if (zArr.length > i2 && zArr[i2]) {
            ...
            int i5 = i + 1;
            return (zArr.length <= i5 || !zArr[i5]) ? zArr[i] ? Barcode128.CODE_AC_TO_B : Barcode128.CODE_AB_TO_C : zArr[i] ? Barcode128.FNC1_INDEX : Barcode128.CODE_BC_TO_A;
        }
        int i6 = i + 2;
    ...
    public static char binaryBeMsb0ToHexDigit(boolean[] zArr, int i) {
        ...
        return zArr2[0] ? zArr2[1] ? zArr2[2] ? zArr2[3] ? Barcode128.FNC1_INDEX : Barcode128.CODE_BC_TO_A : zArr2[3] ? Barcode128.CODE_AC_TO_B : Barcode128.CODE_AB_TO_C : zArr2[2] ? zArr2[3] ? 'b' : 'a' : zArr2[3] ? '9' : '8' : zArr2[1] ? zArr2[2] ? zArr2[3] ? '7' : '6' : zArr2[3] ? '5' : '4' : zArr2[2] ? zArr2[3] ? '3' : '2' : zArr2[3] ? '1' : '0';
    }
    ...
    public static long intArrayToLong(int[] iArr, int i, long j, int i2, int i3) {
        ...
        for (int i4 = 0; i4 < i3; i4++) {
            int i5 = (i4 * 32) + i2;
            j = (j & (~(BodyPartID.bodyIdMax << i5))) | ((((long) iArr[i4 + i]) & BodyPartID.bodyIdMax) << i5);
        }
        return j;
    }
