...
public class StrBuilder implements CharSequence, Appendable, Serializable, Builder<String> {
    ...
    public StrBuilder append(boolean z) {
        if (z) {
            ...
            cArr[i3] = 'u';
            this.size = i + 4;
            cArr[i4] = Barcode128.CODE_BC_TO_A;
        } else {
            ...
            int i6 = i5 + 1;
            this.size = i6;
            cArr2[i5] = Barcode128.FNC1_INDEX;
            int i7 = i5 + 2;
            this.size = i7;
            cArr2[i6] = 'a';
            int i8 = i5 + 3;
    ...
    public StrBuilder insert(int i, boolean z) {
        ...
        if (z) {
            ...
            cArr2[i + 1] = 'r';
            cArr2[i + 2] = 'u';
            cArr2[i + 3] = Barcode128.CODE_BC_TO_A;
            this.size += 4;
        } else {
            ensureCapacity(this.size + 5);
            ...
            cArr4[i] = Barcode128.FNC1_INDEX;
            cArr4[i + 1] = 'a';
            cArr4[i + 2] = 'l';
            cArr4[i + 3] = 's';
            cArr4[i + 4] = Barcode128.CODE_BC_TO_A;
            this.size += 5;
        }
        return this;
    }
    ...
    */
    public int indexOf(java.lang.String r9, int r10) {
        ...
        L3e:
            return r1
        */
        throw new UnsupportedOperationException("Method not decompiled: org.shadow.apache.commons.lang3.text.StrBuilder.indexOf(java.lang.String, int):int");
    }
    ...
    */
    public int lastIndexOf(java.lang.String r8, int r9) {
        ...
        L40:
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: org.shadow.apache.commons.lang3.text.StrBuilder.lastIndexOf(java.lang.String, int):int");
    }
