...
public class StringUtils {
    ...
    public static final String f4767CR = "\r";
    public static final String EMPTY = "";
    public static final int INDEX_NOT_FOUND = -1;

    /* JADX INFO: renamed from: LF */
    public static final String f4768LF = "\n";
    ...
    private static int ordinalIndexOf(CharSequence charSequence, CharSequence charSequence2, int i, boolean z) {
        if (charSequence != null && charSequence2 != null && i > 0) {
            ...
            do {
                if (z) {
                    length = CharSequenceUtils.lastIndexOf(charSequence, charSequence2, length - charSequence2.length());
                } else {
                    length = CharSequenceUtils.indexOf(charSequence, charSequence2, length + charSequence2.length());
                }
                if (length < 0) {
                    return length;
                }
    ...
    */
    public static int indexOfAnyBut(java.lang.CharSequence r11, char... r12) {
        /*
            ...
            r1 = -1
            if (r0 != 0) goto L43
            boolean r0 = org.shadow.apache.commons.lang3.ArrayUtils.isEmpty(r12)
            if (r0 == 0) goto Le
            goto L43
        Le:
            int r0 = r11.length()
        ...
        L43:
            return r1
        */
        throw new UnsupportedOperationException("Method not decompiled: org.shadow.apache.commons.lang3.StringUtils.indexOfAnyBut(java.lang.CharSequence, char[]):int");
    }
    ...
    */
    public static java.lang.String chomp(java.lang.String r6) {
        ...
        L3b:
            ...
            return r6
        */
        throw new UnsupportedOperationException("Method not decompiled: org.shadow.apache.commons.lang3.StringUtils.chomp(java.lang.String):java.lang.String");
    }
    ...
    public static String capitalize(String str) {
        ...
        char cCharAt = str.charAt(0);
        return Character.isTitleCase(cCharAt) ? str : new StringBuilder(length).append(Character.toTitleCase(cCharAt)).append(str.substring(1)).toString();
    }
    ...
    public static String uncapitalize(String str) {
        ...
        char cCharAt = str.charAt(0);
        return Character.isLowerCase(cCharAt) ? str : new StringBuilder(length).append(Character.toLowerCase(cCharAt)).append(str.substring(1)).toString();
    }
    ...
    public static double getJaroWinklerDistance(CharSequence charSequence, CharSequence charSequence2) {
        ...
        return Math.round((dScore + ((((double) commonPrefixLength(charSequence, charSequence2)) * 0.1d) * (1.0d - dScore))) * 100.0d) / 100.0d;
    }
    ...
    private static double score(CharSequence charSequence, CharSequence charSequence2) {
        ...
        return (((((double) setOfMatchingCharacterWithin.length()) / ((double) lowerCase.length())) + (((double) setOfMatchingCharacterWithin2.length()) / ((double) lowerCase2.length()))) + (((double) (setOfMatchingCharacterWithin.length() - transpositions(setOfMatchingCharacterWithin, setOfMatchingCharacterWithin2))) / ((double) setOfMatchingCharacterWithin.length()))) / 3.0d;
    }
    ...
    private static String getSetOfMatchingCharacterWithin(CharSequence charSequence, CharSequence charSequence2, int i) {
        ...
        for (int i2 = 0; i2 < charSequence.length(); i2++) {
            ...
            boolean z = false;
            for (int iMax = Math.max(0, i2 - i); !z && iMax < Math.min(i2 + i, charSequence2.length()); iMax++) {
