...
public abstract class CounterImpl implements ICounter {
    ...
    /* JADX INFO: renamed from: org.jacoco.core.internal.analysis.CounterImpl$1 */
    ...
    public double getValue(ICounter.CounterValue counterValue) {
        int totalCount;
        int i = C48021.$SwitchMap$org$jacoco$core$analysis$ICounter$CounterValue[counterValue.ordinal()];
        if (i == 1) {
