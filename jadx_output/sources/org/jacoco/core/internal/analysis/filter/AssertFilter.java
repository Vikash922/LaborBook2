...
final class AssertFilter implements IFilter {
    ...
    private static class Matcher extends AbstractMatcher {
        ...
        public void matchSet(String str, AbstractInsnNode abstractInsnNode, IFilterOutput iFilterOutput) {
            ...
            nextIs(Opcodes.GOTO);
            nextIs(3);
            nextIsField(Opcodes.PUTSTATIC, str, "$assertionsDisabled", SvgConstants.Attributes.PATH_DATA_CLOSE_PATH);
            if (this.cursor != null) {
        ...
        public void matchGet(String str, AbstractInsnNode abstractInsnNode, IFilterOutput iFilterOutput) {
            this.cursor = abstractInsnNode;
            nextIsField(Opcodes.GETSTATIC, str, "$assertionsDisabled", SvgConstants.Attributes.PATH_DATA_CLOSE_PATH);
            nextIs(154);
            if (this.cursor != null) {
