...
public class CertificateID {
    ...
    public CertificateID(DigestCalculator digestCalculator, X509CertificateHolder x509CertificateHolder, BigInteger bigInteger) throws OCSPException {
        this.f3861id = createCertID(digestCalculator, x509CertificateHolder, new ASN1Integer(bigInteger));
    }
    ...
    public static CertificateID deriveCertificateID(CertificateID certificateID, BigInteger bigInteger) {
        return new CertificateID(new CertID(certificateID.f3861id.getHashAlgorithm(), certificateID.f3861id.getIssuerNameHash(), certificateID.f3861id.getIssuerKeyHash(), new ASN1Integer(bigInteger)));
    }

    public boolean equals(Object obj) {
        if (obj instanceof CertificateID) {
            return this.f3861id.toASN1Primitive().equals(((CertificateID) obj).f3861id.toASN1Primitive());
        }
        return false;
    }

    public ASN1ObjectIdentifier getHashAlgOID() {
        return this.f3861id.getHashAlgorithm().getAlgorithm();
    }

    public byte[] getIssuerKeyHash() {
        return this.f3861id.getIssuerKeyHash().getOctets();
    }

    public byte[] getIssuerNameHash() {
        return this.f3861id.getIssuerNameHash().getOctets();
    }

    public BigInteger getSerialNumber() {
        return this.f3861id.getSerialNumber().getValue();
    }

    public int hashCode() {
        return this.f3861id.toASN1Primitive().hashCode();
    }
    ...
    public boolean matchesIssuer(X509CertificateHolder x509CertificateHolder, DigestCalculatorProvider digestCalculatorProvider) throws OCSPException {
        try {
            return createCertID(digestCalculatorProvider.get(this.f3861id.getHashAlgorithm()), x509CertificateHolder, this.f3861id.getSerialNumber()).equals(this.f3861id);
