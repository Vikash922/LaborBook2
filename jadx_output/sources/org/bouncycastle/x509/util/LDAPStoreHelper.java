...
public class LDAPStoreHelper {
    ...
    */
    ...
    /* JADX WARN: Removed duplicated region for block: B:47:0x0106 A[EXC_TOP_SPLITTER, PHI: r3
      0x0106: PHI (r3v3 javax.naming.directory.DirContext) = (r3v2 javax.naming.directory.DirContext), (r3v4 javax.naming.directory.DirContext) binds: [B:40:0x0111, B:33:0x0104] A[DONT_GENERATE, DONT_INLINE], SYNTHETIC] */
    /*
        Code decompiled incorrectly, please refer to instructions dump.
        To view partially-correct add '--show-bad-code' argument
    */
