...
public class McElieceCCA2PublicKey extends ASN1Object {
    ...
    private final GF2Matrix f4588g;

    /* JADX INFO: renamed from: n */
    private final int f4589n;

    /* JADX INFO: renamed from: t */
    private final int f4590t;

    public McElieceCCA2PublicKey(int i, int i2, GF2Matrix gF2Matrix, AlgorithmIdentifier algorithmIdentifier) {
        this.f4589n = i;
        this.f4590t = i2;
        this.f4588g = new GF2Matrix(gF2Matrix.getEncoded());
        this.digest = algorithmIdentifier;
    }

    private McElieceCCA2PublicKey(ASN1Sequence aSN1Sequence) {
        this.f4589n = ((ASN1Integer) aSN1Sequence.getObjectAt(0)).intValueExact();
        this.f4590t = ((ASN1Integer) aSN1Sequence.getObjectAt(1)).intValueExact();
        this.f4588g = new GF2Matrix(((ASN1OctetString) aSN1Sequence.getObjectAt(2)).getOctets());
    ...
    public ASN1Primitive toASN1Primitive() {
        ...
        aSN1EncodableVector.add(new ASN1Integer(this.f4589n));
        aSN1EncodableVector.add(new ASN1Integer(this.f4590t));
        aSN1EncodableVector.add(new DEROctetString(this.f4588g.getEncoded()));
