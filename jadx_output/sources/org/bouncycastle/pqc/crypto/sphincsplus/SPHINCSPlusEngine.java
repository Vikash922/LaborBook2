...
abstract class SPHINCSPlusEngine {
    ...
    static class Sha256Engine extends SPHINCSPlusEngine {
        ...
        public byte[] mo2888F(byte[] bArr, ADRS adrs, byte[] bArr2) {
            ...
            return Arrays.copyOfRange(this.digestBuf, 0, this.f4706N);
        }

        @Override // org.bouncycastle.pqc.crypto.sphincsplus.SPHINCSPlusEngine
        /* JADX INFO: renamed from: H */
        public byte[] mo2889H(byte[] bArr, ADRS adrs, byte[] bArr2, byte[] bArr3) {
            ...
            this.treeDigest.update(bArr, 0, bArr.length);
            this.treeDigest.update(this.padding, 0, 64 - this.f4706N);
            this.treeDigest.update(bArrCompressedADRS, 0, bArrCompressedADRS.length);
        ...
        IndexedDigest H_msg(byte[] bArr, byte[] bArr2, byte[] bArr3, byte[] bArr4) {
            int i = ((this.f4702A * this.f4705K) + 7) / 8;
            int i2 = this.f4704H / this.f4703D;
            int i3 = this.f4704H - i2;
            int i4 = (i2 + 7) / 8;
            int i5 = (i3 + 7) / 8;
            ...
            byte[] bArrBitmask = bitmask(Arrays.concatenate(bArr, bArr2, bArr5), new byte[i + i4 + i5]);
            byte[] bArr6 = new byte[8];
            System.arraycopy(bArrBitmask, i, bArr6, 8 - i5, i5);
            long jBigEndianToLong = Pack.bigEndianToLong(bArr6, 0) & ((-1) >>> (64 - i3));
            byte[] bArr7 = new byte[4];
            System.arraycopy(bArrBitmask, i5 + i, bArr7, 4 - i4, i4);
            return new IndexedDigest(jBigEndianToLong, Pack.bigEndianToInt(bArr7, 0) & ((-1) >>> (32 - i2)), Arrays.copyOfRange(bArrBitmask, 0, i));
        }
        ...
        public byte[] PRF_msg(byte[] bArr, byte[] bArr2, byte[] bArr3) {
            ...
            return Arrays.copyOfRange(this.hmacBuf, 0, this.f4706N);
        }
    ...
    static class Shake256Engine extends SPHINCSPlusEngine {
        ...
        @Override // org.bouncycastle.pqc.crypto.sphincsplus.SPHINCSPlusEngine
        /* JADX INFO: renamed from: F */
        byte[] mo2888F(byte[] bArr, ADRS adrs, byte[] bArr2) {
            if (this.robust) {
        ...
        @Override // org.bouncycastle.pqc.crypto.sphincsplus.SPHINCSPlusEngine
        /* JADX INFO: renamed from: H */
        byte[] mo2889H(byte[] bArr, ADRS adrs, byte[] bArr2, byte[] bArr3) {
            byte[] bArrConcatenate = Arrays.concatenate(bArr2, bArr3);
            if (this.robust) {
        ...
        IndexedDigest H_msg(byte[] bArr, byte[] bArr2, byte[] bArr3, byte[] bArr4) {
            ...
            return new IndexedDigest(jBigEndianToLong, Pack.bigEndianToInt(bArr7, 0) & ((-1) >>> (32 - i2)), Arrays.copyOfRange(bArr5, 0, i));
        }
        ...
        byte[] PRF(byte[] bArr, ADRS adrs) {
            this.treeDigest.update(bArr, 0, bArr.length);
            this.treeDigest.update(adrs.value, 0, adrs.value.length);
            byte[] bArr2 = new byte[this.f4706N];
            this.treeDigest.doFinal(bArr2, 0, this.f4706N);
            return bArr2;
        }
    ...
    /* JADX INFO: renamed from: F */
    abstract byte[] mo2888F(byte[] bArr, ADRS adrs, byte[] bArr2);

    /* JADX INFO: renamed from: H */
    abstract byte[] mo2889H(byte[] bArr, ADRS adrs, byte[] bArr2, byte[] bArr3);
