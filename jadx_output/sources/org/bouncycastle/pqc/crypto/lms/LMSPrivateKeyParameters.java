...
public class LMSPrivateKeyParameters extends LMSKeyParameters implements LMSContextBasedSigner {
    ...
    private static CacheKey f4630T1;
    private static CacheKey[] internedKeys;

    /* JADX INFO: renamed from: I */
    private final byte[] f4631I;
    ...
    private LMSPrivateKeyParameters(LMSPrivateKeyParameters lMSPrivateKeyParameters, int i, int i2) {
        ...
        this.f4632q = i;
        this.f4631I = lMSPrivateKeyParameters.f4631I;
        this.maxQ = i2;
    ...
    public boolean equals(Object obj) {
        ...
        if (this.f4632q != lMSPrivateKeyParameters.f4632q || this.maxQ != lMSPrivateKeyParameters.maxQ || !Arrays.areEqual(this.f4631I, lMSPrivateKeyParameters.f4631I)) {
            return false;
        }
    ...
    LMOtsPrivateKey getCurrentOTSKey() {
        ...
        synchronized (this) {
            if (this.f4632q >= this.maxQ) {
                throw new ExhaustedPrivateKeyException("ots private keys expired");
            }
            lMOtsPrivateKey = new LMOtsPrivateKey(this.otsParameters, this.f4631I, this.f4632q, this.masterSecret);
        }
    ...
    public byte[] getEncoded() throws IOException {
        return Composer.compose().u32str(0).u32str(this.parameters.getType()).u32str(this.otsParameters.getType()).bytes(this.f4631I).u32str(this.f4632q).u32str(this.maxQ).u32str(this.masterSecret.length).bytes(this.masterSecret).build();
    }

    public byte[] getI() {
        return Arrays.clone(this.f4631I);
    }
    ...
    public LMSPublicKeyParameters getPublicKey() {
        ...
        synchronized (this) {
            if (this.publicKey == null) {
                this.publicKey = new LMSPublicKeyParameters(this.parameters, this.otsParameters, findT(f4630T1), this.f4631I);
            }
    ...
    public long getUsagesRemaining() {
        return this.maxQ - this.f4632q;
    }

    public int hashCode() {
        int iHashCode = ((this.f4632q * 31) + Arrays.hashCode(this.f4631I)) * 31;
        LMSigParameters lMSigParameters = this.parameters;
