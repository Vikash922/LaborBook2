...
public class McElieceKobaraImaiCipher implements MessageEncryptor {
    ...
    private void initCipherDecrypt(McElieceCCA2PrivateKeyParameters mcElieceCCA2PrivateKeyParameters) {
        ...
        this.f4663n = mcElieceCCA2PrivateKeyParameters.getN();
        this.f4662k = mcElieceCCA2PrivateKeyParameters.getK();
        this.f4665t = mcElieceCCA2PrivateKeyParameters.getT();
    }

    private void initCipherEncrypt(McElieceCCA2PublicKeyParameters mcElieceCCA2PublicKeyParameters) {
        this.messDigest = Utils.getDigest(mcElieceCCA2PublicKeyParameters.getDigest());
        this.f4663n = mcElieceCCA2PublicKeyParameters.getN();
        this.f4662k = mcElieceCCA2PublicKeyParameters.getK();
        this.f4665t = mcElieceCCA2PublicKeyParameters.getT();
    }
    ...
    public void init(boolean z, CipherParameters cipherParameters) {
        ...
        if (!z) {
            ...
            if (!(cipherParameters instanceof ParametersWithRandom)) {
                this.f4664sr = CryptoServicesRegistrar.getSecureRandom();
            ...
            this.f4664sr = parametersWithRandom.getRandom();
    ...
    public byte[] messageDecrypt(byte[] bArr) throws InvalidCipherTextException {
        ...
        int i2 = this.f4662k >> 3;
        int iBitLength = (IntegerFunctions.binomial(this.f4663n, this.f4665t).bitLength() - 1) >> 3;
        ...
        GF2Vector[] gF2VectorArrDecryptionPrimitive = McElieceCCA2Primitives.decryptionPrimitive((McElieceCCA2PrivateKeyParameters) this.key, GF2Vector.OS2VP(this.f4663n, bArr));
        ...
        byte[] bArrDecode = Conversions.decode(this.f4663n, this.f4665t, gF2Vector);
    ...
    public byte[] messageEncrypt(byte[] bArr) {
        ...
        byte[] encoded = McElieceCCA2Primitives.encryptionPrimitive((McElieceCCA2PublicKeyParameters) this.key, GF2Vector.OS2VP(this.f4662k, bArr9), Conversions.encode(this.f4663n, this.f4665t, bArr8)).getEncoded();
