                        ...
                        if (!(aSN1Primitive instanceof ASN1RelativeOID)) {
                            if (aSN1Primitive instanceof ASN1Boolean) {
                                ...
                                if (aSN1Primitive instanceof ASN1Integer) {
                                    ...
                                    if (!(aSN1Primitive instanceof ASN1BitString)) {
                                        if (aSN1Primitive instanceof ASN1IA5String) {
                                            ...
                                            if (aSN1External.getDirectReference() != null) {
                                                stringBuffer.append(str + "Direct Reference: " + aSN1External.getDirectReference().getId() + strLineSeparator);
                                            }
                                            if (aSN1External.getIndirectReference() != null) {
                                                stringBuffer.append(str + "Indirect Reference: " + aSN1External.getIndirectReference().toString() + strLineSeparator);
                                            }
                                            if (aSN1External.getDataValueDescriptor() != null) {
                                                _dumpAsString(str, z, aSN1External.getDataValueDescriptor(), stringBuffer);
                                            }
                                            stringBuffer.append(str + "Encoding: " + aSN1External.getEncoding() + strLineSeparator);
                                    ...
                                    stringBuffer.append(sbAppend4.append(str2).append(bytes.length).append(", ").append(padBits).append("] ").toString());
                                    if (z) {
