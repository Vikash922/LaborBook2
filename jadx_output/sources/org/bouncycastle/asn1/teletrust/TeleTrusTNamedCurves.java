...
public class TeleTrusTNamedCurves {
    ...
    public static ASN1ObjectIdentifier getOID(short s, boolean z) {
        return getOID("brainpoolP" + ((int) s) + (z ? SvgConstants.Attributes.PATH_DATA_REL_SHORTHAND_CURVE_TO : "r") + AppEventsConstants.EVENT_PARAM_VALUE_YES);
    }
}
