...
public interface NSRIObjectIdentifiers {
    ...
    static {
        ...
        id_pad_null = aSN1ObjectIdentifierBranch.branch(AppEventsConstants.EVENT_PARAM_VALUE_NO);
        id_pad_1 = aSN1ObjectIdentifierBranch.branch(AppEventsConstants.EVENT_PARAM_VALUE_YES);
        id_aria128_ecb = aSN1ObjectIdentifierBranch2.branch(AppEventsConstants.EVENT_PARAM_VALUE_YES);
