...
public class ASN1OutputStream {
    ...
    private OutputStream f3763os;

    ASN1OutputStream(OutputStream outputStream) {
        this.f3763os = outputStream;
    }
    ...
    public static ASN1OutputStream create(OutputStream outputStream, String str) {
        return str.equals(ASN1Encoding.DER) ? new DEROutputStream(outputStream) : str.equals(ASN1Encoding.f3762DL) ? new DLOutputStream(outputStream) : new ASN1OutputStream(outputStream);
    }
