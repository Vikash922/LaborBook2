...
public class ASN1GeneralizedTime extends ASN1Primitive {
    ...
    private String pruneFractionalSeconds(String str) {
        ...
        if (i2 > 3) {
            ...
            str2 = strSubstring.substring(0, i) + AppEventsConstants.EVENT_PARAM_VALUE_NO + strSubstring.substring(i);
            sb = new StringBuilder();
        }
    ...
    public Date getDate() throws ParseException {
        ...
        if (strFromByteArray.endsWith(SvgConstants.Attributes.PATH_DATA_CLOSE_PATH)) {
            ...
            simpleDateFormatCalculateGMTDateFormat.setTimeZone(new SimpleTimeZone(0, SvgConstants.Attributes.PATH_DATA_CLOSE_PATH));
