...
public class DVCSRequestInformation extends ASN1Object {
    ...
    public String toString() {
        ...
        stringBuffer.append("service: " + this.service + StringUtils.f4768LF);
        if (this.nonce != null) {
            stringBuffer.append("nonce: " + this.nonce + StringUtils.f4768LF);
        }
        if (this.requestTime != null) {
            stringBuffer.append("requestTime: " + this.requestTime + StringUtils.f4768LF);
        }
        if (this.requester != null) {
            stringBuffer.append("requester: " + this.requester + StringUtils.f4768LF);
        }
        if (this.requestPolicy != null) {
            stringBuffer.append("requestPolicy: " + this.requestPolicy + StringUtils.f4768LF);
        }
        if (this.dvcs != null) {
            stringBuffer.append("dvcs: " + this.dvcs + StringUtils.f4768LF);
        }
        if (this.dataLocations != null) {
            stringBuffer.append("dataLocations: " + this.dataLocations + StringUtils.f4768LF);
        }
