...
public class DVCSCertInfo extends ASN1Object {
    ...
    public String toString() {
        ...
        if (this.version != 1) {
            stringBuffer.append("version: " + this.version + StringUtils.f4768LF);
        }
        stringBuffer.append("dvReqInfo: " + this.dvReqInfo + StringUtils.f4768LF);
        stringBuffer.append("messageImprint: " + this.messageImprint + StringUtils.f4768LF);
        stringBuffer.append("serialNumber: " + this.serialNumber + StringUtils.f4768LF);
        stringBuffer.append("responseTime: " + this.responseTime + StringUtils.f4768LF);
        if (this.dvStatus != null) {
            stringBuffer.append("dvStatus: " + this.dvStatus + StringUtils.f4768LF);
        }
        if (this.policy != null) {
            stringBuffer.append("policy: " + this.policy + StringUtils.f4768LF);
        }
        if (this.reqSignature != null) {
            stringBuffer.append("reqSignature: " + this.reqSignature + StringUtils.f4768LF);
        }
        if (this.certs != null) {
            stringBuffer.append("certs: " + this.certs + StringUtils.f4768LF);
        }
        if (this.extensions != null) {
            stringBuffer.append("extensions: " + this.extensions + StringUtils.f4768LF);
        }
        stringBuffer.append("}\n");
