...
public abstract class KeyPairGeneratorSpi extends KeyPairGenerator {
    ...
    public static class C4604EC extends KeyPairGeneratorSpi {
        ...
        public C4604EC(String str, ProviderConfiguration providerConfiguration) {
            super(str);
            this.engine = new ECKeyPairGenerator();
            this.ecParams = null;
            this.strength = 239;
    ...
    public static class ECDH extends C4604EC {
        public ECDH() {
            super("ECDH", BouncyCastleProvider.CONFIGURATION);
        }
    }

    public static class ECDHC extends C4604EC {
        public ECDHC() {
            super("ECDHC", BouncyCastleProvider.CONFIGURATION);
        }
    }

    public static class ECDSA extends C4604EC {
        public ECDSA() {
            super("ECDSA", BouncyCastleProvider.CONFIGURATION);
        }
    }

    public static class ECMQV extends C4604EC {
        public ECMQV() {
