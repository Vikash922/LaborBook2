...
public class DefaultCMSSignatureAlgorithmNameGenerator implements CMSSignatureAlgorithmNameGenerator {
    ...
    public String getSignatureName(AlgorithmIdentifier algorithmIdentifier, AlgorithmIdentifier algorithmIdentifier2) {
        ...
        return (!digestAlgName.equals(algorithm.getId()) ? new StringBuilder().append(digestAlgName) : new StringBuilder().append(getDigestAlgName(algorithmIdentifier.getAlgorithm()))).append("with").append(getEncryptionAlgName(algorithm)).toString();
    }
