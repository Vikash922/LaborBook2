    ...
    public JcaContentSignerBuilder(String str, AlgorithmParameterSpec algorithmParameterSpec) {
        ...
        if (algorithmParameterSpec instanceof PSSParameterSpec) {
            ...
            if (!(algorithmParameterSpec instanceof CompositeAlgorithmSpec)) {
                throw new IllegalArgumentException("unknown sigParamSpec: " + (algorithmParameterSpec == null ? Constants.ATTENDANCE_STATUS_NULL : algorithmParameterSpec.getClass().getName()));
            }
