...
public class SecP521R1Point extends ECPoint.AbstractFp {
    ...
    public ECPoint add(ECPoint eCPoint) {
        ...
        SecP521R1FieldElement secP521R1FieldElement = (SecP521R1FieldElement) this.f4463x;
        SecP521R1FieldElement secP521R1FieldElement2 = (SecP521R1FieldElement) this.f4464y;
        ...
        SecP521R1FieldElement secP521R1FieldElement5 = (SecP521R1FieldElement) this.f4465zs[0];
        ...
        if (zIsOne) {
            iArr = secP521R1FieldElement3.f4537x;
            iArr2 = secP521R1FieldElement4.f4537x;
        } else {
            SecP521R1Field.square(secP521R1FieldElement5.f4537x, iArrCreate3);
            SecP521R1Field.multiply(iArrCreate3, secP521R1FieldElement3.f4537x, iArrCreate2);
            SecP521R1Field.multiply(iArrCreate3, secP521R1FieldElement5.f4537x, iArrCreate3);
            SecP521R1Field.multiply(iArrCreate3, secP521R1FieldElement4.f4537x, iArrCreate3);
            iArr = iArrCreate2;
            iArr2 = iArrCreate3;
        }
        boolean zIsOne2 = secP521R1FieldElement6.isOne();
        if (zIsOne2) {
            iArr3 = secP521R1FieldElement.f4537x;
            iArr4 = secP521R1FieldElement2.f4537x;
        } else {
            SecP521R1Field.square(secP521R1FieldElement6.f4537x, iArrCreate4);
            SecP521R1Field.multiply(iArrCreate4, secP521R1FieldElement.f4537x, iArrCreate);
            SecP521R1Field.multiply(iArrCreate4, secP521R1FieldElement6.f4537x, iArrCreate4);
            SecP521R1Field.multiply(iArrCreate4, secP521R1FieldElement2.f4537x, iArrCreate4);
            iArr3 = iArrCreate;
            iArr4 = iArrCreate4;
        }
        ...
        SecP521R1Field.square(iArrCreate2, secP521R1FieldElement7.f4537x);
        SecP521R1Field.add(secP521R1FieldElement7.f4537x, iArrCreate6, secP521R1FieldElement7.f4537x);
        SecP521R1Field.subtract(secP521R1FieldElement7.f4537x, iArrCreate3, secP521R1FieldElement7.f4537x);
        SecP521R1Field.subtract(secP521R1FieldElement7.f4537x, iArrCreate3, secP521R1FieldElement7.f4537x);
        SecP521R1FieldElement secP521R1FieldElement8 = new SecP521R1FieldElement(iArrCreate6);
        SecP521R1Field.subtract(iArrCreate3, secP521R1FieldElement7.f4537x, secP521R1FieldElement8.f4537x);
        SecP521R1Field.multiply(secP521R1FieldElement8.f4537x, iArrCreate2, iArrCreate2);
        SecP521R1Field.subtract(iArrCreate2, iArrCreate, secP521R1FieldElement8.f4537x);
        SecP521R1FieldElement secP521R1FieldElement9 = new SecP521R1FieldElement(iArrCreate5);
        if (!zIsOne) {
            SecP521R1Field.multiply(secP521R1FieldElement9.f4537x, secP521R1FieldElement5.f4537x, secP521R1FieldElement9.f4537x);
        }
        if (!zIsOne2) {
            SecP521R1Field.multiply(secP521R1FieldElement9.f4537x, secP521R1FieldElement6.f4537x, secP521R1FieldElement9.f4537x);
        }
    ...
    public ECPoint negate() {
        return isInfinity() ? this : new SecP521R1Point(this.curve, this.f4463x, this.f4464y.negate(), this.f4465zs);
    }
    ...
    public ECPoint twice() {
        ...
        ECCurve curve = getCurve();
        SecP521R1FieldElement secP521R1FieldElement = (SecP521R1FieldElement) this.f4464y;
        if (secP521R1FieldElement.isZero()) {
            return curve.getInfinity();
        }
        SecP521R1FieldElement secP521R1FieldElement2 = (SecP521R1FieldElement) this.f4463x;
        SecP521R1FieldElement secP521R1FieldElement3 = (SecP521R1FieldElement) this.f4465zs[0];
        int[] iArrCreate = Nat.create(17);
        int[] iArrCreate2 = Nat.create(17);
        int[] iArrCreate3 = Nat.create(17);
        SecP521R1Field.square(secP521R1FieldElement.f4537x, iArrCreate3);
        int[] iArrCreate4 = Nat.create(17);
        SecP521R1Field.square(iArrCreate3, iArrCreate4);
        boolean zIsOne = secP521R1FieldElement3.isOne();
        int[] iArr = secP521R1FieldElement3.f4537x;
        if (!zIsOne) {
            SecP521R1Field.square(secP521R1FieldElement3.f4537x, iArrCreate2);
            iArr = iArrCreate2;
        }
        SecP521R1Field.subtract(secP521R1FieldElement2.f4537x, iArr, iArrCreate);
        SecP521R1Field.add(secP521R1FieldElement2.f4537x, iArr, iArrCreate2);
        ...
        SecP521R1Field.multiply(iArrCreate3, secP521R1FieldElement2.f4537x, iArrCreate3);
        ...
        SecP521R1Field.square(iArrCreate2, secP521R1FieldElement4.f4537x);
        SecP521R1Field.subtract(secP521R1FieldElement4.f4537x, iArrCreate3, secP521R1FieldElement4.f4537x);
        SecP521R1Field.subtract(secP521R1FieldElement4.f4537x, iArrCreate3, secP521R1FieldElement4.f4537x);
        SecP521R1FieldElement secP521R1FieldElement5 = new SecP521R1FieldElement(iArrCreate3);
        SecP521R1Field.subtract(iArrCreate3, secP521R1FieldElement4.f4537x, secP521R1FieldElement5.f4537x);
        SecP521R1Field.multiply(secP521R1FieldElement5.f4537x, iArrCreate2, secP521R1FieldElement5.f4537x);
        SecP521R1Field.subtract(secP521R1FieldElement5.f4537x, iArrCreate, secP521R1FieldElement5.f4537x);
        SecP521R1FieldElement secP521R1FieldElement6 = new SecP521R1FieldElement(iArrCreate2);
        SecP521R1Field.twice(secP521R1FieldElement.f4537x, secP521R1FieldElement6.f4537x);
        if (!zIsOne) {
            SecP521R1Field.multiply(secP521R1FieldElement6.f4537x, secP521R1FieldElement3.f4537x, secP521R1FieldElement6.f4537x);
        }
