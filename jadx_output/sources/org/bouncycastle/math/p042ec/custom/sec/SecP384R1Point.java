...
public class SecP384R1Point extends ECPoint.AbstractFp {
    ...
    public ECPoint add(ECPoint eCPoint) {
        ...
        SecP384R1FieldElement secP384R1FieldElement = (SecP384R1FieldElement) this.f4463x;
        SecP384R1FieldElement secP384R1FieldElement2 = (SecP384R1FieldElement) this.f4464y;
        ...
        SecP384R1FieldElement secP384R1FieldElement5 = (SecP384R1FieldElement) this.f4465zs[0];
        ...
        if (zIsOne) {
            iArr = secP384R1FieldElement3.f4533x;
            iArr2 = secP384R1FieldElement4.f4533x;
        } else {
            SecP384R1Field.square(secP384R1FieldElement5.f4533x, iArrCreate3);
            SecP384R1Field.multiply(iArrCreate3, secP384R1FieldElement3.f4533x, iArrCreate2);
            SecP384R1Field.multiply(iArrCreate3, secP384R1FieldElement5.f4533x, iArrCreate3);
            SecP384R1Field.multiply(iArrCreate3, secP384R1FieldElement4.f4533x, iArrCreate3);
            iArr = iArrCreate2;
            iArr2 = iArrCreate3;
        }
        boolean zIsOne2 = secP384R1FieldElement6.isOne();
        if (zIsOne2) {
            iArr3 = secP384R1FieldElement.f4533x;
            iArr4 = secP384R1FieldElement2.f4533x;
        } else {
            SecP384R1Field.square(secP384R1FieldElement6.f4533x, iArrCreate4);
            SecP384R1Field.multiply(iArrCreate4, secP384R1FieldElement.f4533x, iArrCreate);
            SecP384R1Field.multiply(iArrCreate4, secP384R1FieldElement6.f4533x, iArrCreate4);
            SecP384R1Field.multiply(iArrCreate4, secP384R1FieldElement2.f4533x, iArrCreate4);
            iArr3 = iArrCreate;
            iArr4 = iArrCreate4;
        }
        ...
        SecP384R1Field.square(iArrCreate6, secP384R1FieldElement7.f4533x);
        SecP384R1Field.subtract(secP384R1FieldElement7.f4533x, iArrCreate7, secP384R1FieldElement7.f4533x);
        SecP384R1FieldElement secP384R1FieldElement8 = new SecP384R1FieldElement(iArrCreate7);
        SecP384R1Field.subtract(iArrCreate3, secP384R1FieldElement7.f4533x, secP384R1FieldElement8.f4533x);
        Nat384.mul(secP384R1FieldElement8.f4533x, iArrCreate6, iArrCreate2);
        SecP384R1Field.addExt(iArrCreate, iArrCreate2, iArrCreate);
        SecP384R1Field.reduce(iArrCreate, secP384R1FieldElement8.f4533x);
        SecP384R1FieldElement secP384R1FieldElement9 = new SecP384R1FieldElement(iArrCreate5);
        if (!zIsOne) {
            SecP384R1Field.multiply(secP384R1FieldElement9.f4533x, secP384R1FieldElement5.f4533x, secP384R1FieldElement9.f4533x);
        }
        if (!zIsOne2) {
            SecP384R1Field.multiply(secP384R1FieldElement9.f4533x, secP384R1FieldElement6.f4533x, secP384R1FieldElement9.f4533x);
        }
    ...
    public ECPoint negate() {
        return isInfinity() ? this : new SecP384R1Point(this.curve, this.f4463x, this.f4464y.negate(), this.f4465zs);
    }
    ...
    public ECPoint twice() {
        ...
        ECCurve curve = getCurve();
        SecP384R1FieldElement secP384R1FieldElement = (SecP384R1FieldElement) this.f4464y;
        if (secP384R1FieldElement.isZero()) {
            return curve.getInfinity();
        }
        SecP384R1FieldElement secP384R1FieldElement2 = (SecP384R1FieldElement) this.f4463x;
        SecP384R1FieldElement secP384R1FieldElement3 = (SecP384R1FieldElement) this.f4465zs[0];
        int[] iArrCreate = Nat.create(12);
        int[] iArrCreate2 = Nat.create(12);
        int[] iArrCreate3 = Nat.create(12);
        SecP384R1Field.square(secP384R1FieldElement.f4533x, iArrCreate3);
        int[] iArrCreate4 = Nat.create(12);
        SecP384R1Field.square(iArrCreate3, iArrCreate4);
        boolean zIsOne = secP384R1FieldElement3.isOne();
        int[] iArr = secP384R1FieldElement3.f4533x;
        if (!zIsOne) {
            SecP384R1Field.square(secP384R1FieldElement3.f4533x, iArrCreate2);
            iArr = iArrCreate2;
        }
        SecP384R1Field.subtract(secP384R1FieldElement2.f4533x, iArr, iArrCreate);
        SecP384R1Field.add(secP384R1FieldElement2.f4533x, iArr, iArrCreate2);
        ...
        SecP384R1Field.multiply(iArrCreate3, secP384R1FieldElement2.f4533x, iArrCreate3);
        ...
        SecP384R1Field.square(iArrCreate2, secP384R1FieldElement4.f4533x);
        SecP384R1Field.subtract(secP384R1FieldElement4.f4533x, iArrCreate3, secP384R1FieldElement4.f4533x);
        SecP384R1Field.subtract(secP384R1FieldElement4.f4533x, iArrCreate3, secP384R1FieldElement4.f4533x);
        SecP384R1FieldElement secP384R1FieldElement5 = new SecP384R1FieldElement(iArrCreate3);
        SecP384R1Field.subtract(iArrCreate3, secP384R1FieldElement4.f4533x, secP384R1FieldElement5.f4533x);
        SecP384R1Field.multiply(secP384R1FieldElement5.f4533x, iArrCreate2, secP384R1FieldElement5.f4533x);
        SecP384R1Field.subtract(secP384R1FieldElement5.f4533x, iArrCreate, secP384R1FieldElement5.f4533x);
        SecP384R1FieldElement secP384R1FieldElement6 = new SecP384R1FieldElement(iArrCreate2);
        SecP384R1Field.twice(secP384R1FieldElement.f4533x, secP384R1FieldElement6.f4533x);
        if (!zIsOne) {
            SecP384R1Field.multiply(secP384R1FieldElement6.f4533x, secP384R1FieldElement3.f4533x, secP384R1FieldElement6.f4533x);
        }
