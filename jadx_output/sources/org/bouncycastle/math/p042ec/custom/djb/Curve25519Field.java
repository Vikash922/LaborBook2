...
public class Curve25519Field {
    ...
    private static final long f4469M = 4294967295L;

    /* JADX INFO: renamed from: P7 */
    private static final int f4471P7 = Integer.MAX_VALUE;
    private static final int PInv = 19;

    /* JADX INFO: renamed from: P */
    static final int[] f4470P = {-19, -1, -1, -1, -1, -1, -1, Integer.MAX_VALUE};
    ...
    public static void half(int[] iArr, int[] iArr2) {
        if ((iArr[0] & 1) == 0) {
            ...
            Nat256.add(iArr, f4470P, iArr2);
            Nat.shiftDownBit(8, iArr2, 0);
        }
    }

    public static void inv(int[] iArr, int[] iArr2) {
        Mod.checkedModOddInverse(f4470P, iArr, iArr2);
    }
    ...
    public static void random(SecureRandom secureRandom, int[] iArr) {
        ...
        } while (Nat.lessThan(8, iArr, f4470P) == 0);
    }
