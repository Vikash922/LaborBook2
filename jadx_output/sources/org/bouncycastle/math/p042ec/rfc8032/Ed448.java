...
import org.bouncycastle.math.p042ec.rfc7748.X448;
import org.bouncycastle.math.p042ec.rfc7748.X448Field;
...
public abstract class Ed448 {
    ...
    private static final int[] f4569P = {-1, -1, -1, -1, -1, -1, -1, -2, -1, -1, -1, -1, -1, -1};

    /* JADX INFO: renamed from: L */
    private static final int[] f4568L = {-1420278541, 595116690, -1916432555, 560775794, -1361693040, -1001465015, 2093622249, -1, -1, -1, -1, -1, -1, LockFreeTaskQueueCore.MAX_CAPACITY_MASK};
    ...
    /* JADX INFO: renamed from: org.bouncycastle.math.ec.rfc8032.Ed448$F */
    private static class C4698F extends X448Field {
        private C4698F() {
        }
    }
    ...
    private static class PointExt {
        ...
        private PointExt() {
            this.f4570x = C4698F.create();
            this.f4571y = C4698F.create();
            this.f4572z = C4698F.create();
        }
    }
    ...
    private static class PointPrecomp {
        ...
        private PointPrecomp() {
            this.f4573x = C4698F.create();
            this.f4574y = C4698F.create();
        }
    }
    ...
    private static int checkPoint(int[] iArr, int[] iArr2) {
        int[] iArrCreate = C4698F.create();
        int[] iArrCreate2 = C4698F.create();
        int[] iArrCreate3 = C4698F.create();
        C4698F.sqr(iArr, iArrCreate2);
        C4698F.sqr(iArr2, iArrCreate3);
        C4698F.mul(iArrCreate2, iArrCreate3, iArrCreate);
        C4698F.add(iArrCreate2, iArrCreate3, iArrCreate2);
        C4698F.mul(iArrCreate, 39081, iArrCreate);
        C4698F.subOne(iArrCreate);
        C4698F.add(iArrCreate, iArrCreate2, iArrCreate);
        C4698F.normalize(iArrCreate);
        return C4698F.isZero(iArrCreate);
    }
    ...
    private static int checkPoint(int[] iArr, int[] iArr2, int[] iArr3) {
        ...
        int[] iArrCreate2 = C4698F.create();
        int[] iArrCreate3 = C4698F.create();
        int[] iArrCreate4 = C4698F.create();
        C4698F.sqr(iArr, iArrCreate2);
        C4698F.sqr(iArr2, iArrCreate3);
        C4698F.sqr(iArr3, iArrCreate4);
        C4698F.mul(iArrCreate2, iArrCreate3, iArrCreate);
        C4698F.add(iArrCreate2, iArrCreate3, iArrCreate2);
        C4698F.mul(iArrCreate2, iArrCreate4, iArrCreate2);
        C4698F.sqr(iArrCreate4, iArrCreate4);
        C4698F.mul(iArrCreate, 39081, iArrCreate);
        C4698F.sub(iArrCreate, iArrCreate4, iArrCreate);
        C4698F.add(iArrCreate, iArrCreate2, iArrCreate);
        C4698F.normalize(iArrCreate);
        return C4698F.isZero(iArrCreate);
    }
    ...
    private static boolean decodePointVar(byte[] bArr, int i, boolean z, PointExt pointExt) {
        ...
        C4698F.decode(bArrCopy, 0, pointExt.f4571y);
        int[] iArrCreate = C4698F.create();
        int[] iArrCreate2 = C4698F.create();
        C4698F.sqr(pointExt.f4571y, iArrCreate);
        C4698F.mul(iArrCreate, 39081, iArrCreate2);
        C4698F.negate(iArrCreate, iArrCreate);
        C4698F.addOne(iArrCreate);
        C4698F.addOne(iArrCreate2);
        if (!C4698F.sqrtRatioVar(iArrCreate, iArrCreate2, pointExt.f4570x)) {
            return false;
        }
        C4698F.normalize(pointExt.f4570x);
        if (i2 == 1 && C4698F.isZeroVar(pointExt.f4570x)) {
            return false;
        }
        if (z ^ (i2 != (pointExt.f4570x[0] & 1))) {
            C4698F.negate(pointExt.f4570x, pointExt.f4570x);
        }
    ...
    private static int encodePoint(PointExt pointExt, byte[] bArr, int i) {
        int[] iArrCreate = C4698F.create();
        int[] iArrCreate2 = C4698F.create();
        C4698F.inv(pointExt.f4572z, iArrCreate2);
        C4698F.mul(pointExt.f4570x, iArrCreate2, iArrCreate);
        C4698F.mul(pointExt.f4571y, iArrCreate2, iArrCreate2);
        C4698F.normalize(iArrCreate);
        C4698F.normalize(iArrCreate2);
        int iCheckPoint = checkPoint(iArrCreate, iArrCreate2);
        C4698F.encode(iArrCreate2, bArr, i);
    ...
    private static boolean isNeutralElementVar(int[] iArr, int[] iArr2, int[] iArr3) {
        return C4698F.isZeroVar(iArr) && C4698F.areEqualVar(iArr2, iArr3);
    }
    ...
    private static void pointAdd(PointExt pointExt, PointExt pointExt2) {
        ...
        int[] iArrCreate3 = C4698F.create();
        int[] iArrCreate4 = C4698F.create();
        int[] iArrCreate5 = C4698F.create();
        int[] iArrCreate6 = C4698F.create();
        int[] iArrCreate7 = C4698F.create();
        int[] iArrCreate8 = C4698F.create();
        C4698F.mul(pointExt.f4572z, pointExt2.f4572z, iArrCreate);
        C4698F.sqr(iArrCreate, iArrCreate2);
        C4698F.mul(pointExt.f4570x, pointExt2.f4570x, iArrCreate3);
        C4698F.mul(pointExt.f4571y, pointExt2.f4571y, iArrCreate4);
        C4698F.mul(iArrCreate3, iArrCreate4, iArrCreate5);
        C4698F.mul(iArrCreate5, 39081, iArrCreate5);
        C4698F.add(iArrCreate2, iArrCreate5, iArrCreate6);
        C4698F.sub(iArrCreate2, iArrCreate5, iArrCreate7);
        C4698F.add(pointExt.f4570x, pointExt.f4571y, iArrCreate2);
        C4698F.add(pointExt2.f4570x, pointExt2.f4571y, iArrCreate5);
        C4698F.mul(iArrCreate2, iArrCreate5, iArrCreate8);
        C4698F.add(iArrCreate4, iArrCreate3, iArrCreate2);
        C4698F.sub(iArrCreate4, iArrCreate3, iArrCreate5);
        C4698F.carry(iArrCreate2);
        C4698F.sub(iArrCreate8, iArrCreate2, iArrCreate8);
        C4698F.mul(iArrCreate8, iArrCreate, iArrCreate8);
        C4698F.mul(iArrCreate5, iArrCreate, iArrCreate5);
        C4698F.mul(iArrCreate6, iArrCreate8, pointExt2.f4570x);
        C4698F.mul(iArrCreate5, iArrCreate7, pointExt2.f4571y);
        C4698F.mul(iArrCreate6, iArrCreate7, pointExt2.f4572z);
    }
    ...
    private static void pointAddPrecomp(PointPrecomp pointPrecomp, PointExt pointExt) {
        ...
        int[] iArrCreate6 = C4698F.create();
        int[] iArrCreate7 = C4698F.create();
        C4698F.sqr(pointExt.f4572z, iArrCreate);
        C4698F.mul(pointPrecomp.f4573x, pointExt.f4570x, iArrCreate2);
        C4698F.mul(pointPrecomp.f4574y, pointExt.f4571y, iArrCreate3);
        C4698F.mul(iArrCreate2, iArrCreate3, iArrCreate4);
        C4698F.mul(iArrCreate4, 39081, iArrCreate4);
        C4698F.add(iArrCreate, iArrCreate4, iArrCreate5);
        C4698F.sub(iArrCreate, iArrCreate4, iArrCreate6);
        C4698F.add(pointPrecomp.f4573x, pointPrecomp.f4574y, iArrCreate);
        C4698F.add(pointExt.f4570x, pointExt.f4571y, iArrCreate4);
        C4698F.mul(iArrCreate, iArrCreate4, iArrCreate7);
        C4698F.add(iArrCreate3, iArrCreate2, iArrCreate);
        C4698F.sub(iArrCreate3, iArrCreate2, iArrCreate4);
        C4698F.carry(iArrCreate);
        C4698F.sub(iArrCreate7, iArrCreate, iArrCreate7);
        C4698F.mul(iArrCreate7, pointExt.f4572z, iArrCreate7);
        C4698F.mul(iArrCreate4, pointExt.f4572z, iArrCreate4);
        C4698F.mul(iArrCreate5, iArrCreate7, pointExt.f4570x);
        C4698F.mul(iArrCreate4, iArrCreate6, pointExt.f4571y);
        C4698F.mul(iArrCreate5, iArrCreate6, pointExt.f4572z);
    }
    ...
    private static void pointAddVar(boolean z, PointExt pointExt, PointExt pointExt2) {
        ...
        int[] iArrCreate8 = C4698F.create();
        if (z) {
            C4698F.sub(pointExt.f4571y, pointExt.f4570x, iArrCreate8);
            iArr2 = iArrCreate2;
            iArr = iArrCreate5;
            iArr4 = iArrCreate6;
            iArr3 = iArrCreate7;
        } else {
            C4698F.add(pointExt.f4571y, pointExt.f4570x, iArrCreate8);
            iArr = iArrCreate2;
            iArr2 = iArrCreate5;
            iArr3 = iArrCreate6;
            iArr4 = iArrCreate7;
        ...
        C4698F.mul(iArrCreate3, iArrCreate4, iArrCreate5);
        C4698F.mul(iArrCreate5, 39081, iArrCreate5);
        C4698F.add(iArrCreate2, iArrCreate5, iArr3);
        C4698F.sub(iArrCreate2, iArrCreate5, iArr4);
        C4698F.add(pointExt2.f4570x, pointExt2.f4571y, iArrCreate5);
        C4698F.mul(iArrCreate8, iArrCreate5, iArrCreate8);
        C4698F.add(iArrCreate4, iArrCreate3, iArr);
        C4698F.sub(iArrCreate4, iArrCreate3, iArr2);
        C4698F.carry(iArr);
        C4698F.sub(iArrCreate8, iArrCreate2, iArrCreate8);
        C4698F.mul(iArrCreate8, iArrCreate, iArrCreate8);
        C4698F.mul(iArrCreate5, iArrCreate, iArrCreate5);
    ...
    private static void pointCopy(PointExt pointExt, PointExt pointExt2) {
        C4698F.copy(pointExt.f4570x, 0, pointExt2.f4570x, 0);
        C4698F.copy(pointExt.f4571y, 0, pointExt2.f4571y, 0);
        C4698F.copy(pointExt.f4572z, 0, pointExt2.f4572z, 0);
    }
    ...
    private static void pointDouble(PointExt pointExt) {
        ...
        int[] iArrCreate5 = C4698F.create();
        int[] iArrCreate6 = C4698F.create();
        C4698F.add(pointExt.f4570x, pointExt.f4571y, iArrCreate);
        C4698F.sqr(iArrCreate, iArrCreate);
        C4698F.sqr(pointExt.f4570x, iArrCreate2);
        C4698F.sqr(pointExt.f4571y, iArrCreate3);
        C4698F.add(iArrCreate2, iArrCreate3, iArrCreate4);
        C4698F.carry(iArrCreate4);
        C4698F.sqr(pointExt.f4572z, iArrCreate5);
        C4698F.add(iArrCreate5, iArrCreate5, iArrCreate5);
        C4698F.carry(iArrCreate5);
        C4698F.sub(iArrCreate4, iArrCreate5, iArrCreate6);
        C4698F.sub(iArrCreate, iArrCreate4, iArrCreate);
        C4698F.sub(iArrCreate2, iArrCreate3, iArrCreate2);
        C4698F.mul(iArrCreate, iArrCreate6, pointExt.f4570x);
        C4698F.mul(iArrCreate4, iArrCreate2, pointExt.f4571y);
        C4698F.mul(iArrCreate4, iArrCreate6, pointExt.f4572z);
    }

    private static void pointExtendXY(PointExt pointExt) {
        C4698F.one(pointExt.f4572z);
    }
    ...
    private static void pointLookup(int i, int i2, PointPrecomp pointPrecomp) {
        ...
        for (int i4 = 0; i4 < 16; i4++) {
            int i5 = ((i4 ^ i2) - 1) >> 31;
            C4698F.cmov(i5, precompBase, i3, pointPrecomp.f4573x, 0);
            C4698F.cmov(i5, precompBase, i3 + 16, pointPrecomp.f4574y, 0);
            i3 += 32;
        }
    }
    ...
    private static void pointLookup(int[] iArr, int i, int[] iArr2, PointExt pointExt) {
        ...
        for (int i5 = 0; i5 < 8; i5++) {
            int i6 = ((i5 ^ i3) - 1) >> 31;
            C4698F.cmov(i6, iArr2, i4, pointExt.f4570x, 0);
            C4698F.cmov(i6, iArr2, i4 + 16, pointExt.f4571y, 0);
            C4698F.cmov(i6, iArr2, i4 + 32, pointExt.f4572z, 0);
            i4 += 48;
        }
        C4698F.cnegate(i2, pointExt.f4570x);
    }
    ...
    private static int[] pointPrecompute(PointExt pointExt, int i) {
        ...
        int[] iArrCreateTable = C4698F.createTable(i * 3);
        int i2 = 0;
        int i3 = 0;
        while (true) {
            C4698F.copy(pointExtPointCopy.f4570x, 0, iArrCreateTable, i2);
            C4698F.copy(pointExtPointCopy.f4571y, 0, iArrCreateTable, i2 + 16);
            C4698F.copy(pointExtPointCopy.f4572z, 0, iArrCreateTable, i2 + 32);
            i2 += 48;
            i3++;
            if (i3 == i) {
    ...
    private static void pointSetNeutral(PointExt pointExt) {
        C4698F.zero(pointExt.f4570x);
        C4698F.one(pointExt.f4571y);
        C4698F.one(pointExt.f4572z);
    }
    ...
    public static void precompute() {
        synchronized (precompLock) {
            ...
            PointExt pointExt = new PointExt();
            C4698F.copy(B_x, 0, pointExt.f4570x, 0);
            C4698F.copy(B_y, 0, pointExt.f4571y, 0);
            pointExtendXY(pointExt);
            precompBaseTable = pointPrecomputeVar(pointExt, 32);
            precompBase = C4698F.createTable(Opcodes.IF_ICMPNE);
            int i = 0;
            for (int i2 = 0; i2 < 5; i2++) {
                ...
                int[] iArrCreateTable = C4698F.createTable(16);
                int[] iArrCreate = C4698F.create();
                C4698F.copy(pointExtArr2[0].f4572z, 0, iArrCreate, 0);
                C4698F.copy(iArrCreate, 0, iArrCreateTable, 0);
                int i9 = 0;
                while (true) {
                    int i10 = i9 + 1;
                    if (i10 >= 16) {
                    ...
                    C4698F.mul(iArrCreate, pointExtArr2[i10].f4572z, iArrCreate);
                    C4698F.copy(iArrCreate, 0, iArrCreateTable, i10 * 16);
                    i9 = i10;
                }
                C4698F.invVar(iArrCreate, iArrCreate);
                int[] iArrCreate2 = C4698F.create();
                while (i9 > 0) {
                    int i11 = i9 - 1;
                    C4698F.copy(iArrCreateTable, i11 * 16, iArrCreate2, 0);
                    C4698F.mul(iArrCreate2, iArrCreate, iArrCreate2);
                    C4698F.copy(iArrCreate2, 0, iArrCreateTable, i9 * 16);
                    C4698F.mul(iArrCreate, pointExtArr2[i9].f4572z, iArrCreate);
                    i9 = i11;
                }
                C4698F.copy(iArrCreate, 0, iArrCreateTable, 0);
                for (int i12 = 0; i12 < 16; i12++) {
                    PointExt pointExt3 = pointExtArr2[i12];
                    C4698F.copy(iArrCreateTable, i12 * 16, pointExt3.f4572z, 0);
                    C4698F.mul(pointExt3.f4570x, pointExt3.f4572z, pointExt3.f4570x);
                    C4698F.mul(pointExt3.f4571y, pointExt3.f4572z, pointExt3.f4571y);
                    C4698F.copy(pointExt3.f4570x, 0, precompBase, i);
                    C4698F.copy(pointExt3.f4571y, 0, precompBase, i + 16);
                    i += 32;
                }
            }
        }
    ...
    private static void scalarMult(byte[] bArr, PointExt pointExt, PointExt pointExt2) {
        ...
        Nat.cadd(14, (~iArr[0]) & 1, iArr, f4568L, iArr);
    ...
    private static void scalarMultBase(byte[] bArr, PointExt pointExt) {
        ...
        int[] iArr = new int[15];
        decodeScalar(bArr, 0, iArr);
        iArr[14] = Nat.cadd(14, (~iArr[0]) & 1, iArr, f4568L, iArr) + 4;
        ...
        while (true) {
            ...
            for (int i3 = 0; i3 < 5; i3++) {
                ...
                C4698F.cnegate(i6, pointPrecomp.f4573x);
    ...
    public static void scalarMultBaseXY(X448.Friend friend, byte[] bArr, int i, int[] iArr, int[] iArr2) {
        ...
        if (checkPoint(pointExt.f4570x, pointExt.f4571y, pointExt.f4572z) == 0) {
            throw new IllegalStateException();
        }
        C4698F.copy(pointExt.f4570x, 0, iArr, 0);
        C4698F.copy(pointExt.f4571y, 0, iArr2, 0);
    }

    private static void scalarMultOrderVar(PointExt pointExt, PointExt pointExt2) {
        byte[] wnafVar = getWnafVar(f4568L, 5);
    ...
    public static boolean validatePublicKeyFull(byte[] bArr, int i) {
        ...
        C4698F.normalize(pointExt.f4570x);
        C4698F.normalize(pointExt.f4571y);
        C4698F.normalize(pointExt.f4572z);
        if (isNeutralElementVar(pointExt.f4570x, pointExt.f4571y, pointExt.f4572z)) {
            return false;
        }
        PointExt pointExt2 = new PointExt();
        scalarMultOrderVar(pointExt, pointExt2);
        C4698F.normalize(pointExt2.f4570x);
        C4698F.normalize(pointExt2.f4571y);
        C4698F.normalize(pointExt2.f4572z);
        return isNeutralElementVar(pointExt2.f4570x, pointExt2.f4571y, pointExt2.f4572z);
    }
