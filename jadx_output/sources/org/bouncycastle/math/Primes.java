                    ...
                    if (iIntValue4 % 71 != 0 && iIntValue4 % 73 != 0 && iIntValue4 % 79 != 0 && iIntValue4 % 83 != 0) {
                        ...
                        if (iIntValue5 % 89 != 0 && iIntValue5 % 97 != 0 && iIntValue5 % 101 != 0 && iIntValue5 % 103 != 0) {
                            ...
                            if (iIntValue6 % 107 != 0 && iIntValue6 % 109 != 0 && iIntValue6 % 113 != 0 && iIntValue6 % 127 != 0) {
                                ...
                                if (iIntValue7 % 131 != 0 && iIntValue7 % Opcodes.L2F != 0 && iIntValue7 % Opcodes.F2I != 0 && iIntValue7 % Opcodes.FCMPL != 0) {
                                    int iIntValue8 = bigInteger.mod(BigInteger.valueOf(645328247)).intValue();
                                    if (iIntValue8 % Opcodes.DCMPL != 0 && iIntValue8 % 157 != 0 && iIntValue8 % Opcodes.IF_ICMPGT != 0 && iIntValue8 % Opcodes.GOTO != 0) {
                                        int iIntValue9 = bigInteger.mod(BigInteger.valueOf(1070560157)).intValue();
                                        if (iIntValue9 % Opcodes.LRETURN != 0 && iIntValue9 % Opcodes.PUTSTATIC != 0 && iIntValue9 % Opcodes.PUTFIELD != 0 && iIntValue9 % Opcodes.ATHROW != 0) {
                                            int iIntValue10 = bigInteger.mod(BigInteger.valueOf(1596463769)).intValue();
                                            if (iIntValue10 % Opcodes.INSTANCEOF != 0 && iIntValue10 % Opcodes.MULTIANEWARRAY != 0 && iIntValue10 % Opcodes.IFNONNULL != 0 && iIntValue10 % SMALL_FACTOR_LIMIT != 0) {
                                                return false;
                                            }
                                        }
                                    }
