...
public final class DERMacData {
    ...
    /* JADX INFO: renamed from: org.bouncycastle.crypto.util.DERMacData$1 */
    static /* synthetic */ class C45521 {
    ...
    public static final class Builder {
        ...
        public DERMacData build() {
            int i = C45521.$SwitchMap$org$bouncycastle$crypto$util$DERMacData$Type[this.type.ordinal()];
            C45521 c45521 = null;
            if (i == 1 || i == 2) {
                return new DERMacData(concatenate(this.type.getHeader(), DerUtil.toByteArray(this.idU), DerUtil.toByteArray(this.idV), DerUtil.toByteArray(this.ephemDataU), DerUtil.toByteArray(this.ephemDataV), this.text), c45521);
            }
            if (i == 3 || i == 4) {
                return new DERMacData(concatenate(this.type.getHeader(), DerUtil.toByteArray(this.idV), DerUtil.toByteArray(this.idU), DerUtil.toByteArray(this.ephemDataV), DerUtil.toByteArray(this.ephemDataU), this.text), c45521);
            }
    ...
    /* synthetic */ DERMacData(byte[] bArr, C45521 c45521) {
        this(bArr);
    }
