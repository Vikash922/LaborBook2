...
public class SM2Engine {
    ...
    /* JADX INFO: renamed from: org.bouncycastle.crypto.engines.SM2Engine$1 */
    ...
    private byte[] encrypt(byte[] bArr, int i, int i2) throws InvalidCipherTextException {
        ...
        return C45411.$SwitchMap$org$bouncycastle$crypto$engines$SM2Engine$Mode[this.mode.ordinal()] != 1 ? Arrays.concatenate(encoded, bArr2, bArr3) : Arrays.concatenate(encoded, bArr3, bArr2);
    }
