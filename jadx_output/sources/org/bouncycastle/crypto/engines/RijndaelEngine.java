...
public class RijndaelEngine implements BlockCipher {
    ...
    private long f4145A0;

    /* JADX INFO: renamed from: A1 */
    private long f4146A1;

    /* JADX INFO: renamed from: A2 */
    private long f4147A2;

    /* JADX INFO: renamed from: A3 */
    private long f4148A3;
    ...
    private void InvMixColumn() {
        ...
        long jMul0xe3 = 0;
        long jMul0xe4 = 0;
        for (int i = 0; i < this.f4149BC; i += 8) {
            int i2 = (int) ((this.f4145A0 >> i) & 255);
            int i3 = (int) ((this.f4146A1 >> i) & 255);
            int i4 = (int) ((this.f4147A2 >> i) & 255);
            long j = jMul0xe3;
            int i5 = (int) ((this.f4148A3 >> i) & 255);
            int i6 = -1;
        ...
        this.f4145A0 = jMul0xe;
        this.f4146A1 = jMul0xe4;
        this.f4147A2 = jMul0xe2;
        this.f4148A3 = jMul0xe3;
    }
    ...
    private void MixColumn() {
        ...
        this.f4145A0 = jMul0x2;
        this.f4146A1 = jMul0x24;
        this.f4147A2 = jMul0x22;
        this.f4148A3 = jMul0x23;
    }

    private void ShiftRow(byte[] bArr) {
        this.f4146A1 = shift(this.f4146A1, bArr[1]);
        this.f4147A2 = shift(this.f4147A2, bArr[2]);
        this.f4148A3 = shift(this.f4148A3, bArr[3]);
    }

    private void Substitution(byte[] bArr) {
        this.f4145A0 = applyS(this.f4145A0, bArr);
        this.f4146A1 = applyS(this.f4146A1, bArr);
        this.f4147A2 = applyS(this.f4147A2, bArr);
        this.f4148A3 = applyS(this.f4148A3, bArr);
    }
    ...
    private long[][] generateWorkingKey(byte[] bArr) {
        ...
        this.ROUNDS = length >= this.blockBits ? i + 6 : (this.f4149BC / 8) + 6;
        int i6 = 0;
        int i7 = 0;
        ...
        int i8 = 0;
        int i9 = 0;
        while (i8 < i && i9 < (this.ROUNDS + 1) * (this.f4149BC / 8)) {
            int i10 = i4;
            while (i10 < i5) {
                int i11 = this.f4149BC;
        ...
        int i12 = 0;
        while (i9 < (this.ROUNDS + i3) * (this.f4149BC / i2)) {
            int i13 = 0;
            while (i13 < 4) {
                byte[] bArr3 = bArr2[i13];
                i13++;
                bArr3[0] = (byte) (f4143S[bArr2[i13 % 4][i - 1] & 255] ^ bArr3[0]);
            }
            byte[] bArr4 = bArr2[0];
            int i14 = i12 + 1;
            ...
            if (i <= 6) {
                ...
                for (int i20 = 0; i20 < 4; i20++) {
                    ...
                    bArr7[4] = (byte) (bArr7[4] ^ f4143S[bArr7[3] & 255]);
                }
                int i21 = 5;
                while (i21 < i) {
                    int i22 = 0;
            ...
            int i23 = 0;
            while (i23 < i && i9 < (this.ROUNDS + i3) * (this.f4149BC / i2)) {
                for (int i24 = 0; i24 < 4; i24++) {
                    int i25 = this.f4149BC;
    ...
    private void packBlock(byte[] bArr, int i) {
        for (int i2 = 0; i2 != this.f4149BC; i2 += 8) {
            bArr[i] = (byte) (this.f4145A0 >> i2);
            bArr[i + 1] = (byte) (this.f4146A1 >> i2);
            int i3 = i + 3;
            bArr[i + 2] = (byte) (this.f4147A2 >> i2);
            i += 4;
            bArr[i3] = (byte) (this.f4148A3 >> i2);
        }
    }

    private long shift(long j, int i) {
        return ((j << (this.f4149BC - i)) | (j >>> i)) & this.BC_MASK;
    }

    private void unpackBlock(byte[] bArr, int i) {
        this.f4145A0 = bArr[i] & 255;
        this.f4146A1 = bArr[i + 1] & 255;
        int i2 = i + 3;
        this.f4147A2 = bArr[i + 2] & 255;
        int i3 = i + 4;
        this.f4148A3 = bArr[i2] & 255;
        for (int i4 = 8; i4 != this.f4149BC; i4 += 8) {
            this.f4145A0 |= ((long) (bArr[i3] & 255)) << i4;
            this.f4146A1 |= ((long) (bArr[i3 + 1] & 255)) << i4;
            int i5 = i3 + 3;
            this.f4147A2 |= ((long) (bArr[i3 + 2] & 255)) << i4;
            i3 += 4;
            this.f4148A3 |= ((long) (bArr[i5] & 255)) << i4;
        }
    }
