...
public class ESTResponse {
    ...
    private void process() throws IOException {
        ...
        if (ResourceResolver.BASE64_IDENTIFIER.equalsIgnoreCase(getHeader("content-transfer-encoding"))) {
    ...
    public Long getContentLength() {
        String firstValue = this.headers.getFirstValue(HttpHeaders.CONTENT_LENGTH);
        if (firstValue == null) {
            return null;
        }
        try {
