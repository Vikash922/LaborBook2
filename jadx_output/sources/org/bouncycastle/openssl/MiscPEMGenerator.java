...
import org.bouncycastle.util.p047io.pem.PemGenerationException;
import org.bouncycastle.util.p047io.pem.PemHeader;
import org.bouncycastle.util.p047io.pem.PemObject;
import org.bouncycastle.util.p047io.pem.PemObjectGenerator;
...
public class MiscPEMGenerator implements PemObjectGenerator {
    ...
    private String getHexEncoded(byte[] bArr) throws IOException {
        ...
        for (int i = 0; i != bArr.length; i++) {
            ...
            cArr[i2 + 1] = (char) bArr2[b & Ascii.f393SI];
        }
        return new String(cArr);
    }

    @Override // org.bouncycastle.util.p047io.pem.PemObjectGenerator
