...
public class ITSImplicitCertificateBuilder extends ITSCertificateBuilder {
    ...
    public ITSCertificate build(CertificateId certificateId, BigInteger bigInteger, BigInteger bigInteger2, PublicEncryptionKey publicEncryptionKey) {
        EccP256CurvePoint eccP256CurvePointCreateUncompressedP256 = EccP256CurvePoint.builder().createUncompressedP256(bigInteger, bigInteger2);
        ...
        builder.setVerificationKeyIndicator(VerificationKeyIndicator.builder().reconstructionValue(eccP256CurvePointCreateUncompressedP256).createVerificationKeyIndicator());
