...
public class BasicMimeParser implements MimeParser {
    ...
    private InputStream processStream(Headers headers, InputStream inputStream) {
        return headers.getContentTransferEncoding().equals(ResourceResolver.BASE64_IDENTIFIER) ? new Base64InputStream(inputStream) : headers.getContentTransferEncoding().equals("quoted-printable") ? new QuotedPrintableInputStream(inputStream) : inputStream;
    }
