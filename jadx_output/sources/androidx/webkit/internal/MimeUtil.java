    ...
    private static String guessHardcodedMime(String str) {
        ...
        switch (lowerCase.hashCode()) {
            ...
            case 108089:
                ...
                break;
            case 108150:
                b = !lowerCase.equals("mjs") ? (byte) -1 : Ascii.f397VT;
                break;
            case 108272:
                b = !lowerCase.equals("mp3") ? (byte) -1 : Ascii.f386FF;
                break;
            case 108273:
                b = !lowerCase.equals("mp4") ? (byte) -1 : Ascii.f384CR;
                break;
            case 108324:
                b = !lowerCase.equals("mpg") ? (byte) -1 : Ascii.f394SO;
                break;
            case 109961:
                b = !lowerCase.equals("oga") ? (byte) -1 : Ascii.f393SI;
                break;
            case 109967:
            ...
            case 111145:
                ...
                break;
            case 114276:
                b = !lowerCase.equals(SvgConstants.Tags.SVG) ? (byte) -1 : Ascii.SYN;
                break;
            case 114791:
            ...
            case 114833:
                ...
                break;
            case 117484:
                b = !lowerCase.equals("wav") ? (byte) -1 : Ascii.f385EM;
                break;
            case 118660:
            ...
            case 118807:
                ...
                break;
            case 120609:
                b = !lowerCase.equals("zip") ? (byte) -1 : Ascii.f387FS;
                break;
            case 3000872:
                b = !lowerCase.equals("apng") ? (byte) -1 : Ascii.f388GS;
                break;
            case 3145576:
                b = !lowerCase.equals("flac") ? (byte) -1 : Ascii.f392RS;
                break;
            case 3213227:
                b = !lowerCase.equals("html") ? (byte) -1 : Ascii.f396US;
                break;
            case 3259225:
