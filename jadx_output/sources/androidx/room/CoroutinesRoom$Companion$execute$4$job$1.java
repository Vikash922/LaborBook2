...
@DebugMetadata(m2734c = "androidx.room.CoroutinesRoom$Companion$execute$4$job$1", m2735f = "CoroutinesRoom.kt", m2736i = {}, m2737l = {}, m2738m = "invokeSuspend", m2739n = {}, m2740s = {})
final class CoroutinesRoom$Companion$execute$4$job$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        try {
            ...
            continuation.resumeWith(Result.m3325constructorimpl(objCall));
        } catch (Throwable th) {
            Continuation continuation2 = this.$continuation;
            Result.Companion companion2 = Result.INSTANCE;
            continuation2.resumeWith(Result.m3325constructorimpl(ResultKt.createFailure(th)));
        }
