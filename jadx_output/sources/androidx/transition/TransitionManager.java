...
public class TransitionManager {
    ...
    private static void changeScene(Scene scene, Transition transition) {
        ...
        Transition transitionMo2994clone = transition.mo2994clone();
        if (currentScene != null && currentScene.isCreatedFromLayoutResource()) {
            transitionMo2994clone.setCanRemoveViews(true);
        }
        sceneChangeSetup(sceneRoot, transitionMo2994clone);
        scene.enter();
        sceneChangeRunTransition(sceneRoot, transitionMo2994clone);
    }
    ...
    public static void m73go(Scene scene) {
    ...
    public static TransitionSeekController createSeekController(Scene scene, Transition transition) {
        ...
        transitionSet.addTransition(transitionMo2994clone);
        if (currentScene != null && currentScene.isCreatedFromLayoutResource()) {
    ...
    public static void beginDelayedTransition(ViewGroup viewGroup, Transition transition) {
        ...
        Transition transitionMo2994clone = transition.mo2994clone();
        sceneChangeSetup(viewGroup, transitionMo2994clone);
        Scene.setCurrentScene(viewGroup, null);
        sceneChangeRunTransition(viewGroup, transitionMo2994clone);
    }
