...
public class FlexBuffersBuilder {
    ...
    private int putKey(String str) {
        ...
        int iWritePosition = this.f123bb.writePosition();
        if ((this.flags & 1) != 0) {
    ...
    private int align(int i) {
        int i2 = 1 << i;
        int iPaddingBytes = Value.paddingBytes(this.f123bb.writePosition(), i2);
        while (true) {
    ...
    public ByteBuffer finish() {
        int iAlign = align(this.stack.get(0).elemWidth(this.f123bb.writePosition(), 0));
        writeAny(this.stack.get(0), iAlign);
        this.f123bb.put(this.stack.get(0).storedPackedType());
        this.f123bb.put((byte) iAlign);
        this.finished = true;
    ...
    private Value createVector(int i, int i2, int i3, boolean z, boolean z2, Value value) {
        ...
        if (value != null) {
            iMax = Math.max(iMax, value.elemWidth(this.f123bb.writePosition(), 0));
            i4 = 3;
        } else {
            i4 = 1;
        }
        ...
        for (int i7 = i2; i7 < this.stack.size(); i7++) {
            iMax2 = Math.max(iMax2, this.stack.get(i7).elemWidth(this.f123bb.writePosition(), i7 + i4));
            if (z && i7 == i2) {
        ...
        if (!z) {
            while (i8 < this.stack.size()) {
                this.f123bb.put(this.stack.get(i8).storedPackedType(iMax2));
                i8++;
            }
        }
        if (value != null) {
    ...
    private void writeOffset(long j, int i) {
        writeInt((int) (((long) this.f123bb.writePosition()) - j), i);
    }
    ...
    private Value createKeyVector(int i, int i2) {
        ...
        while (i3 < this.stack.size()) {
            i3++;
            iMax = Math.max(iMax, Value.elemWidth(4, 0, this.stack.get(i3).key, this.f123bb.writePosition(), i3));
        }
