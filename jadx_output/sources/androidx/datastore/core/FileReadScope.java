...
public class FileReadScope<T> implements ReadScope<T> {
    ...
    @DebugMetadata(m2734c = "androidx.datastore.core.FileReadScope", m2735f = "FileStorage.kt", m2736i = {0}, m2737l = {Opcodes.RET, Opcodes.GETSTATIC}, m2738m = "readData$suspendImpl", m2739n = {"$this"}, m2740s = {"L$0"})
    static final class C03951<T> extends ContinuationImpl {
        Object L$0;
        Object L$1;
        int label;
        ...
        C03951(FileReadScope<T> fileReadScope, Continuation<? super C03951> continuation) {
            super(continuation);
    ...
    */
    static /* synthetic */ <T> java.lang.Object readData$suspendImpl(androidx.datastore.core.FileReadScope<T> r8, kotlin.coroutines.Continuation<? super T> r9) {
        /*
            boolean r0 = r9 instanceof androidx.datastore.core.FileReadScope.C03951
            if (r0 == 0) goto L14
            r0 = r9
            androidx.datastore.core.FileReadScope$readData$1 r0 = (androidx.datastore.core.FileReadScope.C03951) r0
            int r1 = r0.label
        ...
        L6f:
            ...
            r9 = r7
        L73:
            kotlin.p024io.CloseableKt.closeFinally(r8, r5)     // Catch: java.io.FileNotFoundException -> L77
            return r9
        L77:
            r8 = r2
            goto L84
        ...
        L7f:
            r4 = move-exception
            kotlin.p024io.CloseableKt.closeFinally(r8, r9)     // Catch: java.io.FileNotFoundException -> L77
        ...
        La9:
            ...
            r8 = r7
        Lac:
            kotlin.p024io.CloseableKt.closeFinally(r8, r5)
            return r9
        Lb0:
            r8 = move-exception
            r7 = r9
        ...
        Lb5:
            r0 = move-exception
            kotlin.p024io.CloseableKt.closeFinally(r8, r9)
            throw r0
        Lba:
