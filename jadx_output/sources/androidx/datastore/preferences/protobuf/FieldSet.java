...
final class FieldSet<T extends FieldDescriptorLite<T>> {
    ...
    /* synthetic */ FieldSet(SmallSortedMap smallSortedMap, C04661 c04661) {
        this(smallSortedMap);
    }
    ...
    public static <T extends FieldDescriptorLite<T>> Builder<T> newBuilder() {
        return new Builder<>((C04661) null);
    }
    ...
    public static boolean isValidType(final WireFormat.FieldType type, final Object value) {
        ...
        switch (C04661.$SwitchMap$com$google$protobuf$WireFormat$JavaType[type.getJavaType().ordinal()]) {
            case 7:
    ...
    static void writeElementNoTag(final CodedOutputStream output, final WireFormat.FieldType type, final Object value) throws IOException {
        switch (C04661.$SwitchMap$com$google$protobuf$WireFormat$FieldType[type.ordinal()]) {
            case 1:
    ...
    static final class Builder<T extends FieldDescriptorLite<T>> {
        ...
        /* synthetic */ Builder(C04661 c04661) {
            this();
        }
