...
public class ExifInterface {
    ...
    private static final byte[] PNG_SIGNATURE = {-119, 80, 78, 71, Ascii.f384CR, 10, Ascii.SUB, 10};
    ...
    static {
        ...
        EXIF_POINTER_TAGS = new ExifTag[]{new ExifTag(TAG_SUB_IFD_POINTER, TIFFConstants.TIFFTAG_SUBIFD, 4), new ExifTag(TAG_EXIF_IFD_POINTER, 34665, 4), new ExifTag(TAG_GPS_INFO_IFD_POINTER, 34853, 4), new ExifTag(TAG_INTEROPERABILITY_IFD_POINTER, 40965, 4), new ExifTag(TAG_ORF_CAMERA_SETTINGS_IFD_POINTER, 8224, 1), new ExifTag(TAG_ORF_IMAGE_PROCESSING_IFD_POINTER, 8256, 1)};
    ...
    public void setAttribute(String str, String str2) {
        ...
        if ((TAG_DATETIME.equals(str3) || TAG_DATETIME_ORIGINAL.equals(str3) || TAG_DATETIME_DIGITIZED.equals(str3)) && strReplaceAll != null) {
            ...
            if (str2.length() != 19 || (!zFind && !zFind2)) {
                ...
                strReplaceAll = strReplaceAll.replaceAll(Identify.UNSET_VALUE, ":");
            }
        }
        ...
        if (str != null && NON_ZERO_TIME_PATTERN.matcher(str).matches()) {
            ...
            try {
                ...
                if (str3 != null) {
                    ...
                    if ((Marker.ANY_NON_NULL_MARKER.equals(strSubstring) || Identify.UNSET_VALUE.equals(strSubstring)) && ":".equals(str3.substring(3, 4)) && i2 <= 14) {
                        int i4 = ((i2 * 60) + i3) * 60000;
                        if (!Identify.UNSET_VALUE.equals(strSubstring)) {
                            i = -1;
                        }
                        time += (long) (i4 * i);
                    }
    ...
    private void getHeifAttributes(final SeekableByteOrderedDataInputStream seekableByteOrderedDataInputStream) throws IOException {
        ...
        try {
            try {
                ...
                if (ConstantEventSources.YES.equals(strExtractMetadata6)) {
                    strExtractMetadata = mediaMetadataRetriever.extractMetadata(29);
                    strExtractMetadata2 = mediaMetadataRetriever.extractMetadata(30);
                    strExtractMetadata3 = mediaMetadataRetriever.extractMetadata(31);
                } else if (ConstantEventSources.YES.equals(strExtractMetadata7)) {
                ...
                if (DEBUG) {
                    Log.d(TAG, "Heif meta: " + strExtractMetadata + SvgConstants.Attributes.f3330X + strExtractMetadata2 + ", rotation " + strExtractMetadata3);
                }
