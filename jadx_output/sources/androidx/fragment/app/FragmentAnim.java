    ...
    */
    static androidx.fragment.app.FragmentAnim.AnimationOrAnimator loadAnimation(android.content.Context r4, androidx.fragment.app.Fragment r5, boolean r6, boolean r7) {
        /*
            ...
            if (r1 == 0) goto L22
            android.view.ViewGroup r1 = r5.mContainer
            int r3 = androidx.fragment.C0559R.id.visible_removing_fragment_view_tag
    ...
    private static int transitToAnimResourceId(int i, boolean z) {
        if (i == 4097) {
            return z ? C0559R.animator.fragment_open_enter : C0559R.animator.fragment_open_exit;
        }
        if (i == 4099) {
            return z ? C0559R.animator.fragment_fade_enter : C0559R.animator.fragment_fade_exit;
        }
        if (i != 8194) {
            return -1;
        }
        return z ? C0559R.animator.fragment_close_enter : C0559R.animator.fragment_close_exit;
    }
