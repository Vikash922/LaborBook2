...
public abstract class FragmentTransaction {
    ...
    static final class C0610Op {
        ...
        C0610Op(int i, Fragment fragment) {
            this.mCmd = i;
        ...
        C0610Op(int i, Fragment fragment, Lifecycle.State state) {
            this.mCmd = i;
            this.mFragment = fragment;
    ...
    void addOp(C0610Op c0610Op) {
        this.mOps.add(c0610Op);
        c0610Op.mEnterAnim = this.mEnterAnim;
        c0610Op.mExitAnim = this.mExitAnim;
        c0610Op.mPopEnterAnim = this.mPopEnterAnim;
        c0610Op.mPopExitAnim = this.mPopExitAnim;
    }
    ...
    public FragmentTransaction remove(Fragment fragment) {
        addOp(new C0610Op(3, fragment));
        return this;
    }

    public FragmentTransaction hide(Fragment fragment) {
        addOp(new C0610Op(4, fragment));
        return this;
    }

    public FragmentTransaction show(Fragment fragment) {
        addOp(new C0610Op(5, fragment));
        return this;
    }

    public FragmentTransaction detach(Fragment fragment) {
        addOp(new C0610Op(6, fragment));
        return this;
    }

    public FragmentTransaction attach(Fragment fragment) {
        addOp(new C0610Op(7, fragment));
        return this;
    }

    public FragmentTransaction setPrimaryNavigationFragment(Fragment fragment) {
        addOp(new C0610Op(8, fragment));
        return this;
    }

    public FragmentTransaction setMaxLifecycle(Fragment fragment, Lifecycle.State state) {
        addOp(new C0610Op(10, fragment, state));
        return this;
    }
