...
public final class WorkSpec {
    ...
    public int hashCode() {
        int iHashCode = ((((this.f146id.hashCode() * 31) + this.state.hashCode()) * 31) + this.workerClassName.hashCode()) * 31;
        String str = this.inputMergerClassName;
    ...
    public static class IdAndState {
        ...
        public boolean equals(Object o) {
            ...
            return this.f147id.equals(idAndState.f147id);
        }

        public int hashCode() {
            return (this.f147id.hashCode() * 31) + this.state.hashCode();
        }
    }
    ...
    public static class WorkInfoPojo {
        ...
        public WorkInfo toWorkInfo() {
            ...
            return new WorkInfo(UUID.fromString(this.f148id), this.state, this.output, this.tags, data, this.runAttemptCount);
        }
        ...
        public boolean equals(Object o) {
            ...
            if (str == null ? workInfoPojo.f148id != null : !str.equals(workInfoPojo.f148id)) {
                return false;
            }
