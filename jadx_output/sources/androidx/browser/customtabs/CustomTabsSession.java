...
public final class CustomTabsSession {
    ...
    class BinderC01911 extends IEngagementSignalsCallback.Stub {
        private final Handler mHandler = new Handler(Looper.getMainLooper());
        final /* synthetic */ EngagementSignalsCallback val$callback;

        BinderC01911(EngagementSignalsCallback engagementSignalsCallback) {
    ...
    private IEngagementSignalsCallback.Stub createEngagementSignalsCallbackWrapper(EngagementSignalsCallback engagementSignalsCallback) {
        return new BinderC01911(engagementSignalsCallback);
    }
    ...
    class BinderC01922 extends IEngagementSignalsCallback.Stub {
        private final Executor mExecutor;
        final /* synthetic */ EngagementSignalsCallback val$callback;
        final /* synthetic */ Executor val$executor;

        BinderC01922(Executor executor, EngagementSignalsCallback engagementSignalsCallback) {
    ...
    private IEngagementSignalsCallback.Stub createEngagementSignalsCallbackWrapper(EngagementSignalsCallback engagementSignalsCallback, Executor executor) {
        return new BinderC01922(executor, engagementSignalsCallback);
    }
