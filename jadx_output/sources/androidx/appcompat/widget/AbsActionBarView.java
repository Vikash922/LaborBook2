...
abstract class AbsActionBarView extends ViewGroup {
    ...
    AbsActionBarView(Context context, AttributeSet attributeSet, int i) {
        ...
        if (context.getTheme().resolveAttribute(C0068R.attr.actionBarPopupTheme, typedValue, true) && typedValue.resourceId != 0) {
    ...
    protected void onConfigurationChanged(Configuration configuration) {
        ...
        TypedArray typedArrayObtainStyledAttributes = getContext().obtainStyledAttributes(null, C0068R.styleable.ActionBar, C0068R.attr.actionBarStyle, 0);
        setContentHeight(typedArrayObtainStyledAttributes.getLayoutDimension(C0068R.styleable.ActionBar_height, 0));
