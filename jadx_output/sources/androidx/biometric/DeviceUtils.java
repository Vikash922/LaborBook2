...
class DeviceUtils {
    ...
    static boolean shouldUseFingerprintForCrypto(Context context, String str, String str2) {
        ...
        return isVendorInList(context, str, C0178R.array.crypto_fingerprint_fallback_vendors) || isModelInPrefixList(context, str2, C0178R.array.crypto_fingerprint_fallback_prefixes);
    }
    ...
    static boolean shouldHideFingerprintDialog(Context context, String str) {
        ...
        return isModelInPrefixList(context, str, C0178R.array.hide_fingerprint_instantly_prefixes);
    }
    ...
    static boolean shouldDelayShowingPrompt(Context context, String str) {
        ...
        return isModelInList(context, str, C0178R.array.delay_showing_prompt_models);
    }
    ...
    static boolean canAssumeStrongBiometrics(Context context, String str) {
        ...
        return isModelInList(context, str, C0178R.array.assume_strong_biometrics_models);
    }
