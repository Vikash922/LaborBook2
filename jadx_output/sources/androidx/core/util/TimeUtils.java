...
public final class TimeUtils {
    ...
    private static int formatDurationLocked(long j, int i) {
        ...
        int i10 = i6 + 1;
        boolean z = i != 0;
        int iPrintField = printField(cArr, i2, Barcode128.CODE_AC_TO_B, i10, false, 0);
        int iPrintField2 = printField(cArr, i3, Barcode128.START_B, iPrintField, iPrintField != i10, z ? 2 : 0);
