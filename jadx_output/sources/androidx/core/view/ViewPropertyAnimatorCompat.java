...
public final class ViewPropertyAnimatorCompat {
    ...
    public ViewPropertyAnimatorCompat m41x(float f) {
        View view = this.mView.get();
        if (view != null) {
            view.animate().x(f);
        }
    ...
    public ViewPropertyAnimatorCompat m42y(float f) {
        View view = this.mView.get();
        if (view != null) {
            view.animate().y(f);
        }
    ...
    public ViewPropertyAnimatorCompat m43z(float f) {
        View view = this.mView.get();
        if (view != null) {
            Api21Impl.m44z(view.animate(), f);
        }
        return this;
    }
    ...
    static class Api21Impl {
        ...
        /* JADX INFO: renamed from: z */
        static ViewPropertyAnimator m44z(ViewPropertyAnimator viewPropertyAnimator, float f) {
