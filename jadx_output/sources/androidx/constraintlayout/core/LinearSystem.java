...
public class LinearSystem {
    ...
    public SolverVariable createObjectVariable(Object obj) {
        ...
        if (obj instanceof ConstraintAnchor) {
            ...
            if (solverVariable.f21id == -1 || solverVariable.f21id > this.mVariablesID || this.mCache.mIndexedVariables[solverVariable.f21id] == null) {
                if (solverVariable.f21id != -1) {
                    solverVariable.reset();
                }
                int i = this.mVariablesID + 1;
                this.mVariablesID = i;
                this.mNumColumns++;
                solverVariable.f21id = i;
    ...
    public SolverVariable createSlackVariable() {
        ...
        this.mVariablesID = i;
        this.mNumColumns++;
        solverVariableAcquireSolverVariable.f21id = i;
    ...
    public SolverVariable createErrorVariable(int i, String str) {
        ...
        this.mNumColumns++;
        solverVariableAcquireSolverVariable.f21id = i2;
    ...
    */
    ...
    private final int optimize(Row row, boolean z) {
        ...
        while (!z2) {
            ...
            if (pivotCandidate != null) {
                if (this.mAlreadyTestedCandidates[pivotCandidate.f21id]) {
                    return i2;
                }
                this.mAlreadyTestedCandidates[pivotCandidate.f21id] = true;
            }
            if (pivotCandidate != null) {
    ...
    private void displayRows() {
        ...
        String str = "";
        for (int i = 0; i < this.mNumRows; i++) {
            str = (str + this.mRows[i]) + StringUtils.f4768LF;
        }
        System.out.println(str + this.mGoal + StringUtils.f4768LF);
    }

    public void displayReadableRows() {
        displaySolverVariables();
        String str = " num vars " + this.mVariablesID + StringUtils.f4768LF;
        for (int i = 0; i < this.mVariablesID + 1; i++) {
            SolverVariable solverVariable = this.mCache.mIndexedVariables[i];
            if (solverVariable != null && solverVariable.isFinalValue) {
                str = str + " $[" + i + "] => " + solverVariable + " = " + solverVariable.computedValue + StringUtils.f4768LF;
            }
        }
        String str2 = str + StringUtils.f4768LF;
        for (int i2 = 0; i2 < this.mVariablesID + 1; i2++) {
            ...
            if (solverVariable2 != null && solverVariable2.isSynonym) {
                str2 = str2 + " ~[" + i2 + "] => " + solverVariable2 + " = " + this.mCache.mIndexedVariables[solverVariable2.synonym] + " + " + solverVariable2.synonymDelta + StringUtils.f4768LF;
            }
        }
        String str3 = str2 + "\n\n #  ";
        ...
        if (this.mGoal != null) {
            str3 = str3 + "Goal: " + this.mGoal + StringUtils.f4768LF;
        }
    ...
    public void displayVariablesReadableRows() {
        ...
        for (int i = 0; i < this.mNumRows; i++) {
            if (this.mRows[i].variable.mType == SolverVariable.Type.UNRESTRICTED) {
                str = (str + this.mRows[i].toReadableString()) + StringUtils.f4768LF;
            }
        }
        System.out.println(str + this.mGoal + StringUtils.f4768LF);
    }
    ...
    private void displaySolverVariables() {
        System.out.println("Display Rows (" + this.mNumRows + SvgConstants.Attributes.f3330X + this.mNumColumns + ")\n");
    }
