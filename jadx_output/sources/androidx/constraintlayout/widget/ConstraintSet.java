...
public class ConstraintSet {
    ...
    static {
        mapToConstant.append(C0257R.styleable.Constraint_layout_constraintLeft_toLeftOf, 25);
        ...
        mapToConstant.append(C0257R.styleable.Constraint_layout_constraintBaseline_toTopOf, 91);
        mapToConstant.append(C0257R.styleable.Constraint_layout_constraintBaseline_toBottomOf, 92);
        ...
        mapToConstant.append(C0257R.styleable.Constraint_guidelineUseRtl, 99);
        ...
        mapToConstant.append(C0257R.styleable.Constraint_layout_constraintLeft_creator, 87);
        mapToConstant.append(C0257R.styleable.Constraint_layout_constraintTop_creator, 87);
        mapToConstant.append(C0257R.styleable.Constraint_layout_constraintRight_creator, 87);
        mapToConstant.append(C0257R.styleable.Constraint_layout_constraintBottom_creator, 87);
        mapToConstant.append(C0257R.styleable.Constraint_layout_constraintBaseline_creator, 87);
        ...
        mapToConstant.append(C0257R.styleable.Constraint_layout_constraintWidth, 95);
        mapToConstant.append(C0257R.styleable.Constraint_layout_constraintHeight, 96);
        ...
        mapToConstant.append(C0257R.styleable.Constraint_animateRelativeTo, 64);
        ...
        mapToConstant.append(C0257R.styleable.Constraint_layout_wrapBehaviorInParent, 97);
        ...
        mapToConstant.append(C0257R.styleable.Constraint_polarRelativeTo, 82);
        mapToConstant.append(C0257R.styleable.Constraint_transformPivotTarget, 83);
        mapToConstant.append(C0257R.styleable.Constraint_quantizeMotionSteps, 84);
        mapToConstant.append(C0257R.styleable.Constraint_quantizeMotionPhase, 85);
        mapToConstant.append(C0257R.styleable.Constraint_quantizeMotionInterpolator, 86);
        overrideMapToConstant.append(C0257R.styleable.ConstraintOverride_layout_editor_absoluteY, 6);
        overrideMapToConstant.append(C0257R.styleable.ConstraintOverride_layout_editor_absoluteY, 7);
        overrideMapToConstant.append(C0257R.styleable.ConstraintOverride_android_orientation, 27);
        overrideMapToConstant.append(C0257R.styleable.ConstraintOverride_layout_goneMarginLeft, 13);
        overrideMapToConstant.append(C0257R.styleable.ConstraintOverride_layout_goneMarginTop, 16);
        overrideMapToConstant.append(C0257R.styleable.ConstraintOverride_layout_goneMarginRight, 14);
        overrideMapToConstant.append(C0257R.styleable.ConstraintOverride_layout_goneMarginBottom, 11);
        overrideMapToConstant.append(C0257R.styleable.ConstraintOverride_layout_goneMarginStart, 15);
        overrideMapToConstant.append(C0257R.styleable.ConstraintOverride_layout_goneMarginEnd, 12);
        overrideMapToConstant.append(C0257R.styleable.ConstraintOverride_layout_constraintVertical_weight, 40);
        overrideMapToConstant.append(C0257R.styleable.ConstraintOverride_layout_constraintHorizontal_weight, 39);
        overrideMapToConstant.append(C0257R.styleable.ConstraintOverride_layout_constraintHorizontal_chainStyle, 41);
        overrideMapToConstant.append(C0257R.styleable.ConstraintOverride_layout_constraintVertical_chainStyle, 42);
        overrideMapToConstant.append(C0257R.styleable.ConstraintOverride_layout_constraintHorizontal_bias, 20);
        overrideMapToConstant.append(C0257R.styleable.ConstraintOverride_layout_constraintVertical_bias, 37);
        overrideMapToConstant.append(C0257R.styleable.ConstraintOverride_layout_constraintDimensionRatio, 5);
        overrideMapToConstant.append(C0257R.styleable.ConstraintOverride_layout_constraintLeft_creator, 87);
        overrideMapToConstant.append(C0257R.styleable.ConstraintOverride_layout_constraintTop_creator, 87);
        overrideMapToConstant.append(C0257R.styleable.ConstraintOverride_layout_constraintRight_creator, 87);
        overrideMapToConstant.append(C0257R.styleable.ConstraintOverride_layout_constraintBottom_creator, 87);
        overrideMapToConstant.append(C0257R.styleable.ConstraintOverride_layout_constraintBaseline_creator, 87);
        overrideMapToConstant.append(C0257R.styleable.ConstraintOverride_android_layout_marginLeft, 24);
        overrideMapToConstant.append(C0257R.styleable.ConstraintOverride_android_layout_marginRight, 28);
        overrideMapToConstant.append(C0257R.styleable.ConstraintOverride_android_layout_marginStart, 31);
        overrideMapToConstant.append(C0257R.styleable.ConstraintOverride_android_layout_marginEnd, 8);
        overrideMapToConstant.append(C0257R.styleable.ConstraintOverride_android_layout_marginTop, 34);
        overrideMapToConstant.append(C0257R.styleable.ConstraintOverride_android_layout_marginBottom, 2);
        overrideMapToConstant.append(C0257R.styleable.ConstraintOverride_android_layout_width, 23);
        overrideMapToConstant.append(C0257R.styleable.ConstraintOverride_android_layout_height, 21);
        overrideMapToConstant.append(C0257R.styleable.ConstraintOverride_layout_constraintWidth, 95);
        overrideMapToConstant.append(C0257R.styleable.ConstraintOverride_layout_constraintHeight, 96);
        overrideMapToConstant.append(C0257R.styleable.ConstraintOverride_android_visibility, 22);
        overrideMapToConstant.append(C0257R.styleable.ConstraintOverride_android_alpha, 43);
        overrideMapToConstant.append(C0257R.styleable.ConstraintOverride_android_elevation, 44);
        overrideMapToConstant.append(C0257R.styleable.ConstraintOverride_android_rotationX, 45);
        overrideMapToConstant.append(C0257R.styleable.ConstraintOverride_android_rotationY, 46);
        overrideMapToConstant.append(C0257R.styleable.ConstraintOverride_android_rotation, 60);
        overrideMapToConstant.append(C0257R.styleable.ConstraintOverride_android_scaleX, 47);
        overrideMapToConstant.append(C0257R.styleable.ConstraintOverride_android_scaleY, 48);
        overrideMapToConstant.append(C0257R.styleable.ConstraintOverride_android_transformPivotX, 49);
        overrideMapToConstant.append(C0257R.styleable.ConstraintOverride_android_transformPivotY, 50);
        overrideMapToConstant.append(C0257R.styleable.ConstraintOverride_android_translationX, 51);
        overrideMapToConstant.append(C0257R.styleable.ConstraintOverride_android_translationY, 52);
        overrideMapToConstant.append(C0257R.styleable.ConstraintOverride_android_translationZ, 53);
        overrideMapToConstant.append(C0257R.styleable.ConstraintOverride_layout_constraintWidth_default, 54);
        overrideMapToConstant.append(C0257R.styleable.ConstraintOverride_layout_constraintHeight_default, 55);
        overrideMapToConstant.append(C0257R.styleable.ConstraintOverride_layout_constraintWidth_max, 56);
        overrideMapToConstant.append(C0257R.styleable.ConstraintOverride_layout_constraintHeight_max, 57);
        overrideMapToConstant.append(C0257R.styleable.ConstraintOverride_layout_constraintWidth_min, 58);
        overrideMapToConstant.append(C0257R.styleable.ConstraintOverride_layout_constraintHeight_min, 59);
        overrideMapToConstant.append(C0257R.styleable.ConstraintOverride_layout_constraintCircleRadius, 62);
        overrideMapToConstant.append(C0257R.styleable.ConstraintOverride_layout_constraintCircleAngle, 63);
        overrideMapToConstant.append(C0257R.styleable.ConstraintOverride_animateRelativeTo, 64);
        overrideMapToConstant.append(C0257R.styleable.ConstraintOverride_transitionEasing, 65);
        overrideMapToConstant.append(C0257R.styleable.ConstraintOverride_drawPath, 66);
        overrideMapToConstant.append(C0257R.styleable.ConstraintOverride_transitionPathRotate, 67);
        overrideMapToConstant.append(C0257R.styleable.ConstraintOverride_motionStagger, 79);
        overrideMapToConstant.append(C0257R.styleable.ConstraintOverride_android_id, 38);
        overrideMapToConstant.append(C0257R.styleable.ConstraintOverride_motionTarget, 98);
        overrideMapToConstant.append(C0257R.styleable.ConstraintOverride_motionProgress, 68);
        overrideMapToConstant.append(C0257R.styleable.ConstraintOverride_layout_constraintWidth_percent, 69);
        overrideMapToConstant.append(C0257R.styleable.ConstraintOverride_layout_constraintHeight_percent, 70);
        overrideMapToConstant.append(C0257R.styleable.ConstraintOverride_chainUseRtl, 71);
        overrideMapToConstant.append(C0257R.styleable.ConstraintOverride_barrierDirection, 72);
        overrideMapToConstant.append(C0257R.styleable.ConstraintOverride_barrierMargin, 73);
        overrideMapToConstant.append(C0257R.styleable.ConstraintOverride_constraint_referenced_ids, 74);
        overrideMapToConstant.append(C0257R.styleable.ConstraintOverride_barrierAllowsGoneWidgets, 75);
        overrideMapToConstant.append(C0257R.styleable.ConstraintOverride_pathMotionArc, 76);
        overrideMapToConstant.append(C0257R.styleable.ConstraintOverride_layout_constraintTag, 77);
        overrideMapToConstant.append(C0257R.styleable.ConstraintOverride_visibilityMode, 78);
        overrideMapToConstant.append(C0257R.styleable.ConstraintOverride_layout_constrainedWidth, 80);
        overrideMapToConstant.append(C0257R.styleable.ConstraintOverride_layout_constrainedHeight, 81);
        overrideMapToConstant.append(C0257R.styleable.ConstraintOverride_polarRelativeTo, 82);
        overrideMapToConstant.append(C0257R.styleable.ConstraintOverride_transformPivotTarget, 83);
        overrideMapToConstant.append(C0257R.styleable.ConstraintOverride_quantizeMotionSteps, 84);
        overrideMapToConstant.append(C0257R.styleable.ConstraintOverride_quantizeMotionPhase, 85);
        overrideMapToConstant.append(C0257R.styleable.ConstraintOverride_quantizeMotionInterpolator, 86);
        overrideMapToConstant.append(C0257R.styleable.ConstraintOverride_layout_wrapBehaviorInParent, 97);
    }
    ...
    */
    ...
    public static class Layout {
        ...
        static {
            ...
            mapToConstant.append(C0257R.styleable.Layout_guidelineUseRtl, 90);
            ...
            mapToConstant.append(C0257R.styleable.Layout_layout_constraintLeft_creator, 91);
            mapToConstant.append(C0257R.styleable.Layout_layout_constraintTop_creator, 91);
            mapToConstant.append(C0257R.styleable.Layout_layout_constraintRight_creator, 91);
            mapToConstant.append(C0257R.styleable.Layout_layout_constraintBottom_creator, 91);
            mapToConstant.append(C0257R.styleable.Layout_layout_constraintBaseline_creator, 91);
            ...
            mapToConstant.append(C0257R.styleable.Layout_layout_constraintWidth, 41);
            mapToConstant.append(C0257R.styleable.Layout_layout_constraintHeight, 42);
            mapToConstant.append(C0257R.styleable.Layout_layout_constrainedWidth, 41);
            mapToConstant.append(C0257R.styleable.Layout_layout_constrainedHeight, 42);
            mapToConstant.append(C0257R.styleable.Layout_layout_wrapBehaviorInParent, 76);
        ...
        void fillFromAttributeList(Context context, AttributeSet attrs) {
            TypedArray typedArrayObtainStyledAttributes = context.obtainStyledAttributes(attrs, C0257R.styleable.Layout);
            this.mApply = true;
    ...
    public static class Transform {
        ...
        static {
            ...
            mapToConstant.append(C0257R.styleable.Transform_transformPivotTarget, 12);
        }

        void fillFromAttributeList(Context context, AttributeSet attrs) {
            TypedArray typedArrayObtainStyledAttributes = context.obtainStyledAttributes(attrs, C0257R.styleable.Transform);
            this.mApply = true;
            int indexCount = typedArrayObtainStyledAttributes.getIndexCount();
            for (int i = 0; i < indexCount; i++) {
                int index = typedArrayObtainStyledAttributes.getIndex(i);
    ...
    public static class PropertySet {
        ...
        void fillFromAttributeList(Context context, AttributeSet attrs) {
            TypedArray typedArrayObtainStyledAttributes = context.obtainStyledAttributes(attrs, C0257R.styleable.PropertySet);
            this.mApply = true;
            int indexCount = typedArrayObtainStyledAttributes.getIndexCount();
            for (int i = 0; i < indexCount; i++) {
                int index = typedArrayObtainStyledAttributes.getIndex(i);
    ...
    public static class Motion {
        ...
        static {
            ...
            mapToConstant.append(C0257R.styleable.Motion_animateRelativeTo, 5);
            mapToConstant.append(C0257R.styleable.Motion_animateCircleAngleTo, 6);
            mapToConstant.append(C0257R.styleable.Motion_motionStagger, 7);
            mapToConstant.append(C0257R.styleable.Motion_quantizeMotionSteps, 8);
            mapToConstant.append(C0257R.styleable.Motion_quantizeMotionPhase, 9);
            mapToConstant.append(C0257R.styleable.Motion_quantizeMotionInterpolator, 10);
        }

        void fillFromAttributeList(Context context, AttributeSet attrs) {
            TypedArray typedArrayObtainStyledAttributes = context.obtainStyledAttributes(attrs, C0257R.styleable.Motion);
            this.mApply = true;
            int indexCount = typedArrayObtainStyledAttributes.getIndexCount();
            for (int i = 0; i < indexCount; i++) {
                int index = typedArrayObtainStyledAttributes.getIndex(i);
    ...
    public void clone(ConstraintSet set) {
        ...
        for (Integer num : set.mConstraints.keySet()) {
            Constraint constraint = set.mConstraints.get(num);
            if (constraint != null) {
                this.mConstraints.put(num, constraint.m2959clone());
            }
        }
    }
    ...
    */
    ...
    private Constraint fillFromAttributeList(Context context, AttributeSet attrs, boolean override) {
        Constraint constraint = new Constraint();
        TypedArray typedArrayObtainStyledAttributes = context.obtainStyledAttributes(attrs, override ? C0257R.styleable.ConstraintOverride : C0257R.styleable.Constraint);
    ...
    public static Constraint buildDelta(Context context, XmlPullParser parser) {
        ...
        Constraint constraint = new Constraint();
        TypedArray typedArrayObtainStyledAttributes = context.obtainStyledAttributes(attributeSetAsAttributeSet, C0257R.styleable.ConstraintOverride);
    ...
    private int[] convertReferenceString(View view, String referenceIdString) {
        ...
        while (i < strArrSplit.length) {
            ...
            try {
                iIntValue = C0257R.id.class.getField(strTrim).getInt(null);
    ...
    class WriteXmlEngine {
        ...
        void writeLayout() throws IOException {
            ...
            for (Integer num : ConstraintSet.this.mConstraints.keySet()) {
                ...
                String[] strArr = {"spread", CommonCssConstants.WRAP, "percent"};
                ...
                writeEnum("app:barrierDirection", layout.mBarrierDirection, new String[]{"left", "right", "top", CommonCssConstants.BOTTOM, "start", "end"}, -1);
        ...
        void writeVariable(String name, String value) throws IOException {
            ...
            this.writer.write(":");
            this.writer.write(", " + value);
            this.writer.write(StringUtils.f4768LF);
        }
    }
